(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
    ...
    90186: (e, t, n) => {
      ...
      n.d(t, { filterAriaProps: () => o, filterDataProps: () => i, filterProps: () => r, isAriaAttribute: () => s, isDataAttribute: () => a });
    },
    24437: (e, t, n) => {
      "use strict";
      n.d(t, { DialogBreakpoints: () => o });
      var i = n(88803);
      const o = { SmallHeight: i["small-height-breakpoint"], TabletSmall: i["tablet-small-breakpoint"], TabletNormal: i["tablet-normal-breakpoint"] };
    },
    69654: (e, t, n) => {
      "use strict";
      ...
      var i = n(50959),
        ...
        l = n(40281);
      function u(e) {
        const { children: t, renderInput: o, onCancel: u, containerClassName: h, inputContainerClassName: m, iconClassName: v, ...p } = e;
        return i.createElement(
          "div",
          { className: r()(l.container, h) },
          i.createElement("div", { className: r()(l.inputContainer, m, u && l.withCancel) }, o || i.createElement(d, { ...p })),
          t,
          i.createElement(s.Icon, { className: r()(l.icon, v), icon: c }),
          u && i.createElement("div", { className: l.cancel, onClick: u }, a.t(null, void 0, n(20036)))
        );
      }
      function d(e) {
        const { className: t, reference: n, value: o, onChange: a, onFocus: s, onBlur: c, onKeyDown: u, onSelect: d, placeholder: h, ...m } = e;
    ...
    41153: (e, t, n) => {
      ...
      const S = i.memo(
        function (e) {
          ...
          return i.createElement(
            "div",
            { className: v()(b.action, l && b.active, E, m && b.withDescription, d && b.selected), onClick: C, ref: h },
            p &&
              (void 0 !== n
                ? i.createElement(w.CircleLogo, { logoUrl: n, size: m ? "xsmall" : "xxxsmall", className: v()(b.icon, E) })
          ...
          function y(e) {
            return i.createElement(A.HighlightedText, { text: e, rules: o, queryString: r, className: v()(l && b.highlighted, l && b.active) });
          }
        },
        (e, t) =>
          Object.keys(t)
                ...
                i.createElement(
                  ...
                  e.name
                    ? i.createElement(
                        ...
                        { summary: e.name, className: N.section, open: k[e.id], onStateChange: (t) => w({ ...k, [e.id]: t }) },
                        e.actions.map(A)
                      )
                    : e.actions.map(A)
                )
        ...
        return i.createElement(z.AdaptivePopupDialog, {
          ...
          render: function () {
            return i.createElement(
              i.Fragment,
              null,
              i.createElement(T.DialogSearch, { placeholder: p.t(null, void 0, n(52298)), onChange: f, reference: h }),
              i.createElement(
                "div",
      ...
      const B = { horizontalAttachEdge: h.HorizontalAttachEdge.Right, horizontalDropDirection: h.HorizontalDropDirection.FromRightToLeft };
      function U(e) {
        const { element: t, ...n } = e,
          [o, r] = (0, i.useState)(x()),
          [m, v] = (0, i.useState)(""),
          ...
          { activeIdx: C, setActiveIdx: E } = (0, c.useKeyboardNavigation)(p.current, o, function (e) {
            ...
            r(
              m
                ? (function (e, t, n) {
                    ...
                    return (0, s.rankedSearch)({ data: i, rules: n, queryString: t, primaryKey: "label", secondaryKey: "description" });
                  })(n.sections, m, g)
                : x()
            );
          }, [m, n.sections, g]);
        ...
        return i.createElement(a.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, (e) =>
          e ? i.createElement(F, { ...n, ...y }) : i.createElement(R, { ...n, ...y, position: (0, h.getPopupPositioner)(t, B), doNotCloseOn: t })
        );
        function x() {
      ...
      class H {
        ...
        _render() {
          const e = { title: this._title, sections: this._sectionsGetter(), element: this._element, onClose: this.close };
      ...
      function r(e, t, n, r = "keydown") {
        ...
        return (
          ...
          (0, i.useEffect)(() => {
            ...
            const i = (e) => {
              var i;
              e.repeat || (13 === (0, o.hashFromEvent)(e) && n(null !== (i = t[a]) && void 0 !== i ? i : null, e));
            };
            return (
    ...
    76068: (e, t, n) => {
      ...
      function a(e) {
        ...
        const r = (0, o.getStyleClasses)(e.size, e.className),
          a = null !== (n = null !== (t = e.alt) && void 0 !== t ? t : e.title) && void 0 !== n ? n : "";
        return (0, o.isCircleLogoWithUrlProps)(e)
          ...
          : i.createElement("span", { className: r, title: e.title, "aria-label": e["aria-label"], "aria-hidden": e["aria-hidden"] }, e.placeholderLetter);
      }
    },
    58492: (e, t, n) => {
      "use strict";
    ...
    19785: (e, t, n) => {
      ...
      var i = n(1722);
      function o(e) {
        const { data: t, rules: n, queryString: o, isPreventedFromFiltering: r, primaryKey: a, secondaryKey: s = a, optionalPrimaryKey: c, tertiaryKey: l } = e;
        return t
          .map((e) => {
            ...
            return (
              n.forEach((e) => {
                ...
                if (((m.lastIndex = 0), (0, i.isString)(t) && t && t.toLowerCase() === o.toLowerCase()))
                  return (h = 4), void (d = null === (n = t.match(v)) || void 0 === n ? void 0 : n.index);
                if ((0, i.isString)(t) && v.test(t)) return (h = 3), void (d = null === (a = t.match(v)) || void 0 === a ? void 0 : a.index);
                if ((0, i.isString)(r) && v.test(r)) return (h = 2), void (d = null === (s = r.match(v)) || void 0 === s ? void 0 : s.index);
                if ((0, i.isString)(r) && m.test(r)) return (h = 2), void (d = null === (c = r.match(m)) || void 0 === c ? void 0 : c.index);
                if (Array.isArray(u)) for (const e of u) if (v.test(e)) return (h = 1), void (d = null === (l = e.match(v)) || void 0 === l ? void 0 : l.index);
              }),
        ...
        const n = [],
          ...
          o =
            e
              ...
              .join("(.*?)") + "(.*)";
        return (
          n.push({ fullMatch: new RegExp(`(${s(e)})`, "i"), re: new RegExp(`^${o}`, "i"), reserveRe: new RegExp(o, "i"), fuzzyHighlight: !0 }),
            ...
            ? s
                ...
                .map((e, t) =>
                  i.createElement(
                    i.Fragment,
                    { key: t },
                    l[t] ? i.createElement("span", { className: o(a.highlighted, c) }, e) : i.createElement("span", null, e)
                  )
                )
            : s
        );
    ...
    51613: (e, t, n) => {
      ...
      function s(e) {
        ...
        return i.createElement("div", {
          className: r()(a.separator, "small" === t && a.small, "normal" === t && a.normal, "large" === t && a.large, n),
          role: "separator",
          "aria-hidden": o,
        });
      }
    ...
    76197: (e, t, n) => {
      ...
      const c = (0, i.forwardRef)(function (e, t) {
        const { open: n, summary: o, children: c, onStateChange: l, tabIndex: u, className: d, ...h } = e;
        return i.createElement(
          i.Fragment,
          null,
          i.createElement(
      ...
      function l(e, t) {
        return (n) => {
          ...
          let y = null !== (l = t.verticalAttachEdge) && void 0 !== l ? l : c.verticalAttachEdge,
            x = null !== (u = t.verticalDropDirection) && void 0 !== u ? u : c.verticalDropDirection;
          y === i.AutoStrict && (m < v.y + v.height + C + h ? ((y = i.Top), (x = r.FromBottomToTop)) : ((y = i.Bottom), (x = r.FromTopToBottom)));
          const k = y === i.Top ? -1 * C : C,
            w = p === o.Right ? v.right : v.left,
            A = y === i.Top ? v.top : v.bottom,
            b = { x: w - (f === a.FromRightToLeft ? d : 0) + g, y: A - (x === r.FromBottomToTop ? h : 0) + k };
    ...
    84298: (e, t, n) => {
      ...
      function s(e, t, s) {
        ...
        if (d.size > 1) {
          const e = (0, r.createAction)("Mixed", o.t(null, void 0, n(95093)), void 0, void 0, null === t.selectedCurrency, () => l(null));
          p.actions.push(e);
        }
        ...
        return (y.length > 0 || E.length > 0) && c.push({ id: "second_section", actions: E.concat(y) }), c;
      }
    },
    79188: (e, t, n) => {
      "use strict";
      ...
      class a extends r.AbstractJsonStoreService {
        constructor(e, t) {
          super(e, t, "FAVORITE_CURRENCY_UNIT_CONVERSION_CHANGED", "currencyUnitConversion.favorites", { currencies: new Set(), units: new Set() });
        }
        add(e, t) {
          const n = this.get();
    ...
    14818: (e, t, n) => {
      ...
      function s(e, t, s) {
        ...
        if (d.size > 1) {
          const e = (0, r.createAction)("Mixed", o.t(null, void 0, n(95093)), void 0, void 0, null === t.selectedUnit, () => l(null));
          p.actions.push(e);
        }
        ...
        (C.length > 0 || E.length > 0) && p.actions.push(...E.sort((e, t) => e.label.toLowerCase().localeCompare(t.label.toLowerCase())), ...C),
          p.actions.length > 0 && c.push(p);
    ...
    89691: (e, t, n) => {
      ...
      function i(e, t, n, i, o, r, a, s) {
        return { id: e, label: t, icon: n, description: i, isActive: o, onClick: r, isFavorite: a, onFavoriteClick: s };
      }
