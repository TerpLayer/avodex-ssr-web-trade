(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7550],
  {
    ...
    94720: (e, t, n) => {
      ...
      function d(e) {
        const { startIcon: t, icon: n, iconOnly: o, children: a, endIcon: u, primaryText: d, secondaryText: h } = e,
          p = null != t ? t : n,
          m = !(t || n || u || o) && !a && d && h;
            ...
            (function (e) {
              return (
                ...
                s.createElement(
                  ...
                  s.createElement("span", { className: l()["primary-text"] }, " ", e.primaryText, " "),
                  "string" == typeof e.secondaryText
                    ? s.createElement("span", { className: l()["secondary-text"] }, " ", e.secondaryText, " ")
                    : s.createElement(
                        "span",
      ...
      function g(e) {
        const { reference: t, tooltipText: n, ...r } = e,
          { isGrouped: o, cellState: i, disablePositionAdjustment: a } = (0, s.useContext)(p.ControlGroupContext),
    ...
    86332: (e, t, n) => {
      ...
      const s = n(50959).createContext({ isGrouped: !1, cellState: { isTop: !0, isRight: !0, isBottom: !0, isLeft: !0 } });
    },
    95604: (e, t, n) => {
      "use strict";
      function s(e) {
    ...
    67029: (e, t, n) => {
      ...
      const f = { FontSizeMedium: (0, o.ensureDefined)(d()["font-size-medium"]), FontSizeLarge: (0, o.ensureDefined)(d()["font-size-large"]) },
        g = { passive: !1 };
      function v(e, t) {
        const {
            style: n,
          ...
          { isGrouped: P, cellState: S, disablePositionAdjustment: N = !1 } = (0, s.useContext)(l.ControlGroupContext),
    ...
    78274: (e, t, n) => {
      ...
      function a(e) {
        ...
        return s.createElement("span", { className: r(i()["inner-slot"], n && i().interactive, o && i().icon, t) }, a);
      }
      function l(e) {
        const { className: t, children: n } = e;
        return s.createElement("span", { className: r(i()["inner-slot"], i()["inner-middle-slot"], t) }, n);
      }
      function c(e) {
        const { className: t, interactive: n = !0, icon: o = !1, children: a } = e;
        return s.createElement("span", { className: r(i()["inner-slot"], n && i().interactive, o && i().icon, t) }, a);
    ...
    31261: (e, t, n) => {
        ...
        return s.createElement(h.ControlSkeleton, {
          ...
          middleSlot: s.createElement(
            ...
            s.createElement("input", {
              ...K,
              className: r(f().input, f()[`size-${Z}`], L, U && f()["with-start-slot"], A && f()["with-end-slot"]),
              disabled: I,
              readOnly: M,
              ref: F,
            })
      ...
      function y(e) {
        e = (0, c.useControl)(e);
        const { disabled: t, autoSelectOnFocus: n, tabIndex: r = 0, onFocus: o, onBlur: h, reference: p, containerReference: m = null } = e,
          f = (0, s.useRef)(null),
          g = (0, s.useRef)(null),
          [y, w] = (0, u.useFocus)(),
          _ = t ? void 0 : y ? -1 : r,
    ...
    48027: (e, t, n) => {
      ...
      function o(e) {
        ...
        return { ...e, intent: o || (l ? "primary" : "default"), highlight: null != i ? i : l, onFocus: u, onBlur: d };
      }
    },
    29202: (e, t, n) => {
      "use strict";
    ...
    36383: (e, t, n) => {
      ...
      var s = n(50959),
        r = n(27267);
      function o(e) {
        const { click: t, mouseDown: n, touchEnd: o, touchStart: i, handler: a, reference: l, ownerDocument: c = document } = e,
          u = (0, s.useRef)(null),
    ...
    99663: (e, t, n) => {
      ...
      class r extends s.Component {
        ...
        render() {
          return s.createElement("div", { style: { position: "fixed", zIndex: 150, left: 0, top: 0 }, ref: this.props.reference });
        }
      }
    ...
    90186: (e, t, n) => {
      ...
      n.d(t, { filterAriaProps: () => r, filterDataProps: () => s, filterProps: () => o, isAriaAttribute: () => a, isDataAttribute: () => i });
    },
    34094: (e, t, n) => {
      "use strict";
        ...
        i = (e) =>
          Array.isArray(e) || (0, s.isValidElement)(e)
            ? s.Children.toArray(e)
                .reduce((e, t) => {
                  let n = "";
                  return (n = (0, s.isValidElement)(t) && r(t) ? i(t.props.children) : (0, s.isValidElement)(t) && !r(t) ? "" : o(t)), e.concat(n);
                }, "")
                .trim()
            : o(e);
    },
        ...
        return () => {
          ...
          if (void 0 === e) {
            const n = document.createElement("div"),
              s = n.style;
            (s.visibility = "hidden"), (s.width = "100px"), (s.msOverflowStyle = "scrollbar"), document.body.appendChild(n);
      ...
      function c(e) {
        ...
        if (e && 1 == ++a) {
          const e = o(t, "overflow"),
            a = i(t, "padding-right");
          "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (r(n, "right", `${s()}px`), (t.style.paddingRight = `${a + s()}px`), (l = !0)),
    ...
    24437: (e, t, n) => {
      ...
      var s = n(88803);
      const r = { SmallHeight: s["small-height-breakpoint"], TabletSmall: s["tablet-small-breakpoint"], TabletNormal: s["tablet-normal-breakpoint"] };
    },
    21788: (e, t, n) => {
      "use strict";
      ...
      class m extends o.PureComponent {
        constructor(e) {
          if (
            ...
            (this._resize = () => {
              null === this._raf &&
                (this._raf = requestAnimationFrame(() => {
                  this.setState({ appearingWidth: void 0, appearingPosition: void 0, isMeasureValid: void 0 }), (this._raf = null);
                }));
            }),
            (this._handleMeasure = () => {
            ...
            (this._handleChange = (e) => {
              const { preventSearchOnEmptyQuery: t, allowUserDefinedValues: n, onChange: s, onSuggestionsOpen: r, onSuggestionsClose: o } = this.props,
                i = e.currentTarget.value;
              if (t && "" === i) this.setState({ queryValue: i, isOpened: !1, active: void 0 }), o && o();
              else {
                const e = this._suggestions(i),
                  t = Object.keys(e).length > 0;
                this.setState({ queryValue: i, isOpened: t, active: n ? void 0 : this._getActiveKeyByValue(i) }), t && r && r();
              }
              n && s && s(i);
            }),
            (this._handleItemClick = (e) => {
              const t = e.currentTarget.id;
              this.setState({ queryValue: f(this.props.source)[t] }), this.props.onChange && this.props.onChange(t), this._close();
            }),
            (this._handleKeyDown = (e) => {
              if (-1 === [s.DownArrow, s.UpArrow, s.Enter, s.Escape].indexOf(e.which)) return;
              const { allowUserDefinedValues: t, value: n, onChange: r, onSuggestionsOpen: o } = this.props,
              ...
              switch (e.which) {
                ...
                case s.Enter:
                  ...
                  t && (a && m ? this.setState(this._valueToQuery(m)) : (m = l)),
                    void 0 !== m && (this._close(), a || this._blur(), m !== n ? r && r(m) : this.setState(this._valueToQuery(m)));
              }
            }),
        ...
        render() {
          return o.createElement(u.OutsideEvent, { handler: this._handleOutsideClick, click: !0 }, (e) =>
            o.createElement(
              "div",
                ...
                endSlot: Object.keys(this._suggestions(this.state.queryValue)).length
                  ? o.createElement(
                      ...
                      o.createElement(
                        ...
                        o.createElement(a.ToolWidgetCaret, { className: h.icon, dropped: this.state.isOpened })
                      )
                    )
                  : void 0,
        ...
        _renderSuggestionsItems() {
          const e = this._suggestions(this.state.queryValue),
            t = Object.keys(e).map((t) => {
              ...
              return o.createElement("li", { id: t, key: t, className: n, onClick: this._handleItemClick }, e[t]);
            }),
