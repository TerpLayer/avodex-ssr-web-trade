  ...
  [6265],
  {
    ...
    63374: (e, t, l) => {
      ...
      class S extends r.PureComponent {
        constructor(e) {
          ...
          super(e),
            (this._handleClose = (e) => {
              ((null == e ? void 0 : e.target) && (e.target.closest('[data-dialog-name="gopro"]') || e.target.closest("[data-name=support-dialog]"))) ||
                this.props.onClose();
            }),
            (this._renderFooterLeft = (e) => {
              ...
              if ((0, g.isStudy)(t)) return r.createElement(h.StudyDefaultsManager, { model: l, source: t, mode: e ? "compact" : "normal" });
        ...
        _renderChildren() {
          return ({ requestResize: e }) => {
            ...
            const { pages: l, source: n, model: o } = this.props,
              ...
              c = l.map(({ label: e, id: t }) => ({ label: e, id: t, dataId: `indicator-properties-dialog-tabs-${t}` }));
            return r.createElement(
              ...
              r.createElement(
                ...
                "Component" in s ? r.createElement(s.Component, { source: n, model: o }) : r.createElement(b.PropertiesEditorTab, { page: a, tableKey: s.id })
              )
            );
          };
        }
      ...
      var B = l(12949),
        ...
        q = l(21579);
      const K = {
          [x.LineStudyPlotStyle.Line]: { type: x.LineStudyPlotStyle.Line, order: 0, icon: z, label: i.t(null, void 0, l(1277)) },
          [x.LineStudyPlotStyle.LineWithBreaks]: { type: x.LineStudyPlotStyle.LineWithBreaks, order: 1, icon: F, label: i.t(null, void 0, l(54934)) },
          [x.LineStudyPlotStyle.StepLine]: { type: x.LineStudyPlotStyle.StepLine, order: 2, icon: H, label: i.t(null, void 0, l(79511)) },
          [x.LineStudyPlotStyle.StepLineWithBreaks]: { type: x.LineStudyPlotStyle.StepLineWithBreaks, order: 3, icon: G, label: i.t(null, void 0, l(64108)) },
          ...
          [x.LineStudyPlotStyle.Histogram]: { type: x.LineStudyPlotStyle.Histogram, order: 5, icon: O, label: i.t(null, void 0, l(11091)) },
          [x.LineStudyPlotStyle.Cross]: { type: x.LineStudyPlotStyle.Cross, order: 6, icon: j, label: i.t(null, { context: "chart_type" }, l(74274)) },
          [x.LineStudyPlotStyle.Area]: { type: x.LineStudyPlotStyle.Area, order: 7, icon: Q, label: i.t(null, void 0, l(42097)) },
          [x.LineStudyPlotStyle.AreaWithBreaks]: { type: x.LineStudyPlotStyle.AreaWithBreaks, order: 8, icon: Z, label: i.t(null, void 0, l(65262)) },
          [x.LineStudyPlotStyle.Columns]: { type: x.LineStudyPlotStyle.Columns, order: 9, icon: Y, label: i.t(null, void 0, l(36018)) },
          [x.LineStudyPlotStyle.Circles]: { type: x.LineStudyPlotStyle.Circles, order: 10, icon: q, label: i.t(null, void 0, l(39495)) },
        },
        $ = Object.values(K)
      ...
      class J extends r.PureComponent {
        render() {
          const { id: e, plotType: t, className: l, priceLine: n, plotTypeChange: o, priceLineChange: i, disabled: s } = this.props;
          ...
          return r.createElement(A.IconDropdown, { id: e, disabled: s, className: l, hideArrowButton: !0, items: [a, ...$], value: t, onChange: o });
        }
      }
      var ee = l(41552),
        te = l(62433);
      ...
      class re extends r.PureComponent {
        ...
        render() {
          const { id: e, paletteColor: t, paletteColorProps: n, styleProp: o, isLine: s, hasPlotTypeSelect: a, grouped: c, offset: p } = this.props,
            d = n.childs();
          return r.createElement(
            B.InputRow,
            { grouped: c, label: r.createElement("div", { className: te.childRowContainer }, i.t(t.name, { context: "input" }, l(88601))), offset: p },
      ...
      class me extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            l && !n
              ...
              : r.createElement(ee.ColorWithThicknessSelect, { disabled: 0 === p.value(), color: o, transparency: a, thickness: s }),
            r.createElement(J, {
              id: (0, k.createDomId)(e, "plot-type-select"),
              disabled: 0 === p.value(),
              className: te.smallStyleControl,
        ...
        _getInputForRgb() {
          ...
          return n && t
            ? r.createElement(de.LineWidthSelect, { id: (0, k.createDomId)(e, "line-width-select"), property: n, disabled: 0 === o.value() })
            : null;
        }
      }
      ...
      class ge extends r.PureComponent {
        ...
        render() {
          const { id: e, isRGB: t, title: l, color: n, transparency: o, thickness: i, children: s, switchable: a = !0, offset: c, grouped: p } = this.props;
            ...
            r.createElement(
              ...
              !t &&
                r.createElement(
                  r.Fragment,
                  null,
                  r.createElement(ge, { id: e, title: He, color: l, transparency: i, display: s, switchable: !1, offset: !0, grouped: !0 }),
                  r.createElement(ge, { id: e, title: Ge, color: n, transparency: i, display: s, switchable: !1, offset: !0, grouped: !0 })
                ),
      ...
      var we = l(87795),
        ...
        Te = l(95586);
      const _e = {
          [Te.MarkLocation.AboveBar]: { value: Te.MarkLocation.AboveBar, content: i.t(null, void 0, l(41389)), order: 0 },
          [Te.MarkLocation.BelowBar]: { value: Te.MarkLocation.BelowBar, content: i.t(null, void 0, l(78626)), order: 1 },
          ...
          [Te.MarkLocation.Absolute]: { value: Te.MarkLocation.Absolute, content: i.t(null, void 0, l(29520)), order: 4 },
        },
        ke = Object.values(_e).sort((e, t) => e.order - t.order);
      class xe extends r.PureComponent {
        render() {
          const { id: e, shapeLocation: t, className: l, menuItemClassName: n, shapeLocationChange: o, disabled: i } = this.props;
          return r.createElement(Ee.Select, { id: e, disabled: i, className: l, menuItemClassName: n, items: ke, value: t, onChange: o });
        }
      }
      ...
      class De extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            !a && !i && r.createElement(ee.ColorWithThicknessSelect, { disabled: 0 === h.value(), color: c, transparency: p }),
      ...
      class Ne extends r.PureComponent {
        render() {
          ...
          return r.createElement(A.IconDropdown, { id: e, disabled: o, className: l, hideArrowButton: !0, items: Be, value: t, onChange: n });
        }
      }
      ...
      class ze extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            !n && !l && r.createElement(ee.ColorWithThicknessSelect, { disabled: 0 === p.value(), color: i, transparency: s }),
            r.createElement(Ne, {
      ...
      class Qe extends r.PureComponent {
        render() {
          ...
          if ("chars" === u || "shapes" === u) {
            ...
            return r.createElement(
              ...
              null,
              "chars" === u
                ? r.createElement(De, { id: a, title: t, char: e.char, property: d, hasPalette: Boolean(h && h.palette), isRGB: m })
                : r.createElement(ze, { id: a, title: t, property: d, hasPalette: Boolean(h && h.palette), isRGB: m }),
              h &&
                h.palette &&
                h.paletteProps &&
                r.createElement(ce, { title: t, plot: n, palette: h.palette, paletteProps: h.paletteProps, hideVisibilitySwitch: !0, styleProp: d })
            );
          }
          if ((0, x.isOhlcPlot)(n)) {
            const e = n.target,
        ...
        _getPlotSwitch(e, t, l) {
          return r.createElement(
            oe.PropertyTable.Row,
            null,
            r.createElement(oe.PropertyTable.Cell, { placement: "first", colSpan: 2 }, r.createElement(pe, { id: e, title: t, display: l }))
          );
        }
      }
      function Ze(e, t) {
      ...
      class $e extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(qe.LineStyleSelect, { ...t, lineStyle: (0, R.getPropertyValue)(e), lineStyleChange: this._onLineStyleChange });
        }
      }
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                "div",
                { className: te.group },
                r.createElement(ee.ColorWithThicknessSelect, { disabled: !a.value(), color: l, transparency: i, thickness: o }),
                r.createElement($e, { id: (0, k.createDomId)(e, "line-style-select"), disabled: !a.value(), className: te.smallStyleControl, lineStyle: n })
              ),
              r.createElement(
                "div",
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                oe.PropertyTable.Cell,
                { placement: "first", colSpan: 2 },
                r.createElement(M, { id: "chart-orders-labels-switch", title: i.t(null, void 0, l(86520)), visible: t })
              )
            ),
            r.createElement(
              oe.PropertyTable.Row,
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              oe.PropertyTable.Row,
              null,
              r.createElement(oe.PropertyTable.Cell, { placement: "first", colSpan: 2, grouped: !0 }, r.createElement(M, { id: a, title: a, visible: s }))
            ),
            r.createElement(
              B.InputRow,
          ...
          return l
            ...
            .map((e) =>
              r.createElement(
                ...
                r.createElement(ee.ColorWithThicknessSelect, { disabled: !o.value(), color: l[+e], transparency: n[+e] })
              )
            );
        }
      }
      ...
      class ut extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(ee.ColorWithThicknessSelect, { disabled: !i.value(), color: l, transparency: t.child("transparency"), thickness: n }),
            r.createElement($e, { id: (0, k.createDomId)(e, "line-style-select"), disabled: !i.value(), className: te.smallStyleControl, lineStyle: o })
          );
        }
      }
      var ht, mt;
        ...
        render() {
          ...
          return Object.keys(s).map((t, n) => {
            ...
            return "horizlines" === e || "vertlines" === e
              ? r.createElement(ut, { key: t, title: (0, o.ensureDefined)(null === (a = l.graphics[e]) || void 0 === a ? void 0 : a[t]).name, property: d })
              : "lines" === e
              ? r.createElement(ut, { key: t, title: (0, o.ensureDefined)(null === (c = l.graphics.lines) || void 0 === c ? void 0 : c[t]).title, property: d })
              : "hhists" === e
              ? r.createElement(dt, { key: t, hHistInfo: (0, o.ensureDefined)(null === (p = l.graphics.hhists) || void 0 === p ? void 0 : p[t]), property: d })
              : null;
          });
        }
      }
      ...
      class wt extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(yt.FontSizeSelect, { ...t, fontSizes: bt, fontSize: e.value(), fontSizeChange: this._onFontSizeChange });
        }
      }
      ...
      class Et extends r.PureComponent {
        ...
        _renderColors() {
          ...
          return l
            .childNames()
            .filter((e) => a.has(e))
            .map((e) => r.createElement(ye, { key: e, id: e, title: e, color: l.childs()[e], visible: i.childs()[e], thickness: n.childs()[e] }));
        }
      }
      Et.contextType = L.StylePropertyContext;
      ...
      class Mt extends r.PureComponent {
        ...
        render() {
          ...
          const { metaInfo: p } = this.props,
            ...
            L = y.childs().pocLines,
            R = (0, o.ensureDefined)(null === (a = p.graphics.horizlines) || void 0 === a ? void 0 : a.pocLines),
          ...
          return r.createElement(
            ...
            r.createElement(
              oe.PropertyTable.Row,
              null,
              r.createElement(oe.PropertyTable.Cell, { placement: "first" }, r.createElement("div", { className: te.childRowContainer }, Lt)),
              r.createElement(
                oe.PropertyTable.Cell,
                { placement: "last" },
                r.createElement(lt.IntegerInputComponent, {
            ...
            r.createElement(
              oe.PropertyTable.Row,
              null,
              r.createElement(oe.PropertyTable.Cell, { placement: "first" }, r.createElement("div", { className: te.childRowContainer }, Tt)),
              r.createElement(
                oe.PropertyTable.Cell,
                { placement: "last" },
                r.createElement(Ee.Select, {
                ...
                v
                  ...
                  .map((t, n) => {
                    ...
                    return r.createElement(
                      ...
                      {
                        key: n,
                        label: r.createElement("div", { className: te.childRowContainer }, (o && i.t(o.titles[n], { context: "input" }, l(88601))) || ""),
                      },
                      r.createElement(ee.ColorWithThicknessSelect, {
                        disabled: !C.value(),
            ...
            k &&
              ...
              r.createElement(
                ye,
                { id: "vahLines", title: k.name, color: _.childs().color, visible: _.childs().visible, thickness: _.childs().width },
                r.createElement($e, {
            ...
            I &&
              ...
              r.createElement(
                ye,
                { id: "valLines", title: I.name, color: x.childs().color, visible: x.childs().visible, thickness: x.childs().width },
                r.createElement($e, {
            ...
            r.createElement(
              ye,
              { id: "pocLines", title: R.name, color: L.childs().color, visible: L.childs().visible, thickness: L.childs().width },
              r.createElement($e, {
        ...
        render() {
          ...
          return r.createElement(ve.Consumer, null, (t) =>
            r.createElement(
              ...
              r.createElement(oe.PropertyTable, null, this._renderCustomContent((0, o.ensureNotNull)(t).metaInfo().shortId))
            )
          );
        }
      ...
      for (let e = 0; e < Yt.length; e++) {
        const t = Yt[e];
        qt.push({ value: t.priceScale + "," + t.minMove + "," + t.frac, content: t.minMove + "/" + t.priceScale });
      }
          ...
          return r.createElement(
            ...
            t
              ...
              : r.createElement(
                  ...
                  null,
                  i &&
                    r.createElement(ee.ColorWithThicknessSelect, { disabled: n && !(Array.isArray(n) ? n[0].value() : n.value()), color: i, transparency: s }),
                  o &&
                    r.createElement(
                      "div",
                      { className: Pe()(o && i && te.additionalSelect) },
                      r.createElement(ee.ColorWithThicknessSelect, { disabled: n && !(Array.isArray(n) ? n[0].value() : n.value()), color: o, transparency: s })
                    )
                ),
            a
          );
      ...
      class rl extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            u && r.createElement(Kt, { id: (0, k.createDomId)(t.id, "min-tick-select"), minTick: i }),
            ...
            (d || p) &&
              r.createElement(
                ...
                d && r.createElement(Ot, { id: (0, k.createDomId)(t.id, "precision-select"), precision: n }),
                p &&
                  r.createElement(
                    r.Fragment,
                    null,
        ...
        _plotsElement() {
          ...
          return new T.MetaInfoHelper(t)
            ...
            .filter(
              (e) => !((0, x.isUpColorerPlot)(e) || (0, x.isDownColorerPlot)(e) || (0, x.isCandleBorderColorerPlot)(e) || (0, x.isCandleWickColorerPlot)(e))
            )
            .map((t) => {
        ...
        _bandsBackgroundsElement() {
          const { study: e } = this.props,
            ...
            { bandsBackground: l } = t;
          return (
            l && r.createElement(ye, { id: "bandsBackground", title: el, visible: l.fillBackground, color: l.backgroundColor, transparency: l.transparency })
          );
        }
        _areasBackgroundsElement() {
          ...
          return t.isRGB
            ? null
            : n && r.createElement(ye, { id: "areaBackground", title: el, visible: n.fillBackground, color: n.backgroundColor, transparency: n.transparency });
        }
        _filledAreasElement() {
          const { study: e } = this.props,
            t = e.metaInfo(),
          ...
          return !l || t.isRGB
            ...
            : l.map((t) => {
                ...
                return r.createElement(ye, { key: t.id, id: t.id, title: n, color: l.color, visible: l.visible, transparency: l.transparency });
              });
        }
        _graphicsElement() {
          const { study: e } = this.props,
        ...
        _findPalettesByTargetId(e) {
          ...
          for (const l of n) {
            ...
            (0, x.isUpColorerPlot)(l) && l.target === e && (i.up = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, x.isDownColorerPlot)(l) && l.target === e && (i.down = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, x.isCandleWickColorerPlot)(l) && l.target === e && (i.wick = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] }),
              (0, x.isCandleBorderColorerPlot)(l) && l.target === e && (i.border = { palette: r[l.palette], paletteProps: t.properties().palettes[l.palette] });
          }
          return i;
        }
      }
      ...
      class il extends r.PureComponent {
        render() {
          return r.createElement(
            ...
            r.createElement(ve.Provider, { value: this.props.source }, r.createElement(ol, { study: this.props.source }))
          );
        }
      }
      var sl = l(73955),
      ...
      class dl extends al.DialogRenderer {
        constructor(e, t, l, r) {
          super(),
            (this._timeout = null),
            (this._handleClose = () => {
              n.unmountComponentAtNode(this._container), this._setVisibility(!1), this._subscription.unsubscribe(this, this._handleCollectionChanged);
            }),
            (this._handleCancel = () => {
        ...
        show(e = {}) {
          ...
          h.hasUserEditableInputs() && s.push({ id: "inputs", label: i.t(null, void 0, l(66304)), Component: _ }),
            h.hasUserEditableProperties(),
            h.hasUserEditableStyles() && s.push({ id: "style", label: i.t(null, void 0, l(32733)), Component: il }),
            this._propertyPages || s.push({ id: "visibilities", label: i.t(null, void 0, l(21852)), page: this._createVisibilitiesPropertyPage() }),
          ...
          n.render(
            ...
            d.emit("edit_object_dialog", { objectType: "study", scriptTitle: this._source.title(pl.TitleDisplayTarget.StatusLine) });
        }
    ...
    50945: (e, t, l) => {
      ...
      var n = l(50959),
        ...
        p = l(44996),
        d = l(92229);
      const u = { reset: s.t(null, void 0, l(79782)), saveAsDefault: s.t(null, void 0, l(18229)), defaults: s.t(null, void 0, l(98938)) };
      class h extends n.PureComponent {
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(c.PopupMenuItem, { className: d.defaultsButtonItem, isActive: !1, label: u.reset, onClick: this._handleResetToDefaults }),
            n.createElement(c.PopupMenuItem, { className: d.defaultsButtonItem, isActive: !1, label: u.saveAsDefault, onClick: this._handleSaveAsDefaults })
          );
        }
    ...
    48531: (e, t, l) => {
      ...
      function d(e) {
        return n.createElement(s.MatchMedia, { rule: "screen and (max-width: 768px)" }, (t) =>
          n.createElement(
            i.ControlDisclosure,
            { className: !t && a.themesButtonText, hideArrowButton: t, buttonChildren: n.createElement(p, { isTabletWidth: t }) },
            e.children
          )
        );
      }
    ...
    37289: (e, t, l) => {
      ...
      const o = {
        ...
        i = { TextText: "big", AnchoredTextText: "big", NoteText: "big", AnchoredNoteText: "big", CalloutText: "big", BalloonText: "big" };
      var s = l(11062),
        a = l(82064);
      function c(e) {
    ...
    69297: (e, t, l) => {
      ...
      function c(e) {
        const t = (0, n.useContext)(i.CustomBehaviourContext),
          { className: l, intent: o = "default", size: s = "small", enableActiveStateStyles: c = t.enableActiveStateStyles } = e;
        return r(l, a().switcher, a()[`size-${s}`], a()[`intent-${o}`], !c && a()["disable-active-state-styles"]);
      }
      function p(e) {
        var t;
        const { reference: l, size: r, intent: o, role: i, "aria-checked": s, checked: p, defaultChecked: d, onKeyDown: u, ...h } = e,
          m = (0, n.useCallback)(
            (e) => {
        ...
        return n.createElement(
          "label",
          {
            ...
            onKeyDown: function (e) {
              ...
              (13 !== t && 32 !== t) || (e.preventDefault(), P.current instanceof HTMLElement && P.current.click());
            },
            tabIndex: S,
    ...
    97456: (e, t, l) => {
      "use strict";
      l.r(t), l.d(t, { getIntervalsVisibilitiesPropertiesDefinitions: () => ae, getSelectionIntervalsVisibilitiesPropertiesDefinition: () => ce });
      var n = l(11542),
        r = l(36298),
        o = l(14483),
        i = l(295),
      ...
      const d = new r.TranslatedString("change {title} visibility on ticks", n.t(null, void 0, l(30810))),
        ...
        k = new r.TranslatedString("change {title} visibility on months", n.t(null, void 0, l(6659))),
        ...
        L = (new r.TranslatedString("change {title} visibility on ranges", n.t(null, { replace: { ranges: "ranges" } }, l(8917))), n.t(null, void 0, l(30973))),
      ...
      function ae(e, t, l) {
        ...
        if ((0, a.isSecondsEnabled)()) {
          const r = (0, i.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesSecond", title: D, min: new s.WatchedValue(le[0]), max: new s.WatchedValue(le[1]) }
          );
          n.push(r);
        }
        const r = (0, i.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesMinutes", title: R, min: new s.WatchedValue(ne[0]), max: new s.WatchedValue(ne[1]) }
          ),
          c = (0, i.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesHours", title: V, min: new s.WatchedValue(re[0]), max: new s.WatchedValue(re[1]) }
          ),
          p = (0, i.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesDays", title: M, min: new s.WatchedValue(oe[0]), max: new s.WatchedValue(oe[1]) }
          );
        n.push(r, c, p);
        const W = (0, i.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesWeeks", title: B, min: new s.WatchedValue(ie[0]), max: new s.WatchedValue(ie[1]) }
          ),
          A = (0, i.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesMonths", title: N, min: new s.WatchedValue(se[0]), max: new s.WatchedValue(se[1]) }
          );
      ...
      function ce(e, t) {
          ...
          const n = (0, i.createRangePropertyDefinition)(
            {
              ...
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.secondsTo), F, t),
            },
            { id: "IntervalsVisibilitiesSecond", title: D, min: new s.WatchedValue(le[0]), max: new s.WatchedValue(le[1]) }
          );
          l.push(n);
        ...
        const n = (0, i.createRangePropertyDefinition)(
            {
              checked: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutes), H, t),
          ...
          d = (0, i.createRangePropertyDefinition)(
            {
              ...
              from: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.daysFrom), Y, t),
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.daysTo), q, t),
            },
            { id: "IntervalsVisibilitiesDays", title: M, min: new s.WatchedValue(oe[0]), max: new s.WatchedValue(oe[1]) }
          );
        l.push(n, r, d);
        const u = (0, i.createRangePropertyDefinition)(
            {
              checked: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeks), K, t),
              from: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksFrom), $, t),
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksTo), X, t),
            },
            { id: "IntervalsVisibilitiesWeeks", title: B, min: new s.WatchedValue(ie[0]), max: new s.WatchedValue(ie[1]) }
          ),
    ...
    62513: (e, t, l) => {
      ...
      var n = l(50151),
        ...
        o = l(36298),
        i = l(88640);
      const s = new o.TranslatedString("change {propertyName} property", r.t(null, void 0, l(18567)));
      class a extends i.default {
        ...
        unsubscribe(e, t) {
          ...
          const r = (0, n.ensureDefined)(
            null === (l = this._listenersMappers.find((l) => l.obj === e && l.method === t)) || void 0 === l ? void 0 : l.callback
          );
