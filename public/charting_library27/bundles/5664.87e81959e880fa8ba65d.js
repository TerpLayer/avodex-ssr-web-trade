  ...
  [5664],
  {
    ...
    41590: (e, t, n) => {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              f === p.currentDrawer && o.createElement("div", { className: u.backdrop, onClick: n }),
              o.createElement(h, { className: a(d.drawer, u[`position${t}`], v), ref: w, "data-name": e["data-name"] }, m)
            )
          )
        );
      }
      const h = (0, o.forwardRef)((e, t) => {
        ...
        return o.createElement(m.TouchScrollContainer, { className: a(u.drawer, n), tabIndex: -1, ref: t, ...r });
      });
    },
    173: (e, t, n) => {
      "use strict";
      ...
      const k = [
        { title: r.t(null, { context: "emoji_group" }, n(15426)), emojis: [], content: o.createElement(a.IconItem, { icon: i }) },
        { title: r.t(null, { context: "emoji_group" }, n(96330)), emojis: p, content: o.createElement(a.IconItem, { icon: c }) },
        { title: r.t(null, { context: "emoji_group" }, n(60558)), emojis: f, content: o.createElement(a.IconItem, { icon: l }) },
        { title: r.t(null, { context: "emoji_group" }, n(35305)), emojis: w, content: o.createElement(a.IconItem, { icon: s }) },
        { title: r.t(null, { context: "emoji_group" }, n(14232)), emojis: E, content: o.createElement(a.IconItem, { icon: m }) },
        { title: r.t(null, { context: "emoji_group" }, n(15395)), emojis: g, content: o.createElement(a.IconItem, { icon: u }) },
        { title: r.t(null, { context: "emoji_group" }, n(72302)), emojis: b, content: o.createElement(a.IconItem, { icon: v }) },
        { title: r.t(null, { context: "emoji_group" }, n(6878)), emojis: C, content: o.createElement(a.IconItem, { icon: h }) },
        { title: r.t(null, { context: "emoji_group" }, n(49546)), emojis: z, content: o.createElement(a.IconItem, { icon: d }) },
      ];
    },
    47291: (e, t, n) => {
      "use strict";
      ...
      function d(e) {
        const { listRef: t, outerRef: n, emojiGroups: a, emojiSize: i, onSelect: c, onContentRendered: l, ItemComponent: s, RowComponent: m, height: d } = e;
        (0, o.useEffect)(() => {
          var e;
        ...
        return o.createElement(
          h.Provider,
          { value: (0, o.useMemo)(() => ({ size: i, onSelect: c, ItemComponent: s, RowComponent: m }), [i, c, s, m]) },
      ...
      const p = o.memo((e) => {
        const { style: t, index: n, data: r } = e,
          a = r[n],
          { size: i, onSelect: c, ItemComponent: u, RowComponent: v = s.EmojisRow } = (0, m.useEnsuredContext)(h);
        return "title" === a.type
          ? o.createElement("div", { style: t }, o.createElement(l, { title: a.relatedTitle }))
          : o.createElement("div", { style: t }, o.createElement(v, { emojis: a.content, itemSize: i, onEmojiClick: c, ItemComponent: u }));
      });
    },
    38297: (e, t, n) => {
      "use strict";
      ...
      function h(e) {
        var t;
        const { className: n, emojis: r, onSelect: h, ItemComponent: d, RowComponent: p, height: f, category: w, emojiSize: E = v } = e,
          g = (0, o.useRef)(null),
          b = (0, o.useRef)(!1),
        ...
        const [A, j] = (0, o.useState)((null === (t = M[0]) || void 0 === t ? void 0 : t.relatedTitle) || ""),
          y = (0, o.useCallback)((e) => {
            b.current || j(e);
          }, []);
        return o.createElement(
    ...
    26601: (e, t, n) => {
      ...
      const l = o.memo((e) => {
        ...
        return o.createElement(
          ...
          t.map((e) => o.createElement(i.EmojiWrap, { key: e, className: c.emojiItem, emoji: e, size: n, onClick: r, ItemComponent: l }))
        );
      });
    },
    85034: (e, t, n) => {
      ...
      function m(e) {
        ...
        return l.PLATFORM_ACCESSIBILITY_ENABLED
          ? o.createElement(
              "button",
              { ref: u, tabIndex: v, onClick: h, className: a()(s.wrapper, n && s.isActive, s.button, m), type: "button", "aria-pressed": n },
              i
            )
          : o.createElement("div", { className: a()(s.wrapper, n && s.isActive, m), onClick: h }, i);
        function h() {
          r(t);
        }
      }
      ...
      function v(e) {
        ...
        return o.createElement(
          ...
          n.map(({ title: e, content: n }) => o.createElement(m, { key: e, tab: e, className: l, isActive: t === e, onTabClick: r }, n))
        );
      }
    },
    99616: (e, t, n) => {
      ...
      var o = n(50959),
        ...
        c = n(53737);
      function l(e) {
        return o.createElement("div", { className: a()(c.wrapper, e.className) }, o.createElement(i.Icon, { icon: e.icon }));
      }
    },
    83682: (e, t, n) => {
      "use strict";
      ...
      function h(e) {
        ...
        return s.PLATFORM_ACCESSIBILITY_ENABLED
          ? o.createElement(
              "button",
              { ref: h, tabIndex: d, onClick: p, style: { width: r, height: r }, className: a()(u.button, u.wrapper, t), type: "button" },
              o.createElement(c, { emoji: n })
            )
          : o.createElement("div", { className: a()(u.wrapper, t), style: { width: r, height: r }, onClick: p }, o.createElement(c, { emoji: n }));
        function p() {
          i(n);
        }
      }
    ...
    81261: (e, t, n) => {
      ...
      const i = [37, 39, 38, 40];
      function c(e, t) {
        e.target && o.PLATFORM_ACCESSIBILITY_ENABLED && e.relatedTarget === t.current && s(e.target);
      }
      function l(e) {
        var t;
