  ...
  [4716],
  {
    ...
    88601: (t) => {
      (t.exports = Object.create(null)),
        ...
        (t.exports["Show real prices on price scale (instead of Heikin-Ashi price)_input"] = ["在价格坐标上显示实际价格(而不是Heikin-Ashi价格)"]),
    ...
    48890: (t) => {
      t.exports = ["Tradingview是交互式的，并且具有与屏幕阅读器一起使用的命令。以下是可用于在平台上交互的键盘命令列表"];
    },
    94770: (t) => {
      t.exports = ["趋势线角度"];
    },
