  ...
  [2077],
  {
    ...
    67029: (e, t, n) => {
      ...
      function v(e, t) {
        const {
          ...
          { isGrouped: C, cellState: N, disablePositionAdjustment: x = !1 } = (0, r.useContext)(l.ControlGroupContext),
    ...
    78274: (e, t, n) => {
      ...
      function s(e) {
        ...
        return r.createElement("span", { className: i(a()["inner-slot"], n && a().interactive, o && a().icon, t) }, s);
      }
      function l(e) {
        const { className: t, children: n } = e;
        return r.createElement("span", { className: i(a()["inner-slot"], a()["inner-middle-slot"], t) }, n);
      }
      function u(e) {
        const { className: t, interactive: n = !0, icon: o = !1, children: s } = e;
        return r.createElement("span", { className: i(a()["inner-slot"], n && a().interactive, o && a().icon, t) }, s);
    ...
    31261: (e, t, n) => {
        ...
        return r.createElement(h.ControlSkeleton, {
          ...
          middleSlot: r.createElement(
            ...
            r.createElement("input", {
              ...K,
              className: i(f().input, f()[`size-${P}`], I, F && f()["with-start-slot"], Z && f()["with-end-slot"]),
              disabled: L,
              readOnly: T,
              ref: U,
            })
      ...
      function D(e) {
        e = (0, u.useControl)(e);
        const { disabled: t, autoSelectOnFocus: n, tabIndex: i = 0, onFocus: o, onBlur: h, reference: m, containerReference: p = null } = e,
          f = (0, r.useRef)(null),
          g = (0, r.useRef)(null),
          [D, y] = (0, c.useFocus)(),
          b = t ? void 0 : D ? -1 : i,
          ...
          C = (0, r.useCallback)(
            (e) => {
              (f.current = e), m && ("function" == typeof m && m(e), "object" == typeof m && (m.current = e));
            },
            [f, m]
          );
    ...
    48027: (e, t, n) => {
      ...
      function o(e) {
        ...
        return { ...e, intent: o || (l ? "primary" : "default"), highlight: null != a ? a : l, onFocus: c, onBlur: d };
      }
    },
    29202: (e, t, n) => {
      "use strict";
    ...
    36383: (e, t, n) => {
      ...
      var r = n(50959),
        i = n(27267);
      function o(e) {
        const { click: t, mouseDown: n, touchEnd: o, touchStart: a, handler: s, reference: l, ownerDocument: u = document } = e,
          c = (0, r.useRef)(null),
    ...
    57163: (e, t, n) => {
      ...
      function g(e) {
        ...
        return r.createElement(h.Icon, { icon: m, className: a()("apply-common-tooltip", t), title: n ? f : p });
      }
      var v = n(94025),
        D = n(36274);
      var y = n(76894);
      function b(e) {
        ...
        return (
          (0, r.useLayoutEffect)(() => {
            var e, t;
            i ? null === (e = h.current) || void 0 === e || e.select() : null === (t = h.current) || void 0 === t || t.focus();
          }, [i]),
          r.createElement(
            d.PopupDialog,
            {
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(g, { className: y.infoHint, isSecondsEnabled: (0, v.isSecondsEnabled)() })
              ),
              r.createElement(
                "form",
                {
              ...
              b ? r.createElement("div", { className: y.hint }, H) : r.createElement("div", { className: a()(y.hint, y.error) }, s.t(null, void 0, n(72572)))
            )
          )
        );
      }
      var H = n(51826);
      function w(e) {
        if (H.dialogsOpenerManager.isOpened("ChangeIntervalDialog") || H.dialogsOpenerManager.isOpened("SymbolSearch")) return;
        const t = document.createElement("div"),
          ...
          s = r.createElement(b, {
            ...
            selectOnInit: o,
            onClose: function () {
              i.unmountComponentAtNode(t), H.dialogsOpenerManager.setAsClosed("ChangeIntervalDialog"), null == a || a();
            },
          });
