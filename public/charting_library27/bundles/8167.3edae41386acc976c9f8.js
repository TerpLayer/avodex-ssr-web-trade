  ...
  [8167],
  {
    41339: (e, t, i) => {
      ...
      class l extends s.UndoCommand {
        constructor({ lineToolId: e, chartModel: t, newPositionPoints: i }) {
          super(null), (this._pointState = null), (this._lineToolId = e), (this._model = t), (this._newPositionPoints = i);
        }
        redo() {
        ...
        undo() {
          if (this._pointState) {
            const e = (0, n.ensureNotNull)(this._model.dataSourceForId(this._lineToolId));
            e.startChanging(), e.restorePoints(...this._pointState), this._model.updateSource(e), e.syncMultichartState(e.endChanging(!0, !1));
          }
        }
      }
      var a = i(295),
      ...
      function P(e, t, i) {
        return { property: (0, a.convertToDefinitionProperty)(e, t.price, u), info: { typeY: 1, stepY: i } };
      }
      function f(e, t) {
        return {
          property: (0, a.convertToDefinitionProperty)(e, t.bar, h),
          info: { typeX: 0, minX: new d.WatchedValue(-5e4), maxX: new d.WatchedValue(15e3), stepX: new d.WatchedValue(1) },
        };
      }
                ...
                e.forEach((e) => {
                  ...
                  switch (a) {
                    case "": {
                      ...
                      (o -= e.price), (t -= e.index), (r = i.map((e) => ({ ...e, index: e.index + t, price: e.price + o })));
                      break;
                    }
                    case "-":
                    case "+": {
                      let { index: e = 0, price: t = 0 } = c;
                      "-" === a && ((e *= -1), (t *= -1)), (r = i.map((i) => ({ ...i, index: i.index + e, price: i.price + t })));
                      break;
                    }
                    case "*": {
                  ...
                  t.undoHistory().pushUndoCommand(new l({ lineToolId: e.id(), chartModel: t.model(), newPositionPoints: r }));
                });
              });
            } finally {
              r.setValue("", !0);
      ...
      function _(e, t) {
        ...
        return (0, a.createSelectionCoordinatesPropertyDefinition)(
          { x: n, y: o },
          { id: "SourcesCoordinates", title: r.t(null, void 0, i(37067)), mathOperationsX: "+", mathOperationsY: "+/*", modeX: "integer", modeY: "float" }
        );
      }
    },
    97456: (e, t, i) => {
      i.r(t), i.d(t, { getIntervalsVisibilitiesPropertiesDefinitions: () => ae, getSelectionIntervalsVisibilitiesPropertiesDefinition: () => de });
      var n = i(11542),
        r = i(36298),
        o = i(14483),
        s = i(295),
        ...
        d = i(68806),
        c = i(62513);
      const p = new r.TranslatedString("change {title} visibility on ticks", n.t(null, void 0, i(30810))),
        u = new r.TranslatedString("change {title} visibility on seconds", n.t(null, void 0, i(46948))),
        ...
        P = new r.TranslatedString("change {title} visibility on minutes", n.t(null, void 0, i(64370))),
        ...
        w = new r.TranslatedString("change {title} visibility on hours", n.t(null, void 0, i(68971))),
        ...
        b = new r.TranslatedString("change {title} visibility on days", n.t(null, void 0, i(29088))),
        ...
        T = new r.TranslatedString("change {title} visibility on weeks", n.t(null, void 0, i(24941))),
        ...
        D = new r.TranslatedString("change {title} visibility on months", n.t(null, void 0, i(6659))),
        ...
        x = (new r.TranslatedString("change {title} visibility on ranges", n.t(null, { replace: { ranges: "ranges" } }, i(8917))), n.t(null, void 0, i(30973))),
      ...
      function ae(e, t, i) {
        ...
        if ((0, a.isSecondsEnabled)()) {
          const r = (0, s.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesSecond", title: I, min: new l.WatchedValue(ie[0]), max: new l.WatchedValue(ie[1]) }
          );
          n.push(r);
        }
        const r = (0, s.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesMinutes", title: M, min: new l.WatchedValue(ne[0]), max: new l.WatchedValue(ne[1]) }
          ),
          d = (0, s.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesHours", title: U, min: new l.WatchedValue(re[0]), max: new l.WatchedValue(re[1]) }
          ),
          c = (0, s.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesDays", title: A, min: new l.WatchedValue(oe[0]), max: new l.WatchedValue(oe[1]) }
          );
        n.push(r, d, c);
        const F = (0, s.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesWeeks", title: L, min: new l.WatchedValue(se[0]), max: new l.WatchedValue(se[1]) }
          ),
          N = (0, s.createRangePropertyDefinition)(
            ...
            { id: "IntervalsVisibilitiesMonths", title: R, min: new l.WatchedValue(le[0]), max: new l.WatchedValue(le[1]) }
          );
      ...
      class m {
        ...
        destroy() {
          null !== this._yCoordinateStepWV &&
            (this._source.ownerSourceChanged().unsubscribeAll(this), this._ownerSource.priceStepChanged().unsubscribeAll(this)),
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, l.createPropertyPage)(
            (0, d.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._undoModel,
              e,
              new o.TranslatedString(this._source.name(), this._source.title(u.TitleDisplayTarget.StatusLine, !0))
            ),
            "visibility",
            h
          );
        ...
        _createCoordinatesPropertyPage() {
          ...
          return null !== e
            ? (e.definitions.length < this._source.pointsCount() && this._source.pointAdded().subscribe(this, this._updateCoordinatesPropertyDefinitons),
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return (
            e.forEach((e, r) => {
              ...
              o &&
                i.push(
                  (0, c.getCoordinatesPropertiesDefinitions)(this._propertyApplier, o, e, n, w.format({ count: (r + 1).toString() }), this._source.name())
                );
            }),
            { definitions: i }
          );
        ...
        _updateCoordinatesPropertyDefinitons() {
          const e = this._coordinatesPropertyDefinitions();
          if (null !== e) {
            (0, n.ensureDefined)(this._propertyPages.find((e) => "coordinates" === e.id)).definitions.setValue(e.definitions),
              this._source.points().length === this._source.pointsCount() && this._source.pointAdded().unsubscribeAll(this);
          }
        }
      }
    },
            ...
            definitions: [
              (0, o.createStudyInputsPropertyDefinition)(
                {},
                {
                  ...
                  source: { isInputsStudy: !0, symbolsResolved: () => new r.Delegate(), resolvedSymbolInfoBySymbol: (e) => null },
                }
              ),
            ],
          };
    ...
    62513: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        o = i(36298),
        s = i(88640);
      const l = new o.TranslatedString("change {propertyName} property", r.t(null, void 0, i(18567)));
