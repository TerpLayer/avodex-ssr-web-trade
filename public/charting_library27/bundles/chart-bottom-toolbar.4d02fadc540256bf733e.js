  ...
  [7260],
  {
                ...
                (n = [].concat(t(n), [h])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !d(s.target) &&
                        ((r && 0 === r.scrollTop && 0 < n) || ((a = r) && a.scrollHeight - a.scrollTop <= a.clientHeight && n < 0)
                          ? u(s)
                          : s.stopPropagation()));
                  }),
                  i || (document.addEventListener("touchmove", u, s ? { passive: !1 } : void 0), (i = !0));
              }
            } else {
              (p = r),
                setTimeout(function () {
            ...
            (e.clearAllBodyScrollLocks = function () {
              a
                ? (n.forEach(function (e) {
                  ...
                  i && (document.removeEventListener("touchmove", u, s ? { passive: !1 } : void 0), (i = !1)),
                  (n = []),
                  (o = -1))
                : (h(), (n = []));
            }),
            (e.enableBodyScroll = function (e) {
              if (a) {
                ...
                (e.ontouchstart = null),
                  ...
                  i && 0 === n.length && (document.removeEventListener("touchmove", u, s ? { passive: !1 } : void 0), (i = !1));
              } else
    ...
    23829: (e, t, s) => {
      ...
      function p(e) {
        const {
          ...
          I = !!E.length;
        return a
          ? r.createElement("li", { className: n()(t, m.item, m.loading, m[A]) }, r.createElement(o.Loader, null))
          : r.createElement(
              "li",
              { className: n()(t, m.item, m.interactive, s && m.title, _ && m.disabled, p && m.hovered, g && m.active, z && m.emptyIcons, m[A]), onClick: x },
              ...
              r.createElement(
                "span",
                { className: n()(m.label) },
                !M && C ? C.map(({ text: e, ...t }, s) => r.createElement("span", { key: s, style: t }, e)) : null != M ? M : k
              ),
              !!w &&
                r.createElement(i.Icon, {
                  onClick: function () {
          ...
          const s = (t) => {
            ...
            null !== s &&
              ...
              ((0, a.isKeyboardClick)(t) ||
                (s.contains(document.activeElement) && "INPUT" !== document.activeElement.tagName && document.activeElement.blur()));
          };
    ...
    81351: (e, t, s) => {
      ...
      function u(e) {
        ...
        return r.createElement(c.PopupMenuItem, {
          ...s,
          className: n()(l.PLATFORM_ACCESSIBILITY_ENABLED && d.accessible, e.isActive && d.active, t),
          reference: a,
          tabIndex: u,
    ...
    54079: (e, t, s) => {
      ...
      const u = (0, r.forwardRef)(function (e, t) {
        const { onKeyDown: s, orientation: u, blurOnEscKeydown: h = !0, blurOnClick: m = !0, ...p } = e,
    ...
    33279: (e, t, s) => {
      ...
      const S = (e) => n.t(null, { plural: "{str} minutes", count: e, replace: { str: `${e}` } }, s(60144)),
        E = (e) => n.t(null, { plural: "{str} hours", count: e, replace: { str: `${e}` } }, s(17174)),
        k = (e) => n.t(null, { plural: "{str} months", count: e, replace: { str: `${e}` } }, s(28039)),
        C = {
          ...
          "1D": { resolution: "1D", text: ((w = 1), n.t(null, { plural: "{str} days", count: w, replace: { str: `${w}` } }, s(74262))) },
          "1W": { resolution: "1W", text: ((T = 1), n.t(null, { plural: "{str} weeks", count: T, replace: { str: `${T}` } }, s(14074))) },
          "1M": {
            resolution: "1M",
            text: k(1),
          },
          ...
          "12M": { resolution: "12M", text: ((x = 1), n.t(null, { plural: "{str} years", count: x, replace: { str: `${x}` } }, s(8222))) },
        };
      var x, T, w;
      function M(e) {
        const t = (function (e) {
            ...
            if (r.isMinutes()) {
              ...
              return e % 60 != 0
                ? ((i = e), n.t(null, { plural: "{str} minutes", count: i, replace: { str: `${i}` }, context: "timeframe_title" }, s(44795)))
                : ((a = e / 60), n.t(null, { plural: "{str} hours", count: a, replace: { str: `${a}` }, context: "timeframe_title" }, s(89020)));
            }
            var a;
            var i;
            if (r.isDays()) return A(r.multiplier());
            if (r.isWeeks())
              return ((e) => n.t(null, { plural: "{str} weeks", count: e, replace: { str: `${e}` }, context: "timeframe_title" }, s(67518)))(r.multiplier());
            if (r.isMonths()) {
              const e = r.multiplier();
              return e % 12 != 0
                ? ((o = e), n.t(null, { plural: "{str} months", count: o, replace: { str: `${o}` }, context: "timeframe_title" }, s(3189)))
                : ((e) => n.t(null, { plural: "{str} years", count: e, replace: { str: `${e}` }, context: "timeframe_title" }, s(6598)))(e / 12);
            }
            var o;
          ...
          r = (function (e) {
            ...
            if (r.isMinutes()) {
              const e = r.multiplier();
              return e % 60 != 0
                ? ((i = e), n.t(null, { plural: "{str} minutes intervals", count: i, replace: { str: `${i}` }, context: "timeframe_title" }, s(56347)))
                : ((a = e / 60), n.t(null, { plural: "{str} hours intervals", count: a, replace: { str: `${a}` }, context: "timeframe_title" }, s(54028)));
            }
            var a;
            var i;
            if (r.isDays())
              return ((e) => n.t(null, { plural: "{str} days intervals", count: e, replace: { str: `${e}` }, context: "timeframe_title" }, s(81693)))(
                r.multiplier()
              );
            if (r.isWeeks())
              return ((e) => n.t(null, { plural: "{str} weeks intervals", count: e, replace: { str: `${e}` }, context: "timeframe_title" }, s(58667)))(
                r.multiplier()
              );
            if (r.isMonths()) {
              const e = r.multiplier();
              return e % 12 != 0
                ? ((o = e), n.t(null, { plural: "{str} months intervals", count: o, replace: { str: `${o}` }, context: "timeframe_title" }, s(99773)))
                : ((e) => n.t(null, { plural: "{str} years intervals", count: e, replace: { str: `${e}` }, context: "timeframe_title" }, s(57849)))(e / 12);
            }
            var o;
            return C[t].text;
          })(e);
      ...
      const A = (e) => n.t(null, { plural: "{str} days", count: e, replace: { str: `${e}` }, context: "timeframe_title" }, s(42908));
      class z {
        constructor(e) {
          (this._state = { ranges: [] }), (this._change = new f.Delegate()), (this._rangeChangedListenerBound = this._onRangeChanged.bind(this));
          const { chartWidget: t } = (this._context = e);
          t.withModel(null, () => {
            const e = t.model(),
              s = e.mainSeries();
            s.onStatusChanged().subscribe(this, this._updateAvailableRanges),
              c.enabled("update_timeframes_set_on_symbol_resolve") && s.dataEvents().symbolResolved().subscribe(this, this._updateAvailableRanges),
        ...
        destroy() {
          ...
          e.withModel(null, () => {
            ...
            s.onStatusChanged().unsubscribe(this, this._updateAvailableRanges),
              c.enabled("update_timeframes_set_on_symbol_resolve") && s.dataEvents().symbolResolved().unsubscribe(this, this._updateAvailableRanges),
        ...
        _updateAvailableRanges() {
          ...
          const s = t.model().mainSeries(),
            r = s.status();
          if (2 === r || 1 === r) return;
          const a = e(s.symbolInfo(), s.status()).map((e) => ({ ...e, description: "" === e.description ? M(e) : e.description }));
          ...
          ((t = class extends r.PureComponent {
            constructor(e, t) {
              super(e, t),
                ...
                (0, b.validateRegistry)(t, { availableTimeFrames: i.any.isRequired, chartWidgetCollection: i.any.isRequired, chartWidget: i.any.isRequired }),
      ...
      const F = { title: n.t(null, void 0, s(60222)), goToDate: (0, W.appendEllipsis)(n.t(null, void 0, s(369))) },
            ...
            (this._renderChildren = (e) => {
              ...
              return e
                ...
                : r.createElement(
                    ...
                    a && r.createElement(p.AccessibleMenuItem, { label: F.goToDate, onClick: this._handleGoToDateClick })
                  );
            }),
      ...
      function K(e) {
        ...
        return r.createElement(Z.ToolbarButton, { ...d, ref: t, text: s, isActive: n, tooltip: a, className: u, onClick: l });
      }
      var Q = s(22586);
      const ee = (0, q.mergeThemes)(G, Q);
      var te = s(31071);
      const se = V(function (e) {
        return r.createElement("div", { className: o(e.className, ee.slider), ref: e.reference }, r.createElement("div", { className: ee.inner }));
      });
      ...
      var ae = s(61814),
        ...
        oe = s(92574),
        le = s(50242);
      const ce = (0, ae.hotKeySerialize)({ keys: [(0, ne.humanReadableModifiers)(ne.Modifiers.Alt, !1), "G"], text: "{0} + {1}" }),
      ...
      class ue extends r.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleClick = () => {
              const { chartWidget: e } = this.context;
              (0, _.trackEvent)("GUI", "Chart Bottom Toolbar", "go to"), (0, B.showGoToDateDialog)(e);
            }),
            (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired });
        }
        render() {
      ...
      var me = s(76460),
        ...
        ye = s(10643),
        Se = s(85616);
      const Ee = (0, q.mergeThemes)(Z.DEFAULT_TOOLBAR_BUTTON_THEME, { isDisabled: Se.disabled, button: Se.button });
      const ke = (0, b.registryContextType)();
      class Ce extends r.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._timeFormatter = new ge.TimeFormatter((0, be.getHourMinuteSecondFormat)(fe.timeHoursFormatProperty.value()))),
            ...
            (this._getActions = () => {
              ...
              return (function (e) {
                e.updateActions();
                const t = e.actions();
                return t && t.applyTimeZone instanceof ve.Action ? t.applyTimeZone.getSubItems() : [];
              })(e);
            }),
            (this._handleRef = (e) => {
              this._element = e;
        ...
        render() {
          const { className: e, withMenu: t } = this.props,
            { time: a } = this.state,
            i = void 0 !== this._timezone ? (0, pe.parseTzOffset)(this._timezone.name()).string : null;
        ...
        _timeHoursFormatPropertyChanged() {
          (this._timeFormatter = new ge.TimeFormatter((0, be.getHourMinuteSecondFormat)(fe.timeHoursFormatProperty.value()))), this.updateTimezonesButton();
        }
      }
      Ce.contextType = ke;
      var xe = s(56812);
      ...
      class ze {
        ...
        _setHighlight() {
          ...
          if (null !== r) {
            ...
            null !== a && i.value().axis !== a && (i.setValue({ owner: this._owner, axis: a }), e.lightUpdate(), (this._highlighted = !0));
          }
        }
        _removeHighlight() {
          if (!this._chartWidget.hasModel()) return;
          ...
          if (null !== s) {
            const t = s.highlightedPriceAxis(),
              r = t.value();
            null !== r.axis && r.owner === this._owner && (t.setValue({ owner: this._owner, axis: null }), e.lightUpdate(), (this._highlighted = !1));
          }
        }
      }
      ...
      class Xe extends r.PureComponent {
        ...
        updateSessionButton() {
          ...
          const a = r.subsession_id,
            n = null !== (t = null === (e = r.subsessions) || void 0 === e ? void 0 : e.filter((e) => !e.private)) && void 0 !== t ? t : [],
            i = n.find((e) => e.id === a);
          this.setState({
            sessionId: a,
            sessionName: (0, Ue.translateSessionShortDescription)((null == i ? void 0 : i.description) || ""),
            sessionDescription: (0, Ue.translateSessionDescription)((null == i ? void 0 : i.description) || ""),
            availableSessions: n,
          });
        }
        _menuItems() {
          ...
          const s = e.model().mainSeries(),
            a = [r.createElement(He.ToolWidgetMenuSummary, { key: "header_menu_text", className: Fe.headerMenuText }, Ye.headerMenuText.toUpperCase())];
          for (const n of t) {
          ...
          ((et = class extends r.PureComponent {
            constructor(e, t) {
              super(e, t),
                ...
                (this._priceAxisHighlighter = new ze(this.context.chartWidget, () => this._priceScale, "logarithm"));
            }
            componentDidMount() {
            ...
            ((t = class extends r.PureComponent {
              constructor(e, t) {
                super(e, t),
                  ...
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new ze(this.context.chartWidget, () => this._priceScale, "auto"));
              }
              componentDidMount() {
                const e = this.context.chartWidget;
                e.withModel(null, () => {
                ...
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      s = t.priceScale(),
                      r = s.mode();
                    t.priceScale().isLockScale() || e.setPriceScaleMode({ percentage: !r.percentage }, s, Re);
                  }),
                  (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new ze(this.context.chartWidget, () => this._priceScale, "percentage"));
              }
              componentDidMount() {
                const e = this.context.chartWidget;
                e.withModel(null, () => {
      ...
      const rt = (0, ae.hotKeySerialize)({ keys: [(0, ne.humanReadableModifiers)(ne.Modifiers.Alt, !1), "Enter"], text: "{0} + {1}" }),
        at = (function (e) {
          var t;
          return (
            ((t = class extends r.PureComponent {
              constructor(e, t) {
                super(e, t),
                  ...
                  (0, b.validateRegistry)(t, { chartWidgetCollection: i.any.isRequired, resizerDetacher: i.any.isRequired });
        ...
        ot = (() => {
          const e = new Map();
          return e.set(Ke, "logarithm"), e.set(st, "percentage"), e.set(tt, "auto"), e.set(Xe, "session"), e.set(at, "fullscreen"), e;
        })();
      function lt(e) {
        0;
      }
      ...
      class ht extends r.PureComponent {
        constructor(e, t) {
          ...
          super(e, t),
              ...
              (e, t, a) => {
                if (r.isValidElement(e) && "string" != typeof e.type) {
                  ...
                  if ("string" == typeof i.className) {
                    ...
                    return r.createElement(
                      "div",
                      { key: null === e.key ? void 0 : e.key, className: o(Ze.inline, c[d] && Ze.collapsed), ref: (e) => n(e, d), onClick: () => lt() },
                      r.cloneElement(e, l)
                    );
                  }
                }
            ...
            (this._updateButtonsVisibility = () => {
              ...
              if (s.symbolResolvingActive().value()) return void this._setStateWithResize({ intervalAllowsSessionButton: a });
                ...
                (this._raf = requestAnimationFrame(() => {
                  ...
                  if ((Object.assign(e, { dateRangeMode: c }), "expanded" !== c)) {
                    ...
                    let s = 0,
                      a = 0;
                    for (const n of r)
                      (s += n.width), n.name in nt ? ((a += n.width), Object.assign(e, { [n.name]: !1 })) : Object.assign(e, { [n.name]: t <= s });
          ...
          (this.state = { isFullscreenable: l.fullscreenable.value(), isPreventPhoneLayoutButton: this._isPreventPhoneLayoutButton() }),
        ...
        render() {
          ...
          return r.createElement(
            we.Toolbar,
            { className: Ze.toolbar, onContextMenu: Pe.preventDefault, ref: this._handleToolbarRef },
            t &&
              r.createElement(
                je.FragmentMap,
                null,
                r.createElement(
                  "div",
                  { className: o(Ze.dateRangeWrapper, "collapsed" !== e.dateRangeMode && Ze.collapsed), ref: this._handleRangeCollapsedRef },
                  r.createElement(
                    "div",
                    { className: o(Ze.dateRangeCollapsed) },
                    r.createElement(J, { goToDateButton: this.props.goToDateEnabled, className: Ze.dateRange })
                  )
                ),
                r.createElement(
                  "div",
                  { className: o(Ze.dateRangeWrapper, "expanded" !== e.dateRangeMode && Ze.collapsed), ref: this._handleRangeExpandedRef },
                  r.createElement(
                    "div",
                    { className: o(Ze.dateRangeExpanded) },
                    r.createElement(re, { onSelectRange: this._trackRangeButtonClick, className: Ze.dateRange }),
            ...
            r.createElement(
              ...
              s &&
                r.createElement(
                  "div",
                  { className: o(Ze.inline, e.timeZones && Ze.collapsed), ref: this._handleTimeZonesRef },
                  r.createElement(
                    "div",
              ...
              this.props.sessionIdButtonEnabled &&
                ...
                r.createElement(
                  "div",
                  { className: o(Ze.inline, e.session && Ze.collapsed), ref: this._handleSessionsRef },
                  r.createElement("div", { className: Ze.inline }, r.createElement(Xe, { className: Ze.item, withMenu: this.props.sessionIdButtonEnabled }))
                ),
              r.createElement("div", { ref: this._handleSeparatorRef, className: o(Ze.inline, e.separator && Ze.collapsed) }, r.createElement(Te, null)),
              r.createElement(
                je.FragmentMap,
                { map: this._injector },
                !1,
                !1,
                !1,
                a && !c.enabled("fundamental_widget") && r.createElement(st, { className: Ze.item }),
                n && r.createElement(Ke, { className: Ze.item }),
                i && r.createElement(tt, { className: Ze.item }),
                l &&
                  this.state.isFullscreenable &&
                  r.createElement(at, { className: Ze.item, mobileChangeLayoutEnabled: this.props.mobileChangeLayoutEnabled }),
                !1
              )
            )
          );
        ...
        _setStateWithResize(e) {
          Object.assign(this._layout, dt), this._applyResizing(), this.setState(e, () => this._handleResize());
        }
        _applyResizing() {
          const { dateRangeMode: e, ...t } = this._layout;
          this._rangeExpanded && this._rangeExpanded.classList.toggle(Ze.collapsed, "expanded" !== e),
            this._rangeCollapsed && this._rangeCollapsed.classList.toggle(Ze.collapsed, "collapsed" !== e);
          let s = !1,
            r = !1;
          Object.keys(t).forEach((e) => {
            ...
            if ("separator" !== a) {
              const e = this._seriesComponents[a],
                n = !0 === t[a];
              e && ("timeZones" === a || "session" === a ? (s = s || !n) : (r = r || !n), e.classList.toggle(Ze.collapsed, n));
            }
          });
      ...
      class pt extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(b.RegistryProvider, { validation: mt, value: this._registry }, r.createElement(ht, { key: e.id(), ...s }));
        }
        _defineRegistry(e) {
          const {
    ...
    81693: (e) => {
      e.exports = {
        ar: ["فترات {str} يوم", "فترات {str} يوم", "فترات {str} يوم", "فترات {str} يوم", "فترات {str} يوم", "فترات {str} يوم"],
        ...
        pl: ["{str} dniowe interwały", "{str} dniowe interwały", "{str} dniowe interwały", "{str} dniowe interwały"],
    ...
    54028: (e) => {
      e.exports = {
        ar: ["فترات {str} ساعة", "فترات {str} ساعة", "فترات {str} ساعة", "فترات {str} ساعة", "فترات {str} ساعة", "فترات {str} ساعة"],
        ...
        pl: ["{str} godzinne interwały", "{str} godzinne interwały", "{str} godzinne interwały", "{str} godzinne interwały"],
    ...
    99773: (e) => {
      e.exports = {
        ar: ["فترات {str} شهر", "فترات {str} شهر", "فترات {str} شهر", "فترات {str} شهر", "فترات {str} شهر", "فترات {str} شهر"],
        ...
        pl: ["{str} miesięczne interwały", "{str} miesięczne interwały", "{str} miesięczne interwały", "{str} miesięczne interwały"],
    ...
    56347: (e) => {
      e.exports = {
        ar: ["فترات {str} دقيقة", "فترات {str} دقيقة", "فترات {str} دقيقة", "فترات {str} دقيقة", "فترات {str} دقيقة", "فترات {str} دقيقة"],
        ...
        pl: ["{str} minutowe interwały", "{str} minutowe interwały", "{str} minutowe interwały", "{str} minutowe interwały"],
    ...
    58667: (e) => {
      e.exports = {
        ar: ["فترات ‎{str}‎ أسبوع", "فترات ‎{str}‎ أسبوع", "فترات ‎{str}‎ أسبوع", "فترات ‎{str}‎ أسبوع", "فترات ‎{str}‎ أسبوع", "فترات ‎{str}‎ أسبوع"],
        ...
        pl: ["{str} tygodniowe interwały", "{str} tygodniowe interwały", "{str} tygodniowe interwały", "{str} tygodniowe interwały"],
    ...
    57849: (e) => {
      e.exports = {
        ar: ["فترات ‎{str}‎ سنة", "فترات ‎{str}‎ سنة", "فترات ‎{str}‎ سنة", "فترات ‎{str}‎ سنة", "فترات ‎{str}‎ سنة", "فترات ‎{str}‎ سنة"],
        ...
        pl: ["{str} roczne interwały", "{str} roczne interwały", "{str} roczne interwały", "{str} roczne interwały"],
