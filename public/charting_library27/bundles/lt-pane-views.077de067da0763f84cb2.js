  ...
  [1583],
  {
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if ((this._polylineRenderer.setData(_), t.append(this._polylineRenderer), this._points.length >= 3)) {
            ...
            this._xbLabelRenderer.setData(e), t.append(this._xbLabelRenderer), this._xbTrend.setData(o(a, d)), t.append(this._xbTrend);
          }
          ...
          if (this._points.length >= 5) {
            ...
            this._bdLabelRenderer.setData(e), t.append(this._bdLabelRenderer), this._xdRetracementTrend.setData(o(a, c)), t.append(this._xdRetracementTrend);
            const n = i(a.add(c).scaled(0.5), this._numericFormatter.format(this._xdRetracement));
            this._xdLabelRenderer.setData(n), t.append(this._xdLabelRenderer), this._bdTrend.setData(o(d, c)), t.append(this._bdTrend);
          }
          const g = i(a, "X");
    ...
    37803: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (this._data.points.length < 3)
            return (
              (t.strokeStyle = this._data.color), (t.lineWidth = this._data.linewidth), t.beginPath(), t.moveTo(i.x, i.y), t.lineTo(o.x, o.y), void t.stroke()
            );
          let a = this._data.points[2];
          ...
          t.scale(1, l / (p * m)),
            ...
            t.restore(),
            t.stroke(),
            this._data.fillBackground && ((t.fillStyle = (0, d.generateColor)(this._data.backcolor, this._data.transparency)), t.fill());
        }
      }
      class _ extends l.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          (L.data = 2), d.push(L);
          const C = [o.PaneCursorType.Default, o.PaneCursorType.Default, (0, l.thirdPointCursorType)(h, u)];
      ...
      class u extends r.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const e = this._getSource(),
            ...
            i = this._getModel();
          this._arrowMarkRenderer.setData({ point: this._points[0], direction: e.direction(), color: t.arrowColor.value() }),
      ...
      class c extends a.MediaCoordinatesPaneRenderer {
        ...
        _hittestGeometry(e) {
          const t = h(e),
            i = [];
          return (
            i.push(new o.Point(0, 0)), i.push(new o.Point(e - t, (1.22 * t) / 4)), i.push(new o.Point(e - t, (1.22 * t) / 2)), i.push(new o.Point(e, 0)), i
          );
        }
      }
      var u = i(70531),
      ...
      class _ extends n.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            (this._ellipseRendererData = { color: "", linewidth: 0, points: [], fillBackground: !0, backcolor: "", noHitTestOnBackground: !0 }),
        ...
        _updateImpl() {
          ...
          if (
            ...
            if (((this._drawAsCircle = 0 === n && Math.abs(r) < 1e-8), (this._textRendererData.points = [e[0]]), this._drawAsCircle)) {
              ...
              Math.abs(t.x) >= Math.abs(t.y)
                ? (e[1].x > e[0].x ? (this._textRendererData.horzAlign = "right") : (this._textRendererData.horzAlign = "left"),
                  (this._textRendererData.vertAlign = "middle"))
                : (e[1].y > e[0].y ? (this._textRendererData.vertAlign = "bottom") : (this._textRendererData.vertAlign = "top"),
    ...
    74718: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          return (0, l.pointInBox)(e, r) ? new u.HitTestResult(u.HitTarget.MovePoint, { areaName: u.AreaName.Text }) : null;
        }
        _drawImpl(e) {
        ...
        _measureInfo(e, t, i) {
          if (this._geomertryCacheInvalidated) {
            ...
            (this._geometryCache = { paddingLeft: s, innerWidth: a, innerHeight: l, textHorizontalPadding: d }), (this._geomertryCacheInvalidated = !1);
          }
          ...
          if (_ > 0 && 2 === u.length) {
            ...
            if (t === g.LineToolBarsPatternMode.Bars || t === g.LineToolBarsPatternMode.OpenClose) {
              ...
              for (let t = 0; t < _; t++) {
                ...
                s.setData({ points: r, color: l, backcolor: l, linewidth: 1, fillBackground: !0, transparency: 10, extendLeft: !1, extendRight: !1 }),
                  x.append(s);
              }
              ...
              const e = v[t],
                i = p.map((t, i) => {
                  ...
                  return { timePointIndex: P + i, center: n, left: NaN, right: NaN, y: m(e(t)) + C };
                });
              x.append(
            ...
            this._vertLineRenderer1.setData({ x: this._points[0].x, color: f, linewidth: 1, linestyle: s.LINESTYLE_SOLID }),
              x.append(this._vertLineRenderer1),
              this._vertLineRenderer2.setData({ x: this._points[1].x, color: f, linewidth: 1, linestyle: s.LINESTYLE_SOLID }),
      ...
      class p extends s.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          if (4 === i.points.length) {
            ...
            if ((0, a.quadroBezierHitTest)(s, n, u, e, t) || (0, a.cubicBezierHitTest)(s, p, g, l, e, t) || (0, a.quadroBezierHitTest)(l, r, f, e, t))
      ...
      class v extends r.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (4 === this._source.points().length) {
            ...
            i.extendLeft.value() && (r = this._extendSegmentLeft(a, n, h, t, e)), i.extendRight.value() && (s = this._extendSegmentRight(l, o, u, t, e));
          }
          const o = this._points.slice(),
            a = this._source.controlPoints();
          null !== a &&
            (o.push((0, f.ensureNotNull)(this._source.pointToScreenPoint(a[0]))), o.push((0, f.ensureNotNull)(this._source.pointToScreenPoint(a[1]))));
          const l = {
            points: o,
        ...
        _extendSegmentLeft(e, t, i, n, r) {
          return (
            (0, g.cacheIsValid)(this._extendedSegmentLeftCache, e, t, i, n, r) ||
              (this._extendedSegmentLeftCache = { p1: e, p2: t, p3: i, width: n, height: r, segment: (0, a.extendQuadroBezier)(e, t, i, n, r) }),
        ...
        _extendSegmentRight(e, t, i, n, r) {
          return (
            (0, g.cacheIsValid)(this._extendedSegmentRightCache, e, t, i, n, r) ||
              (this._extendedSegmentRightCache = { p1: e, p2: t, p3: i, width: n, height: r, segment: (0, a.extendQuadroBezier)(e, t, i, n, r) }),
      ...
      class h extends s.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (3 === this._source.points().length) {
            ...
            i.extendLeft.value() && (s = this._extendSegmentLeft(l, r, h, t, e)), i.extendRight.value() && (a = this._extendSegmentRight(l, o, c, t, e));
          }
        ...
        _extendSegmentLeft(e, t, i, r, s) {
          return (
            d(this._extendedSegmentLeftCache, e, t, i, r, s) ||
              (this._extendedSegmentLeftCache = { p1: e, p2: t, p3: i, width: r, height: s, segment: (0, a.extendQuadroBezier)(e, t, i, r, s) }),
        ...
        _extendSegmentRight(e, t, i, r, s) {
          return (
            d(this._extendedSegmentRightCache, e, t, i, r, s) ||
              (this._extendedSegmentRightCache = { p1: e, p2: t, p3: i, width: r, height: s, segment: (0, a.extendQuadroBezier)(e, t, i, r, s) }),
      ...
      class p extends r.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          if (null !== this._data && 3 === this._data.points.length) {
            ...
            if ((0, a.quadroBezierHitTest)(r, i, l, e, t) || (0, a.quadroBezierHitTest)(r, n, h, e, t)) return new o.HitTestResult(o.HitTarget.MovePoint);
    ...
    70326: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          return e.x >= n && e.x <= n + this._textSizeCache.totalWidth && e.y >= r && e.y <= r + this._textSizeCache.totalHeight
    ...
    79104: (e, t, i) => {
      ...
      class h {
        ...
        hitTest(e, t) {
          ...
          const s = n > r && (0, l.pointInCircle)(e, i, n - r) ? a.HitTarget.MovePointBackground : a.HitTarget.MovePoint;
          return new a.HitTestResult(s);
        }
      }
      class c extends o.LineSourcePaneView {
        constructor() {
          super(...arguments), (this._circleRenderer = new h()), (this._textRenderer = new r.TextRenderer()), (this._renderer = new s.CompositeRenderer());
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }
    ...
    37662: (e, t, i) => {
      ...
      class g extends u.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          return (0, d.pointInBox)(e, r) ? new p.HitTestResult(p.HitTarget.MovePoint, { areaName: p.AreaName.Text }) : null;
        }
        _drawImpl(e) {
          if (null === this._data || 0 === this._data.points.length) return;
          const t = e.context;
      ...
      class f extends o.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if ((this._commentRenderer.setData(o), 1 === o.points.length)) {
            ...
            return e.append(this._commentRenderer), e.append(this.createLineAnchor({ points: o.points }, 0)), void (this._renderer = e);
          }
      ...
      class l extends n.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          this._horizLineRenderer.setData(t),
            this._horizLineRenderer.setHitTest(new a.HitTestResult(a.HitTarget.MovePoint, { snappingPrice: this._source.points()[0].price })),
            this._vertLineRenderer.setData(t),
            this._vertLineRenderer.setHitTest(new a.HitTestResult(a.HitTarget.MovePoint, { snappingIndex: this._source.points()[0].index }));
    ...
    47346: (e, t, i) => {
      ...
      class c extends a.LineSourcePaneView {
        constructor() {
          super(...arguments), (this._coordinates = []), (this._trendRenderer = new o.TrendLineRenderer()), (this._renderer = new r.CompositeRenderer());
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
        _updateImpl(e, t) {
          ...
          if (null === u) return;
          if (c > 0) {
            for (let e = o.index; e <= u.lastBar(); e += c) this._coordinates.push(i.indexToCoordinate(e));
          } else {
            for (let e = o.index; e >= u.firstBar(); e += c) this._coordinates.push(i.indexToCoordinate(e));
          }
          if (this._points.length < 2) return;
          ...
          for (let e = 0; e < this._coordinates.length; e++) {
            const t = { x: this._coordinates[e], color: p.linecolor.value(), linewidth: p.linewidth.value(), linestyle: p.linestyle.value() },
          ...
          if (2 === this._source.points().length) {
            ...
            this._renderer.append(this.createLineAnchor({ points: [new n.Point(this._points[0].x, r.height() / 2)], hittestResult: d.HitTarget.MovePoint }, 1));
        }
      }
    },
    25615: (e, t, i) => {
        ...
        _updateCustomTextRenderer(e, t) {
          ...
          if (i.visible.value() && i.text.value().length > 0) {
            ...
            return (
              ...
              this._needLabelExclusionPath(this._customTextrenderer, "middle") ? (0, s.getTextBoundaries)(this._customTextrenderer, t, e) : null
            );
          }
      ...
      class T extends x.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._distancePriceRenderer.setData({
            ...
            extendright: !1,
            leftend: p.LineEnd.Normal,
            rightend: Math.abs(C.y - S.y) >= 25 * d.linewidth.value() ? p.LineEnd.Arrow : p.LineEnd.Normal,
            excludeBoundaries: null != f ? f : void 0,
          }),
          ...
          O &&
            ...
            ((this._pipFormatter = new g.PipFormatter(O.pricescale, O.minmov, O.type, O.minmove2, O.typespecs)), (this._lastSymbolInfo = O));
          const W = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            F =
              (null !== (s = null === (i = W.formatChange) || void 0 === i ? void 0 : i.call(W, I, M)) && void 0 !== s ? s : W.format(A)) +
              " (" +
          ...
          let U;
          Number.isNaN(j) || (Y += `\n${b} ${R.format(j)}`),
            (U = I > M ? new r.Point(0.5 * (h.x + c.x), c.y - 2 * d.fontsize.value()) : new r.Point(0.5 * (h.x + c.x), c.y + 0.7 * d.fontsize.value()));
          const q = { x: 0, y: 10 },
            Q = d.fontsize.value(),
            Z = {
              points: [U],
          ...
          (null === (l = d.fillLabelBackground) || void 0 === l ? void 0 : l.value()) &&
            ((Z.boxShadow = { shadowColor: d.shadow.value(), shadowBlur: 4, shadowOffsetY: 1 }), (Z.backgroundColor = d.labelBackgroundColor.value())),
      ...
      class m extends g.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._distancePriceRenderer.setData({
            ...
            extendright: !1,
            leftend: c.LineEnd.Normal,
            rightend: Math.abs(y.x - b.x) >= 15 * r.linewidth.value() ? c.LineEnd.Arrow : c.LineEnd.Normal,
          ...
          (null === (i = r.fillLabelBackground) || void 0 === i ? void 0 : i.value()) &&
            ((z.boxShadow = { shadowColor: r.shadow.value(), shadowBlur: 4, shadowOffsetY: 1 }), (z.backgroundColor = r.labelBackgroundColor.value())),
            this._textRenderer.setData(z);
    ...
    53288: (e, t, i) => {
      ...
      var n = i(50151),
        ...
        c = i(46501),
        u = i(33295);
      const p = [h.PaneCursorType.Default, h.PaneCursorType.Default, h.PaneCursorType.VerticalResize, h.PaneCursorType.Default];
      class _ extends u.AlertableLineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (this._points.length >= 3) {
            ...
            v.labelVisible.value() && v.labelText.value() && this._renderer.append(this._getLabelTextRenderer(x, m, R, w));
          }
          const y = (e, t) => ({
              points: [e, t],
          ...
          this._trendLineRendererPoints43.setData(y(R, w)),
            ...
            b(this._p3LabelRenderer, this._p4LabelRenderer, w, R, (0, n.ensureDefined)(g), (0, n.ensureDefined)(f));
          const T = [x, m, w, R];
    ...
    14417: (e, t, i) => {
      ...
      class v extends n.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          this._model.lineBeingCreated() === this._source && x.pop(), h.append(this.createLineAnchor({ points: x }, 0)), (this._renderer = h);
        }
      }
    },
    11756: (e, t, i) => {
      ...
      class f extends _.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (this._data.points.length < 3)
            return (
              (s.strokeStyle = this._data.color), (s.lineWidth = this._data.linewidth), s.beginPath(), s.moveTo(t.x, t.y), s.lineTo(i.x, i.y), void s.stroke()
            );
          ...
          (v = (0, c.transformPoint)(x, v)),
            ...
            s.restore(),
            s.stroke(),
            this._data.fillBackground && ((s.fillStyle = (0, u.generateColor)(this._data.backcolor, this._data.transparency)), s.fill());
        }
      }
      class v extends h.LineSourcePaneView {
        constructor() {
          super(...arguments), (this._ellipseRenderer = new f()), (this._textRenderer = new a.TextRenderer()), (this._renderer = null);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(), this._renderer;
        }
      ...
      class a extends o.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          if (("buy" === this._data.direction ? ((o = n), (a = n + r)) : ((o = n - r), (a = n)), e.x >= i - 2 && e.x <= i + 2 && e.y >= o && e.y <= a)) {
            ...
            return new s.HitTestResult(s.HitTarget.Custom, { tooltip: "" !== e ? { text: e, rect: { x: i, y: o, w: 2, h: a - o } } : void 0 });
          }
          return null;
        }
        setData(e) {
        ...
        _drawImpl(e) {
          ...
          const { arrowHeight: r, arrowSpacing: s, fontHeight: o, direction: a, text: l, font: d, textColor: h } = this._data,
            c = (function (e, t, i) {
      ...
      class u extends d.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          ...
          if (this._points.length < 3) {
            ...
            return this._baseLineRenderer.setData(e), p.append(this._baseLineRenderer), this.addAnchors(p), void (this._renderer = p);
          }
          ...
          for (let i = 1; i < v; i++) {
            ...
            let A;
            null !== I && (p.append(I), (A = null !== (a = (0, h.getTextBoundaries)(I, t, e)) && void 0 !== a ? a : void 0));
            const k = {
          ...
          if (null !== m) {
            ...
            if (i.visible.value()) {
              ...
              let v;
              null !== c && (p.append(c), (v = null !== (l = (0, h.getTextBoundaries)(c, t, e)) && void 0 !== l ? l : void 0));
              const w = {
                points: [r, o],
                color: i.color.value(),
                linewidth: _.levelsStyle.childs().linewidth.value(),
          ...
          if (
            ...
            for (var s = this._source.properties(), c = this._source.levelsCount(), u = 1; u <= c; u++) {
              ...
              if (p.visible.value()) {
                ...
                this._levels.push({ color: g, points: f, labelPoint: v, linewidth: p.linewidth.value(), linestyle: p.linestyle.value(), index: u });
              }
            }
            if (!(this._points.length < 2)) {
              var x = new l(),
        ...
        _updateImpl(e, t) {
          ...
          for (let i = 0; i < this._levels.length; i++) {
            ...
            if ((null === c || c.isOutOfScreen(t, e) || this._renderer.append(c), L)) {
              let n;
              null !== c && "middle" === g.vertLabelsAlign.value() && (n = null !== (l = (0, o.getTextBoundaries)(c, t, e)) && void 0 !== l ? l : void 0);
              const u = {
                  points: [r, h],
                  color: this._levels[i].color,
              ...
              p.setData(u),
                p.setHitTest(new a.HitTestResult(a.HitTarget.MovePoint, { snappingPrice: this._levels[i].price }, this._levels[i].index)),
      ...
      class _ extends p.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl() {
          ...
          for (let e = 1; e <= c; e++) {
            ...
            this._levels.push({ color: a, radius: h, dir: c, labelPoint: u, linewidth: s.linewidth.value(), linestyle: s.linestyle.value(), index: e });
          }
          if (this._points.length < 2) return;
          const p = new o.CompositeRenderer(),
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          for (let e = 0; e < g.length; e++) {
            ...
            if (e > 0 && A) {
              const i = { p1: y, p2: t, p3: y, p4: new r.Point(b.x, g[e - 1].y), color: g[e].color, transparency: k, hittestOnBackground: !0, extendLeft: !1 },
            ...
            }
            {
              const i = {
                ...
                n = new c.TrendLineRenderer();
              n.setData(i), n.setHitTest(new o.HitTestResult(o.HitTarget.MovePoint, void 0, { type: "h", index: g[e].index })), R.append(n);
            }
          }
          for (let e = 0; e < x.length; e++) {
            const t = new r.Point(x[e].x, b.y);
            if (e > 0 && A) {
              const i = { p1: y, p2: t, p3: y, p4: new r.Point(x[e - 1].x, b.y), color: x[e].color, transparency: k, hittestOnBackground: !0, extendLeft: !1 },
                n = new a.ChannelRenderer();
              n.setData(i), R.append(n);
            }
            {
              const i = {
                ...
                n = new c.TrendLineRenderer();
              n.setData(i), n.setHitTest(new o.HitTestResult(o.HitTarget.MovePoint, void 0, { type: "v", index: x[e].index })), R.append(n);
            }
          }
      ...
      class u extends h.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          for (let e = 0; e < 4; e++) {
            ...
            if (null !== n && ((n = (n * i.length()) / 5), Math.abs(n - c) < u)) return new a.HitTestResult(a.HitTarget.MovePoint);
          }
          return null;
        }
        _drawImpl(e) {
    ...
    54498: (e, t, i) => {
      ...
      class p extends u.LineSourcePaneView {
        constructor(e, t) {
          super(e, t), (this._levels = []), (this._trendRenderer = new a.TrendLineRenderer()), (this._renderer = new d.CompositeRenderer());
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
        _updateImpl(e, t) {
          ...
          for (let o = 0; o < this._levels.length; o++) {
            ...
            if (p.showLabels.value()) {
              ...
              this._needLabelExclusionPath(h) && (a = null !== (i = (0, s.getTextBoundaries)(h, t, e)) && void 0 !== i ? i : void 0), this._renderer.append(h);
            }
            const h = { x: this._levels[o].x, color: d, linewidth: this._levels[o].width, linestyle: this._levels[o].style, excludeBoundaries: a },
          ...
          2 === this._source.points().length
            ...
            : this._points.length > 0 &&
              this._renderer.append(this.createLineAnchor({ points: [new n.Point(this._points[0].x, e / 2)], hittestResult: l.HitTarget.MovePoint }, 0));
        }
        _needLabelExclusionPath(e) {
    ...
    60322: (e, t, i) => {
      ...
      class c extends s.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl() {
          if ((super._updateImpl(), (this._renderer = null), (this._levels = []), this._points.length < 3)) return void this._updateRenderer();
          ...
          if ((o.dotProduct(l) < 0 && (h = 2 * Math.PI - h), h < d && ([d, h] = [h, d]), Math.abs(d - h) > Math.PI)) {
        ...
        _updateRenderer(e = NaN, t = NaN) {
          ...
          const f = [r, s];
          this._model.lineBeingCreated() !== this._source && f.push(u), i.append(this.createLineAnchor({ points: f }, 0)), (this._renderer = i);
        }
      }
    },
    13227: (e, t, i) => {
      ...
      class c extends n.LineSourcePaneView {
        ...
        _updateImpl() {
          if ((super._updateImpl(), (this._renderer = null), 1 !== this._points.length)) return;
          this._flagMarkRenderer.setData({ point: this._points[0], color: this._getSource().properties().childs().flagColor.value() });
      ...
      class u extends c.AlertableLineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (3 === this._points.length) {
            if (((_ = (0, r.point)(p.x, this._points[2].y)), (_.data = 2), (g = (0, r.point)(u.x, _.y)), (g.data = 3), f.fillBackground.value())) {
            ...
            f.labelVisible.value() && f.labelText.value() && this._renderer.append(this._getLabelTextRenderer(u, p, g, _));
          }
          const v = (e, t) => ({
            points: [e, t],
          ...
          if ((this._trendLineRendererPoints12.setData(v(u, p)), this._renderer.append(this._trendLineRendererPoints12), 2 === this._points.length))
            return void this.addAnchors(this._renderer);
          const x = (e, t, i, n, r, s) => {
            f.showPrices.value() &&
              (e.setData({
          ...
          if ((x(this._p1LabelRenderer, this._p2LabelRenderer, u, p, l, d), !_ || !g)) return void this.addAnchors(this._renderer);
          this._trendLineRendererPoints43.setData(v(g, _)),
            this._renderer.append(this._trendLineRendererPoints43),
            x(this._p3LabelRenderer, this._p4LabelRenderer, _, g, (0, n.ensureDefined)(c), (0, n.ensureDefined)(c));
          const m = [u, p, _, g];
      ...
      class a extends o.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          this._data.fillBack &&
            ...
            t.fill()),
            t.beginPath(),
            this._data.point.x > this._data.center.x ? t.arc(0, 0, Math.abs(a), 0, Math.PI / 2, !1) : t.arc(0, 0, Math.abs(a), -Math.PI / 2, -Math.PI, !0),
            t.scale(1, 1 / s),
            t.stroke();
        }
      }
      ...
      class u extends r.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const o = n.x - i.x,
            ...
            h = n,
            c = this._getModel(),
            u = { barsCoordsRange: o, priceCoordsRange: l, startPoint: d, endPoint: h, p1: i, p2: n, isLabelsVisible: r.isLabelsVisible(), reversed: s };
          this._prepareLevels(e, u), this._prepareFanLines(e, u), this._prepareArcs(e, u), this._prepareLabels(e, u);
          const p = [i, n];
          c.lineBeingCreated() === r && p.pop(), e.append(this.createLineAnchor({ points: p }, 0)), (this._renderer = e);
        }
        _initRenderers() {
          const e = this._getSource(),
            t = e.levelsCount();
        ...
        _prepareArcs(e, t) {
          ...
          for (const t of u) {
            ...
            const i = t.x / 5,
              ...
              u = r.x + i * o,
              p = r.y + d * a,
              _ = { center: r, point: new n.Point(u, p), edge: s, color: t.color, linewidth: t.width, fillBack: h, transparency: c, prevPoint: l },
        ...
        _updateImpl() {
          ...
          for (let e = 1; e <= 9; e++) {
            ...
            s > o ? ((c = i.x), (_ = t.y + p / a)) : ((c = t.x + u * a), (_ = i.y)),
              h.push({ label: d, color: l, x: c, y: _, linewidth: r.linewidth.value(), linestyle: r.linestyle.value(), index: e });
          }
    ...
    57583: (e, t, i) => {
      ...
      class h extends r.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const f = [l, s[1]];
          _.lineBeingCreated() === e && f.pop(), a.append(this.createLineAnchor({ points: f }, 0)), (this._renderer = a);
        }
        _initRenderers() {
          const e = this._getSource(),
            t = e.levelsCount();
      ...
      t.GannSquarePaneView = class extends r {
        ...
        _updateImpl() {
          if (
            (super._updateImpl(),
            (this._renderer = null),
            !(this._source.points().length < 2) && this._source.priceScale() && !this._source.priceScale().isEmpty() && !this._model.timeScale().isEmpty())
          ) {
            ...
            this._hlevels = [];
            for (
              var r = i ? e.price - t.price : t.price - e.price, d = i ? t.price : e.price, u = this._source.ownerSource().firstValue(), p = 1;
              p <= 7;
              p++
            ) {
            ...
            if (((this._hfans = []), (this._vfans = []), S.fans.visible.value()))
              for (p = 1; p <= 7; p++) {
                (R = Math.round(m + S["hlevel" + p].coeff.value() * x)), (f = d + S["vlevel" + p].coeff.value() * r);
            ...
            (j.data = 3), b.append(this.createLineAnchor({ points: [...this._points, Y, j] }, 0)), (this._renderer = b);
          }
          function U(e, t, i) {
            var r = new n(T, P),
              s = new n(L, P),
    ...
    45495: (e, t, i) => {
      ...
      var n = i(5531),
        ...
        u = i(79191),
        p = i(46501);
      const _ = { leftShoulder: r.t(null, void 0, i(68589)), rightShoulder: r.t(null, void 0, i(78934)), head: r.t(null, void 0, i(63706)) };
      class g extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if ((this._polyLineRenderer.setData(m), f.append(this._polyLineRenderer), this._points.length >= 5)) {
            ...
            (c.extendleft = r), (c.extendright = d), this._trendLineRenderer.setData(c), f.append(this._trendLineRenderer);
            const u = x(o, a, l);
    ...
    74660: (e, t, i) => {
      ...
      class u extends h.AlertableLineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const p = { y: this._points[0].y, color: s.linecolor.value(), linewidth: s.linewidth.value(), linestyle: s.linestyle.value(), excludeBoundaries: h };
          this._lineRenderer.setData(p),
            this._lineRenderer.setHitTest(new r.HitTestResult(r.HitTarget.MovePoint, { snappingPrice: this._source.points()[0].price }));
    ...
    57964: (e, t, i) => {
      ...
      class _ extends u.BitmapCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          (t.lineCap = void 0 === this._data.linestyle || this._data.linestyle === p.LINESTYLE_SOLID ? "round" : "butt"),
    ...
    79191: (e, t, i) => {
      ...
      class _ {
        ...
        _needLabelExclusionPath(e, t) {
          const i = this._source.properties().childs();
          return "middle" === (null != t ? t : i.vertLabelsAlign.value()) && (0, h.needTextExclusionPath)(e);
        }
    ...
    134: (e, t, i) => {
      ...
      class d extends r.LineSourcePaneView {
        constructor(e, t) {
          ...
          (this._numericFormatter = new o.NumericFormatter()), (this._percentageFormatter = new a.PercentageFormatter());
        }
        _updateLabelForLevel({
          ...
          switch (L) {
            case "left":
              ...
              break;
            case "right":
              (P = r.y), c ? (T = b ? this._model.timeScale().width() : i.x) : ((T = r.x), (L = "left"));
              break;
            default:
    ...
    34658: (e, t, i) => {
      ...
      class v {
        ...
        update(e) {
          ...
          (t = this._data),
            (i = e),
            (null === t || t.markerColor !== i.markerColor || t.borderColor !== i.borderColor || t.width !== i.width || t.height !== i.height) &&
        ...
        _createSource(e, t, i) {
          (this._sourceCanvas = (0, u.createDisconnectedCanvas)(document, (0, _.size)({ width: e, height: t }), this._renderParams.pixelRatio)),
      ...
      class x {
        ...
        draw(e, t) {
          ...
          (null !== this._source && (0, p.areEqualPaneRenderParams)(this._source.renderParams(), t)) ||
            (null === (i = this._source) || void 0 === i || i.destroy(), (this._source = new v(t)), this._source.update(this._data));
        ...
        _drawTooltipOn(e, t) {
          ...
          (w = Math.round(w * t.pixelRatio)), (g = Math.round(g * t.pixelRatio)), (_ = Math.round(_ * t.pixelRatio));
          const b = Math.round(7 * t.pixelRatio);
          e.moveTo(R, y),
            x || "top" !== m || (e.lineTo(w - b, y), e.lineTo(w, y - b), e.lineTo(w + b, y)),
            e.lineTo(R + _, y),
            e.lineTo(R + _, y + g),
            x || "bottom" !== m || (e.lineTo(w + b, y + g), e.lineTo(w, y + g + b), e.lineTo(w - b, y + g)),
            e.lineTo(R, y + g),
            e.closePath(),
            e.fill(),
            e.stroke(),
          ...
          (0, u.drawScaled)(e, t.pixelRatio, t.pixelRatio, () => {
            for (let t = 0; t < a.length; t++) e.fillText(a[t].replace(/^\s+/, ""), P, L), (L += i.fontSize + p);
          }),
            e.restore();
        }
      }
    ...
    61144: (e, t, i) => {
      ...
      class f extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          let h = !1;
          0 !== n && (this._drawBody(t, o, d), this._adapter.hasMoveCallback() && this._drawMovePoints(t, o, d), this._drawBodyText(t, o, d), (h = !0)),
        ...
        _drawCancelButton(e, t, i, r) {
          ...
          e.fillRect(t + 0.5, i + 0.5, s - 1, o - 1),
            this._adapter.getBlocked() && ((e.fillStyle = "rgba(140, 140, 140, 0.75)"), e.fillRect(t + 0.5, i + 0.5, s - 1, o - 1)),
            e.save(),
      ...
      class u extends d.AlertableLineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (3 === this._points.length) {
            ...
            (o = i.add((0, n.point)(0, e))), (l = s.add((0, n.point)(0, e))), t.showMidline.value() && ((d = i.add(o).scaled(0.5)), (h = s.add(l).scaled(0.5)));
          }
          const u = t.linewidth.value(),
            ...
            g = {
              ...
              line2: null === o || null === l ? void 0 : { color: _, lineStyle: p, lineWidth: u, points: [o, l] },
              middleLine:
                null === d || null === h
                  ? void 0
                  : { color: t.midlinecolor.value(), lineStyle: t.midlinestyle.value(), lineWidth: t.midlinewidth.value(), points: [d, h] },
          ...
          v && f.append(v);
          const x = [];
          if ((this._points[0] && x.push(this._points[0]), this._points[1] && x.push(this._points[1]), o && l)) {
            const e = o;
            (e.data = 2), x.push(e);
            const t = l;
            (t.data = 3), x.push(t);
        ...
        _getLabelTextRenderer(e, t, i, n) {
          ...
          switch (r.labelVertAlign.value()) {
            ...
            case "top":
              ...
              break;
            case "middle":
              i && n ? ((o = e.add(i).scaled(0.5)), (a = t.add(n).scaled(0.5))) : ((o = e), (a = t)), (d = l);
          }
          const h = o.x < a.x ? o : a,
            c = h === o ? a : o;
          let u, p;
    ...
    95337: (e, t, i) => {
      ...
      class c extends h {
        ...
        _updateRenderer() {
            ...
            i = e.childs().median.childs();
          {
            ...
            if ((this._backSideRenderer.setData(e), t.append(this._backSideRenderer), !this._medianPoint || !this._modifiedBase))
      ...
      class p extends h {
        ...
        _updateRenderer() {
          if ((this._points.length > 1 && (this._modifiedBase = this._points[0].add(this._points[1]).scaled(0.5)), this._points.length < 2)) return;
    ...
    46258: (e, t, i) => {
      ...
      class f extends h {
        ...
        _drawReverseButton(e, t, i) {
          ...
          var n = this._reverseButtonWidth(),
            r = this._height();
          e.fillRect(t + 0.5, i + 0.5, n - 1, r - 1), e.strokeRect(t, i, n, r), (e.strokeStyle = this._adapter.getReverseButtonIconColor());
          var s = function (e, t) {
          ...
          e.save(),
            ...
            s(e, 10),
            e.restore(),
            this._adapter._blocked && ((e.fillStyle = "rgba(140, 140, 140, 0.75)"), e.fillRect(t + 0.5, i + 0.5, n - 1, r - 1)),
            e.restore();
        }
        ...
        _drawImpl(e) {
          ...
          (this._cache.bodyRight = a + n),
            ...
            0 !== r && (this._drawQuantity(t, this._cache.bodyRight, h), this._drawQuantityText(t, this._cache.bodyRight, h)),
        ...
        hitTest(e) {
          return null === this._data ||
            ...
            : new s(o.Custom, {
                ...
                tooltip: {
                  text: this._adapter.getTooltip(),
                  rect: { x: this._cache.left, y: this._cache.top, w: this._cache.bodyRight - this._cache.left, h: this._cache.bottom - this._cache.top },
                },
              });
        }
      }
      t.PositionPaneView = class extends n {
        ...
        renderer(e, t) {
          return (
            this._invalidated && this._updateImpl(), this._renderer.setData({ points: this._points, width: this._model.timeScale().width() }), this._renderer
          );
        }
      };
    },
      ...
      class S extends b {
        ...
        drawTargetLabel(e) {
          ...
          var b = "up" === this._data.direction ? "down" : "up",
            T = this.drawBalloon(e, g, this._targetWidth, this._targetHeight, b, this._targetRectLeftOffset);
            ...
            (e.fillStyle = B),
              "up" === this._data.direction
                ? (R(e, T.x - 1, T.y - H - 2, this._targetWidth + 2, H, 5),
                  ...
                  E && e.drawImage(E, T.x + O - E.width - 4, T.y - H - 2 + Math.abs(H - E.height) / 2))
                : (R(e, T.x - 1, T.y + this._targetHeight + 2, this._targetWidth + 2, H, 5),
                  e.fill(),
                  (e.fillStyle = z),
                  e.fillText(D, T.x + O + W, T.y + this._targetHeight + 5),
                  E && e.drawImage(E, T.x + O - E.width - 4, T.y + this._targetHeight + 10 - Math.abs(H - E.height) / 2)),
              e.restore();
          } else e.restore();
        }
        drawStartLabel(e) {
        ...
        _updateImpl() {
          if (
            ...
            if (d && a) {
              ...
              this._targetLine2 = i.tf(null, { context: "dates" }, i(91481)) + " " + L(new f().format(m));
            }
            (this._sourceLine1 = e.format(n.price)), (this._sourceLine2 = "");
            var w = this._model.timeScale().indexToUserTime(n.index);
            w && ((this._sourceLine2 = new u().format(w)), h || (this._sourceLine2 = this._sourceLine2 + " " + new p(v ? g : _).format(w))),
    ...
    86583: (e, t, i) => {
      ...
      class v extends g {
        ...
        _drawImpl(e) {
          if (null !== this._data && null !== this._points && 0 !== this._points.length) {
            ...
            var d = p(t, i.width);
            this._measureCache && Object.assign(this._measureCache, { innerWidth: s, innerHeight: o, tailLeft: -9, tailHeight: 15 }),
      ...
      t.PriceLabelPaneView = class extends a {
        constructor(e, t, i) {
          super(e, t), (this._rendererCache = {}), (this._priceLabelRenderer = new v(this._rendererCache, t)), (this._renderer = null);
        }
        _updateImpl() {
          ...
          if (
            ...
            return (
              ...
              r.append(new l({ points: n.points, bgColors: this._lineAnchorColors(n.points), visible: this.areAnchorsVisible() })),
    ...
    29734: (e, t, i) => {
      ...
      class x {
        constructor() {
          (this._data = null),
            (this._priceLabelRenderer = new a.TextRenderer(void 0, new _.HitTestResult(_.HitTarget.MovePoint, { areaName: _.AreaName.Style, activeItem: 1 }))),
        ...
        _updateImpl(e, t) {
          ...
          if (h.showLabel && h.showLabel.value()) {
            ...
            this._customLabelRenderer.setData(v),
              ...
              "middle" === c && (_.excludeBoundaries = null !== (i = (0, a.getTextBoundaries)(this._customLabelRenderer, t, e)) && void 0 !== i ? i : void 0);
          }
          this._renderer.append(this._priceNoteRenderer), this._priceNoteRenderer.setData(_), this._renderer.append(this.createLineAnchor({ points: l }, 0));
        }
      }
    },
    61416: (e, t, i) => {
      ...
      class v extends g.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          k &&
            ...
            ((this._pipFormatter = new p.PipFormatter(k.pricescale, k.minmov, k.type, k.minmove2, k.typespecs)), (this._lastSymbolInfo = k));
          const N = (0, n.ensureNotNull)(this._source.ownerSource()).formatter(),
            D = null !== (a = null === (i = N.formatChange) || void 0 === i ? void 0 : i.call(N, M, S)) && void 0 !== a ? a : N.format(I),
            B = (0, s.forceLTRStr)(D + " (" + f.format(A) + ") " + (this._pipFormatter ? this._pipFormatter.format(I) : ""));
          let z;
          z = M > S ? new r.Point(0.5 * (v.x + x.x), x.y - 2 * d.fontsize.value()) : new r.Point(0.5 * (v.x + x.x), x.y + 0.7 * d.fontsize.value());
          const E = { x: 0, y: 10 },
            H = d.fontsize.value(),
            V = {
              points: [z],
          ...
          (null === (l = d.fillLabelBackground) || void 0 === l ? void 0 : l.value()) &&
            ((V.boxShadow = { shadowColor: d.shadow.value(), shadowBlur: 4, shadowOffsetY: 1 }), (V.backgroundColor = d.labelBackgroundColor.value())),
    ...
    31320: (e, t, i) => {
      ...
      class h extends l.LineSourcePaneView {
        constructor(e, t) {
          super(e, t), (this._rectangleRenderer = new s.RectangleRenderer()), (this._textRenderer = new a.TextRenderer()), (this._renderer = null);
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
        _updateImpl(e, t) {
          ...
          if (s.middleLine.childs().showLine.value()) {
            ...
            s.showLabel.value() &&
              ...
              (n = null !== (i = (0, a.getTextBoundaries)(this._textRenderer, t, e)) && void 0 !== i ? i : void 0);
        ...
        _updateImpl() {
          ...
          for (let t = 1; t < i.length; t++) {
            const n = i[t].color,
              ...
              h = i[t].extendright,
              c = {
                line1: { color: n, lineStyle: d, lineWidth: o, points: [i[t].points[0], i[t].points[1]] },
                line2: { color: n, lineStyle: d, lineWidth: o, points: [i[t - 1].points[0], i[t - 1].points[1]] },
                extendLeft: !1,
                extendRight: h,
          ...
          for (let n = 0; n < i.length; n++) {
            ...
            r.setData(_[n]), r.setHitTest(new s.HitTestResult(s.HitTarget.Regular)), e.append(r), 0 !== n && (t = t.concat(i[n].points));
          }
          this._data.pearsons &&
    ...
    56457: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        R = i(46501),
        y = i(79849);
      const b = [m.PaneCursorType.Default, m.PaneCursorType.HorizontalResize, m.PaneCursorType.VerticalResize, m.PaneCursorType.VerticalResize],
      ...
      class A extends o.LineSourcePaneView {
        constructor() {
          super(...arguments),
            ...
            (this._fullStopBgRenderer = new d.RectangleRenderer(new h.HitTestResult(h.HitTarget.MovePoint), new h.HitTestResult(h.HitTarget.MovePoint))),
            (this._stopBgRenderer = new d.RectangleRenderer(new h.HitTestResult(h.HitTarget.MovePoint), new h.HitTestResult(h.HitTarget.MovePoint))),
            (this._fullTargetBgRenderer = new d.RectangleRenderer(new h.HitTestResult(h.HitTarget.MovePoint), new h.HitTestResult(h.HitTarget.MovePoint))),
            (this._targetBgRenderer = new d.RectangleRenderer(new h.HitTestResult(h.HitTarget.MovePoint), new h.HitTestResult(h.HitTarget.MovePoint))),
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            f !== this._lastSymbolInfo &&
              ((this._pipFormatter = new _.PipFormatter(f.pricescale, f.minmov, f.type, f.minmove2, f.typespecs)), (this._lastSymbolInfo = f)),
            (N = [this._profitLabelRenderer, this._stopLabelRenderer, this._middleLabelRenderer].reduce((i, n) => i && n.isOutOfScreen(t, e), N)),
            N)
          )
            return;
        ...
        _creareMiddleLabel(e, t, i) {
          const { entryPrice: s, profitPrice: o, stopPrice: a, currentPrice: l, pl: d, left: h, edge: c, isClosed: u } = e,
          ...
          if (_.compact.value()) (v += x ? x + " ~ " : ""), (v += y + "\n"), (v += m);
            ...
            const e = u ? L : P;
            (v += x ? T.format({ status: e, pnl: x }) + ", " : ""), (v += I.format({ qty: "" + y }) + "\n"), (v += C.format({ ratio: m }) + " ");
          }
          let b = _.linecolor.value();
          return (
            d < 0 ? (b = _.stopBackground.value()) : d > 0 && (b = _.profitBackground.value()),
            this._addCenterLabel(t, this._middleLabelRenderer, { p: f, txt: v, color: b, vertAlign: "middle", offsetY: 0, border: "white" })
          );
        }
        _createStopLabel(e, t) {
          ...
          const v = u.formatter(),
            m =
              null !== (s = null === (i = v.formatChange) || void 0 === i ? void 0 : i.call(v, Math.max(o, a), Math.min(o, a))) && void 0 !== s
                ? s
                : v.format(p),
          ...
          return (
            ...
            this._addCenterLabel(t, this._stopLabelRenderer, { p: g, txt: f, color: c.stopBackground.value(), vertAlign: a < o ? "bottom" : "top", offsetY: 0 })
          );
        }
        _createTargetLabel(e, t) {
          ...
          const m = p.formatter(),
            w =
              null !== (s = null === (i = m.formatChange) || void 0 === i ? void 0 : i.call(m, Math.max(o, a), Math.min(o, a))) && void 0 !== s
                ? s
                : m.format(_),
        ...
        _createLabelsRenderers(e, t, i) {
          ...
          if (
            h - d - c <= 8 &&
            (l && ((l.offsetY += c + 8), this._profitLabelRenderer.setData(l)), a && ((a.offsetY += c + 8), this._stopLabelRenderer.setData(a)), o)
          ) {
            let t;
            ...
            const i = e.profitLevel < e.stopLevel ? 1 : -1,
              a = (0, r.ensureDefined)(o.points)[0].add(new n.Point(0, i * t * (0.5 * this._middleLabelRenderer.measure().height + c + 8)));
    ...
    26294: (e, t, i) => {
      ...
      class R {
        ...
        setData(e) {
          ...
          if ((t.labelRenderer.setData(r), (this._data.labelHeight = this._data.labelRenderer.measure().height), t.inverseAnchorPosition)) {
            ...
            const e =
              1 === t.direction ? Math.min(t.poleStartY - this._data.labelHeight, t.anchorY) : Math.max(t.poleStartY + this._data.labelHeight, t.anchorY);
        ...
        hitTest(e, t) {
          ...
          if (i || r || s) {
            const e = { hideCrosshairLinesOnHover: !0, activeItem: i || r ? this._data.itemIndex : this._data.label.labelIndex };
            return s ? (e.areaName = a.AreaName.Text) : r && (e.areaName = a.AreaName.Style), new a.HitTestResult(this._hitTestResult, e);
          }
          return null;
        }
        draw(e, t) {
            ...
            void 0 !== this._data.plate &&
              ...
              e.lineTo(
                ...
                Math.round(
                  (function (e) {
                    var t, i;
                    const n = null !== (i = null === (t = e.plate) || void 0 === t ? void 0 : t.poleTailHeight) && void 0 !== i ? i : 0;
      ...
      class L extends l.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          (s.data = r.data),
            (s.square = !0),
            this._renderer.append(this.createLineAnchor({ points: [s], pointsCursorType: [o.PaneCursorType.VerticalResize] }, 0));
        }
        _itemAnchorY() {
        ...
        async _updateEmoji() {
          ...
          null !== this._emojiCache &&
            (null === (e = this._emojiCache.abortController) || void 0 === e || e.abort(), (this._emojiCache.abortController = void 0));
      ...
      class h extends r.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const u = 2 * a,
            ...
            _ = { point: new n.Point(p, s.y), width: a, height: l, color: h.linecolor.value(), lineWidth: h.linewidth.value(), lineStyle: h.linestyle.value() };
    ...
    44666: (e, t, i) => {
      ...
      class r extends n.LineSourcePaneView {
        renderer() {
          return this._invalidated && (this._updateImpl(), (this._invalidated = !1)), this.createLineAnchor({ points: this._getPoints() }, 0);
        }
      }
    },
    50761: (e, t, i) => {
      ...
      class _ extends c.MediaCoordinatesPaneRenderer {
        ...
        isOutOfScreen(e, t) {
          ...
          let s;
          return (s = r % (Math.PI / 2) == 0 ? i / 2 : Math.sqrt(i ** 2 * 2) / 2), n.x + s < 0 || n.x - s > t || n.y + s < 0 || n.y - s > e;
        }
        _drawImpl(e) {
          if (null === this._data) return;
          ...
          l.rotate(d);
          const h = t / 2;
          a && ((l.fillStyle = o), (l.strokeStyle = p), l.beginPath(), l.rect(-h, -h, t, t), l.closePath(), l.fill(), l.stroke()),
            i &&
              (l.translate(-h, -h),
      ...
      class g extends d.LineSourcePaneView {
        ...
        _calculateBackgroundColor() {
          return (0, o.generateColor)(
            this._model.backgroundColorAtYPercentFromTop(this._points[0].y / (0, s.ensureNotNull)(this._model.paneForSource(this._source)).height()),
            60,
            !0
          );
        }
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            i.isPriceDencityLog() && !o.isLog() && (t = o.height() / ((0, h.toLog)(e.maxValue(), r) - (0, h.toLog)(e.minValue(), r))),
              !i.isPriceDencityLog() && o.isLog() && (t = o.height() / ((0, h.fromLog)(e.maxValue(), r) - (0, h.fromLog)(e.minValue(), r)));
      ...
      class h extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          (t.strokeStyle = this._data.color),
            ...
            t.restore(),
            t.stroke(),
            this._data.fillBackground && ((t.fillStyle = (0, o.generateColor)(this._data.backcolor, this._data.transparency)), t.fill());
        }
      }
      ...
      class m extends x.TrendToolWithStatsPaneView {
        ...
        _updateImpl(e, t) {
          ...
          m.statsPosition.value() === h.StatsPosition.Auto &&
            (b = (0, r.equalPoints)(v, x) ? !(0, o.pointInBox)(v, y) : null === (0, s.intersectLineSegmentAndBox)((0, r.lineSegment)(v, x), y));
          if ((this.isHoveredSource() || this.isSelectedSource() || m.alwaysShowStats.value()) && !b && 2 === this._points.length) {
            const e = new g.PaneRendererCachedImage(this, 0);
            this._renderer.append(e);
          }
          const T = (this.isHoveredSource() || this.isSelectedSource()) && m.showMiddlePoint.value();
          this._middlePoint &&
            this._renderer.append(
          ...
          const P = { point: v, angle: null !== (i = n.angle()) && void 0 !== i ? i : 0, color: m.linecolor.value(), size: 50 };
        ...
        _updateImpl(e, t) {
          ...
          if (x)
            for (let e = 0; e < this._levels.length; e++)
              if (e > 0 && x) {
                ...
                this._rectangleRenderers.hasOwnProperty(e) || (this._rectangleRenderers[e] = new r.RectangleRenderer(void 0, void 0, !0));
          ...
          for (let i = 0; i < this._levels.length; i++) {
            ...
            null !== u &&
              ...
              "middle" === p.vertLabelsAlign.value() && (c = null !== (a = (0, h.getTextBoundaries)(u, e, t)) && void 0 !== a ? a : void 0));
            const _ = {
              points: [r, d],
              color: this._levels[i].color,
              linewidth: this._levels[i].linewidth,
            ...
            g.setData(_),
              g.setHitTest(new o.HitTestResult(o.HitTarget.MovePoint, { snappingPrice: this._levels[i].price }, this._levels[i].index)),
        ...
        _updateImpl(e, t) {
          ...
          for (let o = 0; o < this._levels.length; o++) {
            ...
            if (m) {
              ...
              this._needLabelExclusionPath(d) && (a = null !== (i = (0, s.getTextBoundaries)(d, t, e)) && void 0 !== i ? i : void 0), u.append(d);
            }
            const d = {
                x: this._levels[o].x,
                color: this._levels[o].color,
    ...
    96310: (e, t, i) => {
      ...
      class g extends _.TrendToolWithStatsPaneView {
        constructor() {
          super(...arguments), (this._trendRenderer = new c.TrendLineRenderer()), (this._labelRenderer = new l.TextRenderer());
        }
        _getPointsForStats() {
        ...
        _updateImpl(e, t) {
          ...
          x.statsPosition.value() === d.StatsPosition.Auto &&
            (P = (0, r.equalPoints)(m, w) ? !(0, s.pointInBox)(m, T) : null === (0, o.intersectLineSegmentAndBox)((0, r.lineSegment)(m, w), T));
    ...
    48063: (e, t, i) => {
      ...
      class S {
        constructor(e, t, i) {
          (this._fontSize = 0),
            ...
            (this._lineSpacing = (0, w.isNumber)(this._data.lineSpacing) && this._data.lineSpacing ? this._data.lineSpacing : 0),
          ...
          if (this._rect) {
            if (
              (("right" !== this._data.horzAlign && "center" !== this._data.horzAlign) ||
                (!0 !== this._data.doNotAlignText && (e.textAlign = "right" === this._data.horzAlign ? "end" : "center")),
        ...
        _preRender() {
          ...
          const c = { top: this._data.paddingTop, right: this._data.paddingRight, bottom: this._data.paddingBottom, left: this._data.paddingLeft },
            u = { x: Math.floor(t), y: Math.floor(n), w: Math.ceil(h + c.left + c.right), h: Math.ceil(l + c.top + c.bottom) };
          ...
          if ("right" === this._data.horzAlign || "center" === this._data.horzAlign) {
            ...
            (i += n - u.x),
              ...
              !0 !== this._data.doNotAlignText &&
                ("right" === this._data.horzAlign ? ((e.textAlign = "end"), (i += h)) : ((e.textAlign = "center"), (i += h / 2)));
          }
          u.w % 2 != 0 && u.w++,
            (u.x += 0.5),
            (u.y += 0.5),
      ...
      function E(e, t) {
        return !(!e && !t) && (Boolean(e) !== Boolean(t) || e.index !== t.index || e.price !== t.price);
      }
      function H(e, t) {
      ...
      class V {
        ...
        updateSource(e, t) {
          ...
          this._currentSymbol !== i &&
            (z.logDebug("TrendLineCache. Clearing canvas because of changing symbol from " + this._currentSymbol + " to " + i),
            (this._currentSymbol = i),
          ...
          if (void 0 === s) {
            ...
            (s = { effectiveState: null, rowIndex: e, width: 0 }), this._sourcesToRow.set(r, s), this._rowsToSources.set(e, r);
          }
        ...
        _repaintSource(e, t, i) {
          ...
          (0, R.drawScaled)(this._ctx, s, s, () => {
            this._ctx.translate(0.5, this.topByRow(t) + 0.5), this._ctx.clearRect(0, 0, this._currentWidth, this._maxRowHeight);
      ...
      class W extends A.AlertableLineSourcePaneView {
        ...
        getCacheRects(e, t) {
          const i = this._createCacheIfRequired(e),
            ...
            d = { left: 0, top: i.topByRow(o.rowIndex), width: i.rowWidth(o.rowIndex), height: i.rowHeight(o.rowIndex) },
          ...
          p ? (u -= 10 + d.height) : (u += 10),
            a !== O.StatsPosition.Auto ||
              ...
              ) && ((u = p ? l[h].y + 10 : l[h].y - 10 - d.height), (c = Math.min(l[O.StatsPosition.Center].x, e.cssWidth) - d.width)));
          return { cacheRect: d, targetRect: { left: Math.floor(c), top: Math.floor(u), width: d.width, height: d.height } };
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        }
        _createCacheIfRequired(e) {
          return (
            (null !== this._cache && null !== this._cacheDrawParams && (0, p.areEqualPaneRenderParams)(e, this._cacheDrawParams)) ||
            ...
            this._cacheInvalidated && ((this._statCache = this._cache.updateSource(this._source, () => this._statLabelData())), (this._cacheInvalidated = !1)),
            this._cache
          );
        }
        _updateImpl(e, t) {
        ...
        _priceRange() {
          ...
          if (this._source.priceScale() && (o || a || l)) {
            ...
            if (o || a) {
              ...
              if (o) {
                const n = d.formatter(),
                  o = null !== (t = null === (e = n.formatChange) || void 0 === e ? void 0 : e.call(n, r.price, i.price)) && void 0 !== t ? t : n.format(s);
                h.push(o);
              }
              if (a) {
            ...
            c &&
              ...
              ((this._pipFormatter = new u.PipFormatter(c.pricescale, c.minmov, c.type, c.minmove2, c.typespecs)), (this._lastSymbolInfo = c)),
        ...
        _statLabelData() {
          ...
          if (x || v) {
            ...
            (u = (0, n.ensureNotNull)(this._source.pointToScreenPoint(t)).subtract(i)), (p = Math.round(1e5 * u.length()) / 1e5);
          }
          if (g || f || v) {
            if (((l = ""), g && ((h = t.index - e.index), (l += o.t(null, void 0, i(33355)).format({ count: (0, a.forceLTRStr)(String(h)) }))), f)) {
            ...
            v &&
              (l && (l += ", "),
              (l += o.t(null, void 0, i(26273)).format({ number: (0, a.forceLTRStr)(this._numericFormatter.format(Math.round(Number(p)))) }))),
              l && s.push("barsRange");
          }
          if (x) {
            let e;
        ...
        _updateImpl() {
          ...
          if (4 === this._points.length) {
            ...
            if (p < n) {
              ...
              (n = Math.max(n, i.x)), (n = Math.max(n, a.x)), (d = new r.Point(n, e.y + (n - e.x) * s)), (c = new r.Point(n, t.y + (n - t.x) * h));
            }
            const _ = e.y + (p - e.x) * s;
            l = new r.Point(p, _);
          }
          ...
          if (
            ...
            this._points.length >= 3 && (this._trendLineRendererPoints12.setData(f(t, i)), _.append(this._trendLineRendererPoints12)),
    ...
    77444: (e, t, i) => {
      ...
      class u extends h.AlertableLineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const p = { x: this._points[0].x, color: o.linecolor.value(), linewidth: o.linewidth.value(), linestyle: o.linestyle.value(), excludeBoundaries: h },
            _ = p.linewidth / 2 + 1;
          if (
            ((u = u && (p.x < -_ || p.x > t + _)),
            this._lineRenderer.setData(p),
            this._lineRenderer.setHitTest(new d.HitTestResult(d.HitTarget.MovePoint, { snappingIndex: this._source.points()[0].index })),
      ...
      class o {
        ...
        draw(e, t) {
          ...
          if (
            ...
            0 === this._cacheRect.width || 0 === this._cacheRect.height || 0 === this._targetRect.width || 0 === this._targetRect.height)
          )
            return;
      ...
      class o extends s.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            (t.lineWidth = this._data.linewidth),
            t.beginPath(),
            t.arc(this._data.center.x, this._data.center.y, this._data.radius, this._data.angle1, this._data.angle2),
            t.stroke(),
    ...
    2436: (e, t, i) => {
      "use strict";
      i.d(t, { cubicBezierHitTest: () => a, extendQuadroBezier: () => l, quadroBezierHitTest: () => s });
      var n = i(4652),
        r = i(37160);
    ...
    14146: (e, t, i) => {
      ...
      class u extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          return null !== i && (0, o.pointInPolygon)(e, i) ? new l.HitTestResult(l.HitTarget.MovePointBackground) : null;
        }
        _drawImpl(e) {
          if (null === this._data) return;
          const t = e.context,
        ...
        _visiblePolygon(e) {
          ...
          let h = [new s.Point(0, 0), new s.Point(e.width, 0), new s.Point(e.width, e.height), new s.Point(0, e.height)];
          return (
            (h = (0, d.clipPolygonByEdge)(h, i, n, [l, o])),
            (h = (0, d.clipPolygonByEdge)(h, l, o, [i, n])),
            (0, s.equalPoints)(o, i) || t.extendLeft || (h = (0, d.clipPolygonByEdge)(h, o, i, [n, l])),
            h
          );
        }
      }
        ...
        setData(e) {
          ...
          if (
            ...
            null !== (0, l.intersectLines)((0, s.lineThroughPoints)(t, i), (0, s.lineThroughPoints)(n, r))
              ? (this._disjointChannelIntersectionRenderer.setData(e), (this._selectedRenderer = this._disjointChannelIntersectionRenderer))
              : (this._parallelChannelRenderer.setData({
                  line1: { color: "rgba(0,0,0,0)", lineStyle: d.LINESTYLE_SOLID, lineWidth: 0, points: [t, i] },
                  line2: { color: "rgba(0,0,0,0)", lineStyle: d.LINESTYLE_SOLID, lineWidth: 0, points: [r, n] },
      ...
      class f extends _.MediaCoordinatesPaneRenderer {
        ...
        _visiblePolygons(e) {
            ...
            c = [];
          {
            ...
            (e = (0, u.clipPolygonByEdge)(e, d, r, [s, s])), (e = x(e, t)), (e = (0, u.clipPolygonByEdge)(e, s, d, [r, r])), null !== e && c.push(e);
          }
          {
            let e = h;
      ...
      class d extends a.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          return (
            ...
            Math.abs(c) < 3 ? this._hitTest : this._data.fillBackground && !this._data.noHitTestOnBackground && c < 3 ? this._backgroundHitTest : null
          );
        }
        _drawImpl(e) {
          const t = e.context;
          ...
          t.save(),
            ...
            t.stroke(),
            this._data.fillBackground &&
              (this._data.wholePoints && (t.translate(a.x, a.y), t.scale(1, s / r), t.arc(0, 0, d / 2, 0, 2 * Math.PI, !0)),
    ...
    18690: (e, t, i) => {
      ...
      function o(e, t, i, o, a, l, d) {
        ...
        if (e.x === t.x) {
          ...
          e.y < t.y
            ? u.push(new n.Point(e.x, 0 === d ? 0 : e.y < 0 ? e.y % d : -(d - (e.y % d))), new n.Point(t.x, l))
            : u.push(new n.Point(e.x, 0 === d ? l : e.y > l ? l + ((e.y - l) % d) : l + (d - ((l - e.y) % d))), new n.Point(t.x, 0));
        } else if (e.y === t.y) {
          if (e.y < 0 || e.y > l) return null;
          e.x < t.x
            ? u.push(new n.Point(0 === d ? 0 : e.x < 0 ? e.x % d : -(d - (e.x % d)), e.y), new n.Point(a, t.y))
            : u.push(new n.Point(0 === d ? a : e.x > a ? a + ((e.x - a) % d) : a + (d - ((a - e.x) % d)), e.y), new n.Point(0, t.y));
        } else {
          ...
          if (null !== p)
            if (d > 0 && (e.x <= 0 || (i && e.x < t.x))) {
              const t =
                e.x <= 0 ? Math.sqrt(Math.pow(0 - e.x, 2) + Math.pow(p - e.y, 2)) % d : d - (Math.sqrt(Math.pow(0 - e.x, 2) + Math.pow(p - e.y, 2)) % d);
          ...
          if (null !== _)
            if (d > 0 && (e.x >= a || (i && e.x > t.x))) {
              const t =
                e.x >= a ? Math.sqrt(Math.pow(e.x - a, 2) + Math.pow(e.y - _, 2)) % d : d - (Math.sqrt(Math.pow(e.x - a, 2) + Math.pow(e.y - _, 2)) % d);
          ...
          if (null !== g && (0 !== g || 0 !== p))
            if (d > 0 && (e.y <= 0 || (i && e.y < t.y))) {
              const t =
                e.y <= 0 ? Math.sqrt(Math.pow(e.x - g, 2) + Math.pow(e.y - 0, 2)) % d : d - (Math.sqrt(Math.pow(e.x - g, 2) + Math.pow(e.y - 0, 2)) % d);
          ...
          if (null !== f && (0 !== f || _ !== l))
            if (d > 0 && (e.y >= l || (i && e.y > t.y))) {
              const t =
                e.y >= l ? Math.sqrt(Math.pow(e.x - f, 2) + Math.pow(e.y - l, 2)) % d : d - (Math.sqrt(Math.pow(e.x - f, 2) + Math.pow(e.y - l, 2)) % d);
    ...
    79059: (e, t, i) => {
      ...
      function f(e, t, i, n) {
        (e.globalAlpha = 0.2), e.beginPath(), e.arc(t.x, t.y, i + n / 2, 0, 2 * Math.PI, !0), e.closePath(), (e.lineWidth = n), e.stroke(), (e.globalAlpha = 1);
      }
      function v(e, t, i, n) {
        ...
        _drawPoints(e, t, i, n, r) {
          ...
          for (let e = 0; e < t.length; ++e) {
            ...
            if (!((0, a.isInteger)(s.data) && c.linePointBeingEdited === s.data)) {
              if ((n(o, new u(Math.round(s.x * l) + x, Math.round(s.y * d) + x, s.data, s.square), v / 2, g), !c.disableInteractions)) {
      ...
      class f extends p.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          for (const t of [i, n, r]) {
            ...
            if (i) {
              if ((0, d.distanceToSegment)(i.points[0], i.points[1], e).distance <= l) return this._hittestResult;
            }
          }
        ...
        _drawImpl(e) {
          if (null === this._data) return;
          const { line1: t, line2: i, middleLine: n, skipLines: r, skipTopLine: s, fillBackground: o, backColor: a } = this._data,
            l = e.context;
          if (
            ((l.lineCap = "round"), r || this._drawLine(l, t, this._data, e.mediaSize), r || s || !i || this._drawLine(l, i, this._data, e.mediaSize), o && i)
          ) {
        ...
        _drawLine(e, t, i, n) {
          ...
          if (!r) return;
          (e.strokeStyle = r.color), (e.lineWidth = r.lineWidth), (0, _.setLineStyle)(e, r.lineStyle), (e.strokeStyle = r.color);
          const [s, o] = r.points;
        ...
        _getClippedLine(e, t, i) {
          ...
          if (void 0 === n) {
            const { lineWidth: r, lineStyle: o, points: a } = e,
              ...
              h = (0, g.intersectLineWithViewport)(a[0], a[1], l, d, i.width, i.height, s((0, _.computeDashPattern)(r, o)));
        ...
        _getBackgroundPolygon(e, t) {
          var i;
          return (
            this._backgroundPolygon || (this._backgroundPolygon = null !== (i = this._getBackgroundPolygonImpl(e, t)) && void 0 !== i ? i : []),
        ...
        _getBackgroundPolygonImpl(e, t) {
          ...
          let o = [new l.Point(0, 0), new l.Point(t.width, 0), new l.Point(t.width, t.height), new l.Point(0, t.height)];
          return (o = v(o, i, n, s)), e.extendRight || (o = v(o, n, s, r)), (o = v(o, s, r, i)), e.extendLeft || (o = v(o, r, i, n)), o;
        }
      }
      function v(e, t, i, n) {
        return null !== e ? (0, h.intersectPolygonAndHalfplane)(e, (0, l.halfplaneThroughPoint)((0, l.lineThroughPoints)(t, i), n)) : null;
      }
    },
    79797: (e, t, i) => {
      "use strict";
      ...
      class p extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (
            (this._data.filled && this._data.fillBackground && ((n.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)), n.fill()),
    ...
    10695: (e, t, i) => {
      ...
      class p extends o.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          if (null === this._data || this._data.points.length < 2) return;
          const i = e.context,
            r = (null !== (t = this._data.linestyle) && void 0 !== t ? t : c.LINESTYLE_SOLID) === c.LINESTYLE_SOLID ? "round" : "butt";
          (i.lineCap = r),
            (i.lineJoin = "round"),
          ...
          const [s, o, a = o] = this._data.points,
            { mediaSize: d } = e;
          if (this._data.fillBackground && Math.abs((s.x - a.x) * (o.y - a.y) - (o.x - a.x) * (s.y - a.y)) > 1e-10) {
            let e = [new n.Point(0, 0), new n.Point(d.width, 0), new n.Point(d.width, d.height), new n.Point(0, d.height)];
            if (
              ...
              (i.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)), i.fill(), i.restore();
            }
          }
          const p = [],
