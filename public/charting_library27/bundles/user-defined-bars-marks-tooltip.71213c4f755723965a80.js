  ...
  [8020],
  {
    27267: (t, e, i) => {
      ...
      function o(t, e, i, o, n) {
        function s(n) {
          ...
          const s = n.target;
          void 0 !== i && null !== e && null !== s && s.ownerDocument === o && (e.contains(s) || i(n));
        }
        return (
    ...
    36383: (t, e, i) => {
      ...
      var o = i(50959),
        n = i(27267);
      function s(t) {
        const { click: e, mouseDown: i, touchEnd: s, touchStart: r, handler: c, reference: h, ownerDocument: d = document } = t,
          a = (0, o.useRef)(null),
    ...
    5972: (t, e, i) => {
      ...
      class h {
        ...
        _showImpl(t) {
          (this._props = t), this._render(t), this._clearTimeouts(), this._tooltipContainer.classList.add(r.show);
        }
        _render(t) {
          const e = t.container;
          this._container !== e && (this._unmountComponent(), (this._container = e), this._container.appendChild(this._tooltipContainer)),
            n.render(
              o.createElement(d, { handler: t.onClickOutside, child: o.createElement(this._tooltipFactory, t.factoryProps) }),
        ...
        _unmountComponent() {
          null !== this._container &&
            (n.unmountComponentAtNode(this._tooltipContainer), this._tooltipContainer.remove(), (this._container = null), this._clearTimeouts());
        }
        _clearTimeouts() {
