  ...
  [9498],
  {
    50210: (e, t, i) => {
      ...
      var s = i(11542),
        ...
        d = i(37160),
        c = i(66764);
      const f = { includeTime: !0, includeUserTime: !1, includeSeries: !0, includeDisplayedValues: !1, includedStudies: "all", includeOffsetStudyValues: !1 };
      function h(e, t = {}) {
        const i = Object.assign({}, f, t),
          s = { schema: [], data: [], displayedData: [] },
          n = e.timeScale().points(),
          r = e.mainSeries(),
          h = (0, c.getChartWidgetApiTimeConverter)(r.interval(), (0, l.ensureNotNull)(r.symbolInfo()), e),
          T = (function (e, t) {
          ...
          const r = (0, l.ensureNotNull)(e.range().value(), "time scale points range"),
            u = (function (e, t, i, s) {
              ...
              const u = s.from,
                ...
                m = (0, l.ensureNotNull)(void 0 !== c ? e.indexOf(c, !0) : (0, l.ensureNotNull)(f).lastIndex);
              let p = m,
                T = h;
              for (let e = 0; e < t.length; e++) {
                const l = t[e],
                  o = s.includeOffsetStudyValues
                    ? (0, d.max)(null !== (r = null === (n = i[e]) || void 0 === n ? void 0 : n.fieldPlotOffsets) && void 0 !== r ? r : [0])
                    : 0,
        ...
        if (i.includeSeries) {
          const e = r.statusProvider({ hideResolution: !0 }).getSplitTitle(),
            t = Object.values(e)
              .filter((e) => "" !== e)
              .join(", ");
          s.schema.push(g("open", t)), s.schema.push(g("high", t)), s.schema.push(g("low", t)), s.schema.push(g("close", t));
        }
        ...
        if (i.includeTime || i.includeUserTime) {
          ...
          for (let e = P; e <= I; ++e) {
            ...
            if (
              ...
              const l = t.format(r);
              i.includeTime && (s.displayedData[e - P][0] = l), i.includeUserTime && (s.displayedData[e - P][S] = l);
            }
          }
        }
        if (i.includeSeries) {
      ...
      function p(e) {
        ...
        for (let n = 0; n < t.plots.length; ++n) {
          ...
          let c,
            f = "";
          if ((0, r.isLinePlot)(d) || (0, r.isShapesPlot)(d) || (0, r.isCharsPlot)(d) || (0, r.isArrowsPlot)(d)) c = (0, l.ensureDefined)(t.styles)[d.id];
          ...
          const h = `${c.title}${f}`;
          o.fields.push(T(a, u, h, d.id)), o.fieldToPlotIndex.push(n + 1), o.fieldPlotOffsets.push(e.offset(d.id));
        }
        return o;
      }
      function T(e, t, i, s) {
        return { type: "value", sourceType: "study", sourceId: e, sourceTitle: t, plotTitle: i, plotId: s };
      }
      function g(e, t) {
