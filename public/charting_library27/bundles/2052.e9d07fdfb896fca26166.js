(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2052],
  {
    ...
    90186: (e, t, o) => {
      ...
      o.d(t, { filterAriaProps: () => r, filterDataProps: () => n, filterProps: () => i, isAriaAttribute: () => s, isDataAttribute: () => a });
    },
    76460: (e, t, o) => {
      "use strict";
      function n(e) {
    ...
    76068: (e, t, o) => {
      ...
      function a(e) {
        ...
        return (0, r.isCircleLogoWithUrlProps)(e)
          ...
          : n.createElement("span", { className: i, title: e.title, "aria-label": e["aria-label"], "aria-hidden": e["aria-hidden"] }, e.placeholderLetter);
      }
    },
    58492: (e, t, o) => {
      "use strict";
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(p, { className: i(m.drawer, u[`position${t}`], h), ref: g, "data-name": e["data-name"] }, d)
            )
          )
        );
      }
      ...
      function u(e) {
                  ...
                  const { reference: o, ...r } = t,
                    ...
                    a =
                      "a" === i
                        ? r
                        : (function (e) {
                            const { download: t, href: o, hrefLang: n, media: r, ping: i, rel: a, target: s, type: l, referrerPolicy: c, ...d } = e;
                            return d;
                          })(r);
        ...
        return n.createElement(
          Y,
          {
            ...
            id: t,
            role: o,
            className: r(c, S.item, g && S.withIcon, { [S.isActive]: E, [S.isDisabled]: w || k, [S.hovered]: C }),
            title: u,
            href: x,
            target: T,
            rel: _,
          ...
          n.createElement("span", { className: r(S.labelRow, h) }, n.createElement("span", { className: r(S.label, p) }, D)),
          (void 0 !== f || v) && n.createElement("span", { className: S.shortcut }, (X = f) && X.split("+").join(" + ")),
          void 0 !== O && n.createElement("span", { onClick: A ? d : void 0, className: r(m, S.toolbox, { [S.showOnHover]: y, [S.showOnFocus]: N }) }, O)
        );
        var X;
      }
    },
    ...
    81261: (e, t, o) => {
      "use strict";
      o.d(t, { focusFirstMenuItem: () => c, handleAccessibleMenuFocus: () => s, handleAccessibleMenuKeyDown: () => l, queryMenuElements: () => h });
      var n = o(16838),
        r = o(71468),
        i = o(68335);
      const a = [37, 39, 38, 40];
      ...
      function h(e) {
        return Array.from(e.querySelectorAll('[data-role="menuitem"]:not([disabled]):not([aria-disabled])')).filter((0, n.createScopedVisibleElementFilter)(e));
      }
      function p(e) {
        return Array.from(e.querySelectorAll("[tabindex]:not([disabled]):not([aria-disabled])")).filter((0, n.createScopedVisibleElementFilter)(e));
      }
    },
    71468: (e, t, o) => {
      "use strict";
      ...
      function c(e, t) {
        return (o) => {
          ...
          let w = null !== (c = t.verticalAttachEdge) && void 0 !== c ? c : l.verticalAttachEdge,
            C = null !== (d = t.verticalDropDirection) && void 0 !== d ? d : l.verticalDropDirection;
          w === n.AutoStrict && (p < m.y + m.height + b + h ? ((w = n.Top), (C = i.FromBottomToTop)) : ((w = n.Bottom), (C = i.FromTopToBottom)));
          const k = w === n.Top ? -1 * b : b,
            D = f === r.Right ? m.right : m.left,
            x = w === n.Top ? m.top : m.bottom,
            y = { x: D - (v === a.FromRightToLeft ? u : 0) + g, y: x - (C === i.FromBottomToTop ? h : 0) + k };
      ...
      const s = a,
        l = n.forwardRef((e, t) => {
          const {
            ...
            T =
              s &&
              ("string" == typeof s ? n.createElement(i.Icon, { className: E.icon, icon: s }) : n.cloneElement(s, { className: r(E.icon, s.props.className) }));
          return "button" === o
            ? n.createElement(
                "button",
                { ...y, ref: t, type: "button", className: r(N, E.accessible), disabled: u && !k, onClick: f, title: b, "data-name": D, "data-tooltip": x },
            ...
            : n.createElement(
                "div",
                { ...y, ref: t, "data-role": "button", className: N, onClick: u ? void 0 : f, title: b, "data-name": D, "data-tooltip": x },
                g && v && n.createElement("div", { className: r("js-button-text", E.text) }, v),
                T,
                !g && v && n.createElement("div", { className: r("js-button-text", E.text) }, v),
    ...
    50813: (e, t, o) => {
      ...
      const s = n.forwardRef(function (e, t) {
        ...
        return n.createElement(i.ToolWidgetButton, { id: s, "data-name": s, ...l, ref: t, className: r(o, a.button) });
      });
    },
    8087: (e, t, o) => {
      "use strict";
      ...
      class v extends n.PureComponent {
          ...
          super(e),
            ...
            (this._handleClick = (e) => {
              (p.enabled("skip_event_target_check") || e.target instanceof Node) &&
                ...
                (this._handleToggleDropdown(void 0, (0, m.isKeyboardClick)(e)), this.props.onClick && this.props.onClick(e, !this.state.isOpened));
            }),
        ...
        render() {
          const {
            ...
            w = r(p, f.button, { "apply-common-tooltip": d || !a, [f.isDisabled]: a, [f.isOpened]: E, [f.clicked]: b });
          return "button" === e
            ? n.createElement(
                "button",
                {
                ...
                o &&
                  n.createElement(
                    "div",
                    { className: f.arrow },
                    n.createElement("div", { className: f.arrowWrap }, n.createElement(s.ToolWidgetCaret, { dropped: E }))
                  ),
                this.state.isOpened && (v ? n.createElement(h.MatchMedia, { rule: v }, (e) => this._renderContent(e)) : this._renderContent(c))
              )
            : n.createElement(
                "div",
                {
        ...
        _renderContent(e) {
          const { menuDataName: t, minWidth: o, menuClassName: r, maxHeight: i, drawerPosition: s = "Bottom", children: l } = this.props,
            ...
            f = (function (e) {
              ...
              : l;
          return m
            ? n.createElement(c.DrawerManager, null, n.createElement(d.Drawer, { onClose: this._handleClose, position: s, "data-name": t }, f))
            : n.createElement(
                a.PopupMenu,
                {
