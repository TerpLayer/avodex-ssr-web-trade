(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4062],
  {
    60676: (e, t, r) => {
      ...
      function Q(e, t) {
        ...
        return (
          (0, i.func)(e)
            ? (r = e)
            : ((0, i.array)(e) ? ((n = e[0]), (r = e[1])) : ((n = e.context), (r = e.fn)), n && (0, i.string)(r) && (0, i.func)(n[r]) && (r = n[r])),
                ...
                (i = [].concat(t(i), [f])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !l(r.target) &&
                        ((n && 0 === n.scrollTop && 0 < i) || ((o = n) && o.scrollHeight - o.scrollTop <= o.clientHeight && i < 0)
                          ? d(r)
                          : r.stopPropagation()));
                  }),
            ...
            (e.enableBodyScroll = function (e) {
              if (o) {
                ...
                (e.ontouchstart = null),
                  ...
                  s && 0 === i.length && (document.removeEventListener("touchmove", d, r ? { passive: !1 } : void 0), (s = !1));
              } else
    ...
    72535: (e, t, r) => {
      ...
      (a[n.ForwardRef] = { $$typeof: !0, render: !0, defaultProps: !0, displayName: !0, propTypes: !0 }), (a[n.Memo] = s);
    ...
    86942: (e, t, r) => {
      ...
      const D = !("undefined" == typeof window || void 0 === window.document || void 0 === window.document.createElement) ? c.useLayoutEffect : c.useEffect;
      function C(e, t) {
      ...
      function I(e, t) {
        ...
        for (let n = 0; n < r.length; n++) if (!Object.prototype.hasOwnProperty.call(t, r[n]) || !C(e[r[n]], t[r[n]])) return !1;
        return !0;
      }
        ...
        return (e) => {
          ...
          function u(t) {
            const [r, o, i] = (0, c.useMemo)(() => {
              ...
              s = (0, c.useMemo)(() => (r && r.Consumer && (0, p.isContextConsumer)(c.createElement(r.Consumer, null)) ? r : S), [r, S]),
              a = (0, c.useContext)(s),
            ...
            const j = (0, c.useMemo)(() => () => I.current && i === C.current ? I.current : m(h.getState(), i), [h, i]),
              k = (0, c.useMemo)(
                () => (e) =>
                  b
        ...
        function g(e, r) {
          try {
            ...
            r
              ? ((i = t.throw(e)), B())
              : (0, a.y)(e)
              ? ((d.status = 1), g.cancel(), (i = (0, s.func)(t.return) ? t.return(n.TASK_CANCEL) : { done: !0, value: n.TASK_CANCEL }))
      ...
      const Y = function (e) {
          ...
          function f(e) {
            var r = e.getState,
              n = e.dispatch;
            return (
              (t = W.bind(null, (0, o.default)({}, d, { context: s, channel: u, dispatch: n, getState: r, sagaMonitor: l }))),
              function (e) {
                return function (t) {
    ...
    36349: (e, t, r) => {
      "use strict";
      r.d(t, { all: () => o._, call: () => o.N, cancel: () => o.M, fork: () => o.L, put: () => o.Y, select: () => o.a3, take: () => o.K, throttle: () => l });
      var n = r(75880),
        o = r(60676),
        i = function (e) {
    ...
    10170: (e, t, r) => {
      ...
      const f = {
        ...
        [l]: { exposeProperties: { html: (e, t) => d(e, t, ""), dataTransfer: (e) => e }, matchesTypes: ["Html", "text/html"] },
        [c]: { exposeProperties: { urls: (e, t) => d(e, t, "").split("\n"), dataTransfer: (e) => e }, matchesTypes: ["Url", "text/uri-list"] },
        [u]: { exposeProperties: { text: (e, t) => d(e, t, ""), dataTransfer: (e) => e }, matchesTypes: ["Text", "text/plain"] },
      };
      function h(e) {
        if (!e) return null;
      ...
      class v {
        ...
        constructor(e, t) {
          ...
          const o = [],
            ...
            s = [];
          let a, c;
          for (let n = 0; n < r - 1; n++) (a = e[n + 1] - e[n]), (c = t[n + 1] - t[n]), i.push(a), o.push(c), s.push(c / a);
          const u = [s[0]];
      ...
      function S(e, t, r, n, o) {
        const i = "IMG" === (s = t).nodeName && (g() || !(null === (a = document.documentElement) || void 0 === a ? void 0 : a.contains(s)));
        var s, a;
        const c = y(i ? e : t),
          ...
          { dragPreviewWidth: m, dragPreviewHeight: S } = (function (e, t, r, n) {
            let o = e ? t.width : r,
              i = e ? t.height : n;
            return p() && e && ((i /= window.devicePixelRatio), (o /= window.devicePixelRatio)), { dragPreviewWidth: o, dragPreviewHeight: i };
          })(i, t, l, d),
      ...
      class T {
        ...
        teardown() {
          ...
          void 0 !== e &&
            ...
            this.asyncEndDragFrameId && (null === (t = this.window) || void 0 === t || t.cancelAnimationFrame(this.asyncEndDragFrameId)));
        }
        ...
        getCurrentSourcePreviewNodeOptions() {
          const e = this.monitor.getSourceId();
          return E({ anchorX: 0.5, anchorY: 0.5, captureDraggingState: !1 }, this.sourcePreviewNodeOptions.get(e) || {});
        }
          ...
          (this.sourcePreviewNodes = new Map()),
            ...
            (this.handleTopDragStart = (e) => {
              ...
              this.monitor.isDragging() && (this.actions.endDrag(), this.cancelHover()),
                this.actions.beginDrag(t || [], { publishSource: !1, getSourceClientOffset: this.getSourceClientOffset, clientOffset: r });
              ...
              if (this.monitor.isDragging()) {
                if (n && "function" == typeof n.setDragImage) {
                  ...
                  if (o) {
                    const { anchorX: e, anchorY: i, offsetX: s, offsetY: a } = this.getCurrentSourcePreviewNodeOptions(),
            ...
            (this.handleTopDropCapture = (e) => {
              ...
              ((this.dropTargetIds = []), this.isDraggingNativeItem())
                ? (e.preventDefault(), null === (t = this.currentNativeSource) || void 0 === t || t.loadDataTransfer(e.dataTransfer))
            ...
            (this.handleSelectStart = (e) => {
              ...
              "function" == typeof t.dragDrop &&
                ("INPUT" === t.tagName || "SELECT" === t.tagName || "TEXTAREA" === t.tagName || t.isContentEditable || (e.preventDefault(), t.dragDrop()));
            }),
        ...
        constructor(e, t, r) {
          (this.getSourceClientOffset = (e) => {
            ...
            (this.handleTopMoveStart = (e) => {
              if (!c(e)) return;
              const t = l(e);
              t && (u(e) && (this.lastTargetTouchFallback = e.targetTouches[0]), (this._mouseClientOffset = t)), (this.waitingForDelay = !1);
            }),
            ...
            (this.handleTopMove = (e) => {
              ...
              if (
                ...
                (!this.monitor.isDragging() &&
                  (function (e, t, r, n, o) {
                    ...
                    return !1;
                  })(this._mouseClientOffset.x || 0, this._mouseClientOffset.y || 0, o.x, o.y, this.options.scrollAngleRanges))
              )
              ...
              if (
                (!this.monitor.isDragging() &&
                  ...
                  (a = o.x),
                  (c = o.y),
                  Math.sqrt(Math.pow(Math.abs(a - i), 2) + Math.pow(Math.abs(c - s), 2)) > (this.options.touchSlop ? this.options.touchSlop : 0)) &&
                  ((this.moveStartSourceIds = void 0),
                  this.actions.beginDrag(t, { clientOffset: this._mouseClientOffset, getSourceClientOffset: this.getSourceClientOffset, publishSource: !1 })),
                !this.monitor.isDragging())
              )
                return;
    ...
    23642: (e, t, r) => {
      ...
      function p(e) {
        return function (t = [], r = { publishSource: !0 }) {
          ...
          return { type: c, payload: { itemType: v, item: p, sourceId: d, clientOffset: o || null, sourceClientOffset: f || null, isSourcePublic: !!n } };
        };
      }
      function v(e, t, r) {
        return t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (e[t] = r), e;
      ...
      class I {
        subscribeToStateChange(e, t = {}) {
          ...
          (0, i.invariant)("function" == typeof e, "listener must be a function."),
            (0, i.invariant)(void 0 === r || Array.isArray(r), "handlerIds, when specified, must be an array of strings.");
          ...
          return this.store.subscribe(() => {
            ...
            try {
              const i =
                ...
                (o === n + 1 &&
                  !(function (e, t) {
                    return e !== D && (e === C || void 0 === t || ((r = e), t.filter((e) => r.indexOf(e) > -1)).length > 0);
                    var r;
                  })(t.dirtyHandlerIds, r));
              i || e();
            } finally {
        ...
        canDragSource(e) {
          ...
          return (0, i.invariant)(t, `Expected to find a valid source. sourceId=${e}`), !this.isDragging() && t.canDrag(this, e);
        }
        canDropOnTarget(e) {
          if (!e) return !1;
          const t = this.registry.getTarget(e);
          if (((0, i.invariant)(t, `Expected to find a valid target. targetId=${e}`), !this.isDragging() || this.didDrop())) return !1;
        ...
        isDraggingSource(e) {
          ...
          if (((0, i.invariant)(t, `Expected to find a valid source. sourceId=${e}`), !this.isDragging() || !this.isSourcePublic())) return !1;
      ...
      function V(e = X, t) {
        ...
        switch (t.type) {
          case a:
          case c:
            return { initialSourceClientOffset: r.sourceClientOffset, initialClientOffset: r.clientOffset, clientOffset: r.clientOffset };
          case l:
            return (
              (n = e.clientOffset),
              (o = r.clientOffset),
      ...
      const Z = { itemType: null, item: null, sourceId: null, targetIds: [], dropResult: null, didDrop: !1, isSourcePublic: null };
      function ee(e = Z, t) {
        const { payload: r } = t;
        switch (t.type) {
          case c:
            return Q({}, e, { itemType: r.itemType, item: r.item, sourceId: r.sourceId, isSourcePublic: r.isSourcePublic, dropResult: null, didDrop: !1 });
          case u:
            return Q({}, e, { isSourcePublic: !0 });
          case l:
            return Q({}, e, { targetIds: r.targetIds });
          case H:
            return -1 === e.targetIds.indexOf(r.targetId) ? e : Q({}, e, { targetIds: ((n = e.targetIds), (o = r.targetId), n.filter((e) => e !== o)) });
          case d:
            return Q({}, e, { dropResult: r.dropResult, didDrop: !0, targetIds: [] });
          case f:
            return Q({}, e, { itemType: null, item: null, sourceId: null, dropResult: null, didDrop: !1, isSourcePublic: null, targetIds: [] });
          default:
            return e;
        }
        var n, o;
        ...
        return {
          dirtyHandlerIds: Y(e.dirtyHandlerIds, {
            ...
            payload: oe({}, t.payload, {
              prevTargetIds: ((r = e), (n = "dragOperation.targetIds"), (o = []), n.split(".").reduce((e, t) => (e && e[t] ? e[t] : o || null), r)),
            }),
          }),
      ...
      class f {
        ...
        disconnectDragPreview() {
          this.dragPreviewUnsubscribe &&
            (this.dragPreviewUnsubscribe(), (this.dragPreviewUnsubscribe = void 0), (this.dragPreviewNode = null), (this.dragPreviewRef = null));
        }
        get dragSource() {
      ...
      function O(e, t) {
        ...
        const u = (function () {
          ...
          l = (function (e, t) {
            ...
            return (
              (0, g.useIsomorphicLayoutEffect)(() => ((n.dragSourceOptions = e || null), n.reconnect(), () => n.disconnectDragSource()), [n, e]),
              (0, g.useIsomorphicLayoutEffect)(() => ((n.dragPreviewOptions = t || null), n.reconnect(), () => n.disconnectDragPreview()), [n, t]),
              n
            );
    ...
    40933: (e, t, r) => {
      ...
      function m(e, t, r) {
        const n = (0, d.useDragDropManager)(),
          ...
          s = (function (e) {
            const { accept: t } = e;
            return (0, i.useMemo)(() => ((0, h.invariant)(null != e.accept, "accept must be defined"), Array.isArray(t) ? t : [t]), [t]);
          })(e);
      ...
      function S(e, t) {
        const r = (0, o.useOptionalFactory)(e, t),
          ...
          c = (function (e) {
            ...
            return (0, f.useIsomorphicLayoutEffect)(() => ((r.dropTargetOptions = e || null), r.reconnect(), () => r.disconnectDropTarget()), [e]), r;
          })(r.options);
