(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6456],
  {
    ...
    61098: (e) => {
      e.exports = { title: "title-z9fs4j4t", small: "small-z9fs4j4t", normal: "normal-z9fs4j4t", large: "large-z9fs4j4t" };
    },
    76797: (e) => {
    ...
    94720: (e, t, n) => {
      ...
      function u(e) {
        const { startIcon: t, icon: n, iconOnly: o, children: s, endIcon: d, primaryText: u, secondaryText: h } = e,
          m = null != t ? t : n,
          p = !(t || n || d || o) && !s && u && h;
        return r.createElement(
          r.Fragment,
          null,
          m && r.createElement(a.Icon, { icon: m, className: l()["start-icon-wrap"] }),
      ...
      function f(e) {
        const { reference: t, tooltipText: n, ...i } = e,
          { isGrouped: o, cellState: a, disablePositionAdjustment: s } = (0, r.useContext)(m.ControlGroupContext),
        ...
        return r.createElement(
          "button",
          {
            ...
            className: l,
            ref: t,
            "data-overflow-tooltip-text": null != n ? n : e.primaryText ? [e.primaryText, e.secondaryText].join(" ") : (0, h.getTextForTooltip)(e.children),
          },
          r.createElement(u, { ...i })
        );
      }
    ...
    86332: (e, t, n) => {
      ...
      const r = n(50959).createContext({ isGrouped: !1, cellState: { isTop: !0, isRight: !0, isBottom: !0, isLeft: !0 } });
    },
    95604: (e, t, n) => {
      "use strict";
      function r(e) {
    ...
    36383: (e, t, n) => {
      ...
      var r = n(50959),
        i = n(27267);
      function o(e) {
        const { click: t, mouseDown: n, touchEnd: o, touchStart: a, handler: s, reference: l, ownerDocument: c = document } = e,
          d = (0, r.useRef)(null),
    ...
    90186: (e, t, n) => {
      ...
      n.d(t, { filterAriaProps: () => i, filterDataProps: () => r, filterProps: () => o, isAriaAttribute: () => s, isDataAttribute: () => a });
    },
    34094: (e, t, n) => {
      "use strict";
      ...
      const i = (e) => (0, r.isValidElement)(e) && Boolean(e.props.children),
        o = (e) => (null == e || "boolean" == typeof e || "{}" === JSON.stringify(e) ? "" : e.toString() + " "),
        a = (e) =>
          Array.isArray(e) || (0, r.isValidElement)(e)
            ? r.Children.toArray(e)
                .reduce((e, t) => {
                  let n = "";
                  return (n = (0, r.isValidElement)(t) && i(t) ? a(t.props.children) : (0, r.isValidElement)(t) && !i(t) ? "" : o(t)), e.concat(n);
                }, "")
                .trim()
            : o(e);
    },
      ...
      function c(e) {
        ...
        if (e && 1 == ++s) {
          const e = o(t, "overflow"),
            s = a(t, "padding-right");
          "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (i(n, "right", `${r()}px`), (t.style.paddingRight = `${s + r()}px`), (l = !0)),
    ...
    24437: (e, t, n) => {
      ...
      var r = n(88803);
      const i = { SmallHeight: r["small-height-breakpoint"], TabletSmall: r["tablet-small-breakpoint"], TabletNormal: r["tablet-normal-breakpoint"] };
    },
    69654: (e, t, n) => {
      "use strict";
      ...
      var r = n(50959),
        ...
        c = n(40281);
      function d(e) {
        const { children: t, renderInput: i, onCancel: d, containerClassName: h, inputContainerClassName: m, iconClassName: p, ...v } = e;
        return r.createElement(
          "div",
          { className: o()(c.container, h) },
          r.createElement("div", { className: o()(c.inputContainer, m, d && c.withCancel) }, i || r.createElement(u, { ...v })),
          t,
          r.createElement(s.Icon, { className: o()(c.icon, p), icon: l }),
          d && r.createElement("div", { className: c.cancel, onClick: d }, a.t(null, void 0, n(20036)))
        );
      }
      function u(e) {
        const { className: t, reference: n, value: i, onChange: a, onFocus: s, onBlur: l, onKeyDown: d, onSelect: u, placeholder: h, ...m } = e;
    ...
    22265: (e, t, n) => {
      "use strict";
      n.d(t, { DialogSidebarContainer: () => d, DialogSidebarItem: () => h, DialogSidebarWrapper: () => u });
      var r = n(50959),
        i = n(97754),
        o = n.n(i),
        a = n(9745),
      ...
      function h(e) {
        const { mode: t, title: n, icon: i, isActive: d, onClick: u, tag: h = "div", reference: m, className: p, ...v } = e,
          { isMobile: f, isTablet: g } = (0, s.getSidebarMode)(t),
          y = d ? (null == i ? void 0 : i.active) : null == i ? void 0 : i.default;
        return r.createElement(
          h,
          { ...v, ref: m, className: o()(c.tab, g && c.isTablet, f && c.isMobile, d && c.active, p), onClick: u },
    ...
    57979: (e, t, n) => {
      ...
      function m(e) {
        var t;
        const { id: r, description: i, shortDescription: a, description_localized: d, is_hidden_study: u, version: h, extra: m, tags: v } = e,
          f =
            c.enabled("graying_disabled_tools_enabled") &&
            (null === (t = window.ChartApiInstance) || void 0 === t ? void 0 : t.studiesAccessController.isToolGrayed(i));
        return {
          id: r,
          ...
          studyData: { id: r, version: h, descriptor: { type: "java", studyId: e.id }, packageName: p(r, m) },
          isGrayed: f,
          tags: v,
        };
      }
      ...
      function k(e) {
        ...
        return r.createElement("div", { ref: t, className: f()(x.container, n), ...i, "data-role": "dialog-content" });
      }
      var E = n(95988);
      function w(e) {
      ...
      function L(e) {
        const t = (0, r.useContext)(I),
          ...
          H = (0, N.useWatchedValueReadonly)({ watchedValue: S.watchedTheme }) === D.StdTheme.Dark ? B.dark : B.light,
          Z = f()(B.container, s.isGrayed && B.disabled, m && B.selected, p && B.highlighted, p && H);
        return r.createElement(
          "div",
          { ref: v, className: Z, onClick: j, style: i, "data-role": "list-item", "data-disabled": s.isGrayed, "data-title": s.title, "data-id": s.id },
          r.createElement(
            "div",
            {
              className: f()(B.main, !F && B.paddingLeft),
            },
            F && r.createElement(R.FavoriteButton, { className: f()(B.favorite, E && B.isActive), isFilled: E, onClick: A }),
            r.createElement(w, { disabled: s.isGrayed }, r.createElement(P.HighlightedText, { queryString: l, rules: c, text: s.title })),
            !1,
            ...
            Boolean(M && !k) && r.createElement(BadgeIndicator, { type: "ep", className: B.badge, tooltip: o.t(null, void 0, n(92490)) }),
            !1
          ),
          L && r.createElement("a", { href: L.authorLink, className: B.author, target: "_blank", onClick: W }, L.authorName),
      ...
      function F(e) {
        ...
        return r.createElement("h3", { className: f()(M.title, "Small" === n && M.small, "Normal" === n && M.normal, "Large" === n && M.large, i) }, t);
      }
      var j = n(76797);
      function W(e) {
      ...
      function te() {
        var e, t;
        X = [];
        const n = Boolean(void 0 === (0, V.getValue)("chart.favoriteLibraryIndicators")),
          r = (0, V.getJSON)("chart.favoriteLibraryIndicators", []);
        if ((X.push(...r), 0 === X.length && n && "undefined" != typeof window)) {
          const n = JSON.parse(null !== (t = null === (e = window.urlParams) || void 0 === e ? void 0 : e.favorites) && void 0 !== t ? t : "{}").indicators;
      ...
      function ie(e) {
              ...
              ),
              {
                ...
                handleKeyDown: function (e) {
                  ...
                  if (
                    ...
                    38 === (0, T.hashFromEvent)(e) && (e.preventDefault(), m(), v(t)),
        ...
        return (
          (0, r.useEffect)(() => {
            var e;
            a || u(""), _.CheckMobile.any() || null === (e = P.current) || void 0 === e || e.focus();
          }, [a]),
          r.createElement(y.AdaptivePopupDialog, {
            ...
            render: () =>
              r.createElement(
                r.Fragment,
                null,
                r.createElement(b.DialogSearch, { reference: P, placeholder: o.t(null, void 0, n(52298)), onChange: R, onFocus: B }),
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    D
                      ...
                      ? r.createElement(
                          r.Fragment,
                          null,
                          r.createElement(W, null, r.createElement(F, { title: o.t(null, void 0, n(15491)) })),
                          v.map((e) =>
                            r.createElement(L, {
                              key: e.id,
                              item: e,
                              ...
                              query: d,
                              regExpRules: m,
                              reference: (null == E ? void 0 : E.id) === e.id ? w : void 0,
                              isSelected: (null == E ? void 0 : E.id) === e.id,
                              isHighlighted: (null == x ? void 0 : x.id) === e.id,
                      ...
                      : r.createElement(q, { className: re.noContentBlock, description: o.t(null, void 0, n(53170)) })
                  )
                )
              ),
          })
        ...
        function B() {
          var e;
          d.length > 0 && (null === (e = P.current) || void 0 === e || e.select());
        }
      }
      function oe(e, t) {
          ...
          e.isGrayed
            ...
            : (_.CheckMobile.any() || null === (n = this._searchInputRef.current) || void 0 === n || n.select(),
              (async function (e, t, n, r, i) {
                ...
                return o.insertStudy(s.descriptor, n, { stubTitle: t.shortDescription, isFundamental: t.isFundamental, isOverlay: t.isOverlay });
    ...
    19785: (e, t, n) => {
      ...
      var r = n(1722);
      function i(e) {
        const { data: t, rules: n, queryString: i, isPreventedFromFiltering: o, primaryKey: a, secondaryKey: s = a, optionalPrimaryKey: l, tertiaryKey: c } = e;
        return t
          .map((e) => {
            ...
            return (
              n.forEach((e) => {
                ...
                if (((m.lastIndex = 0), (0, r.isString)(t) && t && t.toLowerCase() === i.toLowerCase()))
                  return (h = 4), void (u = null === (n = t.match(p)) || void 0 === n ? void 0 : n.index);
                if ((0, r.isString)(t) && p.test(t)) return (h = 3), void (u = null === (a = t.match(p)) || void 0 === a ? void 0 : a.index);
                if ((0, r.isString)(o) && p.test(o)) return (h = 2), void (u = null === (s = o.match(p)) || void 0 === s ? void 0 : s.index);
                if ((0, r.isString)(o) && m.test(o)) return (h = 2), void (u = null === (l = o.match(m)) || void 0 === l ? void 0 : l.index);
                if (Array.isArray(d)) for (const e of d) if (p.test(e)) return (h = 1), void (u = null === (c = e.match(p)) || void 0 === c ? void 0 : c.index);
              }),
        ...
        const n = [],
          ...
          i =
            e
              ...
              .join("(.*?)") + "(.*)";
        return (
          n.push({ fullMatch: new RegExp(`(${s(e)})`, "i"), re: new RegExp(`^${i}`, "i"), reserveRe: new RegExp(i, "i"), fuzzyHighlight: !0 }),
            ...
            ? s
                ...
                .map((e, t) =>
                  r.createElement(
                    r.Fragment,
                    { key: t },
                    c[t] ? r.createElement("span", { className: i(a.highlighted, l) }, e) : r.createElement("span", null, e)
                  )
                )
            : s
        );
    ...
    63932: (e, t, n) => {
      ...
      n(83135);
      function a(e) {
        const t = i(e.className, "tv-spinner", "tv-spinner--shown", `tv-spinner--size_${o.spinnerSizeMap[e.size || o.DEFAULT_SIZE]}`);
