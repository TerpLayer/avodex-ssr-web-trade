    ...
    50765: (t, e, i) => {
      ...
      class f {
        ...
        apply(t, e) {
          ...
          const { getFillStyle: i, getStrokeStyle: s, strokeWidth: r, transform: n, strokeOpacity: o, fillOpacity: l } = this._styleData,
          ...
          void 0 !== h &&
            "none" !== h &&
            (void 0 !== r && (t.lineWidth = r), e.doNotApplyColors || (void 0 !== l && (t.globalAlpha = l), (t.strokeStyle = h)), this._stroke(t)),
            a && t.restore();
        }
        _fill(t) {
          t.fill();
      ...
      class y extends f {
        constructor(t, e, i) {
          ...
          (this._path = null !== r ? new Path2D(r) : null), (this._fillRule = null !== (s = t.getAttribute("fill-rule")) && void 0 !== s ? s : void 0);
        }
        _fill(t) {
      ...
      class _ extends f {
        constructor(t, e, i) {
          super(t, e, i), (this._cx = u(t, "cx")), (this._cy = u(t, "cy")), (this._rx = u(t, "rx")), (this._ry = u(t, "ry"));
        }
        _render(t) {
      ...
      function F(t, e, i, s) {
        ...
        let o,
          l = s;
        ("g" !== t.tagName && "svg" !== t.tagName) || ((l = { ...l, ...d(t, i, !1) }), (o = null !== (r = a(t)) && void 0 !== r ? r : void 0)),
