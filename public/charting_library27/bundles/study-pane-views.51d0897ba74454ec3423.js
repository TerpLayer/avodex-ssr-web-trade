    ...
    79797: (t, e, i) => {
      ...
      class p extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(t) {
          ...
          if (
            (this._data.filled && this._data.fillBackground && ((s.fillStyle = (0, l.generateColor)(this._data.backcolor, this._data.transparency)), s.fill()),
    ...
    21335: (t, e, i) => {
          ...
          for (const s of i.histograms) {
            ...
            for (const o of s.bars) {
              ...
              for (let e = 0; e < o.subBarValues.length; e++) {
                ...
                if (((f = l), ((t.x >= a && t.x <= l) || (t.x >= l && t.x <= a)) && t.y >= i && t.y <= s)) return new n.HitTestResult(n.HitTarget.Regular);
              }
            }
          }
          return null;
            ...
            i.histograms.forEach((n) => {
              ...
              if (
                (n.bars.forEach((s) => {
                  ...
                  if (!l.visible) return;
                  if (l.showValues && l.addToTotalValue) for (let t = 0; t < s.subBarValues.length; t++) a[t] = (a[t] || 0) + s.subBarValues[t];
      ...
      function g(t, e, i, s, r, n) {
        const { fontSize: o, verticalOffset: l } = (function (t, e, i) {
            return { fontSize: Math.min(Math.round((1.7 * t) / i.length), Math.round(0.6 * e)), verticalOffset: 0.7 * e };
          })(t, i, n),
      ...
      class y {
        ...
        _prepareStyles() {
          ...
          const i = (0, r.ensureDefined)(this._provider.graphicsInfo().hhists),
            ...
            o =
              (null === (e = null === (t = this._provider.properties().child("inputs")) || void 0 === t ? void 0 : t.child("volume")) || void 0 === e
                ? void 0
        ...
        _updateDataForRenderers(t, e, i) {
          ...
          const d =
              (null === (n = null === (s = this._provider.properties().child("inputs")) || void 0 === s ? void 0 : s.child("volume")) || void 0 === n
                ? void 0
          ...
          t.forEach((t) => {
            ...
            let i = [],
              ...
              r = t.styleId;
            if (d) {
              const [e, n, a] = t.rate[0] > t.rate[1] ? [t.rate[1], t.rate[0], "UpDominate"] : [t.rate[0], t.rate[1], "DownDominate"];
              (i = [n - e, e, e]), (s = [n - e]), (r += a);
            ...
            u.sort((t, e) => t.y - e.y),
            this._rendererData.histograms.push({ xRange: h, yRange: p(u[0].y, u[u.length - 1].y + u[u.length - 1].height), bars: u });
        }
      }
      function w(t, e) {
        let i;
      ...
      class o {
        constructor(t, e, i, s = !1) {
          (this._data = []),
            ...
            (this._hitTestResult = void 0 !== i ? new r.HitTestResult(r.HitTarget.Custom, i) : new r.HitTestResult(r.HitTarget.Regular));
        }
        update() {
          this._invalidated = !0;
        }
      ...
      class d {
        constructor(t, e, i) {
          (this._data = []),
            ...
            (this._provider = t),
            (this._model = e),
            (this._hitTestResult = void 0 !== i ? new n.HitTestResult(n.HitTarget.Custom, i) : new n.HitTestResult(n.HitTarget.Regular));
        }
        update() {
          this._invalidated = !0;
        }
