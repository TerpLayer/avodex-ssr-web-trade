(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [139],
  {
    ...
    81200: (e, r, t) => {
      "use strict";
      t.r(r), t.d(r, { ErrorCard: () => v, ErrorCardRenderer: () => g, ResizableErrorCard: () => _ });
      var o = t(50959),
        i = t(962),
        n = t(43370),
        s = t(97754),
        ...
        m = t(30509);
      const u = {
        ghost: { 1: (0, l.enabled)("hide_image_invalid_symbol") ? void 0 : h, 2: (0, l.enabled)("hide_image_invalid_symbol") ? void 0 : c },
        "stop-hand": { 1: void 0, 2: void 0 },
      };
      const v = o.forwardRef((e, r) => {
        const { icon: t, message: i, size: n = 1, rawHtml: s = !1, doNotLimitWidth: l, solutionId: h } = e,
          c = o.useMemo(
            () =>
              t &&
              (function (e, r) {
        ...
        return o.createElement(
          "div",
          { ref: r, className: a()(m.errorCard, 2 === n && m.errorCard_size_big, !l && m.errorCard_limitWidth) },
          c && o.createElement(d.Icon, { icon: c, className: m.errorCard__icon }),
          s
            ? o.createElement("div", { className: m.errorCard__message, dangerouslySetInnerHTML: { __html: i } })
            : o.createElement("div", { className: m.errorCard__message }, i),
          null
        );
      });
      function _(e) {
        const { icon: r, message: t, rawHtml: i, doNotLimitWidth: s, maxWidth: a = 200, maxHeight: d = 200, offsetHeight: l = 0, solutionId: h } = e,
          c = o.useRef(null),
          [m, u] = o.useState(1);
        return (
          o.useEffect(() => {
          ...
          o.createElement(v, { ref: c, message: t, icon: r, size: m, rawHtml: i, doNotLimitWidth: s, solutionId: h })
        );
        function _() {
          const e = c.current;
          if (!e) return;
      ...
      class g {
        ...
        _render() {
          const { message: e, icon: r, rawHtml: t, doNotLimitWidth: n, maxWidth: s, maxHeight: a, offsetHeight: d, solutionId: l } = this._state;
          i.render(
            e
              ? o.createElement(_, { message: e, icon: r, rawHtml: t, doNotLimitWidth: n, maxWidth: s, maxHeight: a, offsetHeight: d, solutionId: l })
