  ...
  [1754],
  {
    36383: (e, t, r) => {
      ...
      var o = r(50959),
        i = r(27267);
      function s(e) {
        const { click: t, mouseDown: r, touchEnd: s, touchStart: n, handler: a, reference: c, ownerDocument: l = document } = e,
          d = (0, o.useRef)(null),
        ...
        return () => {
          ...
          if (void 0 === e) {
            const r = document.createElement("div"),
              o = r.style;
            (o.visibility = "hidden"), (o.width = "100px"), (o.msOverflowStyle = "scrollbar"), document.body.appendChild(r);
      ...
      function l(e) {
        ...
        if (e && 1 == ++a) {
          const e = s(t, "overflow"),
            a = n(t, "padding-right");
          "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (i(r, "right", `${o()}px`), (t.style.paddingRight = `${a + o()}px`), (c = !0)),
    ...
    89324: (e, t, r) => {
      "use strict";
      r.r(t), r.d(t, { Components: () => d, showDefaultSearchDialog: () => l, showSymbolSearchItemsDialog: () => n.showSymbolSearchItemsDialog });
      var o = r(82992),
        i = (r(32563), r(31330)),
        s = r(65106),
        n = r(1861),
        ...
        c = r(84015);
      r(14483), r(49483);
      !(0, c.isOnMobileAppPage)("any") && window.matchMedia("(min-width: 602px) and (min-height: 445px)").matches;
      function l(e) {
        new a.WatchedValue({});
        const t = (0, s.getSymbolSearchCompleteOverrideFunction)(),
          { defaultValue: r, showSpreadActions: c, source: l, onSearchComplete: d, trackResultsOptions: h, ...u } = e,
          m = {
            ...u,
            ...
            onSearchComplete: (e, r) => {
              ...
              t(e[0].symbol, e[0].result).then((e) => {
                o.linking.setSymbolAndLogInitiator(e.symbol, "symbol search"), null == d || d(e.symbol);
              });
            },
    ...
    1861: (e, t, r) => {
      ...
      function c(e) {
        ...
        return i.render(E, N), n.dialogsOpenerManager.setAsOpened("SymbolSearch"), b && b(), { close: M };
      }
    },
    51826: (e, t, r) => {
      "use strict";
