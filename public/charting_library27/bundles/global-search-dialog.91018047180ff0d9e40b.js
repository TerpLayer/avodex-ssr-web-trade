(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9754, 9685],
  {
    ...
    61213: (e) => {
      e.exports = { dialog: "dialog-UAy2ZKyS", wrap: "wrap-UAy2ZKyS", empty: "empty-UAy2ZKyS", image: "image-UAy2ZKyS", emptyState: "emptyState-UAy2ZKyS" };
    },
    44445: (e) => {
    ...
    89324: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { Components: () => h, showDefaultSearchDialog: () => c, showSymbolSearchItemsDialog: () => i.showSymbolSearchItemsDialog });
      var o = n(82992),
        s = (n(32563), n(31330)),
        l = n(65106),
        i = n(1861),
        ...
        r = n(84015);
      n(14483), n(49483);
      !(0, r.isOnMobileAppPage)("any") && window.matchMedia("(min-width: 602px) and (min-height: 445px)").matches;
      function c(e) {
        new a.WatchedValue({});
        const t = (0, l.getSymbolSearchCompleteOverrideFunction)(),
          { defaultValue: n, showSpreadActions: r, source: c, onSearchComplete: h, trackResultsOptions: d, ...u } = e,
          v = {
            ...u,
            ...
            onSearchComplete: (e, n) => {
              ...
              t(e[0].symbol, e[0].result).then((e) => {
                o.linking.setSymbolAndLogInitiator(e.symbol, "symbol search"), null == h || h(e.symbol);
              });
            },
    ...
    1861: (e, t, n) => {
      ...
      function r(e) {
        ...
        return s.render(T, L), i.dialogsOpenerManager.setAsOpened("SymbolSearch"), S && S(), { close: D };
      }
    },
    72539: (e, t, n) => {
      "use strict";
      ...
      function D(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            s.map((e) => o.createElement(L, { key: e.id, action: e, isSelected: e.id === n, activeElRef: e.id === n ? l : void 0, onExecute: i }))
          )
        );
      }
      var N = n(61213);
                  ...
                  ? o.createElement(
                      ...
                      p.length
                        ? P.map((e) => {
                            ...
                            return t && t.length
                              ? o.createElement(D, { key: e.name, heading: e.label, items: t, selectedId: T(), activeElRef: w, onExecute: H })
                              : null;
                          })
                        : o.createElement(S, { text: r.t(null, void 0, n(45850)), className: N.emptyState })
                    )
                  : o.createElement(
                      o.Fragment,
                      null,
                      Boolean(p.length)
                        ? o.createElement(D, { heading: r.t(null, void 0, n(90612)), selectedId: T(), activeElRef: w, items: p, onExecute: H })
                        : o.createElement(S, { text: r.t(null, void 0, n(64185)), showIcon: !1, className: N.emptyState })
                    )
              )
            ),
          className: N.dialog,
      ...
      class G extends Z.Action {
        constructor({ id: e, category: t, favourite: n, onFavouriteClick: o, hotkeyGroup: s, hotkeyHash: l, aliases: i, ...a }) {
          super({ actionId: "UnknownAction", options: { ...a, doNotCloseOnClick: !0 }, id: e }),
            (this.execute = () => {
              super.execute();
              const e = new Set(c.getJSON("GlobalSearchDialog.recent", [])),
                t = this._searchOptions.id;
              e.has(t) && e.delete(t), e.add(t), c.setJSON("GlobalSearchDialog.recent", Array.from(e).slice(-10));
            }),
            (this.getState = () => ({
              ...super.getState(),
            ...
            (this._onFavouriteClick = (e) => {
              this._searchOptions.onFavouriteClick && (this.update({ favourite: !this._searchOptions.favourite }), this._searchOptions.onFavouriteClick(e));
            }),
            (this._searchOptions = { id: e, category: t, favourite: n, onFavouriteClick: o, aliases: i });
        }
      }
      var U,
        W = n(36298),
              ...
              t.forEach((t) => {
                o.push(
                  new G({
                    ...
                    onExecute: () => {
                      q.loadTheme(e.chartWidgetCollection(), { themeName: t, standardTheme: !1 }).then(() => {
      ...
      const { DrawingSyncMode: ie } = te,
        ae = { drawings: "ToggleHideAllDrawingTools", indicators: "ToggleHideAllIndicators", positions: "ToggleHideAllPositions", all: "ToggleHideAll" },
        ...
        ue = (r.t(null, void 0, n(77989)), r.t(null, void 0, n(19407)), r.t(null, void 0, n(37057))),
      ...
      class we extends G {
        constructor(e) {
          super({
            ...
            (this._model = e);
          (this._props = this._model.mainSeries().priceScale().properties().childs().isInverted).subscribe(this, () => {
          ...
          super({
            ...
            onExecute: () => {
              this.isChecked()
                ...
                : this._model.togglePriceScalePercentageScaleMode(this._model.mainSeries().priceScale());
            },
            shortcutHint: (0, h.humanReadableHash)(h.Modifiers.Alt + 80),
            disabled: e.mainSeries().priceScale().isLockScale() || 6 === e.mainSeries().properties().childs().style.value(),
            checked: e.mainSeries().priceScale().isPercentage(),
          }),
            (this._model = e);
          (this._props = this._model.mainSeries().priceScale().properties().childs().percentage).subscribe(this, () => {
            this._onUpdate.fire(this);
          });
        }
        destroy() {
      ...
      class Se extends G {
        constructor(e) {
          super({
            ...
            (this._model = e);
          (this._props = this._model.mainSeries().priceScale().properties().childs().log).subscribe(this, () => {
            this._onUpdate.fire(this);
          });
        }
        destroy() {
      ...
      const ye = F.enabled("show_average_close_price_line_and_label"),
        ...
        ke = new W.TranslatedString("change countdown to bar close visibility", r.t(null, void 0, n(58108))),
        Ce = new W.TranslatedString("scale price chart only", r.t(null, void 0, n(99042))),
        Me = new W.TranslatedString("change symbol last value visibility", r.t(null, void 0, n(53150))),
        _e = new W.TranslatedString("change high and low price labels visibility", r.t(null, void 0, n(66805))),
        Ae = new W.TranslatedString("change average close price label visibility", r.t(null, void 0, n(39402))),
        Ie = new W.TranslatedString("change indicators and financials value labels visibility", r.t(null, void 0, n(90512))),
        He = new W.TranslatedString("change indicators and financials name labels visibility", r.t(null, void 0, n(59820))),
        Le = new W.TranslatedString("change high and low price lines visibility", r.t(null, void 0, n(92556))),
        Te = new W.TranslatedString("change average close price line visibility", r.t(null, void 0, n(98866))),
        De = new W.TranslatedString("change symbol labels visibility", r.t(null, void 0, n(9402))),
        Ne =
          (new W.TranslatedString("change pre/post market price label visibility", r.t(null, void 0, n(49889))),
          new W.TranslatedString("change symbol previous close value visibility", r.t(null, void 0, n(12707))),
          new W.TranslatedString("change previous close price line visibility", r.t(null, void 0, n(59883)))),
        Pe =
          (new W.TranslatedString("change bid and ask labels visibility", r.t(null, void 0, n(5100))),
          new W.TranslatedString("change bid and ask lines visibility", r.t(null, void 0, n(32311))),
          new W.TranslatedString("change pre/post market price lines visibility", r.t(null, void 0, n(50393))),
          new W.TranslatedString("change price line visibility", r.t(null, void 0, n(67761)))),
        Oe = new W.TranslatedString("change session breaks visibility", r.t(null, void 0, n(15403))),
        Re =
      ...
      async function ze(e) {
        ...
        const u = [],
          ...
          p = ((e) => {
            const t = [],
              { stayInDrawingMode: n, drawOnAllCharts: o, drawOnAllChartsMode: s } = te.properties().childs();
            t.push(
              new G({
                label: he,
                checkable: !0,
            ...
            return (
              t.push(
                new G({
                  ...
                  onExecute: () => {
                    a.value() && r.value() === oe.MagnetMode.WeakMagnet ? (0, ne.setIsMagnetEnabled)(!1) : (0, ne.setMagnetMode)(oe.MagnetMode.WeakMagnet);
                  },
                })
              ),
              t.push(
                new G({
                  ...
                  onExecute: () => {
                    a.value() && r.value() === oe.MagnetMode.StrongMagnet ? (0, ne.setIsMagnetEnabled)(!1) : (0, ne.setMagnetMode)(oe.MagnetMode.StrongMagnet);
                  },
                })
              ),
              t
              ...
              F.enabled("header_widget") &&
                ...
                t.push(
                  new G({
                    ...
                    shortcutHint: e.options().indicatorsDialogShortcutEnabled ? (0, h.humanReadableHash)(47) : void 0,
                  })
                ),
              ...
              F.enabled("header_widget") &&
                ...
                t.push(
                  new G({
                    ...
                    category: "functionActions",
                    onExecute: () => {
                      (0, be.showDefaultSearchDialog)({ defaultValue: "", trackResultsOptions: void 0 });
                    },
                  })
                ),
        ...
        u.push(
          new G({
            ...
            category: "functionActions",
            disabled: Boolean("regular" === (null === (s = b.symbolInfo()) || void 0 === s ? void 0 : s.subsession_id)),
            onExecute: () => {
              e.model().setProperty(f.sessionId, "regular", Ee);
            },
            checked: Boolean("regular" === (null === (l = b.symbolInfo()) || void 0 === l ? void 0 : l.subsession_id)),
          })
        ),
          u.push(
            new G({
              ...
              category: "functionActions",
              disabled: !(null === (a = null === (i = b.symbolInfo()) || void 0 === i ? void 0 : i.subsessions) || void 0 === a
                ? void 0
                : a.some((e) => !e.private && "extended" === e.id)),
              onExecute: () => {
                var t;
                const n = "extended" === (null === (t = b.symbolInfo()) || void 0 === t ? void 0 : t.subsession_id) ? "regular" : "extended";
                e.model().setProperty(f.sessionId, n, Ee);
              },
              checked: Boolean("extended" === (null === (c = b.symbolInfo()) || void 0 === c ? void 0 : c.subsession_id)),
            })
          ),
          u.push(
            new G({
            ...
            new G({
              ...
              onExecute: () => {
                w.isIndexedTo100()
                  ...
                  : e.model().togglePriceScaleIndexedTo100ScaleMode(e.model().mainSeries().priceScale());
              },
              disabled: y || E,
        ...
        u.push(
          ...
          u.push(
            new G({
              ...
              category: "settingsActions",
              onExecute: () => {
                e.model().setProperty(X.addPlusButtonProperty, !X.addPlusButtonProperty.value(), xe);
              },
            })
          );
        ...
        u.push(
          new G({
            ...
            onExecute: () => {
              e.model().setProperty(I.highLowPriceLabelsVisible, !I.highLowPriceLabelsVisible.value(), _e);
            },
          })
        ),
          ye &&
        ...
        const L = (0, J.combineProperty)((e, t) => e || t, C.showStudyLastValue.weakReference(), C.showFundamentalLastValue.weakReference());
        u.push(
          new G({
        ...
        const T = (0, J.combineProperty)((e, t) => e || t, C.showStudyPlotLabels.weakReference(), C.showFundamentalNameLabel.weakReference());
        u.push(
          new G({
            ...
            onExecute: () => {
              ...
              const t = !T.value();
              e.model().setProperty(C.showStudyPlotLabels, t, null), e.model().setProperty(C.showFundamentalNameLabel, t, null), e.model().endUndoMacro();
            },
            onDestroy: () => {
              T.destroy();
            },
          ...
          u.push(
            new G({
              ...
              onExecute: () => {
                e.model().setProperty(I.highLowPriceLinesVisible, !I.highLowPriceLinesVisible.value(), Le);
              },
            })
          ),
          ye &&
        ...
        const P = e.model().model().sessions().properties().childs().graphics.childs().vertlines.childs().sessBreaks.childs().visible;
        if (
          (u.push(
            new G({
          ...
          for (const n of t)
            u.push(
              new G({
                id: `ChartStyle_${n}`,
                category: "functionActions",
                disabled: !(null === (d = R.linking.supportedChartStyles.value()) || void 0 === d ? void 0 : d.includes(n)),
                onExecute: () => {
          ...
          (function (e) {
            ...
            const o = Be.lineToolsInfo[e],
              ...
              l = {
                ...
                onFavouriteClick: (t) => {
                  t.preventDefault(),
                    Ve.LinetoolsFavoritesStore.isFavorite(e) ? Ve.LinetoolsFavoritesStore.removeFavorite(e) : Ve.LinetoolsFavoritesStore.addFavorite(e);
                },
              };
            return e.toLowerCase().includes("fib") && (l.aliases = [r.t(null, void 0, n(22305))]), new G(l);
          })(e.name)
        );
      }
      var Ge = n(37404);
      ...
      function Ue(e, t) {
        ...
        return n === o ? 0 : "drawingsActions" === o ? 1 : "drawingsActions" === n || "functionActions" === n ? -1 : 1;
      }
      var We = n(16216);
        ...
        constructor() {
          super(),
            ...
            (this.show = (e) => {
              (async function (e) {
                const t = [],
                  [o, s, l, i, a] = await Promise.all([ze(e), Promise.resolve(null), Promise.resolve(null), Promise.resolve(null), Promise.resolve(null)]);
                t.push(...o);
                ...
                if (F.enabled("header_widget") && F.enabled("header_resolutions")) {
                  const o = {
                    ...
                    category: "functionActions",
                    onExecute: () => {
                      (0, z.showChangeIntervalDialogAsync)({ initVal: R.linking.interval.value(), selectOnInit: !0 });
                    },
                  };
      ...
      function l(e, t, n, l = "keydown") {
        ...
        return (
          ...
          (0, o.useEffect)(() => {
            ...
            const o = (e) => {
              var o;
              e.repeat || (13 === (0, s.hashFromEvent)(e) && n(null !== (o = t[i]) && void 0 !== o ? o : null, e));
            };
            return (
    ...
    10772: (e, t, n) => {
      ...
      function p(e) {
        ...
        return o.createElement(v.ContextMenuItem, {
          size: t,
          jsxLabel: o.createElement("div", { className: d()(m.loaderWrap, m[t]) }, o.createElement(u.Loader, { className: m.loader })),
          noInteractive: !0,
      ...
      class y extends o.PureComponent {
            ...
            (this._registerSubmenu = () => {
              ...
              return null === (e = this.context) || void 0 === e
                ...
                : e.registerSubmenu(
                    ...
                    (e) =>
                      (0, s.ensureNotNull)(this._itemRef).contains(e) || (null !== this._menuElementRef.current && this._menuElementRef.current.contains(e))
                  );
            }),
        ...
        componentDidUpdate(e, t) {
          var n, o, s;
          t.loading !== this.state.loading && (null === (o = (n = this.props).onRequestUpdate) || void 0 === o || o.call(n)),
            0 === t.subItems.length && this.state.subItems.length > 0 && (this._unsubscribe = this._registerSubmenu()),
            t.subItems.length > 0 && 0 === this.state.subItems.length && (null === (s = this._unsubscribe) || void 0 === s || s.call(this)),
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              w &&
                void 0 !== a &&
                o.createElement("td", null, o.createElement(c.FavoriteButton, { className: r.favourite, isFilled: a, onClick: this.props.onFavouriteClick })),
              o.createElement("td", { className: s(r.iconCell), "data-icon-cell": !0 }, this._icon(r)),
              o.createElement(
                "td",
                ...
                o.createElement(
                  ...
                  o.createElement(
                    ...
                    !b && f ? f.map(({ text: e, ...t }, n) => o.createElement("span", { key: n, style: t }, e)) : null != b ? b : m
                  ),
                  this._toolbox(r),
                  e && o.createElement("span", { className: r.arrowIcon, dangerouslySetInnerHTML: { __html: p }, "data-submenu-arrow": !0 }),
                  !e && t && !i.CheckMobile.any() && o.createElement(h.Hint, { className: s(l && r.invisibleHotkey), text: t }),
                  !e && !t && n && o.createElement(h.Hint, { text: n })
                )
              )
            ),
            o.createElement("tr", { className: r.subMenu }, o.createElement("td", null, this.props.children))
          );
        }
        _icon(e) {
          if (this.props.checkable) {
            if (this.props.checkboxInput) return o.createElement(l.CheckboxInput, { className: s(e.icon, e.checkboxInput), checked: this.props.checked });
            if (this.props.checked) {
              const t = !this.props.icon && !this.props.iconChecked,
                n = this.props.iconChecked || this.props.icon || m;
              return o.createElement("span", { className: s(e.icon, t && e.checkmark), dangerouslySetInnerHTML: { __html: n }, "data-icon-checkmark": t });
            }
            return this.props.icon
              ? o.createElement("span", { className: e.icon, dangerouslySetInnerHTML: { __html: this.props.icon } })
              : o.createElement("span", { className: e.icon });
          }
          return this.props.icon ? o.createElement("span", { className: e.icon, dangerouslySetInnerHTML: { __html: this.props.icon } }) : null;
        }
        _toolbox(e) {
          return this.props.toolbox
            ? o.createElement(
                "span",
                { className: s(e.toolbox, this.props.showToolboxOnHover && e.showToolboxOnHover), onClick: this._handleClickToolbox, "data-toolbox": !0 },
    ...
    91561: (e, t, n) => {
      ...
      function w(e) {
        ...
        return (
          ...
          o.createElement(
            ...
            c && o.createElement(g.Drawer, { onClose: h }, o.createElement(y, { items: s.subItems, parentAction: n, closeNested: h }))
          )
        );
        function h(e) {
      ...
      function y(e) {
        const { items: t, parentAction: n, closeNested: s } = e,
          l = !Boolean(n) && t.every((e) => !Boolean("separator" !== e.type && (e.getState().icon || e.getState().checkable)));
        return o.createElement(
          ...
          super(e),
            ...
            (this._handleFocusOnOpen = () => {
              ...
              (null === (e = this.props.menuElementReference) || void 0 === e ? void 0 : e.current) &&
                ...
                (null === (t = this.props.menuElementReference) || void 0 === t || t.current.focus({ preventScroll: !0 }));
            }),
            (this._handleFocus = (e) => {
              this.props.isKeyboardEvent && e.target && k.PLATFORM_ACCESSIBILITY_ENABLED && (0, x.focusFirstMenuItem)(e.target);
            }),
            (this.state = {});
        }
        render() {
          const { isOpened: e, onClose: t, items: n, doNotCloseOn: s, menuStatName: i, parentStatName: v, takeFocus: m, ...p } = this.props;
          return e
            ? o.createElement(
                d.DrawerManager,
                null,
                ...
                o.createElement(u.MatchMedia, { rule: "screen and (max-width: 430px)" }, (t) =>
                  this._isDrawer(t)
                    ? o.createElement(
                        ...
                        o.createElement(
                          g.Drawer,
                          { onClose: this._handleClose, position: "Bottom", "data-name": p["data-name"] },
                    ...
                    : o.createElement(
                        ...
                        o.createElement(
                          r.OutsideEvent,
                          { handler: this._handleOutsideClickClose, mouseDown: !0, touchStart: !0, reference: this.props.menuElementReference },
                          (t) =>
                            o.createElement(
                              a.Menu,
                              {
    ...
    23829: (e, t, n) => {
      ...
      function m(e) {
        const {
          ...
          L = !!E.length;
        return s
          ? o.createElement("li", { className: l()(t, v.item, v.loading, v[I]) }, o.createElement(a.Loader, null))
          : o.createElement(
              "li",
              { className: l()(t, v.item, v.interactive, n && v.title, b && v.disabled, m && v.hovered, p && v.active, H && v.emptyIcons, v[I]), onClick: C },
              ...
              o.createElement(
                "span",
                { className: l()(v.label) },
                !A && k ? k.map(({ text: e, ...t }, n) => o.createElement("span", { key: n, style: t }, e)) : null != A ? A : x
              ),
              !!_ &&
                o.createElement(i.Icon, {
                  onClick: function () {
    ...
    37558: (e, t, n) => {
      ...
      class l extends o.PureComponent {
        ...
        componentDidUpdate(e, t) {
          !t.stack.length && this.state.stack.length && ((0, s.setFixedBodyState)(!0), (this._isBodyFixed = !0)),
            t.stack.length && !this.state.stack.length && this._isBodyFixed && ((0, s.setFixedBodyState)(!1), (this._isBodyFixed = !1));
        }
        componentWillUnmount() {
    ...
    41590: (e, t, n) => {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              g === p.currentDrawer && o.createElement("div", { className: d.backdrop, onClick: n }),
              o.createElement(v, { className: l(m.drawer, d[`position${t}`], u), ref: b, "data-name": e["data-name"] }, h)
            )
          )
        );
      }
      const v = (0, o.forwardRef)((e, t) => {
        const { className: n, ...s } = e;
        return o.createElement(h.TouchScrollContainer, { className: l(d.drawer, n), tabIndex: -1, ref: t, ...s });
      });
    },
    96040: (e, t, n) => {
      "use strict";
    ...
    81261: (e, t, n) => {
      "use strict";
      n.d(t, { focusFirstMenuItem: () => c, handleAccessibleMenuFocus: () => a, handleAccessibleMenuKeyDown: () => r, queryMenuElements: () => u });
      var o = n(16838),
        s = n(71468),
        l = n(68335);
      const i = [37, 39, 38, 40];
      ...
      function r(e) {
        ...
        const c =
          ...
          (null === (t = document.activeElement.parentElement) || void 0 === t ? void 0 : t.querySelector('[data-role="menuitem"]'));
      ...
      function u(e) {
        return Array.from(e.querySelectorAll('[data-role="menuitem"]:not([disabled]):not([aria-disabled])')).filter((0, o.createScopedVisibleElementFilter)(e));
      }
      function v(e) {
        return Array.from(e.querySelectorAll("[tabindex]:not([disabled]):not([aria-disabled])")).filter((0, o.createScopedVisibleElementFilter)(e));
      }
    },
    28127: (e, t, n) => {
      "use strict";
      ...
      function l(e) {
        return o.createElement(
          ...
          o.createElement("td", null, o.createElement("div", { className: s.line }), e.hint ? o.createElement("div", { className: s.hint }, e.hint) : null)
        );
      }
      var i = n(10772);
