(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4403],
  {
    ...
    94720: (e, t, n) => {
      ...
      function d(e) {
        const { startIcon: t, icon: n, iconOnly: l, children: i, endIcon: u, primaryText: d, secondaryText: h } = e,
          m = null != t ? t : n,
          f = !(t || n || u || l) && !i && d && h;
      ...
      function b(e) {
        const { reference: t, tooltipText: n, ...r } = e,
          { isGrouped: l, cellState: s, disablePositionAdjustment: i } = (0, o.useContext)(m.ControlGroupContext),
    ...
    67029: (e, t, n) => {
      ...
      const p = { FontSizeMedium: (0, l.ensureDefined)(d()["font-size-medium"]), FontSizeLarge: (0, l.ensureDefined)(d()["font-size-large"]) },
        b = { passive: !1 };
      function g(e, t) {
        const {
            style: n,
    ...
    31261: (e, t, n) => {
        ...
        return o.createElement(h.ControlSkeleton, {
          ...
          middleSlot: o.createElement(
            ...
            o.createElement("input", {
              ...V,
              className: r(p().input, p()[`size-${W}`], _, O && p()["with-start-slot"], A && p()["with-end-slot"]),
              disabled: T,
              readOnly: I,
              ref: j,
            })
      ...
      function C(e) {
        e = (0, c.useControl)(e);
        const { disabled: t, autoSelectOnFocus: n, tabIndex: r = 0, onFocus: l, onBlur: h, reference: m, containerReference: f = null } = e,
          p = (0, o.useRef)(null),
          b = (0, o.useRef)(null),
          [C, R] = (0, u.useFocus)(),
          v = t ? void 0 : C ? -1 : r,
      ...
      function s(e, t, n, s, i, a, c = {}, u) {
        const d = (0, o.useCallback)(
            (e) => {
              ...
              if (t === n.length - 1 && !a) return void ((null == u ? void 0 : u.onFailNext) && u.onFailNext(e));
          ...
          h = (0, o.useCallback)(
            (e) => {
              const t = n.findIndex(s);
              if (0 === t && !a) return void ((null == u ? void 0 : u.onFailPrev) && u.onFailPrev(e));
              const o = l(t - 1, n.length);
              i && i(n[o], "previous");
            },
            [n, s, i, a]
    ...
    16921: (e, t, n) => {
      ...
      const s = { duration: 200, additionalScroll: 0 },
        i = {
          vertical: { scrollSize: "scrollHeight", clientSize: "clientHeight", start: "top", end: "bottom", size: "height" },
          horizontal: { scrollSize: "scrollWidth", clientSize: "clientWidth", start: "left", end: "right", size: "width" },
        };
      function a(e, t) {
        const n = i[e];
      ...
      function c(e, t, n, o, r, s) {
        const a = (function (e, t, n, o = 0) {
          const r = i[e];
          return { start: -1 * o, middle: -1 * (Math.floor(n[r.size] / 2) - Math.floor(t[r.size] / 2)), end: -1 * (n[r.size] - t[r.size]) + o };
        ...
        return (function (e) {
          ...
          return (
            (p = window.requestAnimationFrame(function e(t) {
              let l;
              if ((f ? (l = t - f) : ((l = 0), (f = t)), l >= n)) return (i[h] = m + d), void (r && r());
              const s = m + d * o(l / n);
        ...
        })({ ...s, target: t, targetRect: o, wrap: n, wrapRect: r, additionalScroll: c, direction: e });
      }
      class u {
        constructor(e = null) {
        ...
        scrollTo(e, t = s) {
          if (
            ...
            this.stopScroll(),
              a("vertical", this._container) && (this._stopVerticalScroll = c("vertical", e, this._container, n, o, this._modifyOptions("vertical", t))),
              a("horizontal", this._container) &&
                (this._stopHorizontalScroll = c("horizontal", e, this._container, n, o, this._modifyOptions("horizontal", t)));
          }
        ...
        setContainer(e) {
          var t;
          (this._container = e),
            (null === (t = this._container) || void 0 === t ? void 0 : t.contains(this._lastScrolledElement)) || (this._lastScrolledElement = null);
        }
        destroy() {
      ...
      function d(e = {}) {
        const { activeItem: t, getKey: n, ...l } = e,
          ...
          a = (function (e) {
            ...
            return (0, o.useEffect)(() => ((t.current = new u(e)), () => (0, r.ensureNotNull)(t.current).destroy()), []), t;
          })(s.current),
          c = (0, o.useCallback)(() => {
          ...
          () =>
            (function (e, t, { x: n = s.x, y: o = s.y } = s) {
              const r = (0, l.ensureNotNull)(e).getBoundingClientRect(),
                i = { x: r.left + n, y: r.top + r.height + o, indentFromWindow: { top: 4, bottom: 4, left: 4, right: 4 } };
