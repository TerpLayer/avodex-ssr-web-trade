  ...
  [2306],
  {
    ...
    94720: (e, t, o) => {
      ...
      var i = o(50959),
        ...
        l = o(1414),
        a = o.n(l);
      const c = "apply-overflow-tooltip apply-overflow-tooltip--check-children-recursively apply-overflow-tooltip--allow-text";
      function h(e) {
        const {
            color: t = "brand",
            size: o = "medium",
      ...
      function d(e) {
        const { startIcon: t, icon: o, iconOnly: r, children: l, endIcon: h, primaryText: d, secondaryText: u } = e,
          p = null != t ? t : o,
          m = !(t || o || h || r) && !l && d && u;
            ...
            (function (e) {
              return (
                ...
                i.createElement(
                  ...
                  i.createElement("span", { className: a()["primary-text"] }, " ", e.primaryText, " "),
                  "string" == typeof e.secondaryText
                    ? i.createElement("span", { className: a()["secondary-text"] }, " ", e.secondaryText, " ")
                    : i.createElement(
                        "span",
      ...
      function v(e) {
        const { reference: t, tooltipText: o, ...n } = e,
          { isGrouped: r, cellState: s, disablePositionAdjustment: l } = (0, i.useContext)(p.ControlGroupContext),
        ...
        return i.createElement(
          "button",
          {
            ...
            className: a,
            ref: t,
            "data-overflow-tooltip-text": null != o ? o : e.primaryText ? [e.primaryText, e.secondaryText].join(" ") : (0, u.getTextForTooltip)(e.children),
          },
          i.createElement(d, { ...n })
        );
      }
    ...
    86332: (e, t, o) => {
      ...
      const i = o(50959).createContext({ isGrouped: !1, cellState: { isTop: !0, isRight: !0, isBottom: !0, isLeft: !0 } });
    },
    95604: (e, t, o) => {
      "use strict";
      function i(e) {
        let t = 0;
        return (
          (e.isTop && e.isLeft) || (t += 1), (e.isTop && e.isRight) || (t += 2), (e.isBottom && e.isLeft) || (t += 8), (e.isBottom && e.isRight) || (t += 4), t
        );
      }
    ...
    34094: (e, t, o) => {
      ...
      const n = (e) => (0, i.isValidElement)(e) && Boolean(e.props.children),
        r = (e) => (null == e || "boolean" == typeof e || "{}" === JSON.stringify(e) ? "" : e.toString() + " "),
        s = (e) =>
          Array.isArray(e) || (0, i.isValidElement)(e)
            ? i.Children.toArray(e)
                .reduce((e, t) => {
                  let o = "";
                  return (o = (0, i.isValidElement)(t) && n(t) ? s(t.props.children) : (0, i.isValidElement)(t) && !n(t) ? "" : r(t)), e.concat(o);
                }, "")
                .trim()
            : r(e);
    },
    ...
    24437: (e, t, o) => {
      ...
      var i = o(88803);
      const n = { SmallHeight: i["small-height-breakpoint"], TabletSmall: i["tablet-small-breakpoint"], TabletNormal: i["tablet-normal-breakpoint"] };
    },
    70114: (e, t, o) => {
      "use strict";
      ...
      var i = o(50959),
        ...
        v = o(12005);
      function _(e) {
        const { property: t, icon: o, propertyApplier: n, title: _, undoText: w, isToolbarFixed: f, className: y } = e,
          b = (0, m.useProperty)(t),
          T = (0, i.useRef)(null),
        ...
        return i.createElement(
          ...
          i.createElement(d.ColorPicker, {
            ...
            onColorChange: function (e, t) {
              ...
              B((0, c.generateColor)(String(e), o, true)), t || (0, s.ensureNotNull)(T.current).close();
            },
    ...
    61259: (e, t, o) => {
      ...
      function y(e) {
        const { multipleProperty: t, title: o, undoText: h, propertyApplier: u, isToolbarFixed: p, className: m, isSmallScreen: g } = e,
        ...
        return i.createElement(
          l.ToolWidgetMenu,
          {
            ...
            content: i.createElement(
              ...
              null,
              b
                ? i.createElement("div", { className: _.multiWidth }, i.createElement(s.Icon, { icon: v }))
                : i.createElement(
                    "div",
          ...
          f.map(({ value: e, icon: t }) =>
            i.createElement(c.PopupMenuItem, { key: e, theme: w, label: `${e}px`, icon: t, isActive: e === y, onClick: C, onClickArg: e })
          )
        );
        function C(e) {
          e &&
    ...
    59369: (e, t, o) => {
          ...
          (0, i.useLayoutEffect)(() => {
            ...
            const e = (0, n.ensureNotNull)(t.current),
              o = () => {
                ...
                if (0 === o.length || (o[0].parentElement && !u(o[0].parentElement, (0, n.ensureNotNull)(t.current)))) {
                  const i = (function (e) {
                    const o = d(e)
                  ...
                  if (null === i) return;
                  if (((0, l.becomeMainElement)(i), o.length > 0)) for (const e of o) (0, l.becomeSecondaryElement)(e);
                }
              };
            return window.addEventListener("keyboard-navigation-activation", o), o(), () => window.removeEventListener("keyboard-navigation-activation", o);
          }, []),
          [
            t,
            function (t) {
              ...
              if (e) {
                ...
                (l = ((u = n),
                Array.from(u.querySelectorAll("button:not([disabled]):not([aria-disabled])")).filter((0, r.createScopedVisibleElementFilter)(u))).sort(
      ...
      function p(e) {
        document.activeElement && (0, l.becomeSecondaryElement)(document.activeElement), (0, l.becomeMainElement)(e), e.focus();
      }
    },
    35789: (e, t, o) => {
      "use strict";
      ...
      const m = function (e, t, o) {
        ...
        if (!i || t < 1) return [];
        for (var n = 0, r = 0, s = Array(u(i / t)); n < i; ) s[r++] = (0, c.default)(e, n, (n += t));
        return s;
      };
      var g = o(24377),
        v = o(50151),
          ...
          super(...arguments),
            ...
            (this._handlePosition = (e) => {
              ...
              const i = (0, v.ensureNotNull)(this._container).getBoundingClientRect(),
                n = e.clientX - i.left,
                r = e.clientY - i.top;
              o({ h: t, s: (0, M.clamp)(n / i.width, 0, 1), v: (0, M.clamp)(1 - r / i.height, 0, 1) });
            }),
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement("div", { className: z.pointer, style: { left: 100 * o + "%", top: 100 * (1 - n) + "%" } })
            )
          );
        }
      }
      ...
      class O extends i.PureComponent {
        ...
        componentDidMount() {
          var e;
          l.PLATFORM_ACCESSIBILITY_ENABLED && !_.CheckMobile.any() && (null === (e = this._inputRef.current) || void 0 === e || e.focus());
        }
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement("input", { ref: this._inputRef, type: "text", className: R.input, value: o, onChange: this._handleInput })
              ),
              i.createElement("div", { className: R.buttonWrap }, i.createElement(P.Button, { size: "s", onClick: this._handleAddColor }, V))
            ),
            i.createElement(
              "div",
                        ...
                        l.PLATFORM_ACCESSIBILITY_ENABLED
                          ? (null == c ? void 0 : c.length)
                            ? i.createElement("button", {
                                title: K,
                                onClick: b,
                                className: r()(H.customButton, H.accessible, "apply-common-tooltip"),
                                tabIndex: -1,
                              })
                            : i.createElement(
                                "div",
                          ...
                          : i.createElement("div", { className: r()(H.customButton, "apply-common-tooltip"), onClick: b, title: K, tabIndex: -1 })
                      )
                  )
                ),
                s &&
        ...
        constructor(e) {
          super(e),
            ...
            (this._handlePosition = (e) => {
              null === this._raf &&
                (this._raf = requestAnimationFrame(() => {
                  ...
                  this.setState({ inputOpacity: Math.round(100 * a).toString() }), this.props.onChange(a), (this._raf = null);
                }));
            }),
            ...
            (this._handleKeyDown = (e) => {
              ...
              37 === t && 0 !== o && this._changeOpacity(o - 1), 39 === t && 100 !== o && this._changeOpacity(o + 1);
            }),
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement("div", { className: c.opacitySliderGradient, style: { backgroundImage: `linear-gradient(90deg, transparent, ${e})` } }),
              i.createElement(
                "div",
                { className: c.opacityPointerWrap },
                i.createElement("div", { className: n(c.pointer, l && c.dragged), style: { left: 100 * t + "%" }, ref: this._refPointer })
              )
            ),
            !o &&
              i.createElement(
                ...
                i.createElement("input", { type: "text", className: c.opacityInput, value: s, onChange: this._handleInput }),
      ...
      function a() {
        ...
        const o = (0, i.useCallback)(
            (t) => {
              ...
              e.some((e) => null !== e && null !== o && (0, l.areEqualRgb)((0, l.parseRgb)(e), o)) ||
          ...
          a = (0, i.useCallback)(
            (t) => {
              (t >= 0 || t < e.length) && (r.emit("remove_custom_color", t), (0, n.setJSON)("pickerCustomColors", h(t, e)));
            },
            [e]
          );
        return [e, o, a];
      ...
      const l = (0, i.forwardRef)((e, t) => {
        ...
        return i.createElement(
          ...
          i.createElement(
            "div",
            { className: g.bg },
            h && ("string" == typeof h ? i.createElement(r.Icon, { className: g.icon, icon: h }) : i.createElement("span", { className: g.icon }, h)),
            a
          )
        );
      });
    ...
    9629: (e, t, o) => {
      ...
      class g extends n.FloatingToolbar {
        constructor(e) {
          super({ dragOnlyInsideToolbar: !0, defaultPosition: e, positionSettingsKey: "chart.favoriteDrawingsPosition", positionStorageType: "device" }),
        ...
        showAndSaveSettingsValue() {
          this._canBeShownValue.value() && (u.TVLocalStorage.setItem("ChartFavoriteDrawingToolbarWidget.visible", "true"), this.show());
        }
        hideAndSaveSettingsValue() {
          u.TVLocalStorage.setItem("ChartFavoriteDrawingToolbarWidget.visible", "false"), this.hide();
        }
        canBeShown() {
        ...
        _onFavoriteAdded(e) {
          this.addWidget(this._createLinetoolWidget(e)),
            r.LinetoolsFavoritesStore.favorites().filter(v).length > 0 && (this._canBeShownValue.setValue(!0), this.showAndSaveSettingsValue());
        }
        _onFavoriteRemoved(e) {
          this.removeWidget(this._linetoolsWidgets[e]),
            delete this._linetoolsWidgets[e],
            0 === r.LinetoolsFavoritesStore.favorites().filter(v).length && (this._canBeShownValue.setValue(!1), this.hide());
        }
        _onFavoriteMoved() {
        ...
        _createLinetoolWidget(e) {
          const t = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${e === c.tool.value() ? "i-active" : ""}" title="${
              h.lineToolsInfo[e].localizedName
            }" data-name="FavoriteToolbar${e}">${h.lineToolsInfo[e].icon}</span>`,
            o = (0, s.parseHtmlElement)(t);
          return (
            o.addEventListener("click", async (t) => {
              t.preventDefault(), await (0, m.initLineTool)(e), c.tool.value() !== e && c.tool.setValue(e);
            }),
        ...
        _loadVisibilityState() {
          ...
          void 0 !== i
            ...
            : (o = "false" !== u.TVLocalStorage.getItem("ChartFavoriteDrawingToolbarWidget.visible")),
    ...
    3809: (e, t, o) => {
      ...
      class m {
        constructor(e) {
              ...
              (this._helper = {
                ...
                containment:
                  this._containment instanceof HTMLElement
                    ? [
                        parseInt(getComputedStyle(this._containment).borderLeftWidth) + parseInt(getComputedStyle(this._containment).paddingLeft),
                        parseInt(getComputedStyle(this._containment).borderTopWidth) + parseInt(getComputedStyle(this._containment).paddingTop),
            ...
            (this._handleDragMove = (e) => {
              ...
              if (null !== this._helper.containment) {
                ...
                l &&
                  ...
                  ((this._helper.nextTop = Math.min(this._helper.nextTop, i)), (this._helper.nextTop = Math.max(this._helper.nextTop, t))),
                  a &&
                    this._helper.nextLeft &&
                    ((this._helper.nextLeft = Math.min(this._helper.nextLeft, o)), (this._helper.nextLeft = Math.max(this._helper.nextLeft, e)));
              }
              null !== this._helper.raf ||
                (r === this._helper.nextTop && s === this._helper.nextLeft) ||
                (this._helper.raf = requestAnimationFrame(() => {
                  null !== this._helper &&
                    (null !== this._helper.nextTop && ((n.style.top = this._helper.nextTop + "px"), (this._helper.nextTop = null)),
                    null !== this._helper.nextLeft && ((n.style.left = this._helper.nextLeft + "px"), (this._helper.nextLeft = null)),
          ...
          const n = (this._handle = null !== (t = e.handle ? i.querySelector(e.handle) : null) && void 0 !== t ? t : i);
          n.classList.add("ui-draggable-handle"),
            (this._start = e.start),
            (this._stop = e.stop),
            (this._drag = e.drag),
            (this._backend = new g({ handle: n, onDragStart: this._handleDragStart, onDragMove: this._handleDragMove, onDragStop: this._handleDragStop })),
      ...
      class g {
          ...
          (this._initial = null),
            ...
            (this._handlePointerMove = (e) => {
              null !== this._initial &&
                ...
                (e.preventDefault(), this._dispatchEvent(this._createEvent("pointer-drag-move", e)));
            }),
        ...
        _getEventTarget() {
          return p.CheckMobile.iOS() || ((0, p.isMac)() && n.touch) ? window.document.documentElement : this._handle;
        }
        _dispatchEvent(e) {
          switch (e.type) {
        ...
        _createEvent(e, t) {
          return (
            ...
            new CustomEvent(e, { bubbles: !0, cancelable: !0, detail: { backend: this, initial: this._initial, current: t } })
          );
        }
      }
      var v = o(70027),
      ...
      class y {
        constructor(e) {
          (this._widget = document.createElement("div")),
            ...
            this._options.layout && "auto" !== this._options.layout && ((this._isVertical = "vertical" === this._options.layout), this._updateLayoutType()),
        ...
        raise() {
          y._toolbars.length + y._startZIndex !== this._zIndex() &&
            (y._toolbars.splice(y._toolbars.indexOf(this), 1), y._toolbars.push(this), y._updateAllZIndexes());
        }
        hideDuration() {
          return 0.75 * r.dur;
        }
        ...
        checkPosition() {
          ...
          this._correctPosition(t),
            (e.left === t.left && e.top === t.top) || ((this._widget.style.left = t.left + "px"), (this._widget.style.top = t.top + "px"));
        }
        ...
        _correctPosition(e) {
          ...
          i < 0 ? (e.left = Math.max(0, window.innerWidth - t.width)) : o && o.left > e.left && (e.left = Math.min(e.left + i, o.left)),
            n < 0 ? (e.top = Math.max(0, window.innerHeight - t.height)) : o && o.top > e.top && (e.top = Math.min(e.top + n, o.top));
        }
        _getCorrectedWidgetRect() {
          ...
          if (this._widget.classList.contains("i-closed")) {
            const t = 1 / 0.925 - 1,
              o = e.width * t,
              i = e.height * t;
            return { bottom: e.bottom + i / 2, height: e.height + i, left: e.left - o / 2, right: e.right + o / 2, top: e.top - i / 2, width: e.width + o };
          }
          return e;
        }
        _getSavedPosition() {
        ...
        _savePosition() {
          ...
          if ("device" === this._options.positionStorageType)
            try {
              h.TVLocalStorage.setItem(this._options.positionSettingsKey, JSON.stringify({ left: e.left, top: e.top }));
            } catch (e) {}
    ...
    44296: (e, t, o) => {
      ...
      class g extends m.default {
        ...
        setValue(e) {
          (this._isProcess = !0),
            this._baseProperty.setValue(e, void 0, { applyValue: (e, t) => this._propertyApplier.setProperty(e, t, this._undoText) }),
            (this._isProcess = !1),
        ...
        unsubscribe(e, t) {
          ...
          const i = (0, p.ensureDefined)(
            null === (o = this._listenersMappers.find((o) => o.obj === e && o.method === t)) || void 0 === o ? void 0 : o.callback
          );
      ...
      function C(e) {
        ...
        return c && c.length
                        ...
                        n.map((o, n) => {
                          ...
                          return r
                            ? o.showForSmallScreen
                              ? i.createElement(o.component, { ...o.props, isSmallScreen: r, key: `${o.props.title}_${n}`, className: w()(T, l) })
                              : null
                            : i.createElement(o.component, { ...o.props, key: `${o.props.title}_${n}`, className: w()(T, l) });
                        })
                    )
                )
            )
          : h();
        function h() {
          return null === t ? null : i.createElement(t.component, { ...t.props, isToolbarFixed: s, isDrawingFinished: r, className: w()(T, l) });
        }
      }
      var x = o(51768),
        L = o(50813),
      ...
      function M(e) {
        ...
        return i.createElement(A.ToolButton, { className: _(t, B.button), tooltipPosition: "horizontal", ...o });
      }
      var z = o(65186),
        D = o(91244);
      function k(e) {
        ...
        const l = s[0].properties().frozen,
          a = (0, E.useProperty)(l),
          c = a ? { tooltip: r.t(null, void 0, o(15101)), icon: z } : { tooltip: r.t(null, void 0, o(42284)), icon: D };
        return i.createElement(M, {
          className: n,
          isActive: Boolean(a),
          onClick: function () {
            (0, x.trackEvent)("GUI", "Context action on drawings", "Lock"), t.toggleLockSelectedObject();
          },
      ...
      var I = o(9745),
        ...
        $ = o(84959);
      function G(e, t) {
        const i = [(0, K.createVisualOrderAction)(e, t), (0, K.createChangeIntervalsVisibilitiesAction)(e, t)],
          n = (function (e, t) {
            const i = [],
              n = Z.isMacKeyboard ? " +" : "",
              ...
              i.push(
                new U.Action({
                  ...
                  options: {
                    ...
                    onExecute: () => {
                      e.model().cloneLineTools(s, !1), (0, x.trackEvent)("GUI", "Context action on drawings", "Clone");
                    },
                  },
                })
              );
            ...
            if (l.length > 0) {
              ...
              i.push(new U.Action({ actionId: "Chart.Clipboard.CopyLineTools", options: t, id: "Copy" }));
            }
            return (function (e, t) {
              return !!(null == e ? void 0 : e.isMultipleLayout().value()) && t.some((e) => e.isSynchronizable());
            })(e, t)
      ...
      var J = o(95586),
        ...
        ie = o(80427);
      function ne(e) {
        const { property: t, propertyApplier: n, title: s, undoText: l, isToolbarFixed: a, className: c } = e,
          h = (0, E.useProperty)(t),
          d = (0, i.useMemo)(
            () => [
              new U.Action({
      ...
      function le(e) {
        const { property: t, propertyApplier: o, title: n, undoText: r, isToolbarFixed: s, className: l } = e,
          a = (0, E.useProperty)(t),
          c = se.map(
            (e) =>
              new U.Action({
                actionId: "Chart.LineTool.Toolbar.ChangeFontSizeProperty",
                options: { label: e.toString(), onExecute: () => o.setProperty(t, e, r), active: e === a },
              })
          );
        return i.createElement(
          V.ToolWidgetMenu,
      ...
      var ae = o(69774),
        ...
        de = o(3587),
        ue = o(87919);
      const pe = new s.TranslatedString("change line tool(s) font size", r.t(null, void 0, o(36819))),
        ...
        ge =
          ...
          new s.TranslatedString("line tool(s) line style", r.t(null, { context: "line tool property name" }, o(2443)))),
      ...
      class be {
        constructor(e) {
          (this._isDrawingFinished = new a.WatchedValue(!0)),
            ...
            (this._handleSourceEdit = (e) => {
              h.isDirectionalMovementActive.value() || (e ? this._floatingToolbar.hide(!0) : this._floatingToolbarRendered && this._floatingToolbar.show());
            }),
            (this._chartWidgetCollection = e),
            (this._floatingToolbar = new y.FloatingToolbar({
              defaultPosition: { top: ae.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15, left: window.innerWidth / 2 },
        ...
        onSourceChanged(e) {
          ...
          if (
            ...
            e.every((t) => t.toolname === e[0].toolname) ? this._showTemplatesOf({ sources: e }) : this._templatesButton && this._clearTemplatesButton(),
            1 === e.length)
          ) {
            const t = e[0];
            t.isAvailableInFloatingWidget() && this.activeChartWidget().model().model().dataSourceForId(t.id())
              ? (!t.userEditEnabled() ||
                  (!(0, he.isLineDrawnWithPressedButton)(t.toolname) && this.activeChartWidget().model().lineBeingCreated()) ||
        ...
        _propertyApplierImpl() {
          return (
            this._propertyApplier ||
              (this._propertyApplier = new ue.PropertyApplierWithoutSavingChart(() => this.activeChartWidget().model(), new a.WatchedValue(false))),
            this._propertyApplier
          );
        }
        _clearProperties() {
        ...
        _show() {
          this._updateVisibilityTimeout && clearTimeout(this._updateVisibilityTimeout),
            (this._updateVisibilityTimeout = setTimeout(() => {
              this._renderFloatingToolbar(), this._floatingToolbar.show(), this._floatingToolbar.checkPosition();
            }, 0));
        }
        ...
        _createSettingsButton() {
          const e = { component: P, props: { title: ve, activeChartWidget: this.activeChartWidget() } };
          this._addCommonButton(e);
        }
        _createLockButton() {
          const e = { component: k, props: { title: "Lock", activeChartWidget: this.activeChartWidget() } };
          this._addCommonButton(e);
        }
        _createRemoveButton() {
          const e = { component: W, props: { title: _e, activeChartWidget: this.activeChartWidget() }, showForSmallScreen: !0 };
          this._addCommonButton(e);
        }
        _createDotsButton() {
          this._addCommonButton({ component: Y, props: { title: we, activeChartWidget: this.activeChartWidget() }, showForSmallScreen: !0 });
        }
        _createAlertButton() {}
        ...
        _createLineStyleButton(e) {
          ...
          if (1 === t.length) {
            ...
            const e = t.map((e) => e.properties().linestyle || e.properties().lineStyle).filter(c.notUndefined);
            if (!e.length) return !1;
            (o = new d.CollectiblePropertyUndoWrapper(new u.LineToolCollectedProperty(e), ge, this._propertyApplierImpl())),
              (i = { ...i, setProperty: (e, t) => e.setValue(t) });
          }
          return this._addPropertyButton({ component: ne, props: { property: o, title: fe, propertyApplier: i, "data-name": "style", undoText: me } }), !0;
        }
        _createFontSizeButton(e) {
          ...
          const i = {
            component: le,
            props: { property: o.properties().fontsize || e, title: ye, propertyApplier: this._propertyApplierImpl(), "data-name": "font-size", undoText: pe },
          };
        ...
        _prepareProperties(e) {
          ...
          if (!(t.filter((t) => t.properties()[e].visible()).length < 1)) return t.map((t) => t.properties()[e]).filter(c.notNull);
        }
        _createProperty(e, t, o, i) {
          if (t) {
            ...
            return this._isWidthProperty(e[0])
              ...
              : new v.CollectibleColorPropertyUndoWrapper(new u.MultipleLineColorsProperty(e), this._propertyApplierImpl(), i);
          }
          if (e && e.visible())
    ...
    78036: (e, t, o) => {
      ...
      const u = (0, h.humanReadableModifiers)(h.Modifiers.Shift, !1),
        ...
        w = {
          ...
          LineToolGannFixed: {},
          LineToolGannFan: {},
          LineToolGannSquare: { hotKey: (0, r.hotKeySerialize)({ keys: [u], text: n.t(null, void 0, o(10289)) }) },
          LineToolHeadAndShoulders: {},
          LineToolHorzLine: { hotKey: (0, r.hotKeySerialize)({ keys: [p, "H"], text: "{0} + {1}" }) },
          LineToolHorzRay: {},
          LineToolIcon: {},
          LineToolEmoji: {},
          ...
          LineToolProjection: {},
          LineToolRay: {},
          LineToolRectangle: { hotKey: (0, r.hotKeySerialize)({ keys: [u], text: n.t(null, void 0, o(81591)) }) },
          LineToolCircle: {},
          ...
          LineToolVertLine: { hotKey: (0, r.hotKeySerialize)({ keys: [p, "V"], text: "{0} + {1}" }) },
          LineToolCrossLine: {},
          LineToolHighlighter: {},
          LineToolGhostFeed: {},
          ...
          measure: { hotKey: (0, r.hotKeySerialize)({ keys: [u], text: n.t(null, void 0, o(32868)) }) },
      ...
      Object.entries(w)
        .map(([e, t]) => {
          ...
          return { ...t, name: e, icon: r, localizedName: h, selectHotkey: d.lineToolsSelectHotkeys[e] };
        })
        .forEach((e) => {
          f[e.name] = e;
        });
      ...
      class A extends n {
        ...
        _createWidthsButton(e, t) {
          if (
            ...
            return !0;
          var o = T;
          t && 1 !== this.selectedSources().filter((e) => e.properties().linesWidths).length && (o = C);
          return (
        ...
        showPropertiesOf(e, t, o) {
          ...
          if ((this._clearProperties(), (this._propertiesVisible = !1), i.length)) {
            for (var n = {}, s = 0; s < i.length; s++) {
              for (var l = i[s], a = t, c = l.name.split("."), h = 0; h < c.length; ++h) a = a && a[c[h]];
              var d = l.showIf;
        ...
        _defaultToolProperties() {
          return [
            { name: "linesColors", inputType: "colorPicker", iconSvgCode: l, title: m, factory: A.prototype._createColorsButton, dataName: "line-tool-color" },
            {
            ...
            { name: "textsColors", title: v, inputType: "colorPicker", iconSvgCode: c, factory: A.prototype._createTextColorsButton, dataName: "text-color" },
            { name: "linesWidths", inputType: "combobox", factory: A.prototype._createWidthsButton },
            { name: "linestyle", title: y, inputType: "combobox", factory: A.prototype._createLineStyleButton },
          ];
        }
        _regressionToolExceptionCases() {
          return [{ name: "linesWidths", inputType: "combobox", factory: A.prototype._createWidthsButton }];
        }
        _pathExceptionCases() {
          return [
            { name: "linesColors", inputType: "colorPicker", iconSvgCode: l, title: m, factory: A.prototype._createColorsButton, dataName: "line-tool-color" },
        ...
        _riskPropertiesExceptionCases() {
          return [
            { name: "textcolor", title: v, inputType: "colorPicker", iconSvgCode: c, dataName: "text-color", undoText: u },
            { name: "profitBackground", title: x, inputType: "colorPicker", iconSvgCode: a, dataName: "background-color", undoText: d },
            { name: "stopBackground", title: L, inputType: "colorPicker", iconSvgCode: a, dataName: "background-color", undoText: d },
          ];
        }
        _rangeExceptionCases() {
          return [
            { name: "linecolor", inputType: "colorPicker", iconSvgCode: l, title: m, dataName: "line-tool-color", undoText: h },
            {
        ...
        _textPropertiesExceptionCases() {
          return [
            { name: "color", title: v, inputType: "colorPicker", iconSvgCode: c, dataName: "text-color", undoText: u },
            {
              name: "backgroundColor",
              title: w,
              inputType: "colorPicker",
            ...
            { name: "fontsize", title: b, inputType: "combobox", factory: A.prototype._createFontSizeButton },
          ];
        }
        _notePropertiesExceptionCases() {
          return [
            { name: "markerColor", title: S, inputType: "colorPicker", iconSvgCode: l, dataName: "line-tool-color", undoText: h },
            { name: "textColor", title: v, inputType: "colorPicker", iconSvgCode: c, dataName: "text-color", undoText: u },
            { name: "fontSize", title: b, inputType: "combobox", factory: A.prototype._createFontSizeButton },
          ];
        }
        _createToolExceptionCases() {
          return {
            ...
            LineToolBarsPattern: [{ name: "color", title: m, inputType: "colorPicker", iconSvgCode: a, dataName: "background-color", undoText: h }],
            LineToolProjection: [
              { name: "color1", title: P, inputType: "colorPicker", iconSvgCode: a, dataName: "background-color", undoText: d },
              { name: "color2", title: E, inputType: "colorPicker", iconSvgCode: a, dataName: "background-color", undoText: d },
              { name: "linesWidths", inputType: "combobox", factory: A.prototype._createWidthsButton },
            ],
            LineToolSignpost: [
              {
    ...
    69152: (e, t, o) => {
      "use strict";
      o.d(t, { CollectibleColorPropertyDirectWrapper: () => l, CollectibleColorPropertyUndoWrapper: () => s });
      var i = o(50151),
        n = o(88640);
    ...
    62513: (e, t, o) => {
      ...
      var i = o(50151),
        ...
        r = o(36298),
        s = o(88640);
      const l = new r.TranslatedString("change {propertyName} property", n.t(null, void 0, o(18567)));
      class a extends s.default {
        ...
        subscribe(e, t) {
          ...
          this._listenersMappers.push({ obj: e, method: t, callback: o }), this._baseProperty.subscribe(e, o);
        }
        unsubscribe(e, t) {
          var o;
          const n = (0, i.ensureDefined)(
      ...
      !(function (e) {
        function t() {
          ...
          if (0 === h.length && c && "undefined" != typeof window) {
            const e = JSON.parse(null !== (i = null === (t = window.urlParams) || void 0 === t ? void 0 : t.favorites) && void 0 !== i ? i : "{}").drawingTools;
            e && Array.isArray(e) && h.push(...e);
          }
          h.forEach((t, i) => {
            const n = t.tool || t;
            o(n) ? (r.includes(n) ? (a = !0) : e.favorites.push(n)) : s && s.includes(n) && e.hiddenToolsPositions.set(n, i);
          }),
            a && l(),
        ...
        (function (e) {
          ...
          (e.favoriteAdded = new i.Delegate()),
            ...
            (e.addFavorite = function (o, i) {
              return !(n(o) || !t(o) || "performance" === o) && (l.favorites.push(o), l.saveFavorites(i), e.favoriteAdded.fire(o), !0);
            }),
