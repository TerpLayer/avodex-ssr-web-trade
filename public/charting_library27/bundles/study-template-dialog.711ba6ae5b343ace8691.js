(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6631],
  {
    ...
    70673: (e, t, a) => {
      ...
      function c(e) {
        ...
        return n.createElement(
          ...
          n.createElement("span", { className: t }, n.createElement(s.Icon, { icon: o, className: m().icon }))
        );
      }
    },
    15294: (e, t, a) => {
      ...
      class m extends n.PureComponent {
        render() {
          ...
          let m = null;
          return (
            this.props.label && (m = n.createElement("span", { className: o, title: this.props.title }, this.props.label)),
            n.createElement("label", { className: l }, n.createElement(s.CheckboxInput, { ...a, className: e }), m)
          );
        }
      }
    ...
    59416: (e, t, a) => {
      ...
      var n = a(50959),
        i = a(74786);
      const l = (0, n.createContext)({ getName: () => "", getValues: () => [], getOnChange: () => i.default, subscribe: i.default, unsubscribe: i.default });
      class s extends n.PureComponent {
        ...
        render() {
          return n.createElement(l.Provider, { value: this.state.switchGroupContext }, this.props.children);
        }
      ...
      function o(e) {
        ...
        return (
          (t = class extends n.PureComponent {
            ...
            render() {
              return n.createElement(e, { ...this.props, name: this._getName(), onChange: this._onChange, checked: this._isChecked() });
            }
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(
                    ...
                    n.createElement(
                      s.Button,
                      { className: b, disabled: c, name: "submit", onClick: d, "data-name": "submit-button" },
    ...
    13932: (e, t, a) => {
      ...
      function b(e) {
        const { isLoading: t } = e;
        return l.createElement("span", { className: t ? p.loading : void 0 }, i.t(null, void 0, a(85520)), t && l.createElement(h.Loader, { color: "white" }));
      }
      class v extends l.PureComponent {
        ...
        _renderDialogBody() {
          return () => l.createElement(d.SlotContext.Consumer, null, (e) => ((this._manager = e), this.props.children));
        }
      }
      var g = a(33547),
        S = a(85508),
      ...
      function x(e) {
        const { title: t, saveSymbolHintText: a, saveIntervalHintText: i, indicatorsText: s, source: u, onClose: d, onSubmit: h } = e,
          [p, b] = (0, l.useState)(""),
          [y, x] = (0, l.useState)(!1),
          [I, T] = (0, l.useState)(!1),
          [D, E] = (0, l.useState)(!1),
            ...
            l.createElement(
              ...
              l.createElement(
                ...
                l.createElement(r.Checkbox, {
                  label: l.createElement("span", { className: _.hintLabel }, C, l.createElement(c.Icon, { icon: S, className: o(k), title: a })),
                  onChange: function () {
              ...
              l.createElement(
                ...
                l.createElement(r.Checkbox, {
                  label: l.createElement("span", { className: _.hintLabel }, N, l.createElement(c.Icon, { icon: S, className: o(k), title: i })),
                  onChange: function () {
      ...
      class D {
        constructor(e) {
          (this._container = document.createElement("div")),
            ...
            (this.unmount = () => {
              I.unsubscribe(T.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null), s.unmountComponentAtNode(this._container);
            }),
            (this._title = e.title),
      ...
      class A {
        ...
        show() {
          (0, M.runOrSigninWithFeature)(this._showSaveDialog, { feature: "customIndicators", source: "Study templates save as", sourceMeta: "Chart" });
        }
        _prepareData(e, t, a) {
          const n = this._controller.model().studyTemplate(t, a);
          return { name: e, content: JSON.stringify(n), meta_info: (0, z.createStudyTemplateMetaInfo)(this._controller, n.interval) };
        }
        _doSave(e, t, a) {
