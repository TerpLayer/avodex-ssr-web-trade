(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8890],
  {
                ...
                (a = [].concat(t(a), [m])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(n.target) &&
                        ((o && 0 === o.scrollTop && 0 < a) || ((l = o) && l.scrollHeight - l.scrollTop <= l.clientHeight && a < 0)
                          ? d(n)
                          : n.stopPropagation()));
                  }),
            ...
            (e.enableBodyScroll = function (e) {
              if (l) {
                ...
                (e.ontouchstart = null),
                  ...
                  r && 0 === a.length && (document.removeEventListener("touchmove", d, n ? { passive: !1 } : void 0), (r = !1));
              } else
    ...
    30507: (e) => {
      e.exports = { actionButton: "actionButton-k53vexPa", small: "small-k53vexPa", hiddenTitle: "hiddenTitle-k53vexPa" };
    },
    55021: (e) => {
    ...
    70493: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { confirmModule: () => D, renameModule: () => L, showSimpleDialog: () => P, warningModule: () => I });
      var o = n(50959),
        l = n(11542),
        a = n(97754),
        r = n(9745),
      ...
      var N = n(30507);
      function w(e) {
        const { disabled: t, name: n, title: l, appearance: r, intent: i, handler: s, reference: c, type: u } = e,
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  (function (t) {
                    ...
                    if ("content" in e) return o.createElement(f.TouchScrollContainer, { className: a(_.content, t && _.small, p) }, e.content);
                    return null;
                  })(i),
                  l &&
                    l.length > 0 &&
                ...
                b && o.createElement(r.Icon, { className: a(_.close, i && _.small), icon: y, onClick: x, "data-name": "close", "data-role": "button" })
              )
            )
          )
        );
        function O(e) {
          switch ((0, c.hashFromEvent)(e)) {
            ...
            case 13:
              ...
              if (e.defaultPrevented || (t instanceof HTMLButtonElement && "submit" !== t.type)) return;
              if (T && l && l.length) {
                e.preventDefault();
                const t = k.current;
                t && t.click();
      ...
      function S(e) {
        return "html" in e ? { html: e.html } : "text" in e ? { content: e.text } : { content: e.content };
      }
      var B = n(21788),
        T = n(55021);
      function U(e) {
        const { maxLength: t, value: n, placeholder: l, onValueChange: a, nameInputRef: r, source: i = [], autocompleteFilter: s } = e,
        ...
        return (
          ...
          o.createElement(
            ...
            (function () {
              ...
              if ("html" in e) return o.createElement("div", { className: T.label, dangerouslySetInnerHTML: { __html: e.html } });
              return null;
            })(),
      ...
      const D = function (e) {
            ...
            actions: [
              {
                ...
                intent: u || "primary",
                handler: ({ dialogClose: e, innerManager: t }) => f({ newValue: C, focusInput: _, dialogClose: e, innerManager: t }),
              },
              {
                name: "cancel",
                type: "button",
        ...
        P = function (e, t, n) {
          const { title: l } = e;
          let a = `${l}_`;
          if (((a += "text" in e ? e.text : "html" in e ? e.html : e.id), M.isOpened(a))) return (0, p.ensureDefined)(M.getDialogPayload(a)).closeHandler;
          ...
          return (
            x.render(o.createElement(C.SlotContext.Provider, { value: n || null }, o.createElement(t, { ...e, onClose: i })), r),
