  ...
  [7129, 5565],
  {
    ...
    40104: (e, t, o) => {
      ...
      async function r(e, t) {
        return s(e, t.length + 1, (e) => (e < t.length ? (0, i.delay)(null, t[e]) : Promise.resolve()));
      }
    },
    16879: (e, t, o) => {
      ...
      const h = function e(t, o, i, n, r) {
        ...
        for (i || (i = d), r || (r = []); ++a < l; ) {
          var h = t[a];
          o > 0 && i(h) ? (o > 1 ? e(h, o - 1, i, n, r) : (0, s.default)(r, h)) : n || (r[r.length] = h);
        }
        return r;
      };
      const u = function (e) {
      ...
      class M {
        ...
        resolveLinkKey(e, t, o) {
          ...
          return n.set(t, r), this._pendingRequests.set(s, n), this._startRequestingDebounced(), r.promise;
        }
        async _startNextRequest() {
          ...
          const e = await (0, p.getChartStorage)(),
            ...
            s = t[1],
            n = { requestType: "mainSeriesLineTools", seriesSourceId: this._ownerSourceId, symbol: o, brokerName: i, sharingMode: 0 };
          try {
      ...
      class D extends G.StudyStub {
        constructor(e, t, o) {
          var i;
          super(e, { ...t, ownFirstValue: null }, o), (this._linkKey = new C.WatchedValue(null !== (i = t.linkKey) && void 0 !== i ? i : null));
        }
        linkKey() {
      ...
      function P(e, t) {
        return { id: e.id, name: e.name().value(), symbol: e.symbol(), currencyId: e.currencyId(), unitId: e.unitId() };
      }
      function U(e) {
        return void 0 === e ? 0 : e;
      }
      ...
      class B {
        constructor(e, t, o, s, n) {
          (this._invalidatedLineToolsAndStudyStubs = new Map()),
            ...
            (this._doNotSaveSharedLineToolsToChartsImpl = new w("do_not_save_shared_line_tools_to_charts", q)),
        ...
        async applyDTO(e, t = 0) {
          this.resetInvalidated(Date.now().valueOf(), e, t), await this._applyLineToolsAndGroupsDTO(e, t);
        }
        ...
        resetInvalidated(e, t, o) {
          const i = (e, t, i, s) => {
            ...
            if (!i.has(s) || i.get(s)) {
              if (i.has(s)) {
                ...
                if (0 === o) {
                  t(s, {
                    sharingMode: this._doNotSaveSharedLineToolsToCharts.value() ? o : null !== (n = null == i ? void 0 : i.sharingMode) && void 0 !== n ? n : o,
                    duplicatedInChart: !this._doNotSaveSharedLineToolsToCharts.value(),
                  });
                } else t(s, { sharingMode: o, duplicatedInChart: null !== (r = null == i ? void 0 : i.duplicatedInChart) && void 0 !== r && r });
              }
            } else {
              const i = e.get(s);
              i && (i.sharingMode === o ? t(s, null) : 0 === o && t(s, { ...i, duplicatedInChart: !1 }));
            }
          };
          ...
          (this._invalidatedLineToolsAndStudyStubs = l.stillInvalidated),
            l.validated.forEach(i.bind(this, this._originalLineToolSharingMode, this._setOriginalLineToolSharingMode.bind(this), n));
          const d = K(this._invalidatedLineToolGroups, e, new Set(null != a ? a : s.keys()));
          l.validated.forEach(i.bind(this, this._originalLineToolGroupsSharingMode, this._setOriginalLineToolGroupsSharingMode.bind(this), s)),
        ...
        applyLineToolUpdateNotification(e, t) {
          ...
          const i = (function (e) {
            const t = z.exec(e);
            return 4 === (null == t ? void 0 : t.length) ? { layoutId: t[1], chartId: t[2], clientId: t[3] } : { layoutId: "", chartId: "", clientId: e };
        ...
        endApplyingLineToolUpdateNotification() {
          this._ignoreInvalidatingEventsDepth--,
            this._ignoreInvalidatingEventsDepth < 0 &&
              (V.logError("Logic error, startApplyingLineToolUpdateNotification/endApplyingLineToolUpdateNotification mismatch, autofixing"),
              (this._ignoreInvalidatingEventsDepth = 0));
        }
        ...
        _processLineToolsGroupModelChanged(e, t) {
          ...
          this._invalidateLineToolGroup(e, o), t && (t.affectedLineTools || []).forEach((e) => this._invalidateLineToolOrStudyStub(e, o));
        }
        _processPanesCollectionChanged(e) {
          ...
          Array.from(this._allLineToolsAndStudyStubs.keys())
            .filter((e) => !o.has(e))
            .forEach((e) => {
              Array.from((0, c.ensureDefined)(this._allLineToolsAndStudyStubs.get(e)).keys()).forEach((e) => {
          ...
          if (this._allLineToolsAndStudyStubs.has(e.id())) {
            ...
            (s = t.filter((e) => !o.has(e.id()))),
              ...
              Array.from(o.entries())
                .filter((e) => !i.has(e[0]))
                .forEach((e) => {
                  null !== e[1] && this._debouncedSave(), this._invalidateLineToolOrStudyStub(e[0], n);
                });
          } else (s = t), t.forEach((e) => this._invalidateLineToolOrStudyStub(e.id(), n));
          s.forEach((e) => {
            if ((0, g.isLineTool)(e)) {
              this._setOriginalLineToolSharingMode(e.id(), { sharingMode: e.sharingMode().value(), duplicatedInChart: !1 });
              const t = this._chartModel.lineToolsGroupModel().groupForLineTool(e);
              t && this._setOriginalLineToolGroupsSharingMode(t.id, { sharingMode: e.sharingMode().value(), duplicatedInChart: !1 });
            }
          }),
        ...
        _unloadLineTools(e, t, o) {
          ...
          this._withoutInvalidating(() => {
            i.forEach((e) => {
              ...
              (null !== (t = this._allLineToolsAndStudyStubs.get(o.id())) && void 0 !== t ? t : new Map()).delete(e.id());
            }),
        ...
        async _saveInvalidatedIfRequired(e, t) {
          ...
          if ((!this._isAutosaveEnabled() && !t) || this._options.readOnlyMode || "" === this._origin.layoutId) return;
            ...
            s = this._sharingModesToUse()
              .map((e) => {
                ...
                const r = null !== (t = n.lineToolsToValidate) && void 0 !== t ? t : Array.from(n.sources.keys()),
                  a = null !== (s = n.groupsToValidate) && void 0 !== s ? s : Array.from(n.groups.keys());
                ...
                if (n.sources.size || n.groups.size) {
                  ...
                  return (
                    ...
                    n.sources.forEach((t, o) => {
                      t && this._setOriginalLineToolSharingMode(o, { sharingMode: e, duplicatedInChart: !1 });
                    }),
                    (0, c.ensureNotNull)(this._saveChartService)
                      ...
                      .catch(async (t) => {
                        t instanceof S.SavingLineToolsError && t.shouldBeCooled && (this._lastBanTime = performance.now());
                        {
                          const { SavingLineToolsLibraryError: e } = await Promise.resolve().then(o.bind(o, 98653));
                          if (t instanceof e && t.safe) return;
                        }
                        if (!(0, I.isAbortError)(t)) throw t;
                        V.logDebug(`Save request has been aborted. ChartId: ${this._origin.chartId} sharingMode: ${e}`);
                      })
                  );
                }
        ...
        async _savePromise(e, t) {
          ...
          return this._isAutosaveEnabled()
            ? null !== (i = null === (o = this._debouncedSave) || void 0 === o ? void 0 : o.flush()) && void 0 !== i
              ? i
              : Promise.resolve()
        ...
        _seriesLineToolsUnloader(e, t, o) {
          ...
          "mainSeriesLineTools" === e.requestType &&
            ...
            (this._unloadLinesOnSeries(o, e.sharingMode, t), this._currentlyLoadedSymbol.set(e.sharingMode, e.symbol));
        }
        ...
        async _makeLoadRequestAndMerge(e, t, o) {
          ...
          const s = this._chartModel.mainSeries(),
            n = null !== (i = this._currentlyLoadedSymbol.get(e.sharingMode)) && void 0 !== i ? i : "";
        ...
        _restoreGroups(e, t, o, i) {
          ...
          return (
            (t.groups || new Map()).forEach((t, n) => {
              ...
              if (null === t) {
                if (r) {
                  const e = i && i.layoutId === this._origin.layoutId && i.chartId === this._origin.chartId;
                  (r.lineTools()[0].sharingMode().value() === o || (0 === o && !this._doNotSaveSharedLineToolsToCharts.value())) &&
                    ((e && 0 !== o) ||
                      (new b.ExcludeLineToolsFromGroupUndoCommand(this._chartModel, r, r.lineTools()).redo(),
                ...
                this._setOriginalLineToolGroupsSharingMode(n, { sharingMode: o, duplicatedInChart: a });
              }
            }),
            s
          );
        ...
        _restoreLineTool(e, t, o, i) {
          var s;
          if ((null !== (s = t.state.points) && void 0 !== s ? s : []).some((e) => !(0, y.isNumber)(e.time_t))) return null;
          let n = this._chartModel.dataSourceForId(t.id);
          if ((null === n && t.state.linkKey && (n = (0, g.lineToolByLinkKey)(this._chartModel, t.state.linkKey)), null !== n && !(0, g.isLineTool)(n)))
            return null;
          ...
          if (n && t.serverUpdateTime) {
            ...
            if ((null !== e && e >= s) || (null !== r && r >= s)) {
              if (this._saveSharedLineTools.value() && 0 !== o) {
                ...
                this._setOriginalLineToolSharingMode(n.id(), { sharingMode: o, duplicatedInChart: t });
              }
              return null;
            }
            this._origin.clientId !== (null == i ? void 0 : i.clientId) && (this._chartModel.restoreLineToolState(n, t.state, !1), n.calcIsActualSymbol());
          }
          0 !== o && ((t.ownerSource = this._chartModel.mainSeries().id()), (t.state.ownerSource = this._chartModel.mainSeries().id()));
        ...
        _restoreLineDTO(e, t, o, i, s, n) {
          if (!this._invalidatedLineToolsAndStudyStubs.get(t))
            if (null === e) {
              ...
              const o = n && n.layoutId === this._origin.layoutId && n.chartId === this._origin.chartId;
              (e.sharingMode().value() === s || (0 === s && !this._doNotSaveSharedLineToolsToCharts.value())) &&
                (0 === s || this._doNotSaveSharedLineToolsToCharts.value() || (e.share(0), o || this._invalidateLineToolOrStudyStub(t, performance.now(), !0)),
              ...
              if (r) {
                if (e.groupId) {
                  ...
                  if (
                    (null !== t && (t.excludeLineTool(r), 0 === t.lineTools().length && this._chartModel.lineToolsGroupModel().removeGroup(t)),
                ...
                (void 0 === i || (0 !== s && !this._doNotSaveSharedLineToolsToCharts.value())) &&
                  this._setOriginalLineToolSharingMode(t, { sharingMode: s, duplicatedInChart: !1 });
                const n = !(!i || (i.sharingMode === s && !i.duplicatedInChart));
                (0, c.ensureDefined)(this._originalLineToolSharingMode.get(t)).duplicatedInChart = n;
              }
            }
        }
        ...
        _invalidateLineToolOrStudyStub(e, t, o) {
          ...
          const s = null === (i = this._invalidatedLineToolsAndStudyStubs.get(e)) || void 0 === i ? void 0 : i.invalidatedViaSyncOnly,
            n = (void 0 === s || s) && this.invalidateViaSync();
          this._invalidatedLineToolsAndStudyStubs.set(e, { timestamp: t, invalidatedViaSyncOnly: n }), this._hasChanges.setValue(!0), this._debouncedSave();
        }
        _invalidateLineToolGroup(e, t, o) {
          (this._ignoreInvalidatingEventsDepth > 0 && !o) ||
            (this._invalidatedLineToolGroups.set(e, { timestamp: t, invalidatedViaSyncOnly: this.invalidateViaSync() }),
            ...
            this._invalidatedLineToolsAndStudyStubs.forEach((n, r) => {
              ...
              const h = () => {
                ...
                this._doNotSaveSharedLineToolsToCharts.value() &&
                  0 === t &&
                  (null === (e = this._originalLineToolSharingMode.get(r)) || void 0 === e ? void 0 : e.duplicatedInChart) &&
                  o.set(r, null);
              };
              if (null === d) {
                ((null === (a = this._originalLineToolSharingMode.get(r)) || void 0 === a ? void 0 : a.sharingMode) === t ||
                  (0 === t && !this._doNotSaveSharedLineToolsToCharts.value())) &&
                  o.set(r, null),
                  h();
              } else {
                if (d === this._chartModel.lineBeingCreated() || d === this._chartModel.lineBeingEdited() || !d.isSavedInChart()) return;
                const s = d.ownerSource() === this._chartModel.mainSeries(),
                  n = !e || s,
                  a = d.sharingMode().value() === t || (0 === t && !this._doNotSaveSharedLineToolsToCharts.value());
                if (n) {
                  ...
                  if (a)
                    o.set(
                      ...
                      (function (e, t) {
                        const o = t.lineToolsGroupModel().groupForLineTool(e),
                          i = { id: e.id(), ownerSource: (0, c.ensureNotNull)(e.ownerSource()).id(), state: e.state(!1) };
                        return (
                    ...
                    const s = null === (l = this._originalLineToolSharingMode.get(r)) || void 0 === l ? void 0 : l.sharingMode;
            ...
            this._invalidatedLineToolGroups.forEach((e, o) => {
              if (0 !== t && e.invalidatedViaSyncOnly) n.push(o);
                ...
                if (null === e) i.set(o, null);
                  ...
                  (e.sharingMode().value() === t || (0 === t && !this._doNotSaveSharedLineToolsToCharts.value())) && i.set(o, P(e, this._chartModel));
                }
              }
            }),
            {
        ...
        _setOriginalLineToolSharingMode(e, t) {
          t ? this._originalLineToolSharingMode.set(e, t) : this._originalLineToolSharingMode.delete(e);
        }
        _setOriginalLineToolGroupsSharingMode(e, t) {
          t ? this._originalLineToolGroupsSharingMode.set(e, t) : this._originalLineToolGroupsSharingMode.delete(e);
        }
        _sharingModesToUse() {
          return this._saveSharedLineTools.value() ? [0, 1, 2] : [0];
        }
        _loadAndMergeLineToolsOnStudies(e, t) {
          const o = { requestType: "studiesLineTools", seriesSourceId: this._chartModel.mainSeries().id(), sharingMode: e },
            i = this._chartModel.mainSeries();
          this._makeLoadRequestAndMerge(
            o,
            (o) => {
              const s = t ? u(Array.from(this._allLineToolsAndStudyStubs.values()).map((e) => Array.from(e.keys()))).filter((e) => !o(e)) : [];
        ...
        _loadAndMergeLineToolsWithoutSymbol(e, t) {
          const o = { requestType: "lineToolsWithoutSymbol", seriesSourceId: this._chartModel.mainSeries().id(), sharingMode: e },
            i = this._chartModel.mainSeries(),
        ...
        _applyToolsAndGroupsDTOToNonDeserializedCharts(e, t) {
          var o, i;
          if (null !== e.sources && 0 === t && this._duplicateOperationsForSerializedCharts() && this._deserializedChartsIds().length > 0) {
            const t = new Map();
            for (const [s, n] of e.sources)
              null !== n &&
              "_seriesId" === n.ownerSource &&
              0 !== U(null === (o = this._originalLineToolSharingMode.get(s)) || void 0 === o ? void 0 : o.sharingMode) &&
              0 === U(n.state.sharingMode)
                ? t.set(s, null)
                : ((null === n && 0 !== U(null === (i = this._originalLineToolSharingMode.get(s)) || void 0 === i ? void 0 : i.sharingMode)) ||
                    (null !== n && "_seriesId" === n.ownerSource && 0 !== U(n.state.sharingMode))) &&
                  t.set(s, n);
            if (t.size > 0) {
