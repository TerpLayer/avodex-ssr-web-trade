  ...
  [5164],
  {
    ...
    3085: (e, t, r) => {
      ...
      function d(e) {
        ...
        (0, n.useEffect)(() => {
          ...
          return (
            N ? (f && f(), e && (e.addEventListener("mousemove", O), e.addEventListener("mouseup", W))) : p && p(),
            () => {
        ...
        return n.createElement(
          ...
          n.createElement(
            "div",
            {
              ...
              onMouseDown: function (e) {
                e.preventDefault(), (P.current = I(e.nativeEvent, (0, a.ensureNotNull)(z.current))), k(!0);
              },
            },
      ...
      function f(e) {
        ...
        return n.createElement(
          "div",
          { ...z, ref: t, className: o(r, m.scrollWrap), style: { visibility: g || b || N ? "visible" : "hidden" } },
          P &&
            n.createElement(d, {
              size: i - C,
              scrollSize: l - C,
        ...
        const r = (0, n.useRef)(null),
          ...
          [v, d] = (0, n.useState)({
            ...
            onVerticalChange: function (e) {
              d((t) => ({ ...t, scrollPosTop: e })), ((0, o.ensureNotNull)(l.current).scrollTop = e);
            },
            onHorizontalChange: function (e) {
              d((t) => ({ ...t, scrollPosLeft: e })), ((0, o.ensureNotNull)(l.current).scrollLeft = e);
            },
            visible: c,
          }),
          h = (0, n.useCallback)(() => {
            if (!l.current) return;
            const { clientHeight: e, scrollHeight: t, scrollTop: n, clientWidth: o, scrollWidth: i, scrollLeft: s } = l.current,
              a = r.current ? r.current.offsetTop : 0;
            d((r) => ({ ...r, containerHeight: e - a, contentHeight: t - a, scrollPosTop: n, containerWidth: o, contentWidth: i, scrollPosLeft: s }));
          }, []);
        function m() {
          d((e) => ({ ...e, scrollPosTop: (0, o.ensureNotNull)(l.current).scrollTop, scrollPosLeft: (0, o.ensureNotNull)(l.current).scrollLeft }));
        }
        return (
          (0, n.useEffect)(() => {
            c && h(), d((e) => ({ ...e, visible: c }));
    ...
    96040: (e, t, r) => {
      ...
      var n = r(11542),
        ...
        l = r(27306);
      function c(e) {
        const { className: t, isActive: c, onClick: u, onMouseDown: v, title: d, hidden: h, "data-name": m = "remove-button", ...f } = e;
        return o.createElement(s.Icon, {
          ...f,
          "data-name": m,
