                ...
                (a = [].concat(t(a), [m])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !d(o.target) &&
                        ((n && 0 === n.scrollTop && 0 < a) || ((r = n) && r.scrollHeight - r.scrollTop <= r.clientHeight && a < 0)
                          ? u(o)
                          : o.stopPropagation()));
                  }),
            ...
            (e.enableBodyScroll = function (e) {
              if (r) {
                ...
                (e.ontouchstart = null),
                  ...
                  s && 0 === a.length && (document.removeEventListener("touchmove", u, o ? { passive: !1 } : void 0), (s = !1));
              } else
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(p, { className: a(v.drawer, u[`position${t}`], m), ref: g, "data-name": e["data-name"] }, d)
            )
          )
        );
      }
        ...
        const o = t.map((t) => {
          ...
          return (
            void 0 !== e.additionalWidgets &&
              (w = e.additionalWidgets.map((e) => (g.has(e) || g.set(e, (0, c.randomHash)()), e.renderer((0, u.ensureDefined)(g.get(e)), f.additionalWidget)))),
            n.createElement(
              "div",
              { key: h.get(t), className: d(f.popupWidget, f[p], e.isMobile && f.mobile) },
              n.createElement(m.Icon, { className: d(f.icon, s, f[p]), style: { "--custom-status-color": r || void 0 }, icon: a || void 0 }),
              n.createElement(
                "div",
                { className: f.desc },
                  ...
                  n.createElement(
                    ...
                    i.map((e, t) => {
                      ...
                      return (
                        ...
                        n.createElement("span", { key: `html_item_${t}`, className: d(f.item, r && f.boldItem), dangerouslySetInnerHTML: { __html: o } })
                      );
                    })
                  ),
                l &&
        ...
        return n.createElement(
          ...
          n.createElement(s.MatchMedia, { rule: o }, (o) =>
            o
              ...
              : n.createElement(i.Drawer, { onClose: e.onClose, position: "Bottom" }, n.createElement(b, { widgetInfo: t, onClose: e.onClose, isMobile: !o }))
          )
        );
      }
      function b(e) {
