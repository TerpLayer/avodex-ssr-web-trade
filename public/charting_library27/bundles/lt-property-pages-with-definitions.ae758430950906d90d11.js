...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8537],
  {
    86778: (e, t, i) => {
      ...
      function y(e, t, i) {
        const n = (0, s.removeSpaces)(i.originalText()),
          o = [],
          y = (0, r.createLineStyleDefinition)(e, { lineColor: t.linecolor, lineWidth: t.linewidth, lineStyle: t.linestyle }, i, "Line");
        ...
        if ("showPrice" in e || "showPriceLabels" in e || "axisLabelVisible" in e) {
          const { showPrice: a = [], showPriceLabels: c = [], axisLabelVisible: d = [] } = e,
            p = (0, s.createCheckablePropertyDefinition)(
              { checked: new r.CollectiblePropertyUndoWrapper(new o.LineToolCollectedProperty([...a, ...c, ...d]), y, t) },
    ...
    75611: (e, t, i) => {
      ...
      function W(e, t, i, n) {
        const o = (0, c.removeSpaces)(i.originalText()),
          a = [],
          W = t,
          B = (0, r.createLineStyleDefinition)(e, { ...W, lineColor: t.linecolor, lineWidth: t.linewidth, lineStyle: t.linestyle }, i, "Line");
        a.push(B);
        ...
        const I = (0, l.createOptionsPropertyDefinition)(
          ...
          { id: `${o}StatsPosition`, title: (n && n.statsPosition) || b, options: new s.WatchedValue(_) }
        );
        return R.push(I), a.push((0, l.createPropertyDefinitionsGeneralGroup)(R, `${o}StatsGroup`, M)), { definitions: a };
      }
    },
    2908: (e, t, i) => {
      ...
      function T(e, t, i, n, o) {
        ...
        return (
          void 0 !== t.showLine && (T.checked = (0, r.convertToDefinitionProperty)(e, t.showLine, s.format({ toolName: i }))),
          void 0 !== t.lineWidth && (T.width = (0, r.convertToDefinitionProperty)(e, t.lineWidth, a.format({ toolName: i }))),
          void 0 !== t.lineStyle && (T.style = (0, r.convertToDefinitionProperty)(e, t.lineStyle, c.format({ toolName: i }))),
          void 0 !== t.lineColor &&
          ...
          void 0 !== t.leftEnd && (T.leftEnd = (0, r.convertToDefinitionProperty)(e, t.leftEnd, u.format({ toolName: i }))),
          ...
          void 0 !== t.rightEnd && (T.rightEnd = (0, r.convertToDefinitionProperty)(e, t.rightEnd, y.format({ toolName: i }))),
    ...
    50653: (e, t, i) => {
      ...
      function m(e, t, i, n) {
        const o = {},
          m = { id: `${(0, l.removeSpaces)(i.originalText())}Text`, title: (n.customTitles && n.customTitles.text) || "" };
        if (
          (void 0 !== t.showText && (o.checked = (0, r.convertToDefinitionProperty)(e, t.showText, s.format({ toolName: i }))),
          void 0 !== t.textColor && (o.color = (0, r.getColorDefinitionProperty)(e, t.textColor, t.transparency || null, a.format({ toolName: i }))),
          void 0 !== t.fontSize && (o.size = (0, r.convertToDefinitionProperty)(e, t.fontSize, c.format({ toolName: i }))),
          void 0 !== t.bold && (o.bold = (0, r.convertToDefinitionProperty)(e, t.bold, d.format({ toolName: i }))),
          void 0 !== t.italic && (o.italic = (0, r.convertToDefinitionProperty)(e, t.italic, p.format({ toolName: i }))),
          void 0 !== t.text &&
          ...
          void 0 !== t.vertLabelsAlign &&
            ((o.alignmentVertical = (0, r.convertToDefinitionProperty)(e, t.vertLabelsAlign, h.format({ toolName: i }))),
            (m.alignmentVerticalItems = n.alignmentVerticalItems)),
          void 0 !== t.horzLabelsAlign &&
            ((o.alignmentHorizontal = (0, r.convertToDefinitionProperty)(e, t.horzLabelsAlign, y.format({ toolName: i }))),
            (m.alignmentHorizontalItems = n.alignmentHorizontalItems)),
          void 0 !== t.textOrientation && (o.orientation = (0, r.convertToDefinitionProperty)(e, t.textOrientation, f.format({ toolName: i }))),
          void 0 !== t.backgroundVisible && (o.backgroundVisible = (0, r.convertToDefinitionProperty)(e, t.backgroundVisible, v.format({ toolName: i }))),
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) || (m.backgroundTitle = (n.customTitles && n.customTitles.backgroundTitle) || P),
          void 0 !== t.borderVisible && (o.borderVisible = (0, r.convertToDefinitionProperty)(e, t.borderVisible, T.format({ toolName: i }))),
          void 0 !== t.borderWidth && (o.borderWidth = (0, r.convertToDefinitionProperty)(e, t.borderWidth, D.format({ toolName: i }))),
          void 0 !== t.borderColor && (o.borderColor = (0, r.getColorDefinitionProperty)(e, t.borderColor, null, w.format({ toolName: i }))),
          ...
          return {
            definitions: [
              (0, r.createTextStyleDefinition)(
                ...
                { text: e.text, showText: e.showLabel, textColor: e.color, fontSize: e.fontsize, bold: e.bold, italic: e.italic },
          ...
          return {
            definitions: [
              (0, r.createColorPropertyDefinition)(
                { color: (0, r.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, null, c.format({ title: i })) },
          ...
          return {
            definitions: [
              (0, a.createTextStyleDefinition)(
                this._propertyApplier,
                { text: e.text, showText: e.showLabel, textColor: e.textColor, fontSize: e.fontsize, bold: e.bold, italic: e.italic },
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
          ...
          return {
            definitions: [
              (0, l.createColorPropertyDefinition)(
                { color: (0, l.getColorDefinitionProperty)(this._propertyApplier, e.color, null, p.format({ title: i })) },
                { id: `${n}Color`, title: f }
              ),
              (0, l.createOptionsPropertyDefinition)(
                { option: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.mode, u.format({ title: i }), [c.convertToInt]) },
                { id: `${n}Mode`, title: v, options: new s.WatchedValue(D) }
              ),
              (0, l.createCheckablePropertyDefinition)(
                { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.mirrored, h.format({ title: i })) },
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, s.createColorPropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.fillBackground, c.format({ title: i })),
                  color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, e.transparency, d.format({ title: i })),
                },
      ...
      class f extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.color, null, d.format({ title: i })) },
                { id: (0, c.removeSpaces)(`${t}BackgroundColor`), title: u }
              ),
              (0, r.createLineStyleDefinition)(this._propertyApplier, { showLine: e.showWave, lineWidth: e.linewidth }, i, "Line", { line: h }),
        ...
        _textPropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createTextStyleDefinition)(
                this._propertyApplier,
                { textColor: e.textColor, text: e.text, bold: e.bold, italic: e.italic, fontSize: e.fontSize, showText: e.showLabel },
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
                { isEditable: !0, isMultiLine: !0, customTitles: { text: s } }
              ),
            ],
        ...
        _stylePropertyDefinitions() {
          const e = [],
            ...
            C = (0, l.createLineStyleDefinition)(
              this._propertyApplier,
              { showLine: m.visible, lineColor: m.color, lineStyle: m.linestyle, lineWidth: m.linewidth },
              a,
              "TrendLine",
              { line: w }
            );
          ...
          for (let i = 1; i <= L; i++) {
            const n = t[`level${i}`].childs(),
              r = (0, s.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, n.visible, p.format({ title: a, index: i })),
          ...
          const x = (0, s.createColorPropertyDefinition)(
            {
              color: (0, s.getColorDefinitionProperty)(
                this._propertyApplier,
                new d.CollectibleColorPropertyUndoWrapper((0, n.ensureNotNull)(this._source.lineColorsProperty()), this._propertyApplier, null),
                null,
                v.format({ title: a }),
                !0
              ),
          ...
          const k = (0, s.createTransparencyPropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.fillBackground, g.format({ title: a })),
              transparency: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.transparency, T.format({ title: a })),
            },
          ...
          const V = (0, s.createCheckablePropertyDefinition)(
            { checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.coeffsAsPercents, D.format({ title: a })) },
    ...
    56194: (e, t, i) => {
      ...
      const h = new r.TranslatedString("change {title} level {index} line visibility", o.t(null, void 0, i(45463))),
        ...
        b = new r.TranslatedString("change {title} fib levels based on log scale", o.t(null, void 0, i(45739))),
      ...
      class U extends a.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          for (let e = 1; e <= Y; e++) {
            const i = t[`level${e}`].childs(),
              n = (0, s.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.visible, h.format({ title: a, index: e })),
                  color: (0, s.getColorDefinitionProperty)(this._propertyApplier, i.color, null, y.format({ title: a, index: e })),
                  level: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.coeff, f.format({ title: a, index: e })),
                },
                { id: `${o}LineLevel${e}` }
              );
            j.push(n);
          ...
          const q = (0, s.createColorPropertyDefinition)(
            {
              color: (0, s.getColorDefinitionProperty)(
                this._propertyApplier,
                new u.CollectibleColorPropertyUndoWrapper((0, n.ensureNotNull)(this._source.lineColorsProperty()), this._propertyApplier, null),
                null,
                v.format({ title: a }),
                !0
              ),
          ...
          const Z = (0, s.createOptionsPropertyDefinition)(
            {
              ...
              option: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.coeffsAsPercents, S.format({ title: a })),
            },
          ...
          const ee = (0, s.createTwoOptionsPropertyDefinition)(
            {
              option1: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.horzLabelsAlign, _.format({ title: a })),
              option2: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.vertLabelsAlign, _.format({ title: a })),
            },
            { id: `${o}Alignment`, title: W, optionsItems1: new d.WatchedValue(c.availableAlignmentHorizontalItems), optionsItems2: new d.WatchedValue(E) }
          );
          e.push(ee);
          const te = (0, s.createOptionsPropertyDefinition)(
            { option: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.labelFontSize, P.format({ title: a })) },
          ...
          if ((e.push(te), "fibLevelsBasedOnLogScale" in t && null !== this._disabledBasedOnLog)) {
            const i = (0, s.createCheckablePropertyDefinition)(
              {
                disabled: (0, s.convertFromWVToDefinitionProperty)(this._propertyApplier, this._disabledBasedOnLog, b.format({ title: a })),
                checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.fibLevelsBasedOnLogScale, b.format({ title: a })),
              },
        ...
        _stylePropertyDefinitions() {
          ...
          for (let e = 1; e <= z; e++) {
            const i = t[`hlevel${e}`].childs(),
              n = (0, l.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, i.visible, d.format({ title: s, index: e })),
                  color: (0, l.getColorDefinitionProperty)(this._propertyApplier, i.color, null, p.format({ title: s, index: e })),
                  level: (0, l.convertToDefinitionProperty)(this._propertyApplier, i.coeff, u.format({ title: s, index: e })),
                },
                { id: `${o}HLineLevel${e}` }
              );
            B.push(n);
          ...
          const N = (0, l.createPropertyDefinitionsLeveledLinesGroup)(B, `${o}HLeveledLinesGroup`),
            R = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showLeftLabels, v.format({ title: s })) },
              { id: `${o}LeftLabels`, title: k }
            ),
            G = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showRightLabels, g.format({ title: s })) },
          ...
          const F = (0, l.createPropertyDefinitionsLeveledLinesGroup)(O, `${o}VLeveledLinesGroup`),
            I = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showTopLabels, T.format({ title: s })) },
              { id: `${o}TopLabels`, title: V }
            ),
            H = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showBottomLabels, D.format({ title: s })) },
          ...
          const Y = (0, l.createColorPropertyDefinition)(
            {
              color: (0, l.getColorDefinitionProperty)(
                this._propertyApplier,
                new c.CollectibleColorPropertyUndoWrapper((0, n.ensureNotNull)(this._source.lineColorsProperty()), this._propertyApplier, null),
                null,
                h.format({ title: s }),
                !0
              ),
          ...
          const X = (0, l.createTransparencyPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.fillBackground, y.format({ title: s })),
              transparency: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.transparency, f.format({ title: s })),
            },
            ...
            J = (0, l.createLinePropertyDefinition)(
              {
                ...
                style: (0, l.convertToDefinitionProperty)(this._propertyApplier, q.linestyle, b.format({ title: s })),
              },
          ...
          return {
            definitions: [
              (0, r.createLinePropertyDefinition)(
                {
                  color: (0, r.getColorDefinitionProperty)(this._propertyApplier, e.linecolor, null, a.format({ title: n })),
              ...
              (0, r.createCheckablePropertyDefinition)(
                { checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.counterclockwise, p.format({ title: n })) },
    ...
    18505: (e, t, i) => {
      i.r(t), i.d(t, { FibTimezoneDefinitionsViewModel: () => C, availableAlignmentHorizontalItems: () => m, availableAlignmentVerticalItems: () => b });
      var n = i(50151),
        o = i(11542),
        r = i(36298),
        l = i(295),
      ...
      class C extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          for (let i = 1; i <= C; i++) {
            const n = t[`level${i}`].childs(),
              r = (0, l.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, n.visible, p.format({ title: s, index: i })),
                  color: (0, l.getColorDefinitionProperty)(this._propertyApplier, n.color, null, u.format({ title: s, index: i })),
                  width: (0, l.convertToDefinitionProperty)(this._propertyApplier, n.linewidth, h.format({ title: s, index: i })),
                  style: (0, l.convertToDefinitionProperty)(this._propertyApplier, n.linestyle, y.format({ title: s, index: i })),
          ...
          const x = (0, l.createTransparencyPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.fillBackground, g.format({ title: s })),
              transparency: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.transparency, T.format({ title: s })),
            },
            { id: `${o}Background`, title: P }
          );
          e.push(x);
          const k = (0, l.createTwoOptionsPropertyDefinition)(
            {
              ...
              option1: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.horzLabelsAlign, w.format({ title: s })),
              option2: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.vertLabelsAlign, w.format({ title: s })),
            },
            { id: `${o}Labels`, title: S, optionsItems1: new a.WatchedValue(m), optionsItems2: new a.WatchedValue(b) }
          );
          return e.push(k), { definitions: e };
        }
      }
      ...
      class S extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            b = (0, l.createLineStyleDefinition)(this._propertyApplier, { showLine: S.visible, lineColor: S.color, lineWidth: S.linewidth }, a, "TrendLine", {
              line: D,
            });
          e.push(b);
    ...
    85951: (e, t, i) => {
      ...
      const y = new r.TranslatedString("change {title} level {index} line visibility", o.t(null, void 0, i(45463))),
        ...
        b = new r.TranslatedString("change {title} arcs {index} line visibility", o.t(null, void 0, i(13853))),
        m = new r.TranslatedString("change {title} arcs {index} line color", o.t(null, void 0, i(17466))),
        ...
        _stylePropertyDefinitions() {
          ...
          for (let e = 0; e < N; e++) {
            const i = t.levels.childs()[e].childs(),
              n = (0, s.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.visible, y.format({ title: a, index: e })),
                  color: (0, s.getColorDefinitionProperty)(this._propertyApplier, i.color, null, f.format({ title: a, index: e })),
                  width: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.width, v.format({ title: a, index: e })),
                },
          ...
          for (let e = 0; e < E; e++) {
            const i = t.fanlines.childs()[e].childs(),
              n = (0, s.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.visible, _.format({ title: a, index: e })),
                  color: (0, s.getColorDefinitionProperty)(this._propertyApplier, i.color, null, P.format({ title: a, index: e })),
                  width: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.width, S.format({ title: a, index: e })),
                },
          ...
          for (let e = 0; e < F; e++) {
            const i = t.arcs.childs()[e].childs(),
              n = (0, s.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.visible, b.format({ title: a, index: e })),
                  color: (0, s.getColorDefinitionProperty)(this._propertyApplier, i.color, null, m.format({ title: a, index: e })),
                  width: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.width, C.format({ title: a, index: e })),
                },
          ...
          const j = t.arcsBackground.childs(),
            Y = (0, s.createTransparencyPropertyDefinition)(
              {
                checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, j.fillBackground, T.format({ title: a })),
                transparency: (0, s.convertToDefinitionProperty)(this._propertyApplier, j.transparency, D.format({ title: a })),
              },
          ...
          if ((e.push(X), z(this._source))) {
            const t = this._source,
              ...
              n = (0, s.createNumberPropertyDefinition)(
                ...
                { id: "scaleRatio", title: V, min: new d.WatchedValue(1e-7), max: new d.WatchedValue(1e8), step: new d.WatchedValue(t.getScaleRatioStep()) }
              );
            e.push(n);
            const o = i.labelsStyle.childs(),
              r = (0, l.createTextStyleDefinition)(this._propertyApplier, { showText: i.showLabels, fontSize: o.fontSize, bold: o.bold, italic: o.italic }, a, {
                customTitles: { text: $ },
              });
            e.push(r);
          }
        ...
        _stylePropertyDefinitions() {
          ...
          for (let i = 1; i <= _; i++) {
            const n = t[`level${i}`].childs(),
              r = (0, l.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, n.visible, d.format({ title: s, index: i })),
                  color: (0, l.getColorDefinitionProperty)(this._propertyApplier, n.color, null, p.format({ title: s, index: i })),
                  width: (0, l.convertToDefinitionProperty)(this._propertyApplier, n.linewidth, u.format({ title: s, index: i })),
                  style: (0, l.convertToDefinitionProperty)(this._propertyApplier, n.linestyle, h.format({ title: s, index: i })),
                },
          ...
          const S = (0, l.createTransparencyPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.fillBackground, f.format({ title: s })),
              transparency: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.transparency, v.format({ title: s })),
            },
        ...
        _stylePropertyDefinitions() {
          ...
          const B = (0, l.createPropertyDefinitionsLeveledLinesGroup)(M, `${o}HLeveledLinesGroup`),
            z = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showLeftLabels, g.format({ title: s })) },
              { id: `${o}LeftLabels`, title: L }
            ),
            N = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showRightLabels, T.format({ title: s })) },
              { id: `${o}RightLabels`, title: x }
            ),
            R = (0, l.createTransparencyPropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.fillHorzBackground, y.format({ title: s })),
                transparency: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.horzTransparency, f.format({ title: s })),
              },
          ...
          const U = (0, l.createPropertyDefinitionsLeveledLinesGroup)(E, `${o}VLeveledLinesGroup`),
            F = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showTopLabels, D.format({ title: s })) },
              { id: `${o}TopLabels`, title: k }
            ),
            I = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showBottomLabels, w.format({ title: s })) },
              { id: `${o}BottomLabels`, title: A }
            ),
            H = (0, l.createTransparencyPropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.fillVertBackground, y.format({ title: s })),
                transparency: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.vertTransparency, f.format({ title: s })),
              },
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, s.createColorPropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._undoModel, e.fillBackground, c.format({ title: i })),
                  color: (0, s.getColorDefinitionProperty)(
                    this._undoModel,
                    e.backgroundColor,
                    e.transparency,
      ...
      class m extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            b = (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: t.linecolor, lineWidth: t.linewidth }, s, "Line", { line: f });
          ...
          const m = (0, a.createColorPropertyDefinition)(
            {
              checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, t.fillBackground, d.format({ title: s })),
              color: (0, a.getColorDefinitionProperty)(this._propertyApplier, t.backgroundColor, t.backgroundTransparency, p.format({ title: s })),
            },
          ...
          if (
            ...
            const i = (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, t.extendTop, u.format({ title: s })) },
                { id: `${n}ExtendTop`, title: T }
              ),
              o = (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, t.extendBottom, h.format({ title: s })) },
          ...
          if (
            ...
            const i = (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, t.extendLeft, y.format({ title: s })) },
                { id: `${n}extendLeft`, title: w }
              ),
              o = (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, t.extendRight, h.format({ title: s })) },
      ...
      class h extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name(),
            i = new o.TranslatedString(t, this._source.translatedType()),
            n = (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.color, lineWidth: e.linewidth }, i, "Line", { line: p }),
          ...
          return {
            definitions: [
              ...
              (0, s.createColorPropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.fillBackground, c.format({ title: i })),
                  color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, l, d.format({ title: i })),
                },
          ...
          return {
            definitions: [
              ...
              (0, a.createColorPropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.fillBackground, d.format({ title: i })),
                  color: (0, a.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, e.transparency, p.format({ title: i })),
                },
          ...
          return {
            definitions: [
              (0, l.createTextStyleDefinition)(
                ...
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
                { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: u, customTitles: { text: h } }
              ),
            ],
          };
        }
          ...
          return {
            definitions: [
              (0, l.createTwoColorsPropertyDefinition)(
                {
                  color1: (0, l.getColorDefinitionProperty)(this._propertyApplier, r.upColor, null, c.format({ title: n })),
                  color2: (0, l.getColorDefinitionProperty)(this._propertyApplier, r.downColor, null, d.format({ title: n })),
                },
                { id: `${i}Candle2Colors`, title: D }
              ),
              (0, l.createTwoColorsPropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, r.drawBorder, p.format({ title: n })),
                  color1: (0, l.getColorDefinitionProperty)(this._propertyApplier, r.borderUpColor, null, u.format({ title: n })),
                  color2: (0, l.getColorDefinitionProperty)(this._propertyApplier, r.borderDownColor, null, h.format({ title: n })),
                },
                { id: `${i}CandleBorder2Colors`, title: w }
              ),
              (0, l.createColorPropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, r.drawWick, y.format({ title: n })),
                  color: (0, l.getColorDefinitionProperty)(this._propertyApplier, r.wickColor, null, f.format({ title: n })),
                },
                { id: `${i}CandleWickColor`, title: _ }
              ),
              (0, l.createTransparencyPropertyDefinition)(
                { transparency: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.transparency, v.format({ title: n })) },
          ...
          return {
            definitions: [
              (0, l.createNumberPropertyDefinition)(
                ...
                { id: `${i}AvgHL`, title: S, type: 0, min: new s.WatchedValue(1), max: new s.WatchedValue(5e4), step: new s.WatchedValue(1) }
              ),
              (0, l.createNumberPropertyDefinition)(
                { value: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.variance, T.format({ title: n })) },
                { id: `${i}Variance`, title: b, type: 0, min: new s.WatchedValue(1), max: new s.WatchedValue(100), step: new s.WatchedValue(1) }
              ),
            ],
          };
        }
    ...
    55252: (e, t, i) => {
      ...
      class h extends a.LineDataSourceDefinitionsViewModel {
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createCoordinatesPropertyDefinition)({ y: i.property }, { id: (0, s.removeSpaces)(`${this._source.name()}Point`), title: u, ...i.info }),
            ],
          };
        }
        _textPropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, d.createTextStyleDefinition)(
                this._propertyApplier,
                { ...e, showText: e.showLabel, textColor: e.textcolor, fontSize: e.fontsize, textOrientation: e.textOrientation },
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
                { isEditable: !0, isMultiLine: !0, customTitles: { text: p } }
              ),
            ],
      ...
      class d extends r.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, l.createColorPropertyDefinition)(
                { color: (0, l.getColorDefinitionProperty)(this._propertyApplier, e.color, null, a.format({ title: i })) },
      ...
      class p extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.markerColor, null, c.format({ title: i })) },
    ...
    21905: (e, t, i) => {
      ...
      const d = new o.TranslatedString("change {title} extending left", n.t(null, void 0, i(3708))),
        ...
        u = new o.TranslatedString("change {title} background visibility", n.t(null, void 0, i(64548))),
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, s.createLineStyleDefinition)(
                this._propertyApplier,
                { showLine: e.showMidline, lineColor: e.midlinecolor, lineStyle: e.midlinestyle, lineWidth: e.midlinewidth },
                n,
                "MiddleLine",
                { line: w }
              ),
              (0, r.createCheckablePropertyDefinition)(
                { checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.extendLeft, d.format({ title: n })) },
                { id: `${i}ExtendLeft`, title: g }
              ),
              (0, r.createCheckablePropertyDefinition)(
                { checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.extendRight, p.format({ title: n })) },
                { id: `${i}ExtendRight`, title: T }
              ),
              (0, r.createColorPropertyDefinition)(
                {
                  checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.fillBackground, u.format({ title: n })),
                  color: (0, r.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, e.transparency, h.format({ title: n })),
                },
          ...
          return {
            definitions: [
              (0, a.createTextStyleDefinition)(
                ...
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
                { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: y, customTitles: { text: f } }
              ),
            ],
          };
        }
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createLineStyleDefinition)(
                this._propertyApplier,
                { lineColor: e.lineColor, lineWidth: e.lineWidth, lineStyle: e.lineStyle, leftEnd: e.leftEnd, rightEnd: e.rightEnd },
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
                "Line",
                { line: s }
              ),
    ...
    25107: (e, t, i) => {
      ...
      class f extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, l.createTextStyleDefinition)(this._propertyApplier, { textColor: e.textcolor, fontSize: e.fontsize, bold: e.bold, italic: e.italic }, i, {
                isEditable: !0,
                isMultiLine: !0,
                customTitles: { text: u },
              }),
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.color, lineWidth: e.linewidth }, i, "Line", { line: h }),
              (0, a.createColorPropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.fillBackground, d.format({ title: i })),
                  color: (0, a.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, e.transparency, p.format({ title: i })),
    ...
    63311: (e, t, i) => {
      ...
      class d extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, l.createTextStyleDefinition)(this._propertyApplier, { textColor: e.textcolor, fontSize: e.fontsize, bold: e.bold, italic: e.italic }, t, {
                isEditable: !0,
                isMultiLine: !0,
                customTitles: { text: a },
              }),
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.color, lineWidth: e.linewidth }, t, "Line", { line: c }),
            ],
          };
        }
      }
      ...
      class b extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          t.hasChild("extendLines") &&
            e.push(
              (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, i.extendLines, p.format({ title: b })) },
                { id: `${s}ExtendLines`, title: S }
              )
            );
          const m = i.median.childs(),
            C = (0, l.createLineStyleDefinition)(this._propertyApplier, { lineColor: m.color, lineStyle: m.linestyle, lineWidth: m.linewidth }, b, "Median", {
              line: w,
            });
          e.push(C);
          const L = this._source.levelsCount();
          for (let t = 0; t <= L; t++) {
            const n = i[`level${t}`].childs(),
              o = (0, a.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, n.visible, u.format({ title: b, index: t + 1 })),
                  color: (0, a.getColorDefinitionProperty)(this._propertyApplier, n.color, null, h.format({ title: b, index: t + 1 })),
                  width: (0, a.convertToDefinitionProperty)(this._propertyApplier, n.linewidth, y.format({ title: b, index: t + 1 })),
                  style: (0, a.convertToDefinitionProperty)(this._propertyApplier, n.linestyle, f.format({ title: b, index: t + 1 })),
                  level: (0, a.convertToDefinitionProperty)(this._propertyApplier, n.coeff, v.format({ title: b, index: t + 1 })),
                },
                { id: `${s}LineLevel${t + 1}` }
              );
            e.push(o);
          ...
          const k = (0, a.createTransparencyPropertyDefinition)(
            {
              checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, i.fillBackground, T.format({ title: b })),
              transparency: (0, a.convertToDefinitionProperty)(this._propertyApplier, i.transparency, D.format({ title: b })),
            },
    ...
    62890: (e, t, i) => {
      ...
      class h extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.linecolor, lineWidth: e.linewidth }, i, "Line", { line: p }),
              (0, s.createColorPropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.fillBackground, c.format({ title: i })),
                  color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, e.transparency, d.format({ title: i })),
    ...
    54440: (e, t, i) => {
      ...
      class k extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.linecolor, lineWidth: e.linewidth }, n, "Line"),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.sourceTextColor, null, c.format({ title: n })) },
                { id: `${i}SourceTextColor`, title: D }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.sourceBackColor, e.transparency, d.format({ title: n })) },
                { id: `${i}SourceBackgroundColor`, title: w }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.sourceStrokeColor, null, p.format({ title: n })) },
                { id: `${i}SourceBorderColor`, title: _ }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.targetTextColor, null, u.format({ title: n })) },
                { id: `${i}TargetTextColor`, title: P }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.targetBackColor, null, h.format({ title: n })) },
                { id: `${i}TargetBackgroundColor`, title: S }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.targetStrokeColor, null, y.format({ title: n })) },
                { id: `${i}TargetBorderColor`, title: b }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.successTextColor, null, f.format({ title: n })) },
                { id: `${i}SuccessTextColor`, title: m }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.successBackground, null, v.format({ title: n })) },
                { id: `${i}SuccessBackgroundColor`, title: C }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.failureTextColor, null, g.format({ title: n })) },
                { id: `${i}FailureTextColor`, title: L }
              ),
              (0, s.createColorPropertyDefinition)(
                { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.failureBackground, null, T.format({ title: n })) },
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            l = (0, s.createColorPropertyDefinition)(
              { color: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.lineColor, null, c.format({ title: n })) },
          ...
          return {
            definitions: [
              (0, s.createTwoColorsPropertyDefinition)(
                {
                  color1: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.color1, e.transparency, c.format({ title: i })),
                  color2: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.color2, e.transparency, d.format({ title: i })),
                },
                { id: (0, a.removeSpaces)(`${t}Background2Color`), title: u }
              ),
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.trendline.childs().color, lineWidth: e.linewidth }, i, "Line", {
                line: p,
              }),
            ],
          };
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            c = (0, s.createLineStyleDefinition)(
              this._propertyApplier,
              { showLine: a.showLine, lineColor: a.lineColor, lineWidth: a.lineWidth, lineStyle: a.lineStyle },
              i,
              t,
              { line: f }
            ),
          ...
          const v = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.extendRight, p.format({ title: i })) },
            { id: `${t}ExtendRight`, title: y }
          );
          n.definitions.push(v);
          const g = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.extendLeft, d.format({ title: i })) },
          ...
          return {
            definitions: [
              (0, c.createTextStyleDefinition)(
                ...
                new o.TranslatedString(this._source.name(), this._source.translatedType()),
                { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: v, customTitles: { text: u } }
              ),
            ],
          };
        }
      ...
      class I extends s.LineDataSourceDefinitionsViewModel {
        constructor(e, t) {
          ...
          (this._riskMaxWV = new d.WatchedValue(this._getRiskMax(n))),
            ...
            this._undoModel.model().mainSeries().dataEvents().symbolResolved().subscribe(this, this._onSymbolInfoChanged);
        }
        destroy() {
          super.destroy();
          const e = this._source.properties().childs();
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.linecolor, lineWidth: e.linewidth }, n, "Line", { line: C }),
              (0, a.createColorPropertyDefinition)(
                { color: (0, a.getColorDefinitionProperty)(this._propertyApplier, e.stopBackground, e.stopBackgroundTransparency, u.format({ title: n })) },
                { id: `${i}StopColor`, title: L }
              ),
              (0, a.createColorPropertyDefinition)(
                { color: (0, a.getColorDefinitionProperty)(this._propertyApplier, e.profitBackground, e.profitBackgroundTransparency, h.format({ title: n })) },
                { id: `${i}ProfitColor`, title: x }
              ),
              (0, l.createTextStyleDefinition)(this._propertyApplier, { textColor: e.textcolor, fontSize: e.fontsize }, n, {
                isEditable: !0,
                isMultiLine: !0,
                customTitles: { text: k },
              }),
              (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.showPriceLabels, y.format({ title: n })) },
              ...
              (0, a.createCheckablePropertyDefinition)(
                { checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.alwaysShowStats, v.format({ title: n })) },
        ...
        _inputsPropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            s = (0, a.createNumberPropertyDefinition)(
              ...
              { id: `${i}LotSize`, title: N, type: 1, min: new d.WatchedValue(1e-9), max: new d.WatchedValue(1e8), step: this._lotSizeStepWV }
            ),
            c = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.risk, D.format({ title: n }), [(e) => parseFloat(e)]),
                unitOptionsValue: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.riskDisplayMode, w.format({ title: n })),
              },
              {
                id: `${i}Risk`,
                title: R,
            ...
            y = (0, a.createNumberPropertyDefinition)(
              ...
              { id: `${i}ProfitLevelTicks`, title: V, type: 0, min: new d.WatchedValue(0), max: new d.WatchedValue(1e9), step: new d.WatchedValue(1) }
            ),
            f = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.targetPrice, S.format({ title: n }), [
                  (e) => e,
                  (e) => this._source.prepareProfitPrice(e),
                ]),
              },
            ...
            C = (0, a.createNumberPropertyDefinition)(
              { value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.stopLevel, b.format({ title: n })) },
              { id: `${i}StopLevelTicks`, title: V, type: 0, min: new d.WatchedValue(0), max: new d.WatchedValue(1e9), step: new d.WatchedValue(1) }
            ),
            L = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.stopPrice, m.format({ title: n }), [
                  (e) => e,
        ...
        _coordinatesPropertyDefinitions() {
          const e = this._source.pointsProperty().childs().points[0].childs(),
            ...
            n = {
              ...
              info: { typeY: 1, stepY: new l.WatchedValue(1), minY: new l.WatchedValue(-100), maxY: new l.WatchedValue(100) },
            };
          return {
            definitions: [
          ...
          return {
            definitions: [
              (0, s.createEmojiPropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.showImage, u.format({ title: i })),
                  backgroundColor: (0, s.getColorDefinitionProperty)(this._propertyApplier, e.plateColor, null, h.format({ title: i })),
    ...
    81888: (e, t, i) => {
      ...
      class h extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createLineStyleDefinition)(this._propertyApplier, { lineColor: e.linecolor, lineWidth: e.linewidth, lineStyle: e.linestyle }, i, "Line", {
                line: p,
              }),
              (0, s.createColorPropertyDefinition)(
                {
      ...
      class y extends l.LineDataSourceDefinitionsViewModel {
        _coordinatesPropertyDefinitions() {
          ...
          const o = (0, r.createNumberPropertyDefinition)(
            ...
            { id: "TrendLineAngleCoordinate", title: p, min: new s.WatchedValue(-360), max: new s.WatchedValue(360), step: new s.WatchedValue(1) }
          );
        ...
        _stylePropertyDefinitions() {
          ...
          for (let i = 1; i <= A; i++) {
            const o = (0, n.ensureDefined)(t.child(`level${i}`)).childs(),
              r = (0, s.createLeveledLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, o.visible, h.format({ title: L, index: i })),
          ...
          const $ = (0, s.createTransparencyPropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.fillBackground, D.format({ title: L })),
              transparency: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.transparency, w.format({ title: L })),
            },
          ...
          const M = (0, s.createTwoOptionsPropertyDefinition)(
            {
              ...
              option1: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.horzLabelsAlign, P.format({ title: L })),
              option2: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.vertLabelsAlign, P.format({ title: L })),
            },
            {
              id: `${a}Labels`,
              title: C,
    ...
    71472: (e, t, i) => {
      ...
      class h extends c.LineDataSourceDefinitionsViewModel {
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return {
            definitions: [
              (0, r.createCoordinatesPropertyDefinition)({ x: t.property }, { id: (0, a.removeSpaces)(`${this._source.name()}Point1`), title: u, ...t.info }),
            ],
          };
        }
        _textPropertyDefinitions() {
    ...
    59973: (e, t, i) => {
      ...
      const c = new o.TranslatedString("change {title} VWAP line color", n.t(null, void 0, i(98057))),
        ...
        b = new o.TranslatedString("change {title} lower band #3 line color", n.t(null, void 0, i(95016))),
        m = new o.TranslatedString("change {title} lower band #3 line width", n.t(null, void 0, i(44693))),
      ...
      function O(e, t, i, n, o, l, s, c, d) {
        return (0, r.createLinePropertyDefinition)(
          {
            checked: (0, r.convertToDefinitionProperty)(e, new a.StudyPlotVisibleProperty(t.display), i.format({ title: d })),
        ...
        _stylePropertyDefinitions() {
          ...
          const U = this._source.properties().childs(),
            ...
            Y = [
              (0, r.createLinePropertyDefinition)(
                {
                  color: (0, r.getColorDefinitionProperty)(this._propertyApplier, j.color, j.transparency, c.format({ title: H })),
          ...
          if (null == X ? void 0 : X.area) {
            const e = U.areaBackground.childs(),
              t = (0, r.createLinePropertyDefinition)(
                {
                  checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.fillBackground, k.format({ title: H })),
                  color: (0, r.getColorDefinitionProperty)(this._propertyApplier, e.backgroundColor, e.transparency, A.format({ title: H })),
                },
          ...
          const q = (0, r.createCheckablePropertyDefinition)(
            { checked: (0, r.convertToDefinitionProperty)(this._propertyApplier, U.axisLabelVisible, V.format({ title: H })) },
    ...
    69152: (e, t, i) => {
      i.d(t, { CollectibleColorPropertyDirectWrapper: () => s, CollectibleColorPropertyUndoWrapper: () => l });
      var n = i(50151),
        o = i(88640);
      class r extends o.default {
        ...
        unsubscribe(e, t) {
          ...
          const o = (0, n.ensureDefined)(
            null === (i = this._listenersMappers.find((i) => i.obj === e && i.method === t)) || void 0 === i ? void 0 : i.callback
          );
