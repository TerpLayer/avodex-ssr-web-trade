  ...
  [5128],
  {
                ...
                (i = [].concat(t(i), [d])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(n.target) &&
                        ((o && 0 === o.scrollTop && 0 < i) || ((s = o) && s.scrollHeight - s.scrollTop <= s.clientHeight && i < 0)
                          ? h(n)
                          : n.stopPropagation()));
                  }),
            ...
            (e.enableBodyScroll = function (e) {
              if (s) {
                ...
                (e.ontouchstart = null),
                  ...
                  r && 0 === i.length && (document.removeEventListener("touchmove", h, n ? { passive: !1 } : void 0), (r = !1));
              } else
    ...
    70673: (e, t, n) => {
      ...
      function u(e) {
        ...
        return o.createElement(
          ...
          o.createElement("span", { className: t }, o.createElement(r.Icon, { icon: a, className: c().icon }))
        );
      }
    },
    26996: (e, t, n) => {
    ...
    10772: (e, t, n) => {
      ...
      function v(e) {
        ...
        return o.createElement(m.ContextMenuItem, {
          size: t,
          jsxLabel: o.createElement("div", { className: h()(p.loaderWrap, p[t]) }, o.createElement(d.Loader, { className: p.loader })),
          noInteractive: !0,
        ...
        render() {
          ...
          return o.createElement(
            ...
            o.createElement(
              ...
              g &&
                void 0 !== a &&
                o.createElement("td", null, o.createElement(c.FavoriteButton, { className: l.favourite, isFilled: a, onClick: this.props.onFavouriteClick })),
              o.createElement("td", { className: s(l.iconCell), "data-icon-cell": !0 }, this._icon(l)),
              o.createElement(
                "td",
                ...
                o.createElement(
                  ...
                  o.createElement(
                    ...
                    !E && f ? f.map(({ text: e, ...t }, n) => o.createElement("span", { key: n, style: t }, e)) : null != E ? E : p
                  ),
                  this._toolbox(l),
                  e && o.createElement("span", { className: l.arrowIcon, dangerouslySetInnerHTML: { __html: v }, "data-submenu-arrow": !0 }),
                  !e && t && !r.CheckMobile.any() && o.createElement(u.Hint, { className: s(i && l.invisibleHotkey), text: t }),
                  !e && !t && n && o.createElement(u.Hint, { text: n })
                )
              )
            ),
            o.createElement("tr", { className: l.subMenu }, o.createElement("td", null, this.props.children))
          );
        }
        _icon(e) {
          if (this.props.checkable) {
            if (this.props.checkboxInput) return o.createElement(i.CheckboxInput, { className: s(e.icon, e.checkboxInput), checked: this.props.checked });
    ...
    91561: (e, t, n) => {
      ...
      function g(e) {
        ...
        return (
          ...
          o.createElement(
            ...
            c && o.createElement(b.Drawer, { onClose: u }, o.createElement(x, { items: s.subItems, parentAction: n, closeNested: u }))
          )
        );
        function u(e) {
      ...
      function x(e) {
        const { items: t, parentAction: n, closeNested: s } = e,
          i = !Boolean(n) && t.every((e) => !Boolean("separator" !== e.type && (e.getState().icon || e.getState().checkable)));
        return o.createElement(
      ...
      class M extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleFocus = (e) => {
              this.props.isKeyboardEvent && e.target && _.PLATFORM_ACCESSIBILITY_ENABLED && (0, C.focusFirstMenuItem)(e.target);
            }),
            (this.state = {});
        }
        render() {
          const { isOpened: e, onClose: t, items: n, doNotCloseOn: s, menuStatName: r, parentStatName: m, takeFocus: p, ...v } = this.props;
          return e
            ? o.createElement(
                h.DrawerManager,
                null,
                ...
                o.createElement(d.MatchMedia, { rule: "screen and (max-width: 430px)" }, (t) =>
                  this._isDrawer(t)
                    ? o.createElement(
                        ...
                        o.createElement(
                          b.Drawer,
                          { onClose: this._handleClose, position: "Bottom", "data-name": v["data-name"] },
    ...
    23829: (e, t, n) => {
      ...
      function p(e) {
        const {
          ...
          D = !!k.length;
        return s
          ? o.createElement("li", { className: i()(t, m.item, m.loading, m[N]) }, o.createElement(a.Loader, null))
          : o.createElement(
              "li",
              { className: i()(t, m.item, m.interactive, n && m.title, E && m.disabled, p && m.hovered, v && m.active, L && m.emptyIcons, m[N]), onClick: I },
              ...
              o.createElement(
                "span",
                { className: i()(m.label) },
                !S && _ ? _.map(({ text: e, ...t }, n) => o.createElement("span", { key: n, style: t }, e)) : null != S ? S : C
              ),
              !!y &&
                o.createElement(r.Icon, {
                  onClick: function () {
    ...
    96040: (e, t, n) => {
      ...
      var o = n(11542),
        ...
        l = n(27306);
      function c(e) {
        const { className: t, isActive: c, onClick: u, onMouseDown: h, title: d, hidden: m, "data-name": p = "remove-button", ...v } = e;
        return s.createElement(r.Icon, {
          ...v,
          "data-name": p,
