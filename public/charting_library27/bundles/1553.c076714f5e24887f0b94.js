  ...
  [1553],
  {
    11553: (t, e, i) => {
      ...
      !(function (r, s, o, a) {
              ...
              (e.timeStamp = f()),
                ...
                (function (t, e) {
                  ...
                  (1 !== e.eventType && 4 !== s.eventType) ||
                    ((r = t.prevDelta = { x: s.deltaX || 0, y: s.deltaY || 0 }), (n = t.offsetDelta = { x: i.x, y: i.y }));
        ...
        E(tt, H, {
          handler: function (t) {
            ...
            1 & e && 0 === t.button && (this.pressed = !0),
              2 & e && 1 !== t.which && (e = 4),
              this.pressed &&
                (4 & e && (this.pressed = !1), this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: k, srcEvent: t }));
          },
        });
        ...
        r.MSPointerEvent && !r.PointerEvent && ((nt = "MSPointerDown"), (rt = "MSPointerMove MSPointerUp MSPointerCancel")),
          E(st, H, {
            handler: function (t) {
              var e = this.store,
                i = !1,
              ...
              1 & r && (0 === t.button || o) ? a < 0 && (e.push(t), (a = e.length - 1)) : 12 & r && (i = !0),
                a < 0 || ((e[a] = t), this.callback(this.manager, r, { pointers: e, changedPointers: [t], pointerType: s, srcEvent: t }), i && e.splice(a, 1));
            },
          });
