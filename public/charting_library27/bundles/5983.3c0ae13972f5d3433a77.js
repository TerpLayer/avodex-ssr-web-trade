(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5983],
  {
    ...
    10047: (e) => {
      e.exports = { underline: "underline-Pun8HxCz", center: "center-Pun8HxCz", corner: "corner-Pun8HxCz", disabled: "disabled-Pun8HxCz" };
    },
    56073: (e, t, n) => {
      "use strict";
      function i(e, t = !1) {
    ...
    75983: (e, t, n) => {
      ...
      var o = n(67842),
        ...
        m = n(53017);
      function b(e) {
        const { itemsList: t, getItemId: n, calcVisibleAndHiddenItems: i, shouldKeepItemVisible: l, onMeasureCallback: s, forceUpdate: r = !1 } = e,
          [b, h] = (0, u.useRefsMap)(),
          v = (0, a.useRef)(null),
        ...
        return (
          (0, d.useIsomorphicLayoutEffect)(() => {
            (!r && !Y.current && f(E.current, t) && f(k, H.current)) || (w(), (Y.current = !1), (E.current = t), (H.current = k));
          }, [t, w, k, r]),
          {
      ...
      function h(e, t, n, l = i.EndFirst) {
        const s = (0, a.useCallback)(
          (n, a) => {
            ...
            return (function ({ items: e, containerWidth: t, elementsWidths: n, menuItemWidth: a, keepVisible: l, direction: s }) {
              const r = [...e],
                o = [],
                c = [];
              let u = 0;
              ...
              if (((u = l.map((e) => d[e]).reduce((e, t) => e + t, 0) + a), s === i.EndFirst))
                for (let e = 0; e < r.length; e++) l.includes(e) ? o.push(r[e]) : ((u += d[e]), u <= t ? o.push(r[e]) : c.push(r[e]));
              else for (let e = r.length - 1; e >= 0; e--) l.includes(e) ? o.unshift(r[e]) : ((u += d[e]), u <= t ? o.unshift(r[e]) : c.unshift(r[e]));
              return { visible: o, hidden: c };
            })({ items: e, containerWidth: n.containerWidth, elementsWidths: s, menuItemWidth: n.moreButtonWidth, keepVisible: a, direction: l });
          },
          [e]
        );
        return b({ itemsList: e, getItemId: t, calcVisibleAndHiddenItems: s, shouldKeepItemVisible: n });
      }
      var v,
        g = n(38528),
        p = n(47201),
      ...
      function w(e, t = "horizontal", n, i, a) {
        return { id: e, role: "tablist", "aria-orientation": t, "aria-label": a, "aria-labelledby": i, "aria-disabled": n };
      }
      function x(e, t, n, i, a) {
        return { id: e, role: "tab", tabIndex: t ? 0 : -1, disabled: a, "aria-selected": n, "aria-controls": i, "aria-disabled": a };
      }
      !(function (e) {
        ...
        return (
          ...
          "automatic" === t
            ? (function (e) {
                ...
                return (0, A.useKeyboardEventHandler)([(0, S.useItemsKeyboardNavigation)(c, t, n, l, u, !0)], i);
              })(e)
            : (function (e) {
                const { isRtl: t, items: n, preventDefaultIfHandled: i = !0, isHighlighted: l, onHighlight: s, onActivate: r, orientation: o } = e,
                  c = n.find(l),
                  u = (0, a.useCallback)(() => {
                    void 0 !== c && r(c);
                  }, [c, r]),
      ...
      function E(e) {
        ...
        const {
          ...
          S = (0, a.useRef)(null !== (n = null === (t = e.itemsRefs) || void 0 === t ? void 0 : t.current) && void 0 !== n ? n : new Map()),
          [I, E] = (0, a.useState)(),
          [Y, H] = (0, z.useFocus)(),
          W = l.find(f),
          ...
          X = (0, a.useCallback)(
            (e, t) => {
              o || e.disabled || (E(e), "number" == typeof t ? (clearTimeout(M.current), (M.current = setTimeout(() => O(e), t))) : O(e));
            },
            [o, E, O]
          ),
          F = (0, a.useCallback)(
        ...
        const [K, L] = (0, R.useKeepActiveItemIntoView)({ ...b, activeItem: null != I ? I : W, getKey: (0, a.useCallback)((e) => e.id, []) }),
          j = (0, a.useCallback)(
            (e, t) => {
          ...
          q = l.map((e) => {
            ...
            const i = T(e),
              a = f(e),
              l = null !== (n = null !== (t = e.disabled) && void 0 !== t ? t : o) && void 0 !== n && n,
              s = !l && (Y ? i : a);
            return { ...x(e.id, s, a, e.tabpanelId, l), highlighted: i, active: a, handleItemRef: j };
          });
        var J;
        return {
          tabsBindings: q,
      ...
      const M = (0, a.forwardRef)((e, t) => {
        ...
        return a.createElement(
          "button",
          { ...b, ref: t, className: O({ size: n, active: l, fake: r, enableActiveStateStyles: c, hideFocusOutline: u, equalTabSize: d, className: o }) },
          d && "string" == typeof m ? a.createElement("span", { className: s()(T["ellipsis-children"], "apply-overflow-tooltip") }, m) : m
        );
      });
      M.displayName = "UnderlineTabsBaseButton";
      const X = (0, a.forwardRef)((e, t) => {
        const { item: n, highlighted: i, handleItemRef: l, onClick: s, "aria-disabled": r, ...o } = e,
          c = (0, a.useCallback)(() => {
            s && s(n);
          }, [s, n]),
          u = (0, a.useCallback)(
            (e) => {
              l && l(n, e), t && "object" == typeof t ? (t.current = e) : "function" == typeof t && t(e);
            },
            [n, l, t]
          );
      ...
      function $(e) {
        ...
        return a.createElement(D.Icon, { icon: V(t), className: l(J["arrow-icon"], J[`size-${t}`], n && J.dropped) });
      }
      var U = n(45015);
      function Z(e) {
        const {
          ...
          C = (function (e, t) {
            ...
            return (
              (0, a.useEffect)(() => {
                ...
                n.current = { xsmall: G(e, "xsmall"), small: G(e, "small"), medium: G(e, "medium"), large: G(e, "large"), xlarge: G(e, "xlarge") };
              }, [t]),
              (0, a.useCallback)(() => {
                const i = (0, y.ensureNotNull)(t.current).getBoundingClientRect(),
                  a = n.current[e];
                return { x: i.left, y: i.top + i.height + a + 4, indentFromWindow: { top: 4, bottom: 4, left: 4, right: 4 } };
              }, [t, e])
            );
          })(t, v);
        return a.createElement(P.PopupMenuDisclosureView, {
          ...
          button: a.createElement(
            M,
            { "aria-hidden": !0, disabled: n, active: i, onClick: b, ref: p, tabIndex: -1, enableActiveStateStyles: l, hideFocusOutline: s, fake: r },
            c,
      ...
      function oe(e) {
        ...
        return a.createElement(
          "div",
          { className: l(re().underline, t && re().disabled), style: { transform: `translateX(${n}px) scaleX(${i})` } },
          a.createElement("div", { className: re().corner, style: { transform: `scaleX(${1 / i})` } }),
          a.createElement("div", { className: re().center, style: { transform: `scaleX(${1 - 30 / e.scale})` } }),
          a.createElement("div", { className: re().corner, style: { transform: `scaleX(${1 / i})` } })
        );
      }
      function ce(e) {
        const {
          ...
          T = "none" === I && A,
          O = null != w ? w : !S,
          { visibleItems: M, hiddenItems: F, containerRefCallback: P, innerContainerRefCallback: D, moreButtonRef: K, setItemRef: L } = h(i, N, b),
          j = "collapse" === I ? M : i,
          q = "collapse" === I ? F : [],
          J = (0, a.useCallback)((e) => q.includes(e), [q]),
          V = (0, a.useRef)(new Map()),
          { isOpened: $, open: U, close: G, onButtonClick: Q } = (0, C.useDisclosure)({ id: t, disabled: c }),
          {
            tabsBindings: se,
            tablistBinding: re,
        ...
        return a.createElement(
          ...
          a.createElement(
            "div",
            { ...ce, className: ne({ size: d, overflowBehaviour: I, className: f }), style: v, "data-name": R },
            a.createElement(
              "div",
              { ...re, className: s()(te["underline-tabs"], { [te["make-grid-column"]]: W || T, [te["stretch-tabs"]]: W, [te["equal-tab-size"]]: T }) },
              j.map((e) =>
                a.createElement(X, {
                  ...ve(e),
                  key: e.id,
      ...
      (0, a.forwardRef)((e, t) => {
        ...
        const i = (0, a.useContext)(H),
          ...
          C = (0, a.useCallback)(
            (e) => {
              o && o(s, e), t && "object" == typeof t ? (t.current = e) : "function" == typeof t && t(e);
            },
            [s, o, t]
          ),
        ...
        return a.createElement(
          k,
          {
            ...
            rel: s.rel,
            target: s.target,
            className: O({ size: i, active: u, fake: d, enableActiveStateStyles: b, anchor: !0, hideFocusOutline: f, className: m }),
          },
          s.label
        );
