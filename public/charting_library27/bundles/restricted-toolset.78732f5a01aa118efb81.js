(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5516, 9685],
  {
      ...
      (a = [t]),
        (n = function (e) {
          ...
          var i = "undefined" != typeof window && window.navigator && window.navigator.platform && /iP(ad|hone|od)/.test(window.navigator.platform),
            ...
            u = function () {
              setTimeout(function () {
                void 0 !== c && ((document.body.style.paddingRight = c), (c = void 0)), void 0 !== r && ((document.body.style.overflow = r), (r = void 0));
              });
            };
                ...
                (o = [].concat(t(o), [u])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !h(n.target) &&
                        ((a && 0 === a.scrollTop && 0 < o) || ((i = a) && i.scrollHeight - i.scrollTop <= i.clientHeight && o < 0)
                          ? d(n)
                          : n.stopPropagation()));
                  }),
            ...
            (e.enableBodyScroll = function (e) {
              if (i) {
                ...
                (e.ontouchstart = null),
                  ...
                  s && 0 === o.length && (document.removeEventListener("touchmove", d, n ? { passive: !1 } : void 0), (s = !1));
              } else
    ...
    33963: (e) => {
      e.exports = { item: "item-zwyEh4hn", label: "label-zwyEh4hn", labelRow: "labelRow-zwyEh4hn", toolbox: "toolbox-zwyEh4hn" };
    },
    92910: (e) => {
      e.exports = { separator: "separator-QjUlCDId", small: "small-QjUlCDId", normal: "normal-QjUlCDId", large: "large-QjUlCDId" };
    },
    27306: (e) => {
      e.exports = {
    ...
    24437: (e, t, n) => {
      ...
      var a = n(88803);
      const i = { SmallHeight: a["small-height-breakpoint"], TabletSmall: a["tablet-small-breakpoint"], TabletNormal: a["tablet-normal-breakpoint"] };
    },
    39362: (e, t, n) => {
      "use strict";
    ...
    51613: (e, t, n) => {
      ...
      function l(e) {
        ...
        return a.createElement("div", {
          className: o()(s.separator, "small" === t && s.small, "normal" === t && s.normal, "large" === t && s.large, n),
          role: "separator",
          "aria-hidden": i,
        });
      }
    ...
    96040: (e, t, n) => {
      ...
      var a = n(11542),
        ...
        r = n(27306);
      function c(e) {
        const { className: t, isActive: c, onClick: h, onMouseDown: d, title: u, hidden: v, "data-name": m = "remove-button", ...p } = e;
        return i.createElement(s.Icon, {
          ...p,
          "data-name": m,
    ...
    27363: (e) => {
      e.exports = { customTradingViewStyleButton: "customTradingViewStyleButton-zigjK1n2", withoutIcon: "withoutIcon-zigjK1n2" };
    },
    75352: (e) => {
      e.exports = {
    ...
    867: (e) => {
      e.exports = { smallWidthMenuItem: "smallWidthMenuItem-RmqZNwwp", menuItem: "menuItem-RmqZNwwp", remove: "remove-RmqZNwwp" };
    },
    80022: (e) => {
      e.exports = {
    ...
    25882: (e) => {
      e.exports = { button: "button-cq__ntSC", smallLeftPadding: "smallLeftPadding-cq__ntSC", text: "text-cq__ntSC", uppercase: "uppercase-cq__ntSC" };
    },
    92710: (e) => {
          ...
          const n = (t) => {
            ...
            null !== n &&
              ...
              ((0, i.isKeyboardClick)(t) ||
                (n.contains(document.activeElement) && "INPUT" !== document.activeElement.tagName && document.activeElement.blur()));
          };
    ...
    81351: (e, t, n) => {
      ...
      function d(e) {
        ...
        return a.createElement(c.PopupMenuItem, {
          ...n,
          className: o()(r.PLATFORM_ACCESSIBILITY_ENABLED && h.accessible, e.isActive && h.active, t),
          reference: i,
          tabIndex: d,
    ...
    76197: (e, t, n) => {
      ...
      const r = (0, a.forwardRef)(function (e, t) {
        const { open: n, summary: i, children: r, onStateChange: c, tabIndex: h, className: d, ...u } = e;
        return a.createElement(
          a.Fragment,
          null,
          a.createElement(
    ...
    12165: (e, t, n) => {
      ...
      function h(e) {
        ...
        return l.PLATFORM_ACCESSIBILITY_ENABLED
          ? a.createElement(
              "button",
              { ref: h, tabIndex: d, onClick: n, className: o()(c.button, i.isActive && c.active), type: "button" },
    ...
    69297: (e, t, n) => {
      ...
      function c(e) {
        const t = (0, a.useContext)(s.CustomBehaviourContext),
          { className: n, intent: o = "default", size: l = "small", enableActiveStateStyles: c = t.enableActiveStateStyles } = e;
        return i(n, r().switcher, r()[`size-${l}`], r()[`intent-${o}`], !c && r()["disable-active-state-styles"]);
      }
      function h(e) {
        var t;
        const { reference: n, size: i, intent: o, role: s, "aria-checked": l, checked: h, defaultChecked: d, onKeyDown: u, ...v } = e,
          m = (0, a.useCallback)(
            (e) => {
        ...
        return a.createElement(
          "label",
          {
            ...
            onKeyDown: function (e) {
              ...
              (13 !== t && 32 !== t) || (e.preventDefault(), y.current instanceof HTMLElement && y.current.click());
            },
            tabIndex: w,
    ...
    2464: (e, t, n) => {
      ...
      class C extends i.PureComponent {
        ...
        render() {
          const { className: e, icon: t, hint: n, text: a, isDisabled: o, isActive: s, isFirst: l, isLast: r, onClick: c, onClickArg: h, ...d } = this.props;
      ...
      function x(e) {
        ...
        return i.createElement("div", {
          ...
          onKeyDown: (0, M.createSafeMulticastEventHandler)(function (e) {
            ...
            Array.from(i.querySelectorAll('[role="radio"]:not([disabled]):not([aria-disabled])')).filter((0, k.createScopedVisibleElementFilter)(i))).sort(
      ...
      class D extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (0, w.validateRegistry)(t, { chartWidgetCollection: o.any.isRequired, favoriteChartStylesService: o.any.isRequired });
        ...
        render() {
          ...
          return i.createElement(_.MatchMedia, { rule: f.DialogBreakpoints.TabletSmall }, (e) => {
            const t = s.map((t, n) => (t === H ? i.createElement(S.PopupMenuSeparator, { key: `separator-${n}` }) : this._renderPopupMenuItem(t, t === a, e)));
            return i.createElement(
              ...
              i.createElement(
                ...
                {
                  arrow: Boolean(m),
                  content: m ? void 0 : i.createElement(p, null, i.createElement(h.Icon, { icon: c.SERIES_ICONS[a] })),
        ...
        _renderPopupMenuItem(e, t, n) {
          ...
          return i.createElement(A.AccessibleMenuItem, {
            ...
            toolbox: a && i.createElement(R.MenuFavoriteButton, { isActive: t, isFilled: o, onClick: () => this._handleClickFavorite(e) }),
            "data-value": r.STYLE_SHORT_NAMES[e],
          });
        }
      ...
      const z = ["medium", "small"],
        V = (0, i.forwardRef)(function (e, t) {
          const { text: n, className: a, displayMode: o, collapseWhen: s = z, ...l } = e,
            r = !s.includes(o);
          return i.createElement(U.ToolWidgetButton, { ...l, ref: t, text: r ? n : void 0, className: u(a, W.button, r ? W.withText : W.withoutText) });
        });
      function Z(e) {
        const { tooltip: t, ...n } = e,
          ...
          super(e, t),
            ...
            (this._handleClick = (e) => {
              ...
              (0, K.trackEvent)("GUI", "Chart Header Toolbar", "compare"),
                null === (t = this._compareDialogRenderer) || void 0 === t || t.show({ shouldReturnFocus: (0, Q.isKeyboardClick)(e) });
            }),
      ...
      var G = n(48889),
        ...
        J = n(97268),
        ee = n(57047);
      const te = (0, X.hotKeySerialize)({ keys: [(0, $.humanReadableModifiers)($.Modifiers.Shift, !1), "F"], text: "{0} + {1}" }),
      ...
      function he(e) {
        ...
        return (
              ...
              (0, re.studyMetaInfoRepository)()
                ...
                .then((e) => {
                  ...
                  for (const n of e)
                    !n.is_hidden_study &&
                      i.has(n.id) &&
                      t.set(n.id, { name: n.description, localizedName: n.description_localized, studyMarketShittyObject: n });
                  return t;
                })
                .then((e) => {
          ...
          Promise.all(t).then((e) => (ce.logNormal("Requesting favorites info finished"), e.reduce((e, t) => e.concat(t), [])))
        );
      }
      var de = n(92249),
        ue = n(88348),
      ...
      function pe(e) {
        const { className: t } = e;
        return i.createElement("div", { className: v()(me.spinnerWrap, t) }, i.createElement(ve.Loader, null));
      }
      var ge = n(82962),
        be = n(76422),
        Ce = n(39681),
      ...
      class ye extends i.PureComponent {
          ...
          super(e, t),
            ...
            (this._handleClick = (e) => {
              ...
              this.setState({ isActive: !0 }, () => {
                t.visible().value() ? t.hide() : t.show({ shouldReturnFocus: (0, Q.isKeyboardClick)(e) });
              }),
                this._trackClick();
            }),
            (this._handleSelectIndicator = (e) => {
              (e = (0, oe.ensureDefined)(e)), this._trackFavoriteAction("Favorite indicator from toolbar");
            ...
            (0, w.validateRegistry)(t, { favoriteScriptsModel: o.any, chartWidgetCollection: o.any.isRequired });
          const { favoriteScriptsModel: n } = t,
            a = void 0 !== n ? n.favorites() : [];
          this.state = { isActive: !1, isLoading: !1, favorites: a, favoriteFundamentals: void 0, infos: [] };
        }
        componentDidMount() {
          ...
          e.visible().subscribe(this._setActiveState),
            void 0 !== t &&
              (t.favoritesChanged().subscribe(this, this._handleFavoriteIndicatorsChange), n.activeChartWidget.subscribe(this._handleChangeActiveWidget)),
        ...
        componentWillUnmount() {
          ...
          e.visible().unsubscribe(this._setActiveState),
            void 0 !== t &&
              (t.favoritesChanged().unsubscribe(this, this._handleFavoriteIndicatorsChange), n.activeChartWidget.unsubscribe(this._handleChangeActiveWidget)),
                ...
                i.createElement(_.MatchMedia, { rule: "screen and (max-width: 430px)" }, (e) =>
                  i.createElement(
                    ...
                    i.createElement(
                      ...
                      i.createElement(ge.ToolWidgetMenuSummary, { className: e && Se.smallWidthTitle }, s.t(null, void 0, n(83127))),
                          ...
                          this.state.infos.length > 0
                            ? this.state.infos.map((t) =>
                                i.createElement(A.AccessibleMenuItem, {
                                  ...
                                  onClickArg: t.item,
                                  label: i.createElement("span", { className: v()(!e && Se.label, e && Se.smallWidthLabel, "apply-overflow-tooltip") }, we(t)),
                                })
                              )
                            : null !== this._promise && i.createElement(se.PopupMenuItem, { isDisabled: !0, label: s.t(null, void 0, n(23687)) })
                        )
                    )
                  )
                )
        ...
        _mapFundamentalToFavoriteItemInfo(e) {
          return {
            ...
            info: { name: e.scriptName, localizedName: getLocalizedFundamentalsName(e), studyMarketShittyObject: void 0 },
          };
        }
      }
      function we(e) {
      ...
      var Ee = n(94025),
        Te = n(20371);
      function Me(e) {
        return i.createElement("div", { className: u(Te.value, { [Te.selected]: e.isSelected }) }, e.value, e.metric);
      }
      var Ie = n(65817),
        ke = n(67972);
      function xe(e) {
      ...
      class Re extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            "div",
            { className: ke.form },
            i.createElement(Ae, { className: ke.input, maxLength: 7, onChange: this._handleChangeInput, value: e }),
            i.createElement(
              d.ToolbarMenuButton,
              {
                orientation: "none",
                ...
                className: ke.menu,
                ref: this._menu,
                content: i.createElement("div", { className: ke.menuLabel }, Ie.INTERVALS.find((e) => e.name === a).label),
              },
              Ie.INTERVALS.map((e) =>
                i.createElement(A.AccessibleMenuItem, { dontClosePopup: !0, key: e.name, label: e.label, onClick: this._handleSelectTime, onClickArg: e.name })
              )
            ),
            i.createElement(xe, { className: ke.add, onClick: this._handleClickAdd }, s.t(null, void 0, n(54777)))
          );
        }
      }
      var Le = n(90186),
            ...
            i.createElement(A.AccessibleMenuItem, {
              ...
              toolbox: (function () {
                const { isRemovable: t, isFavoritingAllowed: n } = e,
                  l = i.createElement(Oe.MenuRemoveButton, { key: "remove", isActive: a, hidden: !Fe.touch && !m, onClick: g, className: He.remove }),
                  r = i.createElement(R.MenuFavoriteButton, { key: "favorite", isActive: a, isFilled: s, onClick: b });
                return [t && l, !o && n && r];
              })(),
      ...
      function Qe(e) {
        ...
        return i.createElement(Ze.CollapsibleSection, {
          ...
          onKeyDown: function (e) {
            ...
            (13 !== t && 32 !== t) || (e.preventDefault(), a.current instanceof HTMLElement && a.current.click());
          },
        });
      }
      var je = n(80022);
      const qe = { openDialog: s.t(null, void 0, n(79353)), timeInterval: s.t(null, void 0, n(32916)) },
      ...
      class Je extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleChangeInterval = (e) => {
              const { activeInterval: t, lastNotQuicked: n } = this.state,
                a = this._getQuicks();
              this.setState({ activeInterval: (0, Ee.normalizeIntervalString)(e), lastNotQuicked: void 0 === t || a.includes(t) ? n : t });
            }),
            ...
            (this._handleClickFavorite = (e) => {
              (e = (0, oe.ensureDefined)(e)), this._isIntervalFavorite(e) ? this._handleRemoveFavorite(e) : this._handleAddFavorite(e);
            }),
            ...
            (this._handleRemoveInterval = (e, t) => {
              ...
              if (e) {
                if (k.PLATFORM_ACCESSIBILITY_ENABLED && t && (0, Q.isKeyboardClick)(t) && this._menuItemsContainerRef.current) {
          ...
          const { chartApiInstance: n, favoriteIntervalsService: s, intervalService: r, intervalsMenuViewStateService: c } = t;
          ...
          const h = l.linking.interval.value(),
            ...
            m = c.get();
          (this._defaultIntervals = n.defaultResolutions().filter(Ee.isIntervalEnabled).map(Ee.normalizeIntervalString)),
            (this.state = { isOpenedFormMenu: !1, activeInterval: d, favorites: u, customs: v, menuViewState: m, isAddIntervalDialogOpened: !1 });
        }
        componentDidMount() {
          const { favoriteIntervalsService: e, intervalService: t, intervalsMenuViewStateService: n } = this.context;
        ...
        render() {
          const { isShownQuicks: e, id: t } = this.props,
            { activeInterval: n, customs: a, lastNotQuicked: o, isAddIntervalDialogOpened: s } = this.state,
            l = this._getQuicks(),
              ...
              i.createElement(
                ...
                r.map((e, t) => {
                  ...
                  return i.createElement(C, {
                    ...
                    text: i.createElement(Me, { value: a.mayOmitMultiplier ? void 0 : a.multiplier, metric: a.shortKind }),
                    hint: a.hint,
                    "aria-checked": n === e,
                    isActive: n === e,
                    isDisabled: !h[e],
                      ...
                      content:
                        c || null === m
                          ...
                          : i.createElement(
                              ...
                              i.createElement(Me, { value: m.mayOmitMultiplier ? void 0 : m.multiplier, metric: m.shortKind })
                            ),
                      hotKey: c ? Ye : void 0,
                      className: je.menu,
                      ref: this._menu,
        ...
        _createMenuItems(e, t) {
          ...
          return (function (e) {
            ...
            return e.filter((e, n, a) => {
              let i = !0;
              return e.type === S.PopupMenuSeparator && ((0 !== n && n !== a.length - 1) || (i = !1), t && (i = !1)), (t = e.type === S.PopupMenuSeparator), i;
            });
          })([].concat(...n));
        }
        _createIntervalForm(e) {
          if (this._customIntervals) {
            const t = e
              ? i.createElement(et, { key: "add-dialog", onClick: this._handleOpenAddIntervalDialog })
              : i.createElement(Re, {
                  key: "add-form",
                  onAdd: this._handleAddInterval,
        ...
        _renderResolutionsGroup(e, t = !1, n) {
          ...
          if (t) a.push(...o);
            ...
            const s = i.createElement(
              Qe,
              { key: e.id, className: je.section, summary: e.name, open: !n[e.id], onStateChange: this._getHandleSectionStateChange(e.id) },
              o
            );
            a.push(s);
          }
      ...
      function et(e) {
        ...
        return i.createElement("div", { key: "add-dialog", className: u(je.addCustomInterval, a), onClick: t }, s.t(null, void 0, n(95798)) + "…");
      }
      function tt(e) {
        const { children: t, title: n, className: a } = e;
        return i.createElement("div", { className: a }, i.createElement("div", { className: je.smallTabletSectionTitle }, n), t);
      }
      Je.contextType = Ge;
      var nt = n(23902),
        at = n(82436);
      ...
      class ot extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleClick = () => {
              const { chartWidgetCollection: e, windowMessageService: t, isFundamental: n } = this.context,
            ...
            (0, w.validateRegistry)(t, { isFundamental: o.any, chartWidgetCollection: o.any.isRequired, windowMessageService: o.any.isRequired });
        }
        render() {
          ...
          super(e, t),
            ...
            (this._handleClick = (e) => {
              ...
              (0, K.trackEvent)("GUI", "Chart Header Toolbar", "chart properties"),
                n.showGeneralChartProperties(void 0, { shouldReturnFocus: (0, Q.isKeyboardClick)(e) });
            }),
            (0, w.validateRegistry)(t, { chartWidgetCollection: o.any.isRequired }),
      ...
      function gt(e) {
        ...
        return i.createElement(
          ...
          a ? i.createElement(ve.Loader, { className: pt.loader, size: "small", staticPosition: !0 }) : s.t(null, void 0, n(85520))
        );
      }
      var bt = n(36296),
        Ct = n(63672),
      ...
      const _t = a.enabled("widget"),
        ...
        wt = (0, dt.mergeThemes)(se.DEFAULT_POPUP_MENU_ITEM_THEME, { shortcut: Ct.shortcut, withIcon: Ct.withIcon }),
        Et = s.t(null, void 0, n(80959)),
        Tt = s.t(null, void 0, n(11680)),
        Mt = [],
        It = (0, X.hotKeySerialize)({ keys: [(0, $.humanReadableModifiers)($.Modifiers.Mod, !1), "S"], text: "{0} + {1}" });
      class kt extends i.PureComponent {
        ...
        componentDidUpdate(e, t) {
          e.isProcessing && !this.props.isProcessing && (clearTimeout(this._timeout), (this._timeout = void 0), this.setState({ isSaving: !1 })),
            !e.isProcessing &&
      ...
      (0, i.forwardRef)((e, t) => {
        ...
        return i.createElement(
          ...
          {
            ref: l,
            className: u(Ct.copyLink, a && Ct.copyLinkMobile, k.PLATFORM_ACCESSIBILITY_ENABLED && Ct.accessibleLabel),
            onClick: o,
            tabIndex: r,
            onKeyDown: function (e) {
              if (!k.PLATFORM_ACCESSIBILITY_ENABLED || e.target !== e.currentTarget) return;
              const t = (0, $.hashFromEvent)(e);
              (13 !== t && 32 !== t) || (e.preventDefault(), l.current instanceof HTMLElement && l.current.click());
            },
            "data-role": k.PLATFORM_ACCESSIBILITY_ENABLED ? "menuitem" : void 0,
          },
      ...
      class At extends i.PureComponent {
        constructor(e, t) {
          ...
          const { chartWidgetCollection: n, chartChangesWatcher: a, saveChartService: i, sharingChartService: s } = t;
          this.state = {
        ...
        componentDidMount() {
          const { chartSaver: e, isFake: t, stateSyncEmitter: a } = this.props,
            { chartWidgetCollection: i, chartChangesWatcher: o, saveChartService: l, sharingChartService: r } = this.context;
          t
            ...
            : (o.getOnChange().subscribe(this, this._onChangeHasChanges),
              ...
              this._hotkeys.add({ desc: s.t(null, void 0, n(75687)), handler: this._handleHotkey, hotkey: 190 }),
        ...
        componentWillUnmount() {
          ...
          const { chartSaver: t, isFake: n, stateSyncEmitter: a } = this.props,
            { chartWidgetCollection: i, chartChangesWatcher: o, saveChartService: s, sharingChartService: l } = this.context;
          n
            ...
            : (o.getOnChange().unsubscribe(this, this._onChangeHasChanges),
              ...
              this.context.saveChartService.getCreateController().visible().unsubscribe(this._onSaveDialogVisibleChange));
        }
        render() {
          ...
          return i.createElement(_.MatchMedia, { rule: f.DialogBreakpoints.TabletSmall }, (e) => i.createElement(kt, { ...m, isTabletSmall: e }));
        }
        _onLoginStateChange() {
          this.setState({
            isAuthenticated: window.is_authenticated,
      ...
      function $t(e) {
        const { serverSnapshot: t, clientSnapshot: a, hideShortcuts: o } = e,
          ...
          b = (0, i.useCallback)(async () => {
            ...
            try {
              await (0, Pt.writePromiseUsingApi)(n, "image/png"), be.emit("onClientScreenshotCopiedToClipboard");
            } catch (n) {
              const { canvas: a } = await t;
              null === (e = window.open()) || void 0 === e || e.document.write(`<img width="100%" src="${a.toDataURL()}"/>`);
            }
          }, [a]),
            ...
            async (e = !1) => {
              ...
              try {
                if (e) await S(n);
                  ...
                  await (0, Pt.writePromiseUsingApi)(e, "text/plain"), be.emit("onServerScreenshotCopiedToClipboard");
                }
                return !0;
              } catch (e) {
                return S(n), !0;
          ...
          f =
            ((0, i.useCallback)(async () => {
              ...
              try {
                const t = 720,
                  n = e.then(async (e) => {
                    ...
                    const o = await snapshoter().getSnapshot(e.symbol, new Set(["description"])),
                      ...
                      l = null !== (a = null === (n = e.imageUrl.match(/\/x\/([0-9a-zA-Z]{8})/)) || void 0 === n ? void 0 : n[1]) && void 0 !== a ? a : "",
                      r = null === (i = createSnapshotImageUrls(l)) || void 0 === i ? void 0 : i.url;
                    return new Blob(
                      [
                ...
                return await (0, Pt.writePromiseUsingApi)(n, "text/plain"), be.emit("onServerScreenshotEmbedCodeCopiedToClipboard"), !0;
              } catch (t) {
                return S(e), !0;
              } finally {
            ...
            (0, i.useCallback)(async () => {
              ...
              e.Twitter.shareSnapshotInstantly(a.symbol, a.imageUrl), g.current && (p(!1), (0, Ve.globalCloseMenu)());
            }, [t]));
        return i.createElement(
          i.Fragment,
          null,
          ...
          i.createElement(A.AccessibleMenuItem, {
            ...
            icon: Qt,
            onClick: b,
            shortcut: o ? void 0 : (0, $.humanReadableHash)($.Modifiers.Mod + $.Modifiers.Shift + 83),
            theme: Xt,
          }),
          !(0, Zt.onWidget)() &&
            i.createElement(A.AccessibleMenuItem, {
      ...
      function en(e) {
        ...
        return i.createElement(U.ToolWidgetButton, { id: e.id, className: e.className, isDisabled: t, onClick: o, title: e.tooltip, icon: e.icon });
      }
      var tn = n(72644);
      const nn =
        ((an = function (e) {
          return (0, Jt.isOnMobileAppPage)("any")
            ...
            : i.createElement(
                d.ToolbarMenuButton,
                {
                  content: i.createElement(U.ToolWidgetButton, { tag: "div", id: e.id, className: e.className, icon: tn }),
                  drawerPosition: "Bottom",
          ...
          constructor(e, t) {
            super(e, t),
              (this._clientSnapshot = async () => {
                ...
                return { canvas: await this.context.chartWidgetCollection.clientSnapshot(), name: `${(0, Nt.shortName)(e)}_${Ft.formatLocal(new Date())}` };
              }),
              (this._serverSnapshot = async () => {
                const e = this.context.chartWidgetCollection.activeChartWidget.value().model().mainSeries().actualSymbol(),
                  t = await this.context.chartWidgetCollection.takeScreenshot(),
                  n = a.enabled("charting_library_base") && void 0 !== this.context.snapshotUrl ? t : (0, Rt.convertImageNameToUrl)(t);
      ...
      class cn {
        async show(e) {
          ...
          if (cn._currentShowingInstance) throw new DOMException("SymbolSearchUI is already shown", "InvalidStateError");
          try {
        ...
        static preload() {
          null === this._provider && null === this._implementation && (this._implementation = (0, rn.loadNewSymbolSearch)());
        }
      }
      ...
      class vn extends i.PureComponent {
                ...
                if (!this.state.isOpened)
                  try {
                    (0, K.trackEvent)("GUI", "SS", "main search"),
                      await new cn().show({
                        trackResultsOptions: { trackResults: !1, emptySearchType: "empty_result__supercharts" },
                        onClose: () => {
                        ...
                        showSpreadActions: (0, sn.canShowSpreadActions)() && this.props.isActionsVisible,
                        source: "searchBar",
                        footer: Fe.mobiletouch ? void 0 : i.createElement(ln.SymbolSearchDialogFooter, null, s.t(null, void 0, n(20987))),
                      });
                  } catch (e) {}
        ...
        componentDidMount() {
          l.linking.proSymbol.subscribe(this._onSymbolChanged), l.linking.seriesShortSymbol.subscribe(this._onSymbolChanged), cn.preload();
        }
        componentWillUnmount() {
          l.linking.proSymbol.unsubscribe(this._onSymbolChanged), l.linking.seriesShortSymbol.unsubscribe(this._onSymbolChanged);
        }
        render() {
          const { id: e, className: t } = this.props;
          return i.createElement(g.ToolbarButton, {
            id: e,
            className: v()(t, a.enabled("uppercase_instrument_names") && dn.uppercase, dn.smallLeftPadding),
            theme: un,
            icon: hn,
      ...
      function gn(e) {
        ...
        return k.PLATFORM_ACCESSIBILITY_ENABLED
          ...
          : i.createElement(
              "div",
              { className: u(n, pn.item, "apply-common-tooltip"), onClick: r, "data-tooltip": a.name },
              i.createElement("div", { className: pn.round }, a.name.length > 0 ? a.name[0].toUpperCase() : " ")
            );
        function r(e) {
      ...
      var _n = n(48261);
      const fn = (0, dt.mergeThemes)(se.DEFAULT_POPUP_MENU_ITEM_THEME, { labelRow: _n.labelRow, toolbox: _n.toolbox, item: _n.titleItem }),
        yn = (0, dt.mergeThemes)(se.DEFAULT_POPUP_MENU_ITEM_THEME, { labelRow: _n.labelRow, toolbox: _n.toolbox, item: _n.titleItemTabletSmall }),
      ...
      function Tn(e) {
        const { className: t, item: n, onApply: a, onRemove: o, onFavor: s, favorite: l, isFavoritingAllowed: r, isTabletSmall: c } = e,
          [h, d] = (0, Ne.useHover)(),
          u = n.meta_info,
        ...
        return i.createElement(
          "div",
          { ...d, className: v()(t, _n.wrap), "data-name": n.name, "data-id": n.id, "data-is-default": Boolean(n.is_default) },
          i.createElement(A.AccessibleMenuItem, {
            theme: p,
            label: n.name,
            ...
            toolbox: i.createElement(
              i.Fragment,
              null,
              !n.is_default && i.createElement(Oe.MenuRemoveButton, { key: "remove", hidden: !Fe.touch && !h, onClick: C, className: _n.remove }),
              Boolean(s) && r && i.createElement(R.MenuFavoriteButton, { key: "favorite", isFilled: Boolean(l), onClick: S })
            ),
          }),
          m &&
            i.createElement(se.PopupMenuItem, {
              theme: g,
              label: i.createElement(Sn, { className: v()(_n.description, c && _n.descriptionTabletSmall) }, m),
              onClick: b,
              isHovered: h,
            })
        );
        ...
        return i.createElement(A.AccessibleMenuItem, {
          ...
          label: i.createElement(
            ...
            i.createElement(
              ...
              i.createElement("div", { className: In.text }, (0, mt.appendEllipsis)(s.t(null, void 0, n(92093))))
            )
          ),
          onClick: t,
        });
      ...
      function Fn(e) {
        ...
        return i.createElement(
          ...
          c && i.createElement(i.Fragment, null, i.createElement(S.PopupMenuSeparator, null), i.createElement(pe, null)),
          !c && (r ? i.createElement(On, { defaults: h, customs: d, render: b }) : i.createElement(Hn, { defaults: h, customs: d, render: b, state: m }))
        );
      }
      function On(e) {
        ...
        return i.createElement(
          ...
          a.length > 0 &&
            i.createElement(
              ...
              i.createElement(ge.ToolWidgetMenuSummary, { className: Nn.menuItemHeaderTabletSmall }, s.t(null, void 0, n(38554))),
              a.map(o)
            ),
          t.length > 0 &&
            i.createElement(
              ...
              null,
              i.createElement(S.PopupMenuSeparator, null),
              i.createElement(ge.ToolWidgetMenuSummary, { className: Nn.menuItemHeaderTabletSmall }, s.t(null, void 0, n(43399))),
              t.map(o)
            )
        );
      }
        ...
        return i.createElement(
          ...
          a.length > 0 &&
            i.createElement(
              ...
              null,
              i.createElement(S.PopupMenuSeparator, null),
              i.createElement(ge.ToolWidgetMenuSummary, { className: Nn.menuItemHeader }, s.t(null, void 0, n(38554))),
              a.map(o)
            ),
          a.length > 0 &&
            t.length > 0 &&
            ...
            i.createElement(
              ...
              i.createElement(
                Qe,
                { summary: s.t(null, void 0, n(43399)), open: !l.get().defaultsCollapsed, onStateChange: (e) => l.set({ defaultsCollapsed: !e }) },
                t.map(o)
              )
            ),
          0 === a.length &&
            ...
            i.createElement(
              ...
              null,
              i.createElement(S.PopupMenuSeparator, null),
              i.createElement(ge.ToolWidgetMenuSummary, { className: Nn.menuItemHeader }, s.t(null, void 0, n(43399))),
              t.map(o)
            )
        );
      }
      ...
      class Dn {
        constructor(e, t) {
          ...
          const o = (null === (n = this._favoriteStudyTemplatesService) || void 0 === n ? void 0 : n.get()) || [],
            s = this._studyTemplates.list();
          (this._state = new Bn.WatchedValue({ isLoading: !1, studyTemplatesList: s, favorites: o })),
            ...
            this._isFavoriteEnabled &&
              (null === (i = this._favoriteStudyTemplatesService) || void 0 === i || i.getOnChange().subscribe(this, this._handleFavoritesChange));
        }
        destroy() {
          var e;
          this._studyTemplates.getOnChange().unsubscribe(this, this._handleTemplatesChange),
            this._isFavoriteEnabled &&
              (null === (e = this._favoriteStudyTemplatesService) || void 0 === e || e.getOnChange().unsubscribe(this, this._handleFavoritesChange));
        }
        state() {
      ...
      class zn extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (0, w.validateRegistry)(t, { favoriteStudyTemplatesService: o.any, studyTemplates: o.any.isRequired, templatesMenuViewStateService: o.any });
          const { favoriteStudyTemplatesService: n, studyTemplates: a } = t;
          (this._model = new Dn(a, n)), (this.state = { ...this._model.state().value(), isActive: !1 });
        }
        componentDidMount() {
          ...
          if (k.PLATFORM_ACCESSIBILITY_ENABLED && t && (0, Q.isKeyboardClick)(t) && C.current) {
            ...
            g(e, () => {
              ...
              if (-1 !== n && C.current) {
                ...
                i ? i.focus() : (0, le.focusFirstMenuItem)(C.current), null === (a = b.current) || void 0 === a || a.update();
              }
            });
          } else g(e);
        }
      ...
      function Zn(e) {
        return i.createElement(
          ...
          e.favorites.map((t, n, a) =>
            i.createElement(gn, { key: t.name, item: t, onApply: e.onTemplateSelect, className: v()({ [Un.first]: 0 === n, [Un.last]: n === a.length - 1 }) })
          )
        );
      }
      zn.contextType = Wn;
      ...
      var Kn = n(77665),
        ...
        jn = n(57778);
      const qn = {
          undoHotKey: (0, X.hotKeySerialize)({ keys: [(0, $.humanReadableModifiers)($.Modifiers.Mod, !1), "Z"], text: "{0} + {1}" }),
          redoHotKey: (0, X.hotKeySerialize)({ keys: [(0, $.humanReadableModifiers)($.Modifiers.Mod, !1), "Y"], text: "{0} + {1}" }),
        },
      ...
      Xn.contextType = Gn;
      const $n = (e) => {
        if (((e) => "http://www.w3.org/1999/xhtml" === (null == e ? void 0 : e.namespaceURI))(e) && "true" !== e.dataset.internalAllowKeyboardNavigation) {
      ...
      class Jn extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(p, { ref: this._setRef, style: e ? { width: t.value() } : void 0, "data-is-custom-header-element": !0 });
        }
      }
      function ea(e) {
        ...
        return i.createElement(
          ...
          n.items.map((e, t) => i.createElement(se.PopupMenuItem, { key: t, label: e.title, onClick: () => e.onSelect(), "data-name": "dropdown-item" }))
        );
      }
      var ta = n(27363);
      function na(e) {
      ...
      var aa = n(60448);
      const ia = (0, X.hotKeySerialize)({ keys: [(0, $.humanReadableModifiers)($.Modifiers.Mod, !1), "K"], text: "{0} + {1}" }),
          ...
          super(e),
            ...
            (this._handleClick = (e) => {
              ...
              t({ shouldReturnFocus: (0, Q.isKeyboardClick)(e) }).then((e) => {
                var t;
                null === (t = this._dialog) || void 0 === t || t.visible().unsubscribe(this._updateState),
                  (this._dialog = e),
      ...
      function ra() {
        return {
          ...
          OpenPopup: ot,
          Properties: a.enabled("header_settings") && a.enabled("show_chart_property_page") ? rt : void 0,
      ...
      function o(e, t) {
        return {
          indicators: e
            ...
            .map((e) => ({ id: e.metaInfo().id, description: e.title(i.TitleDisplayTarget.StatusLine, !0, void 0, !0) })),
          interval: t,
        };
      }
      function s(e) {
    ...
    95366: (e, t, n) => {
      "use strict";
      n.d(t, { RegistryProvider: () => r, registryContextType: () => c, validateRegistry: () => l });
      var a = n(50959),
        i = n(19036),
        o = n.n(i);
    ...
    25931: (e, t, n) => {
      ...
      let a = (e = 21) =>
        crypto
          ...
          .reduce((e, t) => (e += (t &= 63) < 36 ? t.toString(36) : t < 62 ? (t - 26).toString(36).toUpperCase() : t > 62 ? "-" : "_"), "");
    },
  },
]);
