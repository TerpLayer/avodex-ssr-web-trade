  ...
  [3263],
  {
      ...
      function m(n) {
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement("div", { className: a()(d.title, y && !w && d.active, h && d.mobile), "data-name": "list-item-title" }, o),
            s.createElement(
              "div",
              {
    ...
    23263: (n, o, e) => {
      ...
      var w = e(90186),
        ...
        v = e.n(h);
      function p(n) {
        const { className: o, color: e, variant: s, size: t, stretch: a, animated: i, disableThemes: l, isInvertedColorTheme: r, ...u } = n;
      ...
      const N = s.forwardRef((n, o) => {
        ...
        return s.createElement(
          ...
          e.map((n) => {
            ...
            return s.createElement(f, { ...e, className: z(i, { ...e, variant: a, isChecked: o }), size: t, variant: a });
          })
        );
      });
      ...
      const x = new l.TranslatedString("remove all line tools for {symbol}", i.t(null, void 0, e(23481))),
        F = (n) => i.t(null, { plural: "{drawingsCount} drawings", count: n }, e(88143)).format({ drawingsCount: n.toString() }),
        ...
        return (
          ...
          s.useEffect(() => {
            if (null !== o) {
              ...
              return m([...n.value()]), n.subscribe(() => m([...n.value()])), () => (null == n ? void 0 : n.destroy());
            }
          }, [o]),
          s.useMemo(() => ({ currentSymbol: a, symbolDrawingsMaps: l, removeSymbolDrawings: g, changeSymbol: b, hiddenSymbols: u }), [a, l, g, b, u])
        );
      ...
      function Y(n) {
        const { isMobile: o, chartWidget: t, onClose: l, onInitialized: r } = n,
          { currentSymbol: u, symbolDrawingsMaps: d, removeSymbolDrawings: c, changeSymbol: b, hiddenSymbols: y } = B(t),
          [w, C] = s.useState(0),
          [h, v, p] = s.useMemo(() => {
            var n;
            if (null !== u && null !== d) {
              ...
              let e = 0,
                s = w;
              if (null === s) for (s = 2; s > 0 && !(((null === (n = d[s].get(u)) || void 0 === n ? void 0 : n.size) || 0) > 0); ) s--;
              return (
                d[s].forEach((n, s) => {
                  y.includes(s) ||
                    (o.push({
                ...
                o.sort((n, o) => (n.drawingsCount === o.drawingsCount ? n.symbol.localeCompare(o.symbol) : n.drawingsCount > o.drawingsCount ? -1 : 1)),
                [o, e, s]
              );
            }
            return [[], 0, 0];
            ...
            h.length > 0 &&
              s.createElement(
                ...
                `${
                  ((f = d ? d[p].size : 0),
                  i
                    .t(null, { plural: "{symbolsCount} symbols", context: "symbols_and_drawings_count", count: f }, e(52908))
                    .format({ symbolsCount: f.toString() }))
                } ${((n) =>
                  i
                    .t(null, { plural: "with {drawingsCount} drawings", context: "symbols_and_drawings_count", count: n }, e(42743))
                    .format({ drawingsCount: n.toString() }))(v)}`
              ),
            0 === h.length
              ? null === d
                ? s.createElement(g.Spinner, { className: D.spinner })
                : s.createElement("div", { className: D.empty }, s.createElement(a.Icon, { className: D.image, icon: j }), s.createElement("span", null, M))
