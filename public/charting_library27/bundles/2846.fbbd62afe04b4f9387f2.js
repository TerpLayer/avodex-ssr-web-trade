        ...
        (l = function (e) {
          ...
          var i = "undefined" != typeof window && window.navigator && window.navigator.platform && /iP(ad|hone|od)/.test(window.navigator.platform),
            ...
            d = function (e) {
              ...
              return !!v(o.target) || 1 < o.touches.length || (o.preventDefault && o.preventDefault(), !1);
            },
            h = function () {
              setTimeout(function () {
                ...
                (t = [].concat(o(t), [h])),
                  ...
                  (e.ontouchmove = function (o) {
                    ...
                    1 === o.targetTouches.length &&
                      ...
                      !v(l.target) &&
                        ((n && 0 === n.scrollTop && 0 < t) || ((i = n) && i.scrollHeight - i.scrollTop <= i.clientHeight && t < 0)
                          ? d(l)
                          : l.stopPropagation()));
                  }),
                  r || (document.addEventListener("touchmove", d, l ? { passive: !1 } : void 0), (r = !0));
              }
            } else {
              (u = n),
                setTimeout(function () {
            ...
            (e.clearAllBodyScrollLocks = function () {
              i
                ? (t.forEach(function (e) {
                  ...
                  r && (document.removeEventListener("touchmove", d, l ? { passive: !1 } : void 0), (r = !1)),
                  (t = []),
                  (a = -1))
                : (h(), (t = []));
            }),
            (e.enableBodyScroll = function (e) {
              if (i) {
                ...
                (e.ontouchstart = null),
                  ...
                  r && 0 === t.length && (document.removeEventListener("touchmove", d, l ? { passive: !1 } : void 0), (r = !1));
              } else
        ...
        return (
          (0, n.useLayoutEffect)(() => {
            ...
            return (
              ...
              () => {
                e.removeEventListener("roving-tabindex:main-element", o), e.removeEventListener("roving-tabindex:secondary-element", o);
              }
            );
          }, o),
      ...
      const t = [
        {
          ...
          items: [{ name: "cursor" }, { name: "dot" }, { name: "arrow" }, { name: "eraser" }, null].filter(i.isExistent),
          trackLabel: null,
        },
        {
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [{ name: "LineToolGannSquare" }, { name: "LineToolGannFixed" }, { name: "LineToolGannComplex" }, { name: "LineToolGannFan" }],
            },
          ],
          trackLabel: null,
        },
        {
          ...
          sections: [
            ...
            { title: n.t(null, void 0, l(50025)), items: [{ name: "LineToolCircleLines" }, { name: "LineToolTimeCycles" }, { name: "LineToolSineLine" }] },
          ],
          trackLabel: null,
        },
        {
          ...
          sections: [
            ...
            },
            {
              ...
              items: [{ name: "LineToolAnchoredVWAP" }, { name: "LineToolFixedRangeVolumeProfile" }, null].filter(i.isExistent),
            },
            {
              title: n.t(null, void 0, l(79961)),
              items: [{ name: "LineToolPriceRange" }, { name: "LineToolDateRange" }, { name: "LineToolDateAndPriceRange" }],
            },
          ],
          trackLabel: null,
        },
        {
          ...
          sections: [
            { title: n.t(null, void 0, l(55939)), items: [{ name: "LineToolBrush" }, { name: "LineToolHighlighter" }] },
            {
    ...
    78036: (e, o, l) => {
      ...
      const h = (0, v.humanReadableModifiers)(v.Modifiers.Shift, !1),
        ...
        T = {
          ...
          LineToolHorzLine: { hotKey: (0, t.hotKeySerialize)({ keys: [m, "H"], text: "{0} + {1}" }) },
          LineToolHorzRay: {},
          LineToolIcon: {},
          LineToolEmoji: {},
          ...
          LineToolProjection: {},
          LineToolRay: {},
          LineToolRectangle: { hotKey: (0, t.hotKeySerialize)({ keys: [h], text: i.t(null, void 0, l(81591)) }) },
          LineToolCircle: {},
          ...
          LineToolVertLine: { hotKey: (0, t.hotKeySerialize)({ keys: [m, "V"], text: "{0} + {1}" }) },
          LineToolCrossLine: {},
          LineToolHighlighter: {},
          LineToolGhostFeed: {},
          ...
          measure: { hotKey: (0, t.hotKeySerialize)({ keys: [h], text: i.t(null, void 0, l(32868)) }) },
      ...
      Object.entries(T)
        .map(([e, o]) => {
          ...
          return { ...o, name: e, icon: t, localizedName: v, selectHotkey: d.lineToolsSelectHotkeys[e] };
        })
        .forEach((e) => {
          f[e.name] = e;
        });
      ...
      !(function (e) {
        function o() {
          ...
          if (0 === v.length && c && "undefined" != typeof window) {
            const e = JSON.parse(null !== (n = null === (o = window.urlParams) || void 0 === o ? void 0 : o.favorites) && void 0 !== n ? n : "{}").drawingTools;
            e && Array.isArray(e) && v.push(...e);
          }
          v.forEach((o, n) => {
            const i = o.tool || o;
            l(i) ? (t.includes(i) ? (s = !0) : e.favorites.push(i)) : r && r.includes(i) && e.hiddenToolsPositions.set(i, n);
          }),
            s && a(),
        ...
        (function (e) {
          ...
          (e.favoriteAdded = new n.Delegate()),
            ...
            (e.addFavorite = function (l, n) {
              return !(i(l) || !o(l) || "performance" === l) && (a.favorites.push(l), a.saveFavorites(n), e.favoriteAdded.fire(l), !0);
            }),
