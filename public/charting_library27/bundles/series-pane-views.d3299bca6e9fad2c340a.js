    ...
    1539: (t, e, a) => {
        ...
        _drawImpl(t) {
          ...
          (T.font = (0, n.makeFont)(12, u.CHART_FONT_FAMILY)),
            r
              ...
              : ((g = T.measureText(null != a ? a : "").width), (p = T.measureText(null != l ? l : "").width), (f = Math.max(g, p)));
          const v = l ? 2 : 1,
      ...
      class T {
        ...
        _updateImpl() {
          ...
          (this._data = { point: b, direction: u, eod: t, dateString: m, timeString: T }), this._renderer.setData(this._data);
        }
        _getTargetBar(t) {
