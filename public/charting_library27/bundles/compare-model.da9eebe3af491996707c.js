(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7271],
  {
          ...
          (e.fromSymbolSearchResult = function (e, t) {
            var s;
            {
              ...
              return n.enabled("pay_attention_to_ticker_not_symbol")
                ? (0, r.ensureDefined)(null !== (s = null != o ? o : i) && void 0 !== s ? s : a)
    ...
    20882: (e, t, s) => {
      "use strict";
      s.d(t, { createSearchSources: () => a, filterSearchSources: () => n, isAllSearchSourcesSelected: () => r, splitSearchSourcesByGroup: () => i });
      const o = [];
      function r(e) {
        return "" === e.value();
      }
      ...
      class n {
        ...
        includes(e) {
          return (function (e, t) {
            ...
            return o.toLowerCase().includes(s) || r.toLowerCase().includes(s) || (void 0 !== n && n.some((e) => e.toLowerCase().includes(s)));
          })(this._exchange, e);
        }
    ...
    56217: (e, t, s) => {
      ...
      function p(e, t, s) {
          ...
          };
        {
          ...
          t.logo_urls &&
            t.logo_urls.length &&
            (t.logo_urls.length > 1 ? ((n.baseCurrencyLogoId = t.logo_urls[0]), (n.currencyLogoId = t.logo_urls[1])) : (n.logoId = t.logo_urls[0])),
      ...
      class I {
        constructor(e) {
          ...
          Promise.all(d).then((e) => {
            ...
            e.forEach((e, r) => {
              const n = o[r],
                i = n.id();
              this._addStudyIdToCheckedSymbols(e, i), this._idToStudyMap.set(i, n), t.has(e) ? s.add(e) : l.add(e);
            });
            ...
            const i = Array.from(new Set(r));
            {
              ...
              Promise.all(t).then((t) =>
                this._handleInitProcess(
                  ...
                  (e, t, s, o) => ("symbol_resolved" === e.method ? p(e.params[1], s, o) : f(t, s, o, this._getSymbolDescription(t)))
                )
              );
            }
          });
        ...
        handleSourcesChange() {
          ...
          Array.from(t).forEach((e) => {
            if (!this._checkedStudiesIds().has(e)) {
              ...
              if (null !== t && S(t)) {
                ...
                if (!t) return;
                this._addStudyIdToCheckedSymbols(t.symbol, e), this._saveRecent(t.symbol), this._updateContentItemList(this._contentItemList.value(), !0);
              }
            }
          });
          Array.from(this._checkedStudiesIds()).forEach((e) => {
            if (!t.has(e)) {
              ...
              s && s.length > 1 ? this._removeStudyIdFromCheckedSymbols(t.symbol, e) : this._checkedSymbols.delete(t.symbol),
                this._updateContentItemList(this._contentItemList.value(), !0);
            }
          });
        }
        ...
        _updateContentItemList(e, t) {
          ...
          if (this._recentSymbolsEnabled) {
            const e = new Set(),
              t = s.reduce((t, s) => (s.checked || e.has(s.symbol) || (t.push(s), e.add(s.symbol)), t), []).slice(0, this._recentLength);
