(() => {
  ...
  (r.m = f),
      ...
      if (!d) {
        ...
        for (i = 0; i < e.length; i++) {
          for (var [d, c, t] = e[i], b = !0, n = 0; n < d.length; n++)
            (!1 & t || f >= t) && Object.keys(r.O).every((e) => r.O[e](d[n])) ? d.splice(n--, 1) : ((b = !1), t < f && (f = t));
          if (b) {
            e.splice(i--, 1);
            var o = c();
            void 0 !== o && (a = o);
    ...
    (r.t = function (e, c) {
      ...
      var f = {};
      a = a || [null, d({}), d([]), d(d)];
      for (var b = 2 & c && e; "object" == typeof b && !~a.indexOf(b); b = d(b)) Object.getOwnPropertyNames(b).forEach((a) => (f[a] = () => e[a]));
      return (f.default = () => e), r.d(t, f), t;
    }),
    (r.d = (e, a) => {
      for (var d in a) r.o(a, d) && !r.o(e, d) && Object.defineProperty(e, d, { enumerable: !0, get: a[d] });
    }),
    (r.f = {}),
    ...
    (r.l = (e, a, d, f) => {
      if (c[e]) c[e].push(a);
        ...
        var s = (a, d) => {
            ...
            var t = c[e];
            if ((delete c[e], b.parentNode && b.parentNode.removeChild(b), t && t.forEach((e) => e(d)), a)) return a(d);
          },
    ...
    (() => {
      ...
      r.tf = (a, d = {}, c) => {
        if (null === a) {
          if (Array.isArray(c)) {
            if (r.g.customTranslateFunction) {
              const e = r.g.customTranslateFunction(c[0], d.plural ? { ...d, plural: c.length > 2 ? c.slice(1) : c[1] } : d, !0);
              if (null !== e) return e;
            }
            return (c[e[r.g.language](d.count)] || c[0]).replace(/{(\w+)}/g, (e, a) => (void 0 !== (d.replace || d)[a] ? (d.replace || d)[a] : e));
          }
        ...
        return (d.plural && 1 != +d.count ? d.plural : a).replace(/{(\w+)}/g, (e, a) => (void 0 !== (d.replace || d)[a] ? (d.replace || d)[a] : e));
      };
    })(),
  ...
  function i(e, a) {
    return n(e).catch(function () {
      return new Promise(function (d) {
        var c = function () {
          self.removeEventListener("online", c, !1), !1 === navigator.onLine ? self.addEventListener("online", c, !1) : d(a < 2 ? i(e, a + 1) : n(e));
        };
                  ...
                  (f.onerror = f.onload =
                    (d) => {
                      if (((f.onerror = f.onload = null), "load" === d.type)) c();
                        ...
                        (n.code = "CSS_CHUNK_LOAD_FAILED"), (n.type = b), (n.request = r), f.parentNode && f.parentNode.removeChild(f), t(n);
                      }
                    }),
                  (f.href = a),
            ...
            r.l(
              ...
              (d) => {
                if (r.o(e, a) && (0 !== (c = e[a]) && (e[a] = void 0), c)) {
                  ...
                  (b.message = "Loading chunk " + a + " failed.\n(" + t + ": " + f + ")"), (b.name = "ChunkLoadError"), (b.type = t), (b.request = f), c[1](b);
                }
              },
              "chunk-" + a,
              a
