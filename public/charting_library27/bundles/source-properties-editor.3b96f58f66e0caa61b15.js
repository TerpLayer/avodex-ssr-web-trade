  ...
  [6780],
  {
    ...
    50945: (e, t, i) => {
      ...
      var a = i(50959),
        ...
        d = i(44996),
        u = i(92229);
      const h = { reset: o.t(null, void 0, i(79782)), saveAsDefault: o.t(null, void 0, i(18229)), defaults: o.t(null, void 0, i(98938)) };
      class p extends a.PureComponent {
        ...
        render() {
          ...
          return a.createElement(
            ...
            a.createElement(c.PopupMenuItem, { className: u.defaultsButtonItem, isActive: !1, label: h.reset, onClick: this._handleResetToDefaults }),
            a.createElement(c.PopupMenuItem, { className: u.defaultsButtonItem, isActive: !1, label: h.saveAsDefault, onClick: this._handleSaveAsDefaults })
          );
        }
    ...
    48531: (e, t, i) => {
      ...
      function u(e) {
        return a.createElement(o.MatchMedia, { rule: "screen and (max-width: 768px)" }, (t) =>
          a.createElement(
            r.ControlDisclosure,
            { className: !t && l.themesButtonText, hideArrowButton: t, buttonChildren: a.createElement(d, { isTabletWidth: t }) },
            e.children
          )
        );
      }
    ...
    37289: (e, t, i) => {
      ...
      const n = {
        ...
        r = { TextText: "big", AnchoredTextText: "big", NoteText: "big", AnchoredNoteText: "big", CalloutText: "big", BalloonText: "big" };
      var o = i(11062),
        l = i(82064);
      function c(e) {
      ...
      class E extends a.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._getTranslatedStringForSource = (e) => new z.TranslatedString(e.name(), e.title(g.TitleDisplayTarget.StatusLine))),
            (this._setTitle = (e) => {
              const { source: t, model: i } = this.props,
                a = L.format({ sourceTitle: t.properties().title.value() || this._getTranslatedStringForSource(t), newSourceTitle: e });
            ...
            (this._renderFooterLeft = () => {
              ...
              return (0, f.isLineTool)(e)
                ...
                : a.createElement(
                    ...
                    (i) => (0, v.isStudy)(e) && a.createElement(b.StudyDefaultsManager, { model: t, source: e, mode: i ? "compact" : "normal" })
                  );
            }),
            (this._subscribe = (e) => {
          ...
          (this.state = { activePageId: i, tableKey: Date.now(), isRenaming: !1 }), window.lineToolPropertiesToolbar && window.lineToolPropertiesToolbar.hide();
        }
        componentDidMount() {
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            return a.createElement(
              a.Fragment,
              null,
              a.createElement(D.DialogTabs, { className: C.tabs, id: r, activeTab: e, onChange: this._handleSelectPage, tabs: o }),
              a.createElement(
                _.TouchScrollContainer,
                { className: C.scrollable, onScroll: this._handleScroll },
                a.createElement(m.PropertiesEditorTab, { page: n, pageRef: this._activePageRef, tableKey: this.state.tableKey })
              )
            );
          };
        }
      ...
      class w extends M.DialogRenderer {
        ...
        show(e) {
          s.render(
            ...
            n.emit("drawings_settings_dialog", { objectType: "drawing", scriptTitle: this._source.title(g.TitleDisplayTarget.StatusLine) });
        }
    ...
    66512: (e, t, i) => {
      ...
      function g(e) {
        const { propertyPages: t, onSubmit: i, onCancel: s, onClose: n, title: r, activeTabId: g, sources: f, undoModel: b, renamable: v } = e,
          ...
          L = (0, a.useMemo)(() => t.map(({ title: e, id: t }) => ({ label: e, id: t, dataId: `sources-properties-editor-tabs-${t}` })), [t]);
        ...
        return a.createElement(l.AdaptiveConfirmDialog, {
          ...
          render: function () {
            ...
            return a.createElement(
              a.Fragment,
              null,
              a.createElement(p.DialogTabs, { className: m.tabs, id: "sources-properties-editor-tabs", activeTab: y, onChange: z, tabs: L }),
              a.createElement(o.TouchScrollContainer, null, a.createElement(d.PropertiesEditorTab, { page: e, tableKey: y }))
            );
          },
          submitOnEnterKey: !1,
          showCloseIcon: !D,
            ...
            (this._dataSourceCollectionChangedHandler = () => {
              null === this._dataSourceChangedPromise &&
                (this._dataSourceChangedPromise = Promise.resolve().then(() => {
                  ...
                  this._sources.find((t) => null === e.dataSourceForId(t.id())) && this._close(), (this._dataSourceChangedPromise = null);
                }));
            }),
