(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7078],
  {
    ...
    22265: (e, t, a) => {
      "use strict";
      a.d(t, { DialogSidebarContainer: () => d, DialogSidebarItem: () => h, DialogSidebarWrapper: () => m });
      var i = a(50959),
        n = a(97754),
        l = a.n(n),
        s = a(9745),
      ...
      function h(e) {
        const { mode: t, title: a, icon: n, isActive: d, onClick: m, tag: h = "div", reference: u, className: p, ..._ } = e,
          { isMobile: g, isTablet: b } = (0, r.getSidebarMode)(t),
          v = d ? (null == n ? void 0 : n.active) : null == n ? void 0 : n.default;
        return i.createElement(
          h,
          { ..._, ref: u, className: l()(c.tab, b && c.isTablet, g && c.isMobile, d && c.active, p), onClick: m },
    ...
    56080: (e, t, a) => {
      ...
      function I(e) {
        ...
        return n.createElement(
          ...
          n.createElement(b.AccessibleMenuItem, {
            ...
            label: t,
            onClick: c,
            toolbox: n.createElement(C.MenuRemoveButton, { className: z.remove, hidden: !E.mobiletouch && !s, onClick: o }),
          })
        );
      }
      var x = a(95276),
      ...
      class H extends n.PureComponent {
        ...
        _getThemeItems(e) {
          ...
          return n.createElement(
            n.Fragment,
            null,
            e && t && n.createElement(b.AccessibleMenuItem, { className: z.defaultsButtonItem, isActive: !1, label: j, onClick: i }),
            n.createElement(b.AccessibleMenuItem, {
            ...
            l.length > 0 &&
              n.createElement(
                ...
                l.map((e) => n.createElement(I, { key: e, themeName: e, onRemove: this._handleRemoveTheme, chartWidgetCollection: a, manager: this._manager }))
              )
          );
        }
      }
      ...
      function J(e) {
        if (!F.PLATFORM_ACCESSIBILITY_ENABLED) return n.createElement(q.DialogSidebarContainer, { ...e });
        ...
        constructor(e) {
          ...
          super(e),
            (this._renderChildren = ({ requestResize: e, isSmallWidth: t }) => (
              (this._requestResize = e), n.createElement("div", { className: ne.content }, this._renderTabs(t), this._renderTabContent(t))
            )),
            (this._renderApplyToAllButton = () => n.createElement(p.MatchMedia, { rule: R.DialogBreakpoints.TabletNormal }, (e) => this._renderApplyToAll(e))),
            (this._renderFooterLeft = () => {
              const { model: e, chartWidgetCollection: t } = this.props,
                { isApplyToAllVisible: a } = this.state;
              return n.createElement(H, { model: e, isApplyToAllVisible: a, applyToAllCallback: this._handleApplyToAll, chartWidgetCollection: t });
            }),
        ...
        _renderApplyToAll(e) {
          ...
          return (
            ...
            n.createElement(
              ...
              n.createElement(s.Button, { appearance: "stroke", onClick: this._handleApplyToAll }, i.t(null, void 0, a(75819)))
            )
          );
        }
        _getCurrentPage(e) {
      ...
      class me extends oe.DialogRenderer {
        ...
        show(e) {
          l.render(
            ...
            re.emit("edit_object_dialog", { objectType: "mainSeries", scriptTitle: this._model.mainSeries().title(ce.TitleDisplayTarget.StatusLine) });
        }
        _ensureCheckpoint(e) {
    ...
    81351: (e, t, a) => {
      ...
      function m(e) {
        ...
        return i.createElement(c.PopupMenuItem, {
          ...a,
          className: l()(o.PLATFORM_ACCESSIBILITY_ENABLED && d.accessible, e.isActive && d.active, t),
          reference: n,
          tabIndex: m,
    ...
    74628: (e, t, a) => {
      ...
      function d(e) {
        ...
        return r.PLATFORM_ACCESSIBILITY_ENABLED
          ? i.createElement(
              "button",
              { ref: d, tabIndex: m, onClick: a, className: l()(c.button, n.isActive && c.active), type: "button" },
