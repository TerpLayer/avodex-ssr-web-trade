...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2183],
  {
    79059: (t, e, i) => {
      ...
      function g(t, e, i, n) {
        (t.globalAlpha = 0.2), t.beginPath(), t.arc(e.x, e.y, i + n / 2, 0, 2 * Math.PI, !0), t.closePath(), (t.lineWidth = n), t.stroke(), (t.globalAlpha = 1);
      }
      function f(t, e, i, n) {
        ...
        _drawPoints(t, e, i, n, r) {
          ...
          for (let t = 0; t < e.length; ++t) {
            ...
            if (!((0, a.isInteger)(s.data) && c.linePointBeingEdited === s.data)) {
              if ((n(o, new h(Math.round(s.x * l) + y, Math.round(s.y * u) + y, s.data, s.square), f / 2, P), !c.disableInteractions)) {
      ...
      class h extends u.StudyInputsPaneView {
        ...
        _fillCompositeRendrer(t, e) {
          this._fillInformationAboutPointsAndCursors(t, e),
            this._renderer.append(this._createStudyAnchor({ points: this._points, pointsCursorType: this._cursors }, t, 0));
        }
        _fillInformationAboutPointsAndCursors(t, e) {
          if (((this._points = []), (this._cursors = []), this._inputs.find((t) => Array.isArray(t) || "price" === t.type))) {
          ...
          this._inputs.forEach((i, r) => {
            ...
            if (Array.isArray(i)) {
              ...
              null !== n && null !== r && ((o = this._convertTimeToCoordinate(n)), (l = this._convertPriceToCoordinate(r)), (u = !1));
            } else {
        ...
        _createLineRendererForinput(t, e) {
          if ("price" === e.type) {
            ...
            if (null !== i) {
              ...
              t.setData({ ...d, y: i });
              const n = this._editable ? new s.HitTestResult(s.HitTarget.MovePoint, { cursorType: o.PaneCursorType.VerticalResize, activeItem: e }) : null;
            ...
            if (null !== i) {
              ...
              t.setData({ ...d, x: i });
              const n = this._editable ? new s.HitTestResult(s.HitTarget.MovePoint, { cursorType: o.PaneCursorType.HorizontalResize, activeItem: e }) : null;
              return t.setHitTest(n), t;
            }
          }
          return null;
