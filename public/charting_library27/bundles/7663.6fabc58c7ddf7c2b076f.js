    ...
    27267: (e, t, n) => {
      ...
      function s(e, t, n, s, r) {
        function i(r) {
          ...
          const i = r.target;
          void 0 !== n && null !== t && null !== i && i.ownerDocument === s && (t.contains(i) || n(r));
        }
        return (
    ...
    34392: (e, t, n) => {
      ...
      function D(e) {
        const { sessionDay: t } = e,
          n = t.entries.map((e, n) =>
            s.createElement(m, { key: `${c(e)}Segment`, segment: e, forceStart: 0 === n && 3 === e.type, forceEnd: n === t.entries.length - 1 && 3 === e.type })
          ),
      ...
      function h(e) {
        ...
        !l.start.isFirstOrLastPoint && l.showStartForLastEntry ? i.push(o.entries[o.entries.length - 1].start) : i.push(l.start);
        ...
        const y = i.map((e) => s.createElement("div", { key: c(e), className: u.timeMark }, e.title)),
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement("div", { className: f, style: { left: 100 * i[0].value + "%", width: `${v}%` } }, y)
          )
        );
      }
      function k(e) {
        const { key: t, className: n, now: i, timezone: a, showAllDays: l, timeZoneClassName: d } = e,
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement("div", { className: u.nowWrapper }, s.createElement("div", { className: u.now, style: { left: 100 * i + "%" } }))
          ),
          s.createElement(h, { sessionDays: c, currentTimeMark: i }),
          s.createElement("div", { className: r(u.timezone, d, l && u.largePadding) }, `${f}: ${a}`)
        );
      }
    },
    76413: (e, t, n) => {
      ...
      var u = n(81702),
        ...
        y = n(22767),
        v = n(84917);
      const f = [v.WeekDays.SUNDAY, v.WeekDays.MONDAY, v.WeekDays.TUESDAY, v.WeekDays.WEDNESDAY, v.WeekDays.THURSDAY, v.WeekDays.FRIDAY, v.WeekDays.SATURDAY];
      function m(e, t) {
        return ((e + t + 6) % 7) + 1;
      }
      function D(e) {
      ...
      var g = n(83854);
      function A(e) {
        for ((0, c.assert)(Number.isInteger(e), "timeMinutes expected to be integer number"); e > i.minutesPerDay; ) e -= i.minutesPerDay;
        const t = e % 60,
          n = (e - t) / 60;
        return (0, g.numberToStringWithLeadingZero)(n, 2) + ":" + (0, g.numberToStringWithLeadingZero)(t, 2);
      }
      function S(e, t) {
        return `${e} — ${t}`;
      }
      ...
      function M(e, t, n, s) {
        (0, c.assert)(t !== i.minutesPerDay, "Start time expected to be normalized (24:00 as range start is not allowed)"),
          (0, c.assert)(0 !== s, "End time expected to be normalized (00:00 as range end is not allowed)");
      ...
      function P(e, t, n, s) {
        return { start: e, end: t, type: n, tooltip: s, showStartForLastEntry: !1, showEndForFirstEntry: !1 };
      }
      function W(e) {
      ...
      function R(e, t, n, s, r) {
        const [i, a] = T(e, t, r),
          [o, u] = U(n, s, r);
        (0, c.assert)(t !== n || i < o, `Days are same (${t}) but prev entry time (${i}) >= next entry time (${o})`);
        const d = l(i),
          y = l(o);
          ...
          (s =
            null !==
              (n = (function ({ thisDay: e, prevDay: t, nextDay: n }) {
                if (0 === e.entries.length) return [F((0, d.default)(t.entries), t.dayIndex, (0, u.default)(n.entries), n.dayIndex, e.dayIndex)];
              })(i)) && void 0 !== n
              ? n
              : (function ({ thisDay: e, prevDay: t, nextDay: n }) {
                  ...
                  return [0 !== a.start.value ? R(0, s, a.start.value, s, s) : void 0, ...O(e), 1 !== o.end.value ? R(o.end.value, s, 1, s, s) : void 0].filter(
                    r.isExistent
                  );
                })(i)) && void 0 !== s
          ? s
      ...
      function j(e) {
        return (t, n) => {
          return (s = (0, c.ensureDefined)(e(t))), (r = (0, c.ensureDefined)(e(n))), s.start.value === r.start.value && s.end.value === r.end.value;
          var s, r;
        };
      }
      const Z = j(u.default),
      ...
      function X(e, t) {
        return e.type === t.type && (3 === e.type || t.end.value - t.start.value + e.end.value - e.start.value <= 1);
      }
      function ee(e, t) {
        var n;
        const s = ((null !== (n = null == t ? void 0 : t.getUTCDay()) && void 0 !== n ? n : new Date().getDay()) % 7) + 1;
        const r = (function (e) {
            if (null === e) return new Map();
            if (void 0 === e.subsessions) return new Map([[0, new H.SessionSpec(e.timezone, e.session, e.session_holidays, e.corrections)]]);
            const t = "regular",
              n = "premarket",
              s = "postmarket",
              r = [t, n, s],
            ...
            for (const a of r) {
              ...
              if (null !== r) {
                ...
                void 0 !== t && i.set(r, new H.SessionSpec(e.timezone, t["session-display"] || t.session, e.session_holidays, t["session-correction"]));
              }
            }
            return i;
          })(e),
        ...
        for (const e of Array.from(r.keys())) {
          Q(i, (0, c.ensureDefined)(r.get(e)).getEntriesForWeekByCalendar((0, c.ensureNotNull)(t)), e);
        }
        return (
          (function (e) {
            const t = new Map();
          ...
          (function (e) {
            for (const t of f) {
              ...
              X(s, (0, c.ensureDefined)((0, d.default)(e[h(t)].entries))) && (s.start.isFirstOrLastPoint = !1);
              const r = (0, c.ensureDefined)((0, d.default)(n));
              X(r, (0, c.ensureDefined)((0, u.default)(e[k(t)].entries))) && (r.end.isFirstOrLastPoint = !1);
            }
          })(i),
          (function (e) {
            for (const t of f) {
      ...
      class te {
        ...
        currentTimeValue() {
          return null === this._todayInExchangeTime ? -1 : o(i.get_minutes_from_midnight(this._todayInExchangeTime));
        }
        timezone() {
        ...
        _updateTodayWithOffsets(e) {
          this._todayInExchangeTime = null !== e ? i.get_cal_from_unix_timestamp_ms(i.get_timezone(e.timezone), window.ChartApiInstance.serverTime()) : null;
        }
      }
    },
  },
