(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5057],
  {
    ...
    57340: (e, t, n) => {
      ...
      const u = s.forwardRef((e, t) => s.createElement(r.NavButton, { ...e, ref: t, icon: d(e.size) }));
    },
    64388: (e, t, n) => {
      "use strict";
      n.d(t, { NavButton: () => c });
      var s = n(50959),
        ...
        i = n(45350);
      function a(e) {
        const { size: t = "large", preservePaddings: n, isLink: s, flipIconOnRtl: o, className: a } = e;
        return r(i["nav-button"], i[`size-${t}`], n && i["preserve-paddings"], o && i["flip-icon"], s && i.link, a);
      }
      function l(e) {
      ...
      const c = (0, s.forwardRef)((e, t) => {
        const { icon: n, type: r = "button", preservePaddings: o, flipIconOnRtl: i, size: c, "aria-label": d, ...u } = e;
        return s.createElement("button", { ...u, className: a({ ...e, children: d }), ref: t, type: r }, s.createElement(l, { icon: n }, d));
      });
      ...
      (0, s.forwardRef)((e, t) => {
        ...
        return s.createElement(
          c,
          { ...i, className: a({ ...e, children: o, isLink: !0 }), reference: (0, u.isomorphicRef)(t) },
    ...
    35057: (e, t, n) => {
      ...
      class B extends s.PureComponent {
              ...
              if (!e.defaultPrevented) {
                if ((this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, a.hashFromEvent)(e))) {
                  ...
                  if (null !== n) {
                    ...
                    if (s.contains(n)) return this.props.onKeyboardClose && this.props.onKeyboardClose(), void this._handleClose();
                  }
                }
                var t, n;
                (function (e) {
        ...
        componentDidMount() {
          var e, t;
          this.props.ignoreClosePopupsAndDialog || g.subscribe(f.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          var e, t;
          this.props.ignoreClosePopupsAndDialog || g.unsubscribe(f.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            ...
            s.createElement(p.MatchMedia, { rule: h.DialogBreakpoints.TabletSmall }, (h) =>
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(m.PopupContext.Consumer, null, (e) => this._renderChildren(e, h || D))
                )
              )
            )
          );
