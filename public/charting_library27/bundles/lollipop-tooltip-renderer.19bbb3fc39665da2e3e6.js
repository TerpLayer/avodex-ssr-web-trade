(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9039],
  {
                ...
                (l = [].concat(t(l), [d])),
                  ...
                  (e.ontouchmove = function (t) {
                    ...
                    1 === t.targetTouches.length &&
                      ...
                      !u(o.target) &&
                        ((n && 0 === n.scrollTop && 0 < l) || ((r = n) && r.scrollHeight - r.scrollTop <= r.clientHeight && l < 0)
                          ? p(o)
                          : o.stopPropagation()));
                  }),
                  i || (document.addEventListener("touchmove", p, o ? { passive: !1 } : void 0), (i = !0));
              }
            } else {
              (h = n),
                setTimeout(function () {
            ...
            (e.clearAllBodyScrollLocks = function () {
              r
                ? (l.forEach(function (e) {
                  ...
                  i && (document.removeEventListener("touchmove", p, o ? { passive: !1 } : void 0), (i = !1)),
                  (l = []),
                  (a = -1))
                : (d(), (l = []));
            }),
            (e.enableBodyScroll = function (e) {
              if (r) {
                ...
                (e.ontouchstart = null),
                  ...
                  i && 0 === l.length && (document.removeEventListener("touchmove", p, o ? { passive: !1 } : void 0), (i = !1));
              } else
    ...
    8025: (e, t, o) => {
      ...
      function v(e) {
        const { startIcon: t, endIcon: o, showCaret: a, iconOnly: c, ellipsis: u = !0, textWrap: d, tooltipText: h, children: v } = e;
            ...
            n.createElement(
              ...
              d || u
                ? n.createElement(
                    ...
                    n.createElement(
                      "span",
                      { className: r(!d && u && m()["ellipsis-container"], d && m()["text-wrap-container"], d && u && m()["text-wrap-with-ellipsis"]) },
                      v
                    ),
                    n.createElement("span", { className: m()["visually-hidden"], "aria-hidden": !0 }, v)
                  )
                : n.createElement(n.Fragment, null, v, n.createElement("span", { className: m()["visually-hidden"], "aria-hidden": !0 }, v))
            ),
          (o || a) && ((e) => n.createElement(i.Icon, { className: r(m().icon, e.showCaret && m().caret), icon: e.showCaret ? p : e.endIcon }))(e)
        );
      }
    },
    15893: (e, t, o) => {
      ...
      function i(e) {
        ...
        return n.createElement(
          ...
          n.createElement(l.LightButtonContent, { showCaret: d, startIcon: c, endIcon: h, iconOnly: u, ellipsis: p, textWrap: w, tooltipText: O }, s)
        );
      }
    },
    86332: (e, t, o) => {
      ...
      const n = o(50959).createContext({ isGrouped: !1, cellState: { isTop: !0, isRight: !0, isBottom: !0, isLeft: !0 } });
    },
    17946: (e, t, o) => {
      "use strict";
    ...
    27267: (e, t, o) => {
      ...
      function n(e, t, o, n, r) {
        function l(r) {
          ...
          const l = r.target;
          void 0 !== o && null !== t && null !== l && l.ownerDocument === n && (t.contains(l) || o(r));
        }
        return (
        ...
        i = (e) =>
          Array.isArray(e) || (0, n.isValidElement)(e)
            ? n.Children.toArray(e)
                .reduce((e, t) => {
                  let o = "";
                  return (o = (0, n.isValidElement)(t) && r(t) ? i(t.props.children) : (0, n.isValidElement)(t) && !r(t) ? "" : l(t)), e.concat(o);
                }, "")
                .trim()
            : l(e);
    },
    ...
    41590: (e, t, o) => {
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              f === v.currentDrawer && n.createElement("div", { className: p.backdrop, onClick: o }),
              n.createElement(m, { className: l(h.drawer, p[`position${t}`], d), ref: g, "data-name": e["data-name"] }, u)
            )
          )
        );
      }
      const m = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(u.TouchScrollContainer, { className: l(p.drawer, o), tabIndex: -1, ref: t, ...r });
      });
    },
    20520: (e, t, o) => {
      "use strict";
    ...
    70434: (e, t, o) => {
      ...
      const f = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(
          d.PopupMenu,
          {
            ...
            tabIndex: -1,
            reference: (e) => {
              "function" == typeof t ? t(e) : (0, v.isObject)(t) && (t.current = e), (s.current = e);
            },
            onClose: o,
            onClickOutside: l,
            onKeyDown: c,
      ...
      function g(e) {
        (0, n.useEffect)(() => {
          return (e = y), window.addEventListener("scroll", e), () => window.removeEventListener("scroll", e);
          var e;
        }, []),
          (0, n.useEffect)(() => {
            if (e.length)
      ...
      function E(e) {
        ...
        return n.createElement(
          ...
          o && n.createElement(x.Icon, { icon: o, className: C.lollipopTooltipTitle__icon, style: r }),
      ...
      var T,
        D = o(13668);
      function N(e) {
        const { name: t, value: o, style: r, valueStyle: l, onValueClick: i, valueRightIcon: s, className: c } = e;
        return n.createElement(
          "div",
          { className: a()(D.groupRow, c), style: r },
          t && n.createElement("div", { className: D.groupCell }, n.createElement("span", { className: D.text }, t)),
          n.createElement(
            "div",
            { className: D.groupCell },
            n.createElement("span", { className: D.text, style: l, onClick: i }, o),
            s && n.createElement(x.Icon, { icon: s.iconContent, className: a()(D.groupIcon, s.iconClass, "apply-common-tooltip"), title: s.tooltipText })
          )
        );
      }
      function S(e) {
        const { content: t = [], subTitle: o, cardRowClass: r } = e,
          ...
          i = "string" == typeof o ? o : o.map((e, t) => n.createElement(N, { key: `subTitle${t}`, ...e }));
        return n.createElement("div", { className: r }, n.createElement("span", { className: D.subtitle }, i), l.length > 0 && n.createElement("div", null, l));
      }
      !(function (e) {
        (e[(e.BeforeMarketOpen = D.beforeMarketOpen)] = "BeforeMarketOpen"), (e[(e.AfterMarketClose = D.afterMarketClose)] = "AfterMarketClose");
      })(T || (T = {}));
      function Q(e) {
        var t;
        ...
        return n.createElement(
          ...
          r && ("mob" !== o || !r.hideInMobileMode) && n.createElement("div", { className: D.group }, n.createElement(O, { ...r }))
        );
      }
      var B = o(25105);
      const F = (0, b.mergeThemes)(w.DEFAULT_MENU_THEME, { menuWrap: B.menuWrap, menuBox: B.menuBox });
      function I(e) {
        const {
            tooltips: t,
            onClose: o,
          ...
          n.createElement(c.MatchMedia, { rule: "screen and (max-width: 419px)" }, (e) =>
            e
              ? n.createElement(
                  ...
                  t.map((e, t) => n.createElement("div", { key: `${t}`, className: B.drawerItem }, n.createElement(Q, { cardType: "mob", ...e })))
                )
              : n.createElement(
                  f,
                  { position: i, theme: F, onClose: o, onForceClose: r || o, onClickOutside: l, doNotCloseOn: v },
                  m &&
                    n.createElement(n.Fragment, null, n.createElement("div", { ref: y, className: B.fadeTop, style: D }), n.createElement("div", { ref: w })),
                  n.createElement(
                    "div",
                    { ref: k },
                    t.map((e, t) => {
                      ...
                      return n.createElement(
                        "div",
                        { key: `${t}`, className: M, style: { borderColor: null === (o = e.style) || void 0 === o ? void 0 : o.color } },
                        n.createElement(Q, { cardType: h, ...e })
                      );
                    })
                  ),
                  m &&
                    n.createElement(n.Fragment, null, n.createElement("div", { ref: x }), n.createElement("div", { ref: b, className: B.fadeBottom, style: I }))
                )
          )
        );
      }
      ...
      function Y(e) {
        ...
        return null === M && ((M = document.createElement("div")), document.body.appendChild(M)), r.render(n.createElement(I, { ...t }), M), _;
      }
      function _() {
      ...
      function L(e, t) {
        ...
        return b < n ? ((f = e.marginTop + u.top), (v = Math.max(b, 0))) : (f = u.height + u.top - y - n), { x: g, y: f, overrideHeight: v };
      }
    },
    2948: (e) => {
      e.exports =
