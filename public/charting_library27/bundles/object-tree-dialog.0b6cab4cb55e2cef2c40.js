(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4862],
  {
    ...
    23490: (e) => {
      e.exports = { dropTargetInside: "dropTargetInside-e_nPSSdZ", dropTarget: "dropTarget-e_nPSSdZ", before: "before-e_nPSSdZ", after: "after-e_nPSSdZ" };
    },
    75564: (e) => {
      e.exports = {
        wrap: "wrap-IEe5qpW4",
    ...
    17742: (e) => {
      e.exports = { dialog: "dialog-VUnQLSMH", buttons: "buttons-VUnQLSMH", button: "button-VUnQLSMH", disabled: "disabled-VUnQLSMH" };
    },
    22813: (e) => {
      e.exports = {
    ...
    86332: (e, t, n) => {
      ...
      const o = n(50959).createContext({ isGrouped: !1, cellState: { isTop: !0, isRight: !0, isBottom: !0, isLeft: !0 } });
    },
    95604: (e, t, n) => {
      "use strict";
      function o(e) {
    ...
    67029: (e, t, n) => {
      ...
      const g = { FontSizeMedium: (0, i.ensureDefined)(d()["font-size-medium"]), FontSizeLarge: (0, i.ensureDefined)(d()["font-size-large"]) },
        v = { passive: !1 };
      function m(e, t) {
        const {
            style: n,
          ...
          { isGrouped: M, cellState: D, disablePositionAdjustment: k = !1 } = (0, o.useContext)(a.ControlGroupContext),
    ...
    31261: (e, t, n) => {
        ...
        return o.createElement(h.ControlSkeleton, {
          ...
          middleSlot: o.createElement(
            ...
            o.createElement("input", {
              ...Z,
              className: r(g().input, g()[`size-${R}`], O, F && g()["with-start-slot"], W && g()["with-end-slot"]),
              disabled: B,
              readOnly: P,
              ref: G,
            })
      ...
      function b(e) {
        e = (0, c.useControl)(e);
        const { disabled: t, autoSelectOnFocus: n, tabIndex: r = 0, onFocus: i, onBlur: h, reference: p, containerReference: f = null } = e,
          g = (0, o.useRef)(null),
          v = (0, o.useRef)(null),
          [b, _] = (0, u.useFocus)(),
          S = t ? void 0 : b ? -1 : r,
    ...
    40104: (e, t, n) => {
      ...
      async function s(e, t) {
        return r(e, t.length + 1, (e) => (e < t.length ? (0, o.delay)(null, t[e]) : Promise.resolve()));
      }
    },
    37404: (e, t, n) => {
      "use strict";
    ...
    56396: (e, t, n) => {
      ...
      function W(e) {
        ...
        return o.createElement(
          ...
          !t && o.createElement("div", { className: f(z.title, z.withoutIcon) }, p.t(null, void 0, n(31095)), h),
          o.createElement(
            "div",
            { className: z.buttons },
      ...
      const $ = Z("SET_NODES"),
        ...
        Se = () => ({ type: re }),
        ye = () => ({ type: ie }),
        Ce = (e, t, n, o, r) => ({ type: se, dropTarget: e, dropType: t, isHoveredLeft: n, boundBox: o, isLastChild: r }),
        Te = () => ({ type: te }),
        we = (e) => ({ type: ee, ids: e }),
      ...
      const je = (e) => e.nodes,
        ...
        Ve = (0, Re.createSelector)([(e) => e.disabled, Oe, Fe], (e, t, n) => !t.ids.includes(n) && e.includes(n)),
        ...
        Qe = (0, Re.createSelector)([je, qe], (e, t) => t.reduce((t, n) => [...t, ...Xe(e, (0, M.ensureDefined)(n))], []));
      function Xe(e, t) {
        const n = [];
      ...
      const Je = (0, Re.createSelector)([je, qe, Pe], (e, t, n) => {
        ...
        et = (0, Re.createSelector)([je, Ke, Pe], (e, t, n) => {
          const o = new Set(n);
          return [{ id: "drag-list", level: -1, children: t }].reduce((t, n) => [...t, ...tt(e, (0, M.ensureDefined)(n), o)], []);
        });
      function tt(e, t, n) {
        const o = [];
      ...
      function* nt(e) {
        ...
        !Ze(yield (0, w.select)()) && t.length > 0 && (yield (0, w.put)(De(t[0])), yield (0, w.put)(ke(t[0])));
      }
      function* ot(e) {
        for (;;) {
      ...
      function* rt() {
        for (;;) {
          ...
          const a = dt(t, e === ie ? "next" : "previous", n, l),
            { id: c } = a;
          i.includes(c) && r ? (yield (0, w.put)(Ne(r, !1, 1)), yield (0, w.put)(De(c))) : yield (0, w.put)(Ne(c, !0, 1)), yield (0, w.put)(ke(c));
        }
      }
      function* it(e, t) {
        for (;;) {
      ...
      function* st(e, t = () => !0) {
        for (;;) {
          ...
          const l = new Set(i);
          (i = s.reduce((e, t) => (l.has(t.id) && e.push(t.id), e), [])), e ? e(i) : yield (0, w.put)(we(i)), yield (0, w.put)(De(o));
        }
      }
      function* lt(e = () => !0, t) {
        ...
        u.map((e) => e.id).includes(d.id)
          ...
          : h && e(u, d, o) && (yield (0, w.put)(((e, t, n) => ({ type: le, node: e, dropType: t, boundBox: n }))(d, o, i)));
      }
      function* at(e) {
      ...
      function dt(e, t, n, o) {
        ...
        -1 === o && "previous" === t && (o = r);
        let s = 0;
        for (; !i || (Math.abs(s) < r && (l = i).level > 1 && !He(e, (0, M.ensureDefined)(l.parentId))); )
          (s += "next" === t ? 1 : -1), (i = n[(o + s + r) % r]);
        var l;
        return i;
      }
      function* ht(e = {}) {
        const { saga: t, onDrop: n, canMove: o, onMove: r, onSelect: i, onKeyboardSelect: s, initState: l, canBeAddedToSelection: a } = e,
          c = [(0, w.fork)(at, o), (0, w.fork)(ct, n), (0, w.fork)(st, i, a), (0, w.fork)(it, i, s), (0, w.fork)(rt)];
        for (t && c.push((0, w.fork)(t)), r && c.push((0, w.fork)(ut, r)), a && c.push((0, w.fork)(ot, a)); ; ) {
            ...
            case q: {
              ...
              for (const e of n) {
                ...
                if (r.hasOwnProperty(t)) {
                  !(0, ft.deepEquals)(r[t].children, e.children)[0] && (r[t] = { ...r[t], children: [...e.children] });
                } else {
                  r[t] = e;
                  const { parentId: n } = e;
        ...
        selection: function (e = vt, t) {
          switch (t.type) {
            ...
            case q: {
              ...
              return e.lastFocusedNodeId && !n.has(e.lastFocusedNodeId) && delete e.lastFocusedNodeId, { ...e, ids: e.ids.filter((e) => n.has(e)) };
            }
            default:
              return e;
          }
      ...
      const xt = (e) => {
          ...
          return (
            (yt.CheckMobile.any() || yt.CheckMobile.isIPad()) && ((C = n), (T = { onMouseOut: Nt, onMouseOver: Nt })),
            o.createElement(
              "div",
              {
                className: f(kt.wrap, n && kt.selected, m && kt.childOfSelected, l && kt.disabled, i && kt.expandable),
                onClick:
                  1 === b && 0 === _
                    ? w
                    : function (e) {
      ...
      function jt(e) {
        return (0, pt.bindActionCreators)(
          { setIsExpanded: Le, processDropTarget: Ce, dropSelection: Te, selectNext: _e, selectPrevious: be, setIsSelected: Ne, endDrag: Ae },
          e
        );
      }
      const Ot = (0, H.connect)(Rt, jt, null, { context: At })(function (e) {
          ...
          return o.createElement(Lt, { ...e, connectDragSource: n, connectDropTarget: i, connectDragPreview: r, ref: t });
        }),
      ...
      const Ht = { top: 0, left: 0, position: "fixed", pointerEvents: "none", zIndex: 100, opacity: 0.5, width: 300, backgroundColor: "red" };
      function Vt(e) {
        return { isDragging: e.isDragging() && "node" === e.getItemType(), mousePosition: e.getClientOffset(), dropTargetOffset: e.getSourceClientOffset() };
      }
            ...
            ? o.createElement(
                ...
                o.createElement(
                  ...
                  t.map((e) => {
                    ...
                    return o.createElement(Bt, { id: e.id, key: e.id, nodeRenderer: r, isDragPreview: !0, isOffset: e.level > 1 });
                  })
                )
              )
            : null;
      ...
      const $t = o.forwardRef((e, t) => {
        ...
        return (
          ...
          (0, o.useImperativeHandle)(t, () => ({ getNode: () => (0, M.ensureNotNull)(n.current) }), []),
            ...
            hover: (n, o) => {
              ...
              if ("last" === e.type) {
                const t = r.x - s.left < 48,
                  n = i[i.length - 1],
                  o = t && 2 === n.level ? (0, M.ensureDefined)(i.find((e) => e.id === n.parentId)) : n,
                  a = { top: s.top - l.top, left: s.left - l.left, bottom: s.top - l.top, right: s.left - l.left + s.width, height: s.height, width: s.width };
      ...
      const on = o.forwardRef((e, t) => {
        ...
        return o.createElement("div", { ...e, ref: t }, e.children, n.isOver && o.createElement(nn, { transform: n.transform }));
      });
      var rn = n(38223),
        sn = n(76106);
      ...
      const cn = o.forwardRef(function (e, t) {
        ...
        (0, o.useEffect)(() => {
          ...
          (0, o.useEffect)(() => {
            const e = (e) => {
              ...
              t = (e) => {
                l && ![E.Modifiers.Mod, E.Modifiers.Shift].includes((0, E.modifiersFromEvent)(e)) && i();
              };
            return (
        ...
        const O = (0, o.useCallback)(() => (0, M.ensureNotNull)($.current), []),
          ...
          P = (0, o.useMemo)(() => {
            ...
            t.push({
              type: "padding",
              node: o.createElement(qt, { type: "first", key: "padding-top", getContainerElement: O, getOrderedNodes: B, processDropTarget: N }),
            });
            for (let i = 0; i < r.length; i++) {
              ...
              1 === s.level &&
                (void 0 !== n &&
                  n !== s.parentId &&
                  t.push({ type: "separator", node: o.createElement("div", { key: n + "_separator", className: sn.separator }) }),
                (n = s.parentId)),
                t.push({
                  type: "node",
            ...
            return (
              t.push({
                type: "padding",
                node: o.createElement(qt, { type: "last", key: "padding-bottom", getContainerElement: O, getOrderedNodes: B, processDropTarget: N }),
              }),
              t
            );
          }, [r]),
        ...
        const F = (0, o.useCallback)((e) => {
            ...
            const { index: n } = e;
            return (
              n === z.current.length - 1 && ((t = { ...t, bottom: 0, minHeight: t.height }), delete t.height),
          ...
          H = (0, o.useMemo)(() => (null === m ? { index: -1 } : { index: z.current.findIndex((e) => e.node.key === m.id) }), [m]);
        d(R);
        ...
        const $ = (0, o.useRef)(null),
          ...
          X = (0, o.useRef)({
            startScroll(e) {
              const t = () => {
                null !== K.current && ((Q.current = requestAnimationFrame(t)), K.current.scrollBy({ top: e }));
              };
              this.stopScroll(), t();
            },
            stopScroll() {
      ...
      const un = (0, H.connect)(
          function (e) {
            return { renderList: Je(e), orderedNodes: Qe(e), isMultiSelecting: Ye(e), selectedIds: Ke(e), scrollToId: ze(e) };
          },
          function (e) {
            return (0, pt.bindActionCreators)(
              {
          ...
          const t = (0, o.useRef)(null),
            [{ isOver: n }, r] = (0, _t.useDrop)({
              ...
              drop: (n, o) => {
                var r;
                ("touch" === e.drag || yt.isFF) && (null === (r = t.current) || void 0 === r || r.stopScroll()), o.getItem().dropSelection();
              },
              hover: (n, o) => {
                var r, i;
                ...
                if (null === s) return;
                const l = null !== (i = null === (r = t.current) || void 0 === r ? void 0 : r.getListElement()) && void 0 !== i ? i : null;
                if (null === l) return;
      ...
      function hn(e) {
        ...
        return (
          (0, o.useEffect)(() => {
            ...
            const o = e.run(ht, { initState: n, onKeyboardSelect: u, saga: d, canMove: i, onMove: l, onDrop: s, onSelect: r, canBeAddedToSelection: t });
            return () => o.cancel();
          }, []),
          (0, o.useEffect)(
            () => (null !== v && a && (p && (p.current = performance.now()), v.dispatch(((e) => ({ type: q, nodes: e }))(a))), () => {}),
            [v, a]
          ),
          (0, o.useEffect)(() => {
      ...
      const pn = o.memo(function (e) {
        ...
        return (
          ...
          o.createElement(K.DndProvider, { backend: i, options: dn }, o.createElement(H.Provider, { store: t, context: At }, o.createElement(un, { ...r })))
        );
      });
      function fn(e, t) {
      ...
      function qn(e) {
        const { id: t, isOffset: r, isDisabled: i, isSelected: s, isChildOfSelected: l, isHovered: a, parentId: c, entity: u, isExpanded: d } = e,
          h = (0, o.useContext)(x),
          ...
          [B, P] = (0, o.useState)(!1),
          [z, F] = ((0, Rn.useWatchedValueReadonly)({ watchedValue: g.getChartLayout() }), (0, o.useState)(!1)),
          W = (0, o.useRef)(null);
        (0, o.useEffect)(() => {
          const e = {};
          u.onLockChanged().subscribe(e, () => k(u.isLocked())), u.onVisibilityChanged().subscribe(e, () => L(u.isVisible()));
        ...
        if (c) {
          const e = g.entity(c);
          e && (G["data-parent-name"] = e.title().value()), (G["data-type"] = u.hasChildren() ? "group" : "data-source");
        }
        const H = Nn.enabled("test_show_object_tree_debug") ? `<${u.id()}> (${u.zOrder()}) ${u.title()}` : u.title().value(),
          V = a || B,
          U = b && s,
          K = !!v && v.isTouch,
          Z = !!v && v.isDialog,
        ...
        let q = null;
        return (
          T && T.type === kn.Svg && (q = o.createElement(D.Icon, { icon: T.content || "", className: Yn.icon })),
          o.createElement(
            "span",
            {
              className: f(
              ...
              onClick:
                1 === m
                  ...
                  : function (e) {
                      ...
                      if (W.current) e.preventDefault(), clearTimeout(W.current), (W.current = null), g.openProperties(u), F(!1);
                      else {
                        const e = g.selection().selected();
                        W.current = setTimeout(() => {
                          (W.current = null), s && !z && 1 === e.length && g.rename(u, () => _(!0)), F(!1);
                        }, 500);
                      }
                    },
            ...
            !U &&
              o.createElement(
                ...
                q,
                !1,
                o.createElement("span", { className: f(Yn.title, g.isMain(u) && Yn.main, (!u.isVisible() || !A) && Yn.disabled), ...G }, H),
                o.createElement(
                  "span",
                  ...
                  o.createElement(An, {
                    icon: Y,
                    className: f(Yn.button, !A && Yn.warn, (V || !N || !A) && Yn.visible, "apply-common-tooltip"),
                    onClick: A
                      ? function (e) {
                          if (e.defaultPrevented) return;
        ...
        function Q(e) {
          e.defaultPrevented || b || !u.fullyConstructed() || (e.preventDefault(), e.persist(), g.openContextMenu(u, () => _(!0), e));
        }
        function X() {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              null,
              s &&
                o.createElement(b.Drawer, { onClose: M, position: "Bottom" }, o.createElement(T.ManageDrawings, { onClose: M, chartWidget: i, isMobile: !0 }))
            )
          )
        );
        function E() {
      ...
      function eo(e) {
        ...
        return o.createElement(Et.Provider, { value: r }, o.createElement(Mn, { nodeRenderer: $n, showHeader: !1, viewModel: n, isDialog: !0 }));
      }
      var to = n(16216),
        no = n(98310),
        oo = n(57898);
      ...
      class lo {
        ...
        set(e) {
          ...
          this._selectionApi.set(t.map((e) => so(e).persistentId)), (this._selected = n), this._onChange.fire(this._selected);
        }
        ...
        buildTree() {
          ...
          for (const t of this._controller.model().panes()) {
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (r.pane() === t) {
                const o = [...n.lineTools()].sort((e, t) => (e.zorder() > t.zorder() ? -1 : 1)).map((e) => io(e.id(), e.instanceId()));
      ...
      const wo = new uo.TranslatedString("show {title}", p.t(null, void 0, n(87358))),
        ...
        Do = new uo.TranslatedString("change {sourceTitle} title to {newSourceTitle}", p.t(null, void 0, n(40001))),
      ...
      function xo(e) {
        return e instanceof go.DataSource && e.showInObjectTree() ? io(e.id(), e.instanceId()) : null;
      }
      function Ao(e) {
      ...
      class Bo {
          ...
          (this._syncStateChanged = new oo.Delegate()),
            ...
            (0, po.isLineTool)(t)
              ? (t.linkKey().subscribe(this._updateSyncState),
                ...
                (this._title = (0, vo.createWVFromGetterAndSubscription)(() => t.properties().title.value() || t.translatedType(), t.properties().title)))
              : (0, mo.isSymbolSource)(t)
              ? (this._title = (0, vo.createWVFromGetterAndSubscriptions)(
                  () => t.symbolTitle(So.TitleDisplayTarget.DataWindow, void 0, void 0, (0, yt.onWidget)() ? "exchange" : "listed_exchange"),
              ...
              ? (this._title = (0, vo.createWVFromGetterAndSubscriptions)(
                  ...
                  [
                    ...
                    this._undoModel.model().properties().childs().paneProperties.childs().legendProperties.childs().showStudyArguments,
                    t.onParentSourcesChanges(),
                  ]
                ))
              : (this._title = new ho.WatchedValue(t.title(So.TitleDisplayTarget.DataWindow)).spawn());
          const n = this._undoModel.lineBeingCreated();
          null !== n && n === t && n.isSynchronizable() && _o.isToolCreatingNow.subscribe(this._updateSyncState);
        }
        destroy() {
          (0, po.isLineTool)(this._dataSource) &&
            (this._dataSource.linkKey().unsubscribe(this._updateSyncState), this._dataSource.sharingMode().unsubscribe(this._updateSyncState)),
            this._title.destroy(),
        ...
        gaLabel() {
          return (0, fo.isStudy)(this._dataSource) ? "Study" : (0, po.isLineTool)(this._dataSource) ? "Drawing" : "Symbol";
        }
        canBeLocked() {
        ...
        isActualInterval() {
          return (!(0, po.isLineTool)(this._dataSource) && !(0, fo.isStudy)(this._dataSource)) || this._dataSource.isActualInterval();
        }
        onIsActualIntervalChange() {
          return (0, po.isLineTool)(this._dataSource) || (0, fo.isStudy)(this._dataSource) ? this._dataSource.onIsActualIntervalChange() : Ro;
        }
        isLocked() {
          return !!(0, po.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value();
        }
        onVisibilityChanged() {
          return this._dataSource.properties().visible.listeners();
        }
        onLockChanged() {
          return (0, po.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : Ro;
        }
        getIcon() {
          const e = a,
        ...
        setName(e) {
          if ((0, po.isLineTool)(this._dataSource)) {
            const t = Do.format({ sourceTitle: this._dataSource.properties().title.value() || Ao(this._dataSource), newSourceTitle: e });
      ...
      class Po {
        ...
        isActualInterval() {
          return (
            this._group.lineTools().length > 0 && (this._lastIsActualInterval = this._group.lineTools().some((e) => e.isActualInterval())),
        ...
        childrenIds() {
          ...
          return e.sort((e, t) => t.zorder() - e.zorder()), new Set(e.map((e) => io(e.id(), e.instanceId())));
        }
        hasChildren() {
          return !0;
        }
        ...
        getDrawingSyncState() {
          ...
          if (jo) {
            const t = null === (e = this._lineTools[0]) || void 0 === e ? void 0 : e.sharingMode().value();
        ...
        _insertBeforeTarget() {
          return (0, M.ensureNotNull)(this._lineTools.reduce((e, t) => (null === e ? t : e.zorder() < t.zorder() ? e : t), null));
        }
        _insertAfterTarget() {
          return (0, M.ensureNotNull)(this._lineTools.reduce((e, t) => (null === e ? t : e.zorder() > t.zorder() ? e : t), null));
        }
      ...
      class zo {
        ...
        canBeGroupped(e) {
          ...
          const t = [];
          if ((e.forEach((e) => e.addSourcesToArray(t)), t.some((e) => !(0, po.isLineTool)(e) || !e.boundToSymbol()))) return !1;
          const n = this._undoModel.model(),
      ...
      class or {
            ...
            : (this.selection().set([e]),
              null !== n
                ? this._controller.mainSeries() === n
                  ...
                  : ((0, po.isLineTool)(n) || (0, fo.isStudy)(n)) && this._chart.value().showChartPropertiesForSource(n, t, { shouldReturnFocus: !0 })
        ...
        canNodeWithIdBeUnmerged(e) {
          ...
          return null !== t && (0, Fo.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t);
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) => (0, M.ensureNotNull)(this._model.dataSourceForId(so(e.id()).persistentId)));
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), fn("Copy", gn(e));
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) => (0, M.ensureNotNull)(this._model.dataSourceForId(so(e.id()).persistentId)));
          t.every(po.isLineTool) && (this._controller.cloneLineTools([...t], !1), fn("Clone", gn(e)));
        }
        rename(e, t) {
        ...
        async openContextMenu(e, t, n) {
          ...
          if (this._objects.some((e) => e.hasChildren())) i = this._getActionsForGroupItem(e, t, r);
            ...
            if (
              ((i = Array.from(e).filter((e, t, n) => "separator" !== e.type || !n[t + 1] || "separator" !== n[t + 1].type)),
          ...
          if (i.length > 0) {
            ...
            (a = s
              ...
              : (0, po.isLineTool)(r)
              ? { menuName: "ObjectTreeContextMenu", detail: { type: "shape", id: null !== (o = null == r ? void 0 : r.id()) && void 0 !== o ? o : null } }
              : l
              ? {
              ...
              : { menuName: "ObjectTreeContextMenu", detail: { type: "study", id: (null == r ? void 0 : r.id()) || null } }),
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          const r = [];
          1 === this._objects.length && r.unshift(this._getRenameAction(t), new Go.Separator()), n && r.unshift(this._getGroupAction(), new Go.Separator());
          ...
          return (
            r.push(
              new Go.Action({
                ...
                options: { label: e.isLocked() ? Bn : Pn, icon: e.isLocked() ? Ho : Vo, onExecute: () => this.setIsLocked(e.id(), !e.isLocked()) },
              }),
              new Go.Action({
                actionId: "ObjectsTree.ToggleItemVisibility",
                options: { label: e.isVisible() ? zn : Fn, icon: e.isVisible() ? Uo : Ko, onExecute: () => this.setIsVisible(e.id(), !e.isVisible()) },
              }),
              new Go.Action({
                actionId: "ObjectsTree.RemoveItem",
                options: { label: Wn, icon: Yo, onExecute: () => this.remove(e.id()), hotkeyHash: E.isMacKeyboard ? 8 : 46 },
              }),
              new Go.Separator(),
              new Go.Action({ actionId: s.actionId, options: { label: s.label, icon: s.icon, onExecute: () => this.openProperties(e) } })
            ),
            r
          );
        }
        ...
        _normalizeTargetAndDropType(e, t) {
          ...
          return "inside" === t && ((t = "before"), (n = (0, M.ensureNotNull)(this.entity([...n.childrenIds()].shift() || "")))), [n, t];
        }
        _getSelectedEntities() {
          ...
          return t.length && qo.logWarn(`Detected dangling sources in selection. They will be ignored: ${JSON.stringify(t)}`), e;
        }
        _getEntityById(e) {
          return this._facade.getObjectById(e);
        }
      ...
      class ir extends rr.DialogRenderer {
        constructor() {
          ...
          (this._activeChartWidget = e.activeChartWidget.value()), (this._viewModel = new or(e.activeChartWidget));
        }
        hide() {
          this._handleClose();
        }
        ...
        show() {
          h().then(() => {
            null !== this._viewModel &&
              (r.render(
                o.createElement(Jn, { onClose: this._handleClose, viewModel: this._viewModel, activeChartWidget: this._activeChartWidget }),
                this._container
              ),
    ...
    63932: (e, t, n) => {
      ...
      n(83135);
      function s(e) {
        const t = r(e.className, "tv-spinner", "tv-spinner--shown", `tv-spinner--size_${i.spinnerSizeMap[e.size || i.DEFAULT_SIZE]}`);
    ...
    54079: (e, t, n) => {
      ...
      const d = (0, o.forwardRef)(function (e, t) {
        const { onKeyDown: n, orientation: d, blurOnEscKeydown: h = !0, blurOnClick: p = !0, ...f } = e,
        ...
        return (
          (0, o.useLayoutEffect)(() => {
            ...
            return window.addEventListener("keyboard-navigation-activation", t), () => window.removeEventListener("keyboard-navigation-activation", t);
          }, []),
