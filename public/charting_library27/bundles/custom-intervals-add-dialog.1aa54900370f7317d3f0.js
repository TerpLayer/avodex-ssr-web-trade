(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4013],
  {
    ...
    86332: (e, t, n) => {
      ...
      const l = n(50959).createContext({ isGrouped: !1, cellState: { isTop: !0, isRight: !0, isBottom: !0, isLeft: !0 } });
    },
    36104: (e, t, n) => {
      "use strict";
      ...
      function o(e) {
        ...
        return { ...i, isFocused: a, highlight: null != n ? n : a, intent: null != t ? t : a ? "primary" : "default" };
      }
    },
    34094: (e, t, n) => {
      "use strict";
      ...
      const o = (e) => (0, l.isValidElement)(e) && Boolean(e.props.children),
        a = (e) => (null == e || "boolean" == typeof e || "{}" === JSON.stringify(e) ? "" : e.toString() + " "),
        i = (e) =>
          Array.isArray(e) || (0, l.isValidElement)(e)
            ? l.Children.toArray(e)
                .reduce((e, t) => {
                  let n = "";
                  return (n = (0, l.isValidElement)(t) && o(t) ? i(t.props.children) : (0, l.isValidElement)(t) && !o(t) ? "" : a(t)), e.concat(n);
                }, "")
                .trim()
            : a(e);
    },
    59054: (e, t, n) => {
      ...
      function h(e) {
        ...
        return l.createElement("span", { className: a()(m.button, n && m.disabled, t) }, l.createElement(p, { isDropped: o }));
      }
      var v = n(66986);
      const b = l.forwardRef((e, t) => {
        const {
          ...
          z = (0, l.useRef)(null),
          M = !m && l.createElement(s.EndSlot, null, l.createElement(h, { isDropped: g, disabled: f, className: S }));
        return l.createElement(d.PopupMenuDisclosureView, {
          ...
          button: l.createElement(r.ControlSkeleton, {
            ...
            middleSlot: l.createElement(s.MiddleSlot, null, l.createElement("span", { className: a()(v["button-children"], m && v.hiddenArrow) }, _)),
            endSlot: M,
          }),
          popupChildren: N,
          repositionOnScroll: x,
    ...
    90405: (e, t, n) => {
      ...
      function g(e, t) {
        var n;
        return null !== (n = null == t ? void 0 : t.id) && void 0 !== n ? n : (0, a.createDomId)(e, "item", null == t ? void 0 : t.value);
      }
      function C(e) {
        var t, n;
        const { selectedItem: o, placeholder: a } = e;
        if (!o) return l.createElement("span", { className: b.placeholder }, a);
        const i = null !== (n = null !== (t = o.selectedContent) && void 0 !== t ? t : o.content) && void 0 !== n ? n : o.value;
      ...
      const x = l.forwardRef((e, t) => {
        ...
        const {
            ...
            listboxRef: te,
            buttonAria: ne,
          } = (0, h.useControlDisclosure)({ id: n, disabled: T, buttonTabIndex: I, intent: k, highlight: y, onFocus: N, onBlur: S, onClick: L }),
          le = W.filter(f),
        ...
        const ue = (0, a.joinDomIds)(_, n),
          ...
          me = (0, l.useMemo)(() => ({ role: "listbox", "aria-labelledby": _, "aria-activedescendant": g(n, oe) }), [_, oe]),
                  ...
                  (n
                    ...
                    : !e.readonly &&
                      (("string" == typeof e.content && e.content.toLowerCase().startsWith(o)) ||
                        ("string" == typeof e.textContent && e.textContent.toLowerCase().startsWith(o)) ||
        ...
        return l.createElement(
          p.ControlDisclosureView,
          {
            ...
            buttonChildren: l.createElement(C, { selectedItem: null != oe ? oe : null, placeholder: E }),
            repositionOnScroll: M,
          },
          W.map((e, t) => {
            var o;
            if (e.readonly) return l.createElement(l.Fragment, { key: `readonly_item_${t}` }, e.content);
            const a = g(n, e);
    ...
    89872: (e) => {
      e.exports = { scrollable: "scrollable-uT4IUFMG", content: "content-uT4IUFMG", row: "row-uT4IUFMG", title: "title-uT4IUFMG", control: "control-uT4IUFMG" };
    },
    44762: (e, t, n) => {
      "use strict";
              ...
              l.createElement(
                ...
                l.createElement(
                  ...
                  l.createElement(
                    ...
                    l.createElement(i.Select, { id: "metric-items", className: c.control, value: v, items: m, onChange: I })
                  ),
                  l.createElement(
                    "div",
                    { className: c.row },
                    l.createElement("div", { className: c.title }, o.t(null, void 0, n(69466))),
                    l.createElement(r.InputControl, { className: c.control, inputMode: "numeric", maxLength: 6, value: f, onChange: C })
                  )
                )
              ),
