(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1584],
  {
    ...
    90186: (e, t, n) => {
      ...
      n.d(t, { filterAriaProps: () => o, filterDataProps: () => r, filterProps: () => i, isAriaAttribute: () => s, isDataAttribute: () => a });
    },
    52778: (e, t, n) => {
      "use strict";
      ...
      class i extends r.PureComponent {
        ...
        componentDidUpdate(e, t) {
          !t.stack.length && this.state.stack.length && ((0, o.setFixedBodyState)(!0), (this._isBodyFixed = !0)),
            t.stack.length && !this.state.stack.length && this._isBodyFixed && ((0, o.setFixedBodyState)(!1), (this._isBodyFixed = !1));
        }
    ...
    41590: (e, t, n) => {
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              p === v.currentDrawer && r.createElement("div", { className: d.backdrop, onClick: n }),
              r.createElement(h, { className: i(f.drawer, d[`position${t}`], m), ref: E, "data-name": e["data-name"] }, l)
            )
          )
        );
      }
      const h = (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(l.TouchScrollContainer, { className: i(d.drawer, n), tabIndex: -1, ref: t, ...o });
      });
    },
    86431: (e, t, n) => {
      "use strict";
    ...
    81261: (e, t, n) => {
      "use strict";
      n.d(t, { focusFirstMenuItem: () => u, handleAccessibleMenuFocus: () => s, handleAccessibleMenuKeyDown: () => c, queryMenuElements: () => m });
      var r = n(16838),
        o = n(71468),
        i = n(68335);
      const a = [37, 39, 38, 40];
      function s(e, t) {
        e.target && r.PLATFORM_ACCESSIBILITY_ENABLED && e.relatedTarget === t.current && u(e.target);
      }
      function c(e) {
        var t;
      ...
      function m(e) {
        return Array.from(e.querySelectorAll('[data-role="menuitem"]:not([disabled]):not([aria-disabled])')).filter((0, r.createScopedVisibleElementFilter)(e));
      }
      function h(e) {
        return Array.from(e.querySelectorAll("[tabindex]:not([disabled]):not([aria-disabled])")).filter((0, r.createScopedVisibleElementFilter)(e));
      }
    },
    71468: (e, t, n) => {
      "use strict";
      ...
      class c {
        ...
        show(e) {
          this._onShow && this._onShow(),
            ...
            this._render({
              ...
              position: (t) => {
                var n, r, o, i, s, c, u;
                const { contentWidth: l, contentHeight: d, availableWidth: m, availableHeight: h } = t;
                let f;
                if (void 0 !== e.box) f = e.box;
                else {
                  f = {
                    x: null !== (r = null === (n = e.touches) || void 0 === n ? void 0 : n[0].clientX) && void 0 !== r ? r : e.clientX,
                    y: null !== (i = null === (o = e.touches) || void 0 === o ? void 0 : o[0].clientY) && void 0 !== i ? i : e.clientY,
                    w: 0,
                    h: 0,
                  };
                }
        ...
        _unmount() {
          (this._isShown = !1),
            ...
            this._returnFocus && this._activeElement instanceof HTMLElement && this._activeElement.focus({ preventScroll: !0 });
        }
        _render(e) {
          o.render(r.createElement(s.SlotContext.Provider, { value: this._manager }, r.createElement(i.OverlapContextMenu, { ...e })), this._root);
        }
      }
    },
    25931: (e, t, n) => {
