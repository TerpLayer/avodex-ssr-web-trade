  ...
  [6408],
  {
    ...
    16181: (t, e, i) => {
      ...
      class d extends s.PureComponent {
        ...
        render() {
          const { rounded: t = !0, shadowed: e = !0, fullscreen: i = !1, darker: n = !1, className: r, backdrop: d, containerTabIndex: c = -1 } = this.props,
      ...
      function _(t) {
        return { x: (0, p.clamp)(t.x, 20, document.documentElement.clientWidth - 20), y: (0, p.clamp)(t.y, 20, window.innerHeight - 20) };
      }
      function m(t) {
        ...
        constructor(t, e, i = { boundByScreen: !0 }) {
          (this._drag = null),
            ...
            (this._onTouchDragStart = (t) => {
              ...
              (this._canBeTouchClick = !0), t.preventDefault(), this._header.addEventListener("touchmove", this._onTouchDragMove, { passive: !1 });
              const e = _(f(t));
              this._dragStart(e);
            }),
        ...
        centerAndFit() {
          ...
          if (i === s)
            if (this._calculateDialogPosition) {
              const { left: t, top: e } = this._calculateDialogPosition(this._dialog, document.documentElement, this._guard);
      ...
      class F extends s.PureComponent {
          ...
          return s.createElement(
            ...
            s.createElement(u.OutsideEvent, { mouseDown: !0, touchStart: !0, handler: this.props.onClickOutside }, (t) =>
              s.createElement(
                ...
                s.createElement(
                  d,
                  { style: this._applyAnimationCSSVariables(), ...this.props, reference: this._handleDialogRef, className: o(T.dialog, this.props.className) },
                  !1,
                  this.props.children
                )
              )
        ...
        componentDidUpdate() {
          if (this._resize) {
            ...
            this._resize.updateOptions({ guard: t, calculateDialogPosition: e }), this._resize.setFullscreen(this._isFullScreen());
          }
      ...
      (F.contextType = E.PortalContext), (F.defaultProps = { boundByScreen: !0, draggable: !0, centeredOnMount: !0, shouldReturnFocus: !0 });
