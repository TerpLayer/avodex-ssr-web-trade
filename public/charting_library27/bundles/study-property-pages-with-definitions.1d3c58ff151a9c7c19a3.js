  ...
  [607],
  {
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs().styles.childs(),
            ...
            T = (0, l.createLinePropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, new o.StudyPlotVisibleProperty(r.display), d.format({ title: n })),
                color: (0, l.getColorDefinitionProperty)(this._propertyApplier, r.color, e.transparency, c.format({ title: n })),
            ...
            N = (0, l.createLinePropertyDefinition)(
              {
                checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, new o.StudyPlotVisibleProperty(L.display), p.format({ title: n })),
                color: (0, l.getColorDefinitionProperty)(this._propertyApplier, L.color, e.transparency, y.format({ title: n })),
          ...
          return {
            definitions: [
              ...
              (0, l.createLinePropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, new o.StudyPlotVisibleProperty(M.display), _.format({ title: n })),
                  color: (0, l.getColorDefinitionProperty)(this._propertyApplier, M.color, e.transparency, m.format({ title: n })),
              ...
              (0, l.createCheckablePropertyDefinition)(
                { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.extendLines, w.format({ title: n })) },
                { id: `${i}ExtendLines`, title: D }
              ),
              (0, l.createCheckablePropertyDefinition)(
                { checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.showPearsons, k.format({ title: n })) },
    ...
    89204: (e, t, i) => {
      ...
      class O extends class {
              ...
              for (const b of t) {
                ...
                if ("resolution" === b.type)
                  ...
                  f = (0, s.createSymbolPropertyDefinition)(
                    { symbol: (0, s.getSymbolDefinitionProperty)(e, t, i, n, u.format({ inputName: v }), d.customSymbolInputSetter) },
                    { id: _, title: m }
                  );
                  ...
                  const t = { id: _, title: m, type: "float" === b.type || "price" === b.type ? 1 : 0, defval: b.defval };
                  void 0 !== b.min && (t.min = new c.WatchedValue(b.min)),
                    ...
                    (f = (0, s.createNumberPropertyDefinition)({ value: (0, s.convertToDefinitionProperty)(e, l[b.id], u.format({ inputName: v })) }, t));
                } else
        ...
        destroy() {
          this._source.properties().childs().style.unsubscribeAll(this), this._source.symbolResolved().unsubscribeAll(this), super.destroy();
        }
        _customSymbolInputSetter() {
          return (e) => {
        ...
        _stylePropertyDefinitions() {
          ...
          return { definitions: [(0, s.createPropertyDefinitionsGeneralGroup)([t, ...this._getSeriesStylesDefinitions()], `SeriesStyleGroup${a}`), i, n] };
        }
        ...
        _availableStyles() {
          ...
          return X.map((t) =>
            t.readonly
              ? t
              : { readonly: !1, value: t.value, title: t.title, disabled: (0, I.isCloseBasedSymbol)(e) && !(0, I.isSingleValueBasedStyle)(t.value) }
          );
        }
      }
    },
