(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4713],
  {
    ...
    53209: (e) => {
      e.exports = { container: "container-PNiXwSz6", icon: "icon-PNiXwSz6", tooltip: "tooltip-PNiXwSz6", date: "date-PNiXwSz6", time: "time-PNiXwSz6" };
    },
    20111: (e) => {
      e.exports = {
    ...
    44022: (e) => {
      e.exports = { errors: "errors-bghR31WL", show: "show-bghR31WL", error: "error-bghR31WL", "visually-hidden": "visually-hidden-bghR31WL" };
    },
    40461: (e) => {
      e.exports = { "error-icon": "error-icon-UhKAouIg", "intent-danger": "intent-danger-UhKAouIg", "intent-warning": "intent-warning-UhKAouIg" };
    },
    78634: (e) => {
    ...
    1405: (e, t, n) => {
      ...
      n(50959);
      const s = {
        bottom: { attachment: { horizontal: "left", vertical: "top" }, targetAttachment: { horizontal: "left", vertical: "bottom" } },
        top: { attachment: { horizontal: "left", vertical: "bottom" }, targetAttachment: { horizontal: "left", vertical: "top" } },
        topRight: { attachment: { horizontal: "right", vertical: "bottom" }, targetAttachment: { horizontal: "right", vertical: "top" } },
        bottomRight: { attachment: { horizontal: "right", vertical: "top" }, targetAttachment: { horizontal: "right", vertical: "bottom" } },
      };
    },
    15499: (e, t, n) => {
      "use strict";
      ...
      const r = [
        ...
        v = { setMonth: s.t(null, void 0, n(92702)), setYear: s.t(null, void 0, n(52051)), setDecades: s.t(null, void 0, n(99990)) };
      var w;
      !(function (e) {
      ...
      function S(e, t) {
        switch (e) {
          ...
          case w.Decades:
            return v.setDecades.format({ year_start: "" + (t.getFullYear() - y), year_end: "" + (t.getFullYear() - 1) });
        }
      }
      function k(e, t) {
        switch (e) {
          ...
          case w.Year:
            return v.setYear.format({ year: `${t.getFullYear() + 1}` });
          case w.Decades:
            return v.setDecades.format({ year_start: `${t.getFullYear() + y}`, year_end: "" + (t.getFullYear() + 2 * y - 1) });
        }
      }
      function N(e, t) {
        switch (e) {
    ...
    28746: (e, t, n) => {
      ...
      function l(e) {
        ...
        return s.createElement(
          ...
          s.createElement(a.LightButton, { size: "small", variant: "ghost", "aria-label": r, onClick: f, disabled: h, onKeyDown: w, reference: p }, l),
          s.createElement(a.LightButton, {
            startIcon: o,
            onClick: g,
            size: "small",
      ...
      var p = n(78869),
        m = n(68335);
      function g({ isDisabledDate: e, findDate: t, getFirstDate: n, getLastDate: r, setNext: a, setPrev: o, dateToFocus: i, verticalOffset: l, dateLevel: u }) {
        const [h, d] = (0, p.useRefsMap)(),
          g = (0, s.useCallback)((t) => (t ? (e(t) ? null : t) : null), [e]),
          f = (0, s.useCallback)(
            (n, s) => {
              if (!n) return null;
              const r = (0, c.getCloneDateWithOffset)({ dateFrom: n, offset: s, isDisabledDate: e, level: u });
              return g(t(r));
            },
            [t, g]
          ),
          ...
          ),
          {
            ...
            focusItem: C,
            bindings: E,
          } = (function ({ refsMap: e, verticalOffset: t, getNextKeyToFocus: n, getFirstKey: r, getLastKey: a, onGridEnd: o }) {
        ...
        return (
          ...
          { itemsRefs: h, setItemRef: d, ensureNotDisabledDate: g, currentlyFocused: b, setCurrentlyFocused: y, focusItem: C, bindings: E }
        );
      }
      function f(e) {
        const {
          ...
          _ = (0, s.useCallback)((e) => D || (0, c.isDayDisabled)({ day: e, minDate: p, maxDate: h, disableWeekends: m }), [p, h, m, D]),
          {
            itemsRefs: F,
            setItemRef: M,
            currentlyFocused: S,
      ...
      function v(e) {
        ...
        return (
          ...
          s.createElement(
            s.Fragment,
            null,
            s.createElement("div", { className: i["sub-header"], "aria-hidden": !0 }, s.createElement("span", null, u.SUB_HEADER_YEAR)),
            s.createElement(
              "div",
      ...
      function w(e) {
        ...
        return (
          ...
          s.createElement(
            s.Fragment,
            null,
            s.createElement("div", { className: i["sub-header"], "aria-hidden": !0 }, s.createElement("span", null, u.SUB_HEADER_DECADES)),
            s.createElement(
              "div",
      ...
      class D {
        ...
        addMessage(e, t = 0) {
          ...
          return (
            this._messagesQueue.push(s), this._renderedMessage || this._renderMessage(), { ...s, type: this._type, destroy: this._getDestroyMessageCallback(n) }
          );
        }
        destroyAll() {
          var e;
        ...
        async _renderMessage() {
          ...
          (this._renderedMessage = { ...t, renderedTo: e, destroyTimer: n, destroyPromise: s }), (this._alternate = !this._alternate);
        }
      }
      class b extends D {}
      const y = new (class {
      ...
      function C({ viewType: e, decadesStartYear: t, viewDate: n, setPrev: r, setNext: a, switchViewType: o }) {
        const [i, l] = (0, s.useState)(null),
          c = (0, s.useCallback)(
            (e) => {
        ...
        return {
          onPrevClick: (0, s.useCallback)(() => {
            c((0, u.getPrevLiveRegionConfirmation)(e, e === u.CalendarViewType.Decades ? t : n)), r(null);
          }, [r, c]),
          onNextClick: (0, s.useCallback)(() => {
            c((0, u.getNextLiveRegionConfirmation)(e, e === u.CalendarViewType.Decades ? t : n)), a(null);
          }, [a, c]),
            ...
            const n = (0, s.useRef)(null),
              ...
              c = (0, s.useCallback)(
                (e) => {
                  ...
                  e.preventDefault(),
                    e.stopPropagation(),
                    t ? null === (s = l.current) || void 0 === s || s.focus() : null === (n = i.current) || void 0 === n || n.focus();
                },
                [t]
              );
            return { focusableDateRef: n, prevRef: i, middleRef: l, onPrevKeyDown: a, onMiddleKeyDown: o, forwardFocusToStart: c };
      ...
      class D extends r.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleFocus = (e) => {
              var t, n;
              this.props.showOnFocus && this.props.onShowPicker(), null === (n = (t = this.props).onFocus) || void 0 === n || n.call(t, e);
            }),
            ...
            (this._handleDropdownKeydown = (e) => {
              var t;
              27 === (0, v.hashFromEvent)(e) && (null === (t = this._input) || void 0 === t || t.focus(), this.props.onHidePicker());
            }),
            (this.state = { value: e.value, valueFromProps: e.value });
        }
        render() {
          const { position: e = "fixed", className: t, size: n, disabled: s, readonly: o, errors: i, icon: l, InputComponent: c = d.FormInput } = this.props;
          return r.createElement(
              ...
              endSlot:
                i && i.length
                  ...
                  : r.createElement(
                      m.EndSlot,
                      null,
                      r.createElement(h.Icon, { icon: l, className: a(w.icon, s && w.disabled), onClick: s || o ? void 0 : this.props.onShowPicker })
                    ),
            ...
            this.props.showPicker && !o
              ? r.createElement(
                  ...
                  r.createElement(g.OutsideEvent, { mouseDown: !0, handler: this.props.onHidePicker }, (t) =>
                    r.createElement(
                      "span",
                      { ref: t, style: { pointerEvents: "auto" } },
                      r.createElement(
                        "div",
                        { className: a(w.picker, w[e]), key: "0", ref: this._onShowPicker, onKeyDown: this._handleDropdownKeydown },
                        this.props.children
                      )
                    )
                  )
      ...
      class b extends r.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onBlur = () => {
              this._nativeInputRef.current && (this._nativeInputRef.current.defaultValue = this.props.value), this.setState({ isFocused: !1 });
            }),
            (this._onChange = (e) => {
        ...
        render() {
          const { className: e, containerClassName: t, disabled: n, errors: s, InputComponent: o = d.FormInput } = this.props,
          ...
          return r.createElement(
            ...
            r.createElement(o, {
              ...
              endSlot:
                s && s.length
                  ? void 0
                  : r.createElement(m.EndSlot, null, r.createElement(h.Icon, { icon: this.props.icon, className: a(w.icon, n && w.disabled) })),
              className: e,
          ...
          super(e),
            ...
            (this._onPickerInputKeyDown = (e) => {
              ...
              if ([v.Modifiers.Shift + 9, 9].includes(t)) this._hideCalendar();
                ...
                if (40 === t) return e.preventDefault(), this._showCalendar(), void this.setState({ autofocusCalendar: !0 });
                13 === t && this.props.onEnter && this.props.onEnter(e), this._hideCalendar();
              }
            }),
            (this._returnFocusToInput = () => {
              var e;
              this.setState({ autofocusCalendar: !1 }), null === (e = this._pickerInpuRef.current) || void 0 === e || e.focus();
            }),
            (this._fixValue = (e) => ((e = (e = e.substring(0, 10)).replace(/-+/g, "-")), (/^\d{4}$/.test(e) || /^\d{4}-\d{2}$/.test(e)) && (e += "-"), e)),
            (this._isValid = (e) => {
              ...
              if (t.res && /^[0-9]{4}(-[0-9]{2}){2}/.test(t.value)) {
                ...
                return (
                  ...
                  (!!(this.props.noRangeValidation || (i.mobiletouch && o.isIOS)) || (0, y.isInRange)(e, this.props.minDate, this.props.maxDate))
                );
              }
              return !1;
            }),
            (this._onBlur = (e) => {
              ...
              if (
                ...
                (null === (t = this._pickerInputContainerRef.current) || void 0 === t ? void 0 : t.contains(e.relatedTarget))
              )
                return;
    ...
    23935: (e, t, n) => {
      ...
      function N({ dateFrom: e, offset: t, level: n = "day", maxIterations: s = 6, isDisabledDate: r = () => !1 }) {
      ...
      function R({ selectedDate: e, dateToFocus: t, currentlyFocused: n, firstEnabledDate: s, getFirstDate: r, getLastDate: a, isDisabledDate: o }) {
    ...
    36565: (e, t, n) => {
      ...
      function b(e, t, n) {
        ...
        for (; a < i && o < l; ) {
          ...
          l
            ? (i.match(l.pattern)
                ? (s.push(i), l.recursive && (-1 === c ? (c = a) : a === d && a !== c && (a = c - 1), d === c && (a -= 1)), (a += 1))
                : i === m
                ? (u--, (m = void 0))
                : l.optional
                ? ((a += 1), (o -= 1))
              ...
              (o += 1))
            : (t || s.push(n), i === n ? (h.push(o), (o += 1)) : ((m = n), h.push(o + u), u++), (a += 1));
        }
        const g = e.charAt(d);
        i !== l + 1 || D[g] || s.push(g);
        const f = s.join(""),
      ...
      function N(e) {
        ...
        const P = (0, v.useOutsideEvent)({
          ...
          touchStart: !0,
          handler: function (e) {
            null !== s.current && C && e.target instanceof Node && null !== a.current && !a.current.contains(e.target) && s.current.blur();
          },
        });
        return r.createElement(
          "div",
    ...
    95263: (e, t, n) => {
      ...
      class m extends s.PureComponent {
        render() {
          const { children: e = [], show: t = !1, customErrorClass: n, disableRtlStyles: a, messageIdCallback: o } = this.props,
      ...
      const g = (0, u.makeOverlapable)(
        ...
        ((v = class extends s.PureComponent {
          ...
          componentDidUpdate(e) {
            (e.children === this.props.children && e.top === this.props.top && e.left === this.props.left && e.width === this.props.width) ||
          ...
          _calcProps(e) {
            if (e.target && e.attachment && e.targetAttachment) {
              ...
              if (null === t) return {};
              const { width: n, inheritWidthFromTarget: s = !0, inheritMaxWidthFromTarget: r = !1 } = this.props,
          ...
          _calcTargetProps(e, t, n) {
            const s = e.getBoundingClientRect(),
              ...
              a = "parent" === this.props.root ? this._getCoordsRelToParentEl(e, s) : this._getCoordsRelToDocument(s);
          ...
          _getCoordsRelToDocument(e) {
            const t = pageYOffset,
              ...
              r = e.bottom + t,
              a = e.left + n;
            return { top: s, bottom: r, left: a, right: e.right + n, middle: (s + e.height) / 2, center: a + e.width / 2 };
          }
          _getCoordsRelToParentEl(e, t) {
            ...
            const s = n.scrollTop,
              ...
              o = e.offsetLeft + r,
              i = t.width + o;
            return { top: a, bottom: t.height + a, left: o, right: i, middle: (a + t.height) / 2, center: (o + t.width) / 2 };
          }
          _getDimensions(e) {
          ...
          _subscribe() {
            "document" === this.props.root &&
              (window.addEventListener("scroll", this._throttleCalcProps, !0), window.addEventListener("resize", this._throttleCalcProps));
          }
          _unsubsribe() {
      ...
      function D(e) {
        const { children: t, messageIdCallback: n, ...r } = e,
          o = s.useId();
        return a(o, n), s.createElement("span", { ...r, className: d["visually-hidden"], id: o }, t);
      }
      var b = n(9745),
        y = n(16658),
        C = n(40461);
      function E(e) {
        ...
        return s.createElement(b.Icon, { icon: y, className: r(C["error-icon"], C[`intent-${t}`]) });
      }
      var _,
        F,
        M = n(27345);
      ...
      const S = {
        top: { attachment: c.anchors.topRight.attachment, targetAttachment: c.anchors.topRight.targetAttachment, attachmentOffsetY: -4 },
        bottom: { attachment: c.anchors.bottomRight.attachment, targetAttachment: c.anchors.bottomRight.targetAttachment, attachmentOffsetY: 4 },
      };
      function k(e) {
        const {
            isOpened: t,
      ...
      function I(e) {
        ...
        const {
          ...
          U =
            !O && !V && !z && w
              ? s.createElement(l.AfterSlot, { className: r(M["static-messages"], M["input-description"]) }, s.createElement(P, { messageIdCallback: R }, w))
              : void 0;
        return {
          ariaIds: F,
          icon: $,
          renderedErrors:
            null !==
              (c = null !== (a = null !== (n = null !== (t = null != K ? K : W) && void 0 !== t ? t : j) && void 0 !== n ? n : J) && void 0 !== a ? a : q) &&
            void 0 !== c
              ? c
              : U,
      ...
      function h(e) {
                  ...
                  const { reference: n, ...r } = t,
                    ...
                    o =
                      "a" === a
                        ? r
                        : (function (e) {
                            const { download: t, href: n, hrefLang: s, media: r, ping: a, rel: o, target: i, type: l, referrerPolicy: c, ...u } = e;
                            return u;
                          })(r);
        ...
        return s.createElement(
          Z,
          {
            ...
            id: t,
            role: n,
            className: r(c, A.item, v && A.withIcon, { [A.isActive]: D, [A.isDisabled]: b || C, [A.hovered]: y }),
            title: h,
            href: _,
            target: S,
            rel: k,
          ...
          s.createElement("span", { className: r(A.labelRow, d) }, s.createElement("span", { className: r(A.label, p) }, E)),
          (void 0 !== g || f) && s.createElement("span", { className: A.shortcut }, (X = g) && X.split("+").join(" + ")),
          void 0 !== N && s.createElement("span", { onClick: P ? u : void 0, className: r(m, A.toolbox, { [A.showOnHover]: F, [A.showOnFocus]: M }) }, N)
        );
        var X;
      }
    },
