(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [92],
  {
    ...
    57340: (e, t, n) => {
      ...
      const d = r.forwardRef((e, t) => r.createElement(i.NavButton, { ...e, ref: t, icon: u(e.size) }));
    },
    64388: (e, t, n) => {
      "use strict";
      n.d(t, { NavButton: () => c });
      var r = n(50959),
        ...
        a = n(45350);
      function s(e) {
        const { size: t = "large", preservePaddings: n, isLink: r, flipIconOnRtl: o, className: s } = e;
        return i(a["nav-button"], a[`size-${t}`], n && a["preserve-paddings"], o && a["flip-icon"], r && a.link, s);
      }
      function l(e) {
      ...
      const c = (0, r.forwardRef)((e, t) => {
        const { icon: n, type: i = "button", preservePaddings: o, flipIconOnRtl: a, size: c, "aria-label": u, ...d } = e;
        return r.createElement("button", { ...d, className: s({ ...e, children: u }), ref: t, type: i }, r.createElement(l, { icon: n }, u));
      });
      ...
      (0, r.forwardRef)((e, t) => {
        ...
        return r.createElement(
          c,
          { ...a, className: s({ ...e, children: o, isLink: !0 }), reference: (0, d.isomorphicRef)(t) },
          ...
          r.createElement(
            ...
            n &&
              r.createElement(
                ...
                u && r.createElement(s.Icon, { className: a(w().icon, C && w()["light-icon"]), icon: null != h ? h : g[t] }),
                r.createElement(
                  "div",
                  { className: a(w()["text-wrap"], C && w()["light-text-wrap"]) },
                  o && r.createElement("span", { className: a(C && w()["light-title"], w().header, w()[`header-${C ? "new-line" : f}`]) }, o),
      ...
      function v(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(p, { content: t, informerIntent: o, className: a(f.notice, s && f.noticeShowed) })
          )
        );
      }
      class C {
        ...
        show(e) {
          this._wrap &&
            ...
            i.render(r.createElement(v, { text: e, style: this._bottomPadding ? { bottom: 70 } : void 0 }), this._wrap),
            this._debouncedHide());
        }
        hide() {
          this._wrap && ((this._showed = !1), i.unmountComponentAtNode(this._wrap), this._wrap.remove());
        }
        destroy() {
