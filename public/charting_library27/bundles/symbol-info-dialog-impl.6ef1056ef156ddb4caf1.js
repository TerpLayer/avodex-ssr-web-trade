  ...
  [9374],
  {
    ...
    36383: (e, t, r) => {
      ...
      var a = r(50959),
        o = r(27267);
      function i(e) {
        const { click: t, mouseDown: r, touchEnd: i, touchStart: n, handler: s, reference: l, ownerDocument: c = document } = e,
          d = (0, a.useRef)(null),
    ...
    90186: (e, t, r) => {
      ...
      r.d(t, { filterAriaProps: () => o, filterDataProps: () => a, filterProps: () => i, isAriaAttribute: () => s, isDataAttribute: () => n });
    },
    67961: (e, t, r) => {
      "use strict";
      ...
      class i {
        ...
        ensureWindow(e, t = { position: "fixed", direction: "normal" }) {
          ...
          if (((a.style.position = t.position), (a.style.zIndex = this._index.toString()), (a.dataset.id = e), void 0 !== t.index)) {
          ...
          } else "reverse" === t.direction ? this._container.insertBefore(a, this._container.firstChild) : this._container.appendChild(a);
        ...
        return () => {
          ...
          if (void 0 === e) {
            const r = document.createElement("div"),
              a = r.style;
            (a.visibility = "hidden"), (a.width = "100px"), (a.msOverflowStyle = "scrollbar"), document.body.appendChild(r);
      ...
      function c(e) {
        ...
        if (e && 1 == ++s) {
          const e = i(t, "overflow"),
            s = n(t, "padding-right");
          "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (o(r, "right", `${a()}px`), (t.style.paddingRight = `${s + a()}px`), (l = !0)),
            t.classList.add("i-no-scroll");
        } else if (!e && s > 0 && 0 == --s && (t.classList.remove("i-no-scroll"), l)) {
          o(r, "right", "0px");
          let e = 0;
          0, t.scrollHeight <= t.clientHeight && (e -= a()), (t.style.paddingRight = (e < 0 ? 0 : e) + "px"), (l = !1);
        }
      }
    },
    24437: (e, t, r) => {
      ...
      var a = r(88803);
      const o = { SmallHeight: a["small-height-breakpoint"], TabletSmall: a["tablet-small-breakpoint"], TabletNormal: a["tablet-normal-breakpoint"] };
    },
    29562: (e, t, r) => {
      "use strict";
      ...
      const s = n,
        l = a.forwardRef((e, t) => {
          const {
            ...
            z =
              s &&
              ("string" == typeof s ? a.createElement(i.Icon, { className: S.icon, icon: s }) : a.cloneElement(s, { className: o(S.icon, s.props.className) }));
          return "button" === r
            ? a.createElement(
                "button",
                { ...M, ref: t, type: "button", className: o(T, S.accessible), disabled: u && !k, onClick: _, title: g, "data-name": I, "data-tooltip": x },
            ...
            : a.createElement(
                "div",
                { ...M, ref: t, "data-role": "button", className: T, onClick: u ? void 0 : _, title: g, "data-name": I, "data-tooltip": x },
                f && v && a.createElement("div", { className: o("js-button-text", S.text) }, v),
                z,
                !f && v && a.createElement("div", { className: o("js-button-text", S.text) }, v),
    ...
    63065: (e, t, r) => {
      ...
      function m(e) {
        return o.createElement(
          o.Fragment,
          null,
          o.createElement("span", { className: i(u().background, e.statesWithoutBg && u()["states-without-bg"]) }),
          e.startIcon && o.createElement(s.Icon, { ...e.startIconAriaAttrs, className: u()["start-icon"], icon: e.startIcon }),
      ...
      function _(e) {
        ...
        return o.createElement(
          ...
          o.createElement(m, { showCaret: d, startIcon: l, startIconAriaAttrs: { ...c }, endIcon: h, endIconAriaAttrs: { ..._ }, statesWithoutBg: S }, s)
        );
      }
      r(21593);
      var v = r(35057),
      ...
      class S extends o.PureComponent {
        constructor(e) {
          super(e), (this._fullSessionScheduleViewModel = new f.FullSessionScheduleViewModel(e.source));
        }
        componentWillUnmount() {
        ...
        render() {
          ...
          return (
            null === (t = null === (e = this.props.source.marketStatusModel()) || void 0 === e ? void 0 : e.futuresContractExpirationTime()) || void 0 === t
              ? void 0
              : t.expired().value()
          )
            ? null
      ...
      function T() {
        document.removeEventListener("scroll", T), document.removeEventListener("touchstart", T), document.removeEventListener("mouseout", T), (0, I.hide)();
      }
      const z = 400;
      function N(e, t = {}) {
        const { initialDelay: a = z, leaveOnMouseOut: o, text: i = n.t(null, void 0, r(79732)) } = t;
        (0, I.showOnElement)(e, { below: !0, tooltipDelay: a, content: { type: "html", data: `${i} <span style="vertical-align: middle;">${x}</span>` } }),
            ...
            render: function ({ requestResize: e }) {
              return (
                ...
                o.createElement(
                  ...
                  m(),
                  s.flat().length && l && o.createElement("div", { className: i(C.separator, C.widgetSeparator) }),
                  l &&
                    o.createElement(
                      o.Fragment,
                      null,
                      o.createElement(
                        ...
                        o.createElement("span", { className: C.title }, n.t(null, void 0, r(25866))),
                        o.createElement(_, { onClick: () => d(!c), color: "light-gray", size: "small", startIcon: p }, n.t(null, void 0, r(50923)))
                      ),
                      o.createElement(S, { source: l, showAllDays: c, className: C.sessionWidget, timeZoneClassName: C.timeZone })
                    )
                )
              );
            },
            ...
            ? s.map((e, t) =>
                e.length
                  ? o.createElement(
                      ...
                      t !== s.length - 1 && o.createElement("div", { className: i(C.separator, C.groupSeparator) })
                    )
                  : null
              )
            : null;
      ...
      function P(e) {
        ...
        return o.createElement(
          ...
          o.createElement(A, { value: W(t), startSlot: t.startSlot, canCopy: t.canCopy, link: t.link })
        );
      }
      function A(e) {
            ...
            o.createElement(y.ToolWidgetButton, {
              ...
              onClick: async function () {
                await (0, b.copyToClipboard)({ text: t }),
                  d.current && (N(d.current, { initialDelay: 0, leaveOnMouseOut: !0, text: n.t(null, void 0, r(82833)) }), M());
              },
              icon: D,
            })
        );
      ...
      class Y {
        ...
        destroy() {
          this._quotesProvider.destroy(), this._marketStatusModel.destroy(), this._symbolInfo.unsubscribe(this._setSymbolInfo);
        }
        symbol() {
      ...
      function ae(e) {
        return re(e) && void 0 !== e.pricescale
          ? new q.PriceFormatter(e.pricescale / (0, $.ensureDefined)(e.minmove2)).format((0, $.ensureDefined)(e.minmove2) / e.pricescale)
          : null;
      }
      function oe(e) {
        ...
        if (o && a && t)
          return i ? n.t(null, { context: "double fractional tick size", replace: { minmove2: String(i), pricescale: String(a / i) } }, r(72653)) : `${t}/${a}`;
        const { variable_tick_size: s, ...l } = e;
        return (0, X.createSeriesFormatter)(l, "default").format(t / a);
      }
      function ie(e) {
        const { type: t = "", typespecs: r = [] } = e;
        return [t, ...r.filter((e) => ee.VISIBLE_TYPESPECS.has(e))].map((e) => (te.has(e) ? e.toUpperCase() : e)).join(" ");
      }
      function ne(e) {
        return !1;
      }
      ...
      class ue {
        constructor() {
          (this._container = null),
            (this._renderDialog = (e) => {
              this._container || (this._container = document.createElement("div")), a.render(o.createElement(H, { ...e }), this._container);
            }),
            (this._close = () => {
        ...
        async show(e) {
          ...
          const i = (function (e) {
            ...
            return [
              { title: n.t(null, void 0, r(3297)), group: 1, propName: (0, O.enabled)("charting_library_base") ? "name" : "pro_name" },
              { title: n.t(null, void 0, r(29601)), group: 1, propName: "description" },
              { title: n.t(null, void 0, r(22992)), group: 1, propName: "front_contract", visibility: ne, canCopy: !0 },
              {
              ...
              { title: n.t(null, void 0, r(54465)), group: 1, propName: "isin", canCopy: !0, visibility: (e) => !1 },
              { title: n.t(null, void 0, r(58416)), group: 2, propName: "type", getter: ie },
              { title: n.t(null, void 0, r(49263)), group: 2, propName: "expiration", visibility: le, formatter: J.bind(null, e.dateFormatter) },
              { title: n.t(null, void 0, r(64659)), group: 2, propName: "pointvalue" },
              {
                ...
                getStartSlot: (e, r) => {
                  var a;
                  const i = null !== (a = null == r ? void 0 : r.country_code) && void 0 !== a ? a : e.country,
                    n = e.exchange_logo;
                  return t ? o.createElement(K, { country: i, providerId: e.provider_id, sourceId: n }) : void 0;
                },
              },
              { title: n.t(null, void 0, r(77295)), group: 2, propName: "exchange", visibility: se },
              {
              ...
              },
              {
                ...
                visibility: (t) => Boolean((0, X.measureUnitId)(t) && (0, X.isMeasureUnitSymbol)(t) && e.showUnit),
                formatter: (e) => (null != e ? e : ""),
                defValue: "",
              },
              {
              ...
              { title: n.t(null, void 0, r(45221)), group: 2, propName: "pip_size", getter: ae, visibility: re },
