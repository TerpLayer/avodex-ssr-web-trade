      ...
      function d(t) {
        const {
          ...
          g = (0, n.useMemo)(function () {
            ...
            return { isInputsStudy: !0, symbolsResolved: () => t, resolvedSymbolInfoBySymbol: () => null, tempProperties: d };
          }, []),
          z = (0, n.useRef)(null),
          [b, v] = (0, n.useState)(C());
        return (
            ...
            render: () =>
              n.createElement(
                ...
                n.createElement(
                  ...
                  n.createElement(c.InputsTabContent, { reference: z, property: d, studyMetaInfo: S, model: y, study: g, inputs: r, onStudyInputChange: M })
                )
              ),
    ...
    73339: (t, i, e) => {
      ...
      async function u(t, i, n, u, c) {
            ...
            if ((0, s.isInputInlines)(t)) {
              ...
              if (i) {
                const { time: r, price: n } = i,
                  s = r.inline
                    ? o.t(null, { replace: { inputInline: r.inline, studyShortDescription: u } }, e(59877))
        ...
        async function d(t) {
          const i = "time" === t.type,
            ...
            n = (function () {
              ...
              const r = t.name
                  ? o.t(null, { replace: { inputTitle: t.name, studyShortDescription: u } }, e(18571))
                  : o.t(null, { replace: { studyShortDescription: u } }, e(42917)),
                n = t.name
                  ? o.t(null, { replace: { inputTitle: t.name, studyShortDescription: u } }, e(58552))
        ...
        async function S(i, e, o, s, u) {
          const c = await t.requestSelectPoint({ pointType: e, pane: a, lineColor: void 0, selectPointMode: p.SelectPointMode.Study }, o);
          void 0 === a && (a = c.pane);
          const h = n.childs().inputs;
          h && (s && (0, r.ensureDefined)(h.child(s)).setValue(1e3 * (c.point.time || 0)), u && (0, r.ensureDefined)(h.child(u)).setValue(c.point.price));
        }
        function y(t) {
          let i;
          return (
