(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [731],
  {
            ...
            (e.enableBodyScroll = function (e) {
              if (a) {
                ...
                (e.ontouchstart = null),
                  ...
                  s && 0 === n.length && (document.removeEventListener("touchmove", u, o ? { passive: !1 } : void 0), (s = !1));
              } else
    ...
    57222: (e) => {
      e.exports = { button: "button-Rc93kXa8", bordersVisible: "bordersVisible-Rc93kXa8", selected: "selected-Rc93kXa8" };
    },
    17723: (e) => {
    ...
    10341: (e) => {
      e.exports = { dialog: "dialog-IKuIIugL", tabletDialog: "tabletDialog-IKuIIugL", desktopDialog: "desktopDialog-IKuIIugL" };
    },
    66076: (e) => {
      e.exports = {
    ...
    36383: (e, t, o) => {
      ...
      var r = o(50959),
        a = o(27267);
      function n(e) {
        const { click: t, mouseDown: o, touchEnd: n, touchStart: s, handler: i, reference: l, ownerDocument: c = document } = e,
          d = (0, r.useRef)(null),
        ...
        return () => {
          ...
          if (void 0 === e) {
            const o = document.createElement("div"),
              r = o.style;
            (r.visibility = "hidden"), (r.width = "100px"), (r.msOverflowStyle = "scrollbar"), document.body.appendChild(o);
      ...
      function c(e) {
        ...
        if (e && 1 == ++i) {
          const e = n(t, "overflow"),
            i = s(t, "padding-right");
          "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (a(o, "right", `${r()}px`), (t.style.paddingRight = `${i + r()}px`), (l = !0)),
    ...
    14283: (e, t, o) => {
      ...
      var w = o(16396),
        ...
        N = o(57222);
      function E(e) {
        const { theme: t = N, children: o, onClick: a, isSelected: n, areBordersVisible: s, isItemSelected: i, className: l, value: d, name: u } = e;
        return r.createElement(
          "button",
          { type: "button", className: c()(l, t.button, n && t.selected, s && !n && !i && t.bordersVisible), name: u, value: d, onClick: a },
          o
        );
      }
      function M(e) {
      ...
      function z(e) {
            ...
            () =>
              (function (e) {
                return [
                  ...
                  { label: a.t(null, void 0, o(34420)), compareOption: D.CompareOption.NewPriceScale },
        ...
        return [
          (0, r.useMemo)(() => {
            var e, t;
            return null !== (t = null === (e = i[n]) || void 0 === e ? void 0 : e.compareOption) && void 0 !== t ? t : i[0].compareOption;
          }, [i, n]),
          i,
        ];
      }
      ...
      function T(e) {
        const { fullSymbolName: t, isSelected: n, className: s, isYield: l } = e,
          ...
          { compareModel: h, setHoveredItemId: p, clearInput: v, allowExtendTimeScale: f } = (0, k.useEnsuredContext)(_),
        ...
        return d
          ? r.createElement(
              ...
              r.createElement(
                ...
                S.map(({ label: e, compareOption: t }) => r.createElement(w.PopupMenuItem, { key: t, className: L.item, onClick: E, onClickArg: t, label: e }))
              )
            )
          : r.createElement(
              "div",
              ...
              S.map(({ label: e, compareOption: t }) =>
                r.createElement(M, { key: t, onClick: E, value: t, isItemSelected: Boolean(n), isSelected: n && y === t }, e)
              )
            );
        function N(e) {
          d && b && b(), v && e && v(u, m);
      ...
      function A(e) {
        const { isSelected: t, fullSymbolName: o, onExpandClick: a, actions: s, id: l, isOffset: c, isYield: d } = e,
          { isMobile: u, toggleExpand: m, searchSpreads: h, searchRef: p, setMode: v, mode: f } = (0, k.useEnsuredContext)(g.SymbolSearchItemsDialogContext),
          { compareModel: b, hoveredItemId: w, setHoveredItemId: I, clearInput: C, allowExtendTimeScale: N } = (0, k.useEnsuredContext)(_),
          [E, M] = (0, r.useState)(!1),
          z = (0, r.useRef)(null),
            ...
            onClick: function (t) {
              ...
              if ((n.mobiletouch ? j : !E) && o) {
                (0, i.getSymbolSearchCompleteOverrideFunction)()(o).then((e) => {
                  const t = b.comparableOnSameScale({ isYield: d }) ? D.CompareOption.SameScale : D.CompareOption.SamePctScale;
      ...
      function R(e) {
        const { handleListWidth: t } = (0, d.ensureNotNull)((0, r.useContext)(g.SymbolSearchItemsDialogContext)),
          { compareModel: n, selectedCompareIndex: s, selectedItemRef: i } = (0, d.ensureNotNull)((0, r.useContext)(_)),
                        ...
                        x.map((e, t) =>
                          r.createElement(y.SymbolSearchDialogContentItem, {
                            ...
                            actions: r.createElement(
                              ...
                              r.createElement(E, { className: H.checkbox, onClick: I.bind(null, e), isSelected: C(e) }, r.createElement(u.Icon, { icon: P }))
                            ),
                          })
                        )
                      ),
          ...
          super(e),
            ...
            (this._getContextValue = () => {
              const { compareModel: e } = this.props,
                { selectedCompareOptionIndex: t, selectedCompareIndex: o, hoveredItemId: r, allowExtendTimeScale: a } = this.state;
              return {
                compareModel: e,
            ...
            (this._toggleAllowExtendTimeScale = () => {
              ...
              O.setValue("showAddSymbolDialog.extendCheckboxState", e), this.setState({ allowExtendTimeScale: e });
            }),
            (this.state = {
            ...
            onKeyDown: function (e) {
              ...
              switch (a) {
                case 13: {
                  ...
                  return void (a && M && (i([{ symbol: f ? a.toUpperCase() : a, resolved: !1, compareOption: R, allowExtendTimeScale: D }]), M(o, d)));
                }
                case 27:
      ...
      function ee(e) {
        ...
        function n() {
          ...
          t.current &&
            a &&
            ("compare" !== a.current ||
            "" === (null === (r = null === (e = null == t ? void 0 : t.current) || void 0 === e ? void 0 : e.value) || void 0 === r ? void 0 : r.trim())
              ? "symbolSearch" === a.current &&
                "" === (null === (s = null === (n = null == t ? void 0 : t.current) || void 0 === n ? void 0 : n.value) || void 0 === s ? void 0 : s.trim()) &&
                o("compare")
              : o("symbolSearch"));
        }
      }
      var te = o(70673),
        ...
        re = o(44467);
      function ae(e) {
        const { allowExtendTimeScale: t, toggleAllowExtendTimeScale: n } = (0, d.ensureNotNull)((0, r.useContext)(_));
        return r.createElement(
      ...
      class n extends r.PureComponent {
        ...
        componentDidUpdate(e, t) {
          !t.stack.length && this.state.stack.length && ((0, a.setFixedBodyState)(!0), (this._isBodyFixed = !0)),
            t.stack.length && !this.state.stack.length && this._isBodyFixed && ((0, a.setFixedBodyState)(!1), (this._isBodyFixed = !1));
        }
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(h, { className: n(p.drawer, u[`position${t}`], m), ref: b, "data-name": e["data-name"] }, d)
            )
          )
        );
      }
      ...
      function u(e) {
                  ...
                  const { reference: o, ...a } = t,
                    ...
                    s =
                      "a" === n
                        ? a
                        : (function (e) {
                            const { download: t, href: o, hrefLang: r, media: a, ping: n, rel: s, target: i, type: l, referrerPolicy: c, ...d } = e;
                            return d;
                          })(a);
        ...
        return r.createElement(
          X,
          {
            ...
            id: t,
            role: o,
            className: a(c, B.item, b && B.withIcon, { [B.isActive]: y, [B.isDisabled]: _ || k, [B.hovered]: S }),
            title: u,
            href: w,
            target: N,
            rel: E,
          ...
          r.createElement("span", { className: a(B.labelRow, m) }, r.createElement("span", { className: a(B.label, h) }, x)),
          (void 0 !== v || f) && r.createElement("span", { className: B.shortcut }, (Q = v) && Q.split("+").join(" + ")),
          void 0 !== M && r.createElement("span", { onClick: A ? d : void 0, className: a(p, B.toolbox, { [B.showOnHover]: I, [B.showOnFocus]: C }) }, M)
        );
        var Q;
      }
    },
