(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3005],
  {
    ...
    46618: (e, t, s) => {
      ...
      var S = s(21043);
      function y(e) {
        const { children: t, className: s, noLeftDecoration: r, noRightDecoration: i, noMinimalWidth: o, onClick: l, removeSeparator: c } = e;
        return n.createElement(
          n.Fragment,
          null,
          !c && n.createElement("div", { className: S.separatorWrap }, n.createElement(g, { className: S.separator })),
          n.createElement("div", { className: a(s, S.group, { [S.noMinimalWidth]: o, [S.noLeftDecoration]: r, [S.noRightDecoration]: i }), onClick: l }, t)
        );
      }
      var _ = s(45601),
        E = s(11542),
      ...
      function I(e) {
        return n.createElement("div", { className: C.wrap }, n.createElement(b.Icon, { className: C.icon, icon: w }), M.text);
      }
      var k = s(88275),
        R = s(61345),
        V = s(38223),
        ...
        return (
          ((o = class extends n.PureComponent {
            constructor(e) {
              super(e),
                ...
                (this._handleResizeWrap = ([e]) => {
                  ...
                  this.props.onMeasureWrap && this.props.onMeasureWrap(t), this.setState({ widthWrap: t.width }), this._checkButtonsVisibility();
                }),
                ...
                (this._checkButtonsVisibility = () => {
                  const { isVisibleLeftButton: e, isVisibleRightButton: t } = this.state,
                    s = this.isAtLeft(),
                    n = this.isAtRight();
                  s || e ? s && e && this.setState({ isVisibleLeftButton: !1 }) : this.setState({ isVisibleLeftButton: !0 }),
                    n || t ? n && t && this.setState({ isVisibleRightButton: !1 }) : this.setState({ isVisibleRightButton: !0 });
                }),
            ...
            isAtRight() {
              return (
                !this._isOverflowed() ||
                this.currentPosition() + this.state.widthWrap >= this.state.widthContent - (0, i.ensureDefined)(this.props.hideButtonsFrom)
              );
            }
            animateTo(e, t = R.dur) {
              ...
              return n.createElement(_.Measure, { onResize: u ? this._handleResizeWrap : null }, (d) =>
                n.createElement(
                  ...
                  n.createElement(
                    ...
                    n.createElement(
                      "div",
                      { className: a(F.scrollWrap, p, { [F.noScrollBar]: !o }), onScroll: this._handleScroll, ref: this._scroll },
      ...
      class j extends n.PureComponent {
                  ...
                  ((e) => {
                    switch (e.type) {
                      ...
                      case "TradingViewStyledButton":
                        return n.createElement(r.CustomTradingViewStyledButton, { ...e.params, className: X.button, displayMode: s });
                      case "Dropdown":
        ...
        render() {
          ...
          return n.createElement(
                          ...
                          n.Children.toArray([
                            (e.SymbolSearch || (!U && e.Compare)) &&
                              n.createElement(
                                ...
                                { key: "symbol" },
                                e.SymbolSearch &&
                                  n.createElement(e.SymbolSearch, { id: h ? void 0 : P.SymbolSearch, isActionsVisible: t.allowSymbolSearchSpread }),
                                e.Compare && n.createElement(e.Compare, { id: h ? void 0 : P.Compare, className: X.button, displayMode: s })
                              ),
                            ...
                            U &&
                              ...
                              n.createElement(
                                y,
                                { key: "compare" },
                                n.createElement(e.Compare, { id: h ? void 0 : P.Compare, className: X.button, displayMode: s })
                              ),
                            e.Indicators &&
                              n.createElement(
                                y,
                                { key: "indicators" },
                                n.createElement(e.Indicators, { id: h ? void 0 : P.Indicators, className: X.button, studyMarket: i, displayMode: s }),
                                e.Templates &&
                            ...
                            e.Alert &&
                              n.createElement(
                                y,
                                { key: "alert" },
                                n.createElement(e.Alert, { id: h ? void 0 : P.Alerts, className: X.button, displayMode: s }),
                                e.Replay && n.createElement(e.Replay, { id: h ? void 0 : P.Replay, className: X.button, displayMode: s })
                              ),
                            e.AlertReferral &&
                              n.createElement(y, { key: "alert-referral" }, n.createElement(e.AlertReferral, { className: X.button, displayMode: s })),
                            e.ScalePercentage && n.createElement(y, { key: "percentage" }, n.createElement(e.ScalePercentage, null)),
                            e.ScaleLogarithm && n.createElement(y, { key: "logarithm" }, n.createElement(e.ScaleLogarithm, null)),
                            ...f,
                          ]),
                        (function (e) {
                          ...
                          n.Children.toArray([
                            o && n.createElement(y, { key: "view-only-badge", removeSeparator: !0 }, n.createElement(I, null)),
                            !o && e.UndoRedo && n.createElement(y, { key: "undo-redo" }, n.createElement(e.UndoRedo, { id: h ? void 0 : P.UndoRedo })),
                            n.createElement(y, { removeSeparator: !0, key: "gap-1", className: a(X.fill, h && X.collapse) }),
                            (e.Layout || e.SaveLoad) &&
                              n.createElement(
                                y,
                                { key: "layout", removeSeparator: !0 },
                                !o && e.Layout && n.createElement(e.Layout, { id: h ? void 0 : P.Layouts }),
                                e.SaveLoad &&
                            ...
                            e.SaveLoadReferral &&
                              n.createElement(y, { key: "save-load-referral" }, n.createElement(e.SaveLoadReferral, { isReadOnly: o, displayMode: s })),
                            t.showLaunchInPopupButton && e.OpenPopup && n.createElement(y, { key: "popup" }, n.createElement(e.OpenPopup, null)),
                            !o &&
                              (e.Properties || e.Fullscreen || (!U && e.Screenshot)) &&
                              n.createElement(
                                y,
                                { key: "properties" },
                                !o && e.QuickSearch && n.createElement(e.QuickSearch, { id: h ? void 0 : P.QuickSearch, className: X.iconButton }),
                                !o && e.Properties && n.createElement(e.Properties, { id: h ? void 0 : P.Properties, className: X.iconButton }),
                                n.createElement(
                                  n.Fragment,
                                  null,
                                  !o &&
                                  ...
                                  !U && e.Screenshot && n.createElement(e.Screenshot, { id: h ? void 0 : P.Screenshot, className: X.iconButton })
                                )
                              ),
                            U &&
                              !o &&
                            ...
                            U &&
                              ...
                              n.createElement(
                                ...
                                n.createElement(e.Screenshot, { id: h ? void 0 : P.Screenshot, className: X.iconButton })
                              ),
                            !o &&
                              e.Publish &&
                              n.createElement(
            ...
            e.Publish && !o && !h && n.createElement(e.Publish, { id: P.PublishDesktop, className: X.desktopPublish })
          );
        }
      ...
      class le {
        ...
        add(e, t, s) {
          ...
          return this._isIntervalDefault(n) || r.includes(n) ? null : (this._customIntervalsService.set((0, $.sortResolutions)([...r, n])), n);
        }
        remove(e) {
      ...
      class ve {
        ...
        removeFavorite(e) {
          ...
          -1 !== s && (this._favorites.splice(s, 1), this._favoritesChanged.fire(t)), this._saveFavs();
        }
        favId(e) {
      ...
      class Ve extends n.PureComponent {
        constructor(e) {
          ...
          (this._favoriteIntervalsService = l || new ee(re.TVXWindowEvents, ne, b)),
            ...
            (this.state = { isVisible: !0, availableWidth: 0, displayMode: "full", measureValid: !1, leftCustomElements: [], rightCustomElements: [] }),
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  h.map((e) => n.createElement(j, { key: e, displayMode: e, onWidthChange: this._panelWidthChangeHandlers[e], ...d })),
                  n.createElement(j, {
                    key: "live",
        ...
        addDropdown(e, t) {
          ...
          "left" === t.align ? this.setState({ leftCustomElements: [...s, r] }) : this.setState({ rightCustomElements: [...n, r] });
        }
        updateDropdown(e, t) {
          ...
          void 0 !== n &&
            ((n.params = { ...n.params, ...t }),
            this.setState({ leftCustomElements: this.state.leftCustomElements.slice(), rightCustomElements: this.state.rightCustomElements.slice() }));
        }
        removeDropdown(e) {
        ...
        _addCustomTradingViewStyledButton(e, t) {
          const s = { type: "TradingViewStyledButton", id: e, params: { key: Number(new Date()), text: t.text, title: t.title, onClick: t.onClick } };
          this._addCustomElementToState(t.align, s);
        }
        _addCustomElementToState(e, t) {
          const { leftCustomElements: s, rightCustomElements: n } = this.state;
          "left" === e ? this.setState({ leftCustomElements: [...s, t] }) : this.setState({ rightCustomElements: [...n, t] });
        }
      }
