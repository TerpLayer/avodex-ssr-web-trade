  ...
  const r = class {
    constructor(t) {
      ...
      (null === (i = t.overrides) || void 0 === i ? void 0 : i["mainSeriesProperties.priceAxisProperties.lockScale"]) &&
        (console.warn("mainSeriesProperties.priceAxisProperties.lockScale can not be set to true within the widget constructor"),
      ...
      "dark" === (null !== (s = this._options.theme) && void 0 !== s ? s : "light").toLowerCase() &&
        ...
        this._options.debug && (o || ((o = !0), console.log("Using CL v27.006 (internal id c7d57a22 @ 2024-05-21T16:14:30.134Z)"))),
        this._create();
    }
    setDebugMode(t) {
    ...
    _create() {
      var t, e;
      const n =
          null !== (e = null === (t = this._options.enabled_features) || void 0 === t ? void 0 : t.includes("iframe_loading_compatibility_mode")) &&
          void 0 !== e &&
          e,
        [i, o] = this._render(!n),
      ...
      (this._innerWindowLoaded = new Promise((t) => {
        ...
        n &&
          (a.contentWindow
            ...
            : console.warn("Unable to locate contentWindow for the created iframe. Please try disabling the `iframe_loading_compatibility_mode` featureset.")),
        (this._options.autosize || this._options.fullscreen) && ((a.style.width = "100%"), this._options.fullscreen || (a.style.height = "100%")),
    ...
    _render(t) {
      ...
      if (
        (this._options.library_path && !this._options.library_path.endsWith("/") && console.warn("library_path option should contain a trailing forward slash"),
      ...
      const n = (function (t, e) {
        ...
        return `<!DOCTYPE html><html ${(h = { bundles: l, localeLanguage: r, htmlAttrs: d, libraryPath: o }).htmlAttrs}><head><base href="${
          h.libraryPath
