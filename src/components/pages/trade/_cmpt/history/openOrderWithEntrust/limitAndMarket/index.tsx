      ...
      content: (
        <div className={styles.alertModalContent}>
          <svg xmlns="http://www.w3.org/2000/svg" width="84" height="84" viewBox="0 0 84 84" fill="none">
            <path
              d="M42 77C22.67 77 7 61.3298 7 42C7 22.67 22.67 7 42 7C61.3298 7 77 22.67 77 42C77 61.3298 61.3298 77 42 77ZM42 70C57.4641 70 70 57.4641 70 42C70 26.536 57.4641 14 42 14C26.536 14 14 26.536 14 42C14 57.4641 26.536 70 42 70ZM38.5 52.5H45.5V59.5H38.5V52.5ZM38.5 24.5H45.5V45.5H38.5V24.5Z"
              fill="#FF453A"
            />
          </svg>
