...
export interface StudyTeAzInputInfo extends StudyInputBaseInfo {
  /** Input type is Text */
...
export interface TextWithCheckboxFieldMetaInfo extends CustomInputFieldMetaInfo {
  ...
  /** @inheritDoc */
  validator?: TeAzInputFieldValidator;
}
...
export type IProjectionBar = [number, number, number, number, number, number] | [number, number, number, number, number, number, number];
/**
...
export type TeAzInputFieldValidator = (value: string) => InputFieldValidatorResult;
