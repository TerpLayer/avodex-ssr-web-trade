declare module "big.js" {
  ...
  export interface Big {
     ...
     *最大小数位
     */
    toFixedMax(max: number): string;
    /**
     * 最小小数位 
     **/
    toFixedMin(min: number): string;
    /**
     * 千分位
     **/
    toFixedCy(dp?: number, rm?: RoundingMode): string;
    /**
     * 最大小数位千分位
     */
    toFixedMaxCy(max: number): string;
    /**
     * 最小小数位千分位
     */
    toFixedMinCy(min: number): string;
    /**
